...
dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.5/bin/z3" > $ADT_5_LOG_DIR/CP3-S0.trace;
echo "4.8.5, CP3, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:random-seed=${i}00 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.5/bin/z3" > $ADT_5_LOG_DIR/CP3-S${i}00.trace;
    echo "4.8.5, CP3, Seed${i}00, done";
done
echo "4.8.5, ADT, CP3, done";

dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:smt.CASE_SPLIT=1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.5/bin/z3" > $ADT_5_LOG_DIR/CP1-S0.trace;
echo "4.8.5, CP1, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.CASE_SPLIT=1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.5/bin/z3" > $ADT_5_LOG_DIR/CP1-S${i}00.trace;
    echo "4.8.5, CP1, Seed${i}00, done";
done
...
dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.9/bin/z3" > $ADT_9_LOG_DIR/CP3-S0.trace;
echo "4.8.9, CP3, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:random-seed=${i}00 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.9/bin/z3" > $ADT_9_LOG_DIR/CP3-S${i}00.trace;
    echo "4.8.9, CP3, Seed${i}00, done";
done
...
# dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.8/bin/z3" > $ADT_8_LOG_DIR/CP3-S0.trace;
# echo "4.8.8, CP3, no Seed, done";
# for i in $seeds; do
#     dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:random-seed=${i}00 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.8/bin/z3" > $ADT_8_LOG_DIR/CP3-S${i}00.trace;
#     echo "4.8.8, CP3, Seed${i}00, done";
# done
# echo "4.8.8, ADT, CP3, done";

# dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:smt.CASE_SPLIT=1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.8/bin/z3" > $ADT_8_LOG_DIR/CP1-S0.trace;
# echo "4.8.8, CP1, no Seed, done";
# for i in $seeds; do
#     dafny /compile:0 DLL-ADT-short-module.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.CASE_SPLIT=1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.8/bin/z3" > $ADT_8_LOG_DIR/CP1-S${i}00.trace;
#     echo "4.8.8, CP1, Seed${i}00, done";
# done
