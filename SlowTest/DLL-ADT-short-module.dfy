  ...
  ensures l'.freeStack != I0 && AbSeqIndex(l'.freeStack, l'.nodes).data.None?
{
  ...
  forall x | AbLt(x, len) ensures AbLt(x, len')
    { Props_lt_transitive_p3 (x, len, len'); } // |g| < |g'|
  Props_lt_is_not_leq ();
  ...
  Props_lt_addition_rev_p3 (I0, AbSub(len', I1), I1); // I1 < len' ==> I0 < len' - 1
