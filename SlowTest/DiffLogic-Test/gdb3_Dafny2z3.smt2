...
(declare-fun _module.__default.myP (Bool Bool) Bool)
(declare-fun |_module.__default.myP#canCall| (Bool Bool) Bool)
(declare-fun |_module.__default.myP#requires| (Bool Bool) Bool)
...
(assert (forall ((|a#0@@4| Int) (|b#0@@4| Int) ) (!  (and (=> (|_module.__default.Sub#requires| |a#0@@4| |b#0@@4|) true) (=> true (|_module.__default.Sub#requires| |a#0@@4| |b#0@@4|)))
 :qid |gdb3Dafn.3:21|
 :skolemid |813|
...
(assert (forall ((arg0@@171 T@U) (arg1@@82 T@U) (arg2@@35 T@U) (arg3@@14 Bool) ) (! (= (type (|lambda#1| arg0@@171 arg1@@82 arg2@@35 arg3@@14)) (MapType4Type refType boolType))
 ...
 :pattern ( (|lambda#1| arg0@@171 arg1@@82 arg2@@35 arg3@@14))
)))
...
(declare-fun %lbl%+7 () Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(assert  (and (= (type $_Frame@0) (MapType4Type refType boolType)) (= (type $Heap) (MapType0Type refType MapType1Type))))
(push 1)
(set-info :boogie-vc-id Impl$$_module.__default.myTest2)
(assert (not
(let ((anon3_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (! (or %lbl%@1  (or |a#0@@11| |b#0@@11|)) :lblneg @1))))
(let ((anon6_Else_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> |a#0@@11| anon3_correct))))
(let ((anon6_Then_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (not |a#0@@11|) anon3_correct))))
