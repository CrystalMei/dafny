...
))))))) (and (and (= (|Seq#Length| (_module.__default.SeqInit _module._default.SeqInit$X |len#0| |func#0|)) |len#0|) (forall ((|i#1| Int) ) (!  (=> true (=> (and (<= 0 |i#1|) (< |i#1| |len#0|)) (=> (Requires1 TInt _module._default.SeqInit$X $Heap |func#0| ($Box (int_2_U |i#1|))) (= (|Seq#Index| (_module.__default.SeqInit _module._default.SeqInit$X |len#0| |func#0|) |i#1|) (Apply1 TInt _module._default.SeqInit$X $Heap |func#0| ($Box (int_2_U |i#1|)))))))
 :qid |DLLDafny.43:18|
 :skolemid |1030|
...
(assert  (and (and (and (and (and (= (type |g#0@@3|) (SeqType BoxType)) (= (type |g'#0@0|) (SeqType BoxType))) (= (type $Heap@0) (MapType0Type refType MapType1Type))) (= (type $_Frame@0) (MapType6Type refType boolType))) (= (type $Heap@@1) (MapType0Type refType MapType1Type))) (= (type |g'#0|) (SeqType BoxType))))
(push 1)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.InsertBefore__SeqInit)
(assert (not
(let ((anon15_correct  (=> (! (and %lbl%+0 true) :lblpos +0) true)))
(let ((anon21_Else_correct  (=> (! (and %lbl%+1 true) :lblpos +1) (=> (=> (and (not (= |x#4@0| |p'#0|)) (> |index'#0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#4@0|))))) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#4@0|))) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#4@0|))))) anon15_correct))))
(let ((anon21_Then_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (not (= |x#4@0| |p'#0|)) (and (! (or %lbl%@3  (and (<= 0 |x#4@0|) (< |x#4@0| (|Seq#Length| |g#0@@3|)))) :lblneg @3) (=> (and (<= 0 |x#4@0|) (< |x#4@0| (|Seq#Length| |g#0@@3|))) (=> (> |index'#0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#4@0|)))) (and (! (or %lbl%@4  (and (<= 0 |x#4@0|) (< |x#4@0| (|Seq#Length| |g'#0@0|)))) :lblneg @4) (=> (and (<= 0 |x#4@0|) (< |x#4@0| (|Seq#Length| |g'#0@0|))) (and (! (or %lbl%@5  (and (<= 0 |x#4@0|) (< |x#4@0| (|Seq#Length| |g#0@@3|)))) :lblneg @5) (=> (and (<= 0 |x#4@0|) (< |x#4@0| (|Seq#Length| |g#0@@3|))) (=> (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#4@0|))) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#4@0|)))) anon15_correct))))))))))))
(let ((anon20_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (and (<= 0 |x#4@0|) (< |x#4@0| (|Seq#Length| |g#0@@3|))) (and anon21_Then_correct anon21_Else_correct)))))
(let ((anon20_Else_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (=> (and (<= 0 |x#4@0|) (< |x#4@0| (|Seq#Length| |g#0@@3|))) (=> (and (not (= |x#4@0| |p'#0|)) (> |index'#0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#4@0|))))) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#4@0|))) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#4@0|)))))) anon15_correct))))
(let ((anon10_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (forall ((|x#3| Int) ) (!  (=> true (=> (and (<= 0 |x#3|) (< |x#3| (|Seq#Length| |g#0@@3|))) (=> (and (not (= |x#3| |p'#0|)) (<= |index'#0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#3|))))) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#3|))) (_module.__default.Add (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#3|))) 1)))))
 :qid |DLLDafny.439:18|
 :skolemid |1602|
 :pattern ( ($Unbox intType (|Seq#Index| |g'#0@0| |x#3|)))
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@3| |x#3|)))
)) (and anon20_Then_correct anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (=> (and (not (= |x#2@0| |p'#0|)) (<= |index'#0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#2@0|))))) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#2@0|))) (_module.__default.Add (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#2@0|))) 1))) anon10_correct))))
(let ((anon19_Then_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (not (= |x#2@0| |p'#0|)) (and (! (or %lbl%@11  (and (<= 0 |x#2@0|) (< |x#2@0| (|Seq#Length| |g#0@@3|)))) :lblneg @11) (=> (and (<= 0 |x#2@0|) (< |x#2@0| (|Seq#Length| |g#0@@3|))) (=> (<= |index'#0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#2@0|)))) (and (! (or %lbl%@12  (and (<= 0 |x#2@0|) (< |x#2@0| (|Seq#Length| |g'#0@0|)))) :lblneg @12) (=> (and (<= 0 |x#2@0|) (< |x#2@0| (|Seq#Length| |g'#0@0|))) (and (! (or %lbl%@13  (and (<= 0 |x#2@0|) (< |x#2@0| (|Seq#Length| |g#0@@3|)))) :lblneg @13) (=> (and (<= 0 |x#2@0|) (< |x#2@0| (|Seq#Length| |g#0@@3|))) (=> (and (= |##a#0@0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#2@0|)))) ($IsAlloc (int_2_U |##a#0@0|) TInt $Heap@0)) (=> (and (and (= |##b#0@0| 1) ($IsAlloc (int_2_U |##b#0@0|) TInt $Heap@0)) (and (|_module.__default.Add#canCall| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#2@0|))) 1) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#2@0|))) (_module.__default.Add (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#2@0|))) 1)))) anon10_correct)))))))))))))
(let ((anon18_Then_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (and (<= 0 |x#2@0|) (< |x#2@0| (|Seq#Length| |g#0@@3|))) (and anon19_Then_correct anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (! (and %lbl%+15 true) :lblpos +15) (=> (=> (and (<= 0 |x#2@0|) (< |x#2@0| (|Seq#Length| |g#0@@3|))) (=> (and (not (= |x#2@0| |p'#0|)) (<= |index'#0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#2@0|))))) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#2@0|))) (_module.__default.Add (U_2_int ($Unbox intType (|Seq#Index| |g#0@@3| |x#2@0|))) 1)))) anon10_correct))))
(let ((anon5_correct  (=> (! (and %lbl%+16 true) :lblpos +16) (=> (forall ((|x#1| Int) ) (!  (=> true (=> (and (<= 0 |x#1|) (< |x#1| (|Seq#Length| |g#0@@3|))) (=> (= |x#1| |p'#0|) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#1|))) |index'#0|))))
 :qid |DLLDafny.438:18|
 :skolemid |1601|
 :pattern ( ($Unbox intType (|Seq#Index| |g'#0@0| |x#1|)))
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@3| |x#1|)))
)) (and anon18_Then_correct anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (=> (=> (= |x#0@0| |p'#0|) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#0@0|))) |index'#0|)) anon5_correct))))
(let ((anon17_Then_correct  (=> (! (and %lbl%+18 true) :lblpos +18) (=> (= |x#0@0| |p'#0|) (and (! (or %lbl%@19  (and (<= 0 |x#0@0|) (< |x#0@0| (|Seq#Length| |g'#0@0|)))) :lblneg @19) (=> (and (<= 0 |x#0@0|) (< |x#0@0| (|Seq#Length| |g'#0@0|))) (=> (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#0@0|))) |index'#0|) anon5_correct)))))))
(let ((anon16_Then_correct  (=> (! (and %lbl%+20 true) :lblpos +20) (=> (and (<= 0 |x#0@0|) (< |x#0@0| (|Seq#Length| |g#0@@3|))) (and anon17_Then_correct anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (! (and %lbl%+21 true) :lblpos +21) (=> (=> (and (<= 0 |x#0@0|) (< |x#0@0| (|Seq#Length| |g#0@@3|))) (=> (= |x#0@0| |p'#0|) (= (U_2_int ($Unbox intType (|Seq#Index| |g'#0@0| |x#0@0|))) |index'#0|))) anon5_correct))))
(let ((anon0_correct  (=> (! (and %lbl%+22 true) :lblpos +22) (=> (= $_Frame@0 (|lambda#129| null $Heap@@1 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and (and ($Is |g'#0@0| (TSeq TInt)) ($IsAlloc |g'#0@0| (TSeq TInt) $Heap@0)) (= (|Seq#Length| |g'#0@0|) (|Seq#Length| |g#0@@3|)))) (and anon16_Then_correct anon16_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+23 true) :lblpos +23) (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($Is |g#0@@3| (TSeq TInt)) ($IsAlloc |g#0@@3| (TSeq TInt) $Heap@@1))) (and (and ($Is |g'#0| (TSeq TInt)) ($IsAlloc |g'#0| (TSeq TInt) $Heap@@1)) (= 40 $FunctionContextHeight))) anon0_correct))))
