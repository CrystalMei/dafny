...
(declare-fun |_module.__default.Length#requires| (T@U T@U T@U) Bool)
(declare-fun _module.__default.Split (T@U T@U Int) T@U)
(declare-fun |_module.__default.Split#canCall| (T@U Int) Bool)
(declare-fun |_module.__default.Split#requires| (T@U T@U Int) Bool)
(declare-fun _module.__default.Elements (T@U T@U T@U) T@U)
(declare-fun |_module.__default.Elements#canCall| (T@U T@U) Bool)
(declare-fun |_module.__default.Elements#requires| (T@U T@U T@U) Bool)
...
(declare-fun |_module.__default.NoDuplicates#requires| (T@U T@U T@U) Bool)
(declare-fun _module.__default.IntRange (T@U Int Int) T@U)
(declare-fun |_module.__default.IntRange#canCall| (Int Int) Bool)
(declare-fun |_module.__default.IntRange#requires| (T@U Int Int) Bool)
(declare-fun |lambda#22| (T@U Int Int) T@U)
...
(declare-fun |lambda#4| (T@U T@U Int) T@U)
...
(assert (forall ((bx@@68 T@U) ) (!  (=> (and (= (type bx@@68) BoxType) ($IsBox bx@@68 Tclass._module.__default)) (and (= ($Box ($Unbox refType bx@@68)) bx@@68) ($Is ($Unbox refType bx@@68) Tclass._module.__default)))
 :qid |unknown.0:0|
 :skolemid |883|
 :pattern ( ($IsBox bx@@68 Tclass._module.__default))
)))
...
(assert (forall (($o@@8 T@U) ($h@@23 T@U) ) (!  (=> (and (= (type $o@@8) refType) (= (type $h@@23) (MapType0Type refType MapType1Type))) (and (=> ($IsAlloc $o@@8 Tclass._module.__default $h@@23) (or (= $o@@8 null) (U_2_bool (MapType1Select (MapType0Select $h@@23 $o@@8) alloc)))) (=> (or (= $o@@8 null) (U_2_bool (MapType1Select (MapType0Select $h@@23 $o@@8) alloc))) ($IsAlloc $o@@8 Tclass._module.__default $h@@23))))
 :qid |unknown.0:0|
 :skolemid |885|
 :pattern ( ($IsAlloc $o@@8 Tclass._module.__default $h@@23))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|a#0| Int) (|b#0| Int) ) (!  (=> (or (|_module.__default.Add#canCall| |a#0| |b#0|) (not (= 1 $FunctionContextHeight))) true)
 :qid |SMNDafny.2:21|
 :skolemid |886|
 :pattern ( (_module.__default.Add |a#0| |b#0|))
))))
(assert (forall ((|a#0@@0| Int) (|b#0@@0| Int) ) (!  (and (=> (|_module.__default.Add#requires| |a#0@@0| |b#0@@0|) true) (=> true (|_module.__default.Add#requires| |a#0@@0| |b#0@@0|)))
 :qid |SMNDafny.2:21|
 :skolemid |887|
 :pattern ( (|_module.__default.Add#requires| |a#0@@0| |b#0@@0|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|a#0@@1| Int) (|b#0@@1| Int) ) (!  (=> (or (|_module.__default.Add#canCall| |a#0@@1| |b#0@@1|) (not (= 1 $FunctionContextHeight))) (= (_module.__default.Add |a#0@@1| |b#0@@1|) (+ |a#0@@1| |b#0@@1|)))
 :qid |SMNDafny.2:21|
 :skolemid |888|
 :pattern ( (_module.__default.Add |a#0@@1| |b#0@@1|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|a#0@@2| Int) (|b#0@@2| Int) ) (!  (=> (or (|_module.__default.Add#canCall| |a#0@@2| |b#0@@2|) (not (= 1 $FunctionContextHeight))) (= (_module.__default.Add |a#0@@2| |b#0@@2|) (+ |a#0@@2| |b#0@@2|)))
 :qid |SMNDafny.2:21|
 :weight 3
 :skolemid |889|
 :pattern ( (_module.__default.Add |a#0@@2| |b#0@@2|))
))))
(assert (forall ((_module._default.Length$_T0 T@U) ($ly T@U) (|xs#0| T@U) ) (!  (=> (and (and (= (type _module._default.Length$_T0) TyType) (= (type $ly) LayerTypeType)) (= (type |xs#0|) DatatypeTypeType)) (= (_module.__default.Length _module._default.Length$_T0 ($LS $ly) |xs#0|) (_module.__default.Length _module._default.Length$_T0 $ly |xs#0|)))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( (_module.__default.Length _module._default.Length$_T0 ($LS $ly) |xs#0|))
)))
(assert  (and (forall ((arg0@@196 T@U) ) (! (= (type (AsFuelBottom arg0@@196)) LayerTypeType)
 :qid |funType:AsFuelBottom|
 :pattern ( (AsFuelBottom arg0@@196))
)) (= (type $LZ) LayerTypeType)))
(assert (forall ((_module._default.Length$_T0@@0 T@U) ($ly@@0 T@U) (|xs#0@@0| T@U) ) (!  (=> (and (and (= (type _module._default.Length$_T0@@0) TyType) (= (type $ly@@0) LayerTypeType)) (= (type |xs#0@@0|) DatatypeTypeType)) (= (_module.__default.Length _module._default.Length$_T0@@0 $ly@@0 |xs#0@@0|) (_module.__default.Length _module._default.Length$_T0@@0 $LZ |xs#0@@0|)))
 :qid |unknown.0:0|
 :skolemid |900|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@0 (AsFuelBottom $ly@@0) |xs#0@@0|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@1 T@U) ($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (and (and (and (= (type _module._default.Length$_T0@@1) TyType) (= (type $ly@@1) LayerTypeType)) (= (type |xs#0@@1|) DatatypeTypeType)) (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@1 |xs#0@@1|) (and (not (= 2 $FunctionContextHeight)) ($Is |xs#0@@1| (Tclass._module.List _module._default.Length$_T0@@1))))) true)
 :qid |unknown.0:0|
 :skolemid |901|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@1 $ly@@1 |xs#0@@1|))
))))
(assert (forall ((_module._default.Length$_T0@@2 T@U) ($ly@@2 T@U) (|xs#0@@2| T@U) ) (!  (=> (and (and (and (= (type _module._default.Length$_T0@@2) TyType) (= (type $ly@@2) LayerTypeType)) (= (type |xs#0@@2|) DatatypeTypeType)) ($Is |xs#0@@2| (Tclass._module.List _module._default.Length$_T0@@2))) (and (=> (|_module.__default.Length#requires| _module._default.Length$_T0@@2 $ly@@2 |xs#0@@2|) true) (=> true (|_module.__default.Length#requires| _module._default.Length$_T0@@2 $ly@@2 |xs#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |902|
 :pattern ( (|_module.__default.Length#requires| _module._default.Length$_T0@@2 $ly@@2 |xs#0@@2|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@3 T@U) ($ly@@3 T@U) (|xs#0@@3| T@U) ) (!  (=> (and (and (and (= (type _module._default.Length$_T0@@3) TyType) (= (type $ly@@3) LayerTypeType)) (= (type |xs#0@@3|) DatatypeTypeType)) (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@3 |xs#0@@3|) (and (not (= 2 $FunctionContextHeight)) ($Is |xs#0@@3| (Tclass._module.List _module._default.Length$_T0@@3))))) (and (=> (not (_module.List.Nil_q |xs#0@@3|)) (let ((|tail#1| (_module.List.tail |xs#0@@3|)))
 (and (|_module.__default.Length#canCall| _module._default.Length$_T0@@3 |tail#1|) (|_module.__default.Add#canCall| 1 (_module.__default.Length _module._default.Length$_T0@@3 $ly@@3 |tail#1|))))) (= (_module.__default.Length _module._default.Length$_T0@@3 ($LS $ly@@3) |xs#0@@3|) (ite (_module.List.Nil_q |xs#0@@3|) 0 (let ((|tail#0| (_module.List.tail |xs#0@@3|)))
(_module.__default.Add 1 (_module.__default.Length _module._default.Length$_T0@@3 $ly@@3 |tail#0|)))))))
 :qid |unknown.0:0|
 :skolemid |903|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@3 ($LS $ly@@3) |xs#0@@3|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@4 T@U) ($ly@@4 T@U) (|xs#0@@4| T@U) ) (!  (=> (and (and (and (= (type _module._default.Length$_T0@@4) TyType) (= (type $ly@@4) LayerTypeType)) (= (type |xs#0@@4|) DatatypeTypeType)) (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@4 (Lit |xs#0@@4|)) (and (not (= 2 $FunctionContextHeight)) ($Is |xs#0@@4| (Tclass._module.List _module._default.Length$_T0@@4))))) (and (=> (not (U_2_bool (Lit (bool_2_U (_module.List.Nil_q (Lit |xs#0@@4|)))))) (let ((|tail#3| (Lit (_module.List.tail (Lit |xs#0@@4|)))))
 (and (|_module.__default.Length#canCall| _module._default.Length$_T0@@4 |tail#3|) (|_module.__default.Add#canCall| 1 (_module.__default.Length _module._default.Length$_T0@@4 ($LS $ly@@4) |tail#3|))))) (= (_module.__default.Length _module._default.Length$_T0@@4 ($LS $ly@@4) (Lit |xs#0@@4|)) (ite (_module.List.Nil_q (Lit |xs#0@@4|)) 0 (let ((|tail#2| (Lit (_module.List.tail (Lit |xs#0@@4|)))))
(_module.__default.Add 1 (_module.__default.Length _module._default.Length$_T0@@4 ($LS $ly@@4) |tail#2|)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |904|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@4 ($LS $ly@@4) (Lit |xs#0@@4|)))
))))
(assert (forall ((arg0@@197 T@U) (arg1@@91 T@U) (arg2@@46 Int) ) (! (= (type (_module.__default.Split arg0@@197 arg1@@91 arg2@@46)) DatatypeTypeType)
 :qid |funType:_module.__default.Split|
 :pattern ( (_module.__default.Split arg0@@197 arg1@@91 arg2@@46))
)))
(assert (forall (($ly@@5 T@U) (|xs#0@@5| T@U) (|b#0@@3| Int) ) (!  (=> (and (= (type $ly@@5) LayerTypeType) (= (type |xs#0@@5|) DatatypeTypeType)) (= (_module.__default.Split ($LS $ly@@5) |xs#0@@5| |b#0@@3|) (_module.__default.Split $ly@@5 |xs#0@@5| |b#0@@3|)))
 :qid |SMNDafny.26:17|
 :skolemid |907|
 :pattern ( (_module.__default.Split ($LS $ly@@5) |xs#0@@5| |b#0@@3|))
)))
(assert (forall (($ly@@6 T@U) (|xs#0@@6| T@U) (|b#0@@4| Int) ) (!  (=> (and (= (type $ly@@6) LayerTypeType) (= (type |xs#0@@6|) DatatypeTypeType)) (= (_module.__default.Split $ly@@6 |xs#0@@6| |b#0@@4|) (_module.__default.Split $LZ |xs#0@@6| |b#0@@4|)))
 :qid |SMNDafny.26:17|
 :skolemid |908|
 :pattern ( (_module.__default.Split (AsFuelBottom $ly@@6) |xs#0@@6| |b#0@@4|))
)))
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($ly@@7 T@U) (|xs#0@@7| T@U) (|b#0@@5| Int) ) (!  (=> (and (and (= (type $ly@@7) LayerTypeType) (= (type |xs#0@@7|) DatatypeTypeType)) (or (|_module.__default.Split#canCall| |xs#0@@7| |b#0@@5|) (and (not (= 7 $FunctionContextHeight)) ($Is |xs#0@@7| (Tclass._module.List TInt))))) (and (let ((|r#0| (_module.__default.Split $ly@@7 |xs#0@@7| |b#0@@5|)))
(= (_module.__default.Length TInt ($LS $LZ) |xs#0@@7|) (_module.__default.Add (_module.__default.Length TInt ($LS $LZ) ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0|))) (_module.__default.Length TInt ($LS $LZ) ($Unbox DatatypeTypeType (_System.Tuple2._1 |r#0|)))))) ($Is (_module.__default.Split $ly@@7 |xs#0@@7| |b#0@@5|) (Tclass._System.Tuple2 (Tclass._module.List TInt) (Tclass._module.List TInt)))))
 :qid |SMNDafny.26:17|
 :skolemid |909|
 :pattern ( (_module.__default.Split $ly@@7 |xs#0@@7| |b#0@@5|))
))))
(assert (forall (($ly@@8 T@U) (|xs#0@@8| T@U) (|b#0@@6| Int) ) (!  (=> (and (and (= (type $ly@@8) LayerTypeType) (= (type |xs#0@@8|) DatatypeTypeType)) ($Is |xs#0@@8| (Tclass._module.List TInt))) (and (=> (|_module.__default.Split#requires| $ly@@8 |xs#0@@8| |b#0@@6|) true) (=> true (|_module.__default.Split#requires| $ly@@8 |xs#0@@8| |b#0@@6|))))
 :qid |SMNDafny.26:17|
 :skolemid |910|
 :pattern ( (|_module.__default.Split#requires| $ly@@8 |xs#0@@8| |b#0@@6|))
)))
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($ly@@9 T@U) (|xs#0@@9| T@U) (|b#0@@7| Int) ) (!  (=> (and (and (= (type $ly@@9) LayerTypeType) (= (type |xs#0@@9|) DatatypeTypeType)) (or (|_module.__default.Split#canCall| |xs#0@@9| |b#0@@7|) (and (not (= 7 $FunctionContextHeight)) ($Is |xs#0@@9| (Tclass._module.List TInt))))) (and (=> (not (_module.List.Nil_q |xs#0@@9|)) (let ((|tail#1@@0| (_module.List.tail |xs#0@@9|)))
(|_module.__default.Split#canCall| |tail#1@@0| |b#0@@7|))) (= (_module.__default.Split ($LS $ly@@9) |xs#0@@9| |b#0@@7|) (ite (_module.List.Nil_q |xs#0@@9|) (|#_System._tuple#2._#Make2| ($Box (Lit |#_module.List.Nil|)) ($Box (Lit |#_module.List.Nil|))) (let ((|tail#0@@0| (_module.List.tail |xs#0@@9|)))
(let ((|x#0@@1| (U_2_int ($Unbox intType (_module.List.head |xs#0@@9|)))))
(let ((|R#0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split $ly@@9 |tail#0@@0| |b#0@@7|)))))
(let ((|L#0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split $ly@@9 |tail#0@@0| |b#0@@7|)))))
(ite (< |x#0@@1| |b#0@@7|) (|#_System._tuple#2._#Make2| ($Box (|#_module.List.Cons| ($Box (int_2_U |x#0@@1|)) |L#0|)) ($Box |R#0|)) (|#_System._tuple#2._#Make2| ($Box |L#0|) ($Box (|#_module.List.Cons| ($Box (int_2_U |x#0@@1|)) |R#0|))))))))))))
 :qid |SMNDafny.26:17|
 :skolemid |911|
 :pattern ( (_module.__default.Split ($LS $ly@@9) |xs#0@@9| |b#0@@7|))
))))
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($ly@@10 T@U) (|xs#0@@10| T@U) (|b#0@@8| Int) ) (!  (=> (and (and (= (type $ly@@10) LayerTypeType) (= (type |xs#0@@10|) DatatypeTypeType)) (or (|_module.__default.Split#canCall| (Lit |xs#0@@10|) |b#0@@8|) (and (not (= 7 $FunctionContextHeight)) ($Is |xs#0@@10| (Tclass._module.List TInt))))) (and (=> (not (U_2_bool (Lit (bool_2_U (_module.List.Nil_q (Lit |xs#0@@10|)))))) (let ((|tail#3@@0| (Lit (_module.List.tail (Lit |xs#0@@10|)))))
(|_module.__default.Split#canCall| |tail#3@@0| |b#0@@8|))) (= (_module.__default.Split ($LS $ly@@10) (Lit |xs#0@@10|) |b#0@@8|) (ite (_module.List.Nil_q (Lit |xs#0@@10|)) (|#_System._tuple#2._#Make2| ($Box (Lit |#_module.List.Nil|)) ($Box (Lit |#_module.List.Nil|))) (let ((|tail#2@@0| (Lit (_module.List.tail (Lit |xs#0@@10|)))))
(let ((|x#2| (U_2_int ($Unbox intType (_module.List.head (Lit |xs#0@@10|))))))
(let ((|R#2| ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit (_module.__default.Split ($LS $ly@@10) |tail#2@@0| |b#0@@8|))))))
(let ((|L#2| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit (_module.__default.Split ($LS $ly@@10) |tail#2@@0| |b#0@@8|))))))
(ite (< |x#2| |b#0@@8|) (|#_System._tuple#2._#Make2| ($Box (|#_module.List.Cons| ($Box (int_2_U |x#2|)) |L#2|)) ($Box |R#2|)) (|#_System._tuple#2._#Make2| ($Box |L#2|) ($Box (|#_module.List.Cons| ($Box (int_2_U |x#2|)) |R#2|))))))))))))
 :qid |SMNDafny.26:17|
 :weight 3
 :skolemid |912|
 :pattern ( (_module.__default.Split ($LS $ly@@10) (Lit |xs#0@@10|) |b#0@@8|))
))))
(assert (forall ((arg0@@198 T@U) (arg1@@92 T@U) (arg2@@47 T@U) ) (! (= (type (_module.__default.Elements arg0@@198 arg1@@92 arg2@@47)) (MapType0Type BoxType boolType))
 :qid |funType:_module.__default.Elements|
 :pattern ( (_module.__default.Elements arg0@@198 arg1@@92 arg2@@47))
)))
(assert (forall ((_module._default.Elements$_T0 T@U) ($ly@@11 T@U) (|xs#0@@11| T@U) ) (!  (=> (and (and (= (type _module._default.Elements$_T0) TyType) (= (type $ly@@11) LayerTypeType)) (= (type |xs#0@@11|) DatatypeTypeType)) (= (_module.__default.Elements _module._default.Elements$_T0 ($LS $ly@@11) |xs#0@@11|) (_module.__default.Elements _module._default.Elements$_T0 $ly@@11 |xs#0@@11|)))
 :qid |unknown.0:0|
 :skolemid |916|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0 ($LS $ly@@11) |xs#0@@11|))
)))
(assert (forall ((_module._default.Elements$_T0@@0 T@U) ($ly@@12 T@U) (|xs#0@@12| T@U) ) (!  (=> (and (and (= (type _module._default.Elements$_T0@@0) TyType) (= (type $ly@@12) LayerTypeType)) (= (type |xs#0@@12|) DatatypeTypeType)) (= (_module.__default.Elements _module._default.Elements$_T0@@0 $ly@@12 |xs#0@@12|) (_module.__default.Elements _module._default.Elements$_T0@@0 $LZ |xs#0@@12|)))
 :qid |unknown.0:0|
 :skolemid |917|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0@@0 (AsFuelBottom $ly@@12) |xs#0@@12|))
)))
(assert  (=> (<= 8 $FunctionContextHeight) (forall ((_module._default.Elements$_T0@@1 T@U) ($ly@@13 T@U) (|xs#0@@13| T@U) ) (!  (=> (and (and (and (= (type _module._default.Elements$_T0@@1) TyType) (= (type $ly@@13) LayerTypeType)) (= (type |xs#0@@13|) DatatypeTypeType)) (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@1 |xs#0@@13|) (and (not (= 8 $FunctionContextHeight)) ($Is |xs#0@@13| (Tclass._module.List _module._default.Elements$_T0@@1))))) ($Is (_module.__default.Elements _module._default.Elements$_T0@@1 $ly@@13 |xs#0@@13|) (TSet _module._default.Elements$_T0@@1)))
 :qid |unknown.0:0|
 :skolemid |918|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0@@1 $ly@@13 |xs#0@@13|))
))))
(assert (forall ((_module._default.Elements$_T0@@2 T@U) ($ly@@14 T@U) (|xs#0@@14| T@U) ) (!  (=> (and (and (and (= (type _module._default.Elements$_T0@@2) TyType) (= (type $ly@@14) LayerTypeType)) (= (type |xs#0@@14|) DatatypeTypeType)) ($Is |xs#0@@14| (Tclass._module.List _module._default.Elements$_T0@@2))) (and (=> (|_module.__default.Elements#requires| _module._default.Elements$_T0@@2 $ly@@14 |xs#0@@14|) true) (=> true (|_module.__default.Elements#requires| _module._default.Elements$_T0@@2 $ly@@14 |xs#0@@14|))))
 :qid |unknown.0:0|
 :skolemid |919|
 :pattern ( (|_module.__default.Elements#requires| _module._default.Elements$_T0@@2 $ly@@14 |xs#0@@14|))
)))
(assert  (=> (<= 8 $FunctionContextHeight) (forall ((_module._default.Elements$_T0@@3 T@U) ($ly@@15 T@U) (|xs#0@@15| T@U) ) (!  (=> (and (and (and (= (type _module._default.Elements$_T0@@3) TyType) (= (type $ly@@15) LayerTypeType)) (= (type |xs#0@@15|) DatatypeTypeType)) (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@3 |xs#0@@15|) (and (not (= 8 $FunctionContextHeight)) ($Is |xs#0@@15| (Tclass._module.List _module._default.Elements$_T0@@3))))) (and (=> (not (_module.List.Nil_q |xs#0@@15|)) (let ((|tail#1@@1| (_module.List.tail |xs#0@@15|)))
(|_module.__default.Elements#canCall| _module._default.Elements$_T0@@3 |tail#1@@1|))) (= (_module.__default.Elements _module._default.Elements$_T0@@3 ($LS $ly@@15) |xs#0@@15|) (ite (_module.List.Nil_q |xs#0@@15|) (|Set#Empty| BoxType) (let ((|tail#0@@1| (_module.List.tail |xs#0@@15|)))
(let ((|x#0@@2| (_module.List.head |xs#0@@15|)))
(|Set#Union| (|Set#UnionOne| (|Set#Empty| BoxType) |x#0@@2|) (_module.__default.Elements _module._default.Elements$_T0@@3 $ly@@15 |tail#0@@1|))))))))
 :qid |unknown.0:0|
 :skolemid |920|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0@@3 ($LS $ly@@15) |xs#0@@15|))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall ((_module._default.Elements$_T0@@4 T@U) ($ly@@16 T@U) (|xs#0@@16| T@U) ) (!  (=> (and (and (and (= (type _module._default.Elements$_T0@@4) TyType) (= (type $ly@@16) LayerTypeType)) (= (type |xs#0@@16|) DatatypeTypeType)) (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@4 (Lit |xs#0@@16|)) (and (not (= 8 $FunctionContextHeight)) ($Is |xs#0@@16| (Tclass._module.List _module._default.Elements$_T0@@4))))) (and (=> (not (U_2_bool (Lit (bool_2_U (_module.List.Nil_q (Lit |xs#0@@16|)))))) (let ((|tail#3@@1| (Lit (_module.List.tail (Lit |xs#0@@16|)))))
(|_module.__default.Elements#canCall| _module._default.Elements$_T0@@4 |tail#3@@1|))) (= (_module.__default.Elements _module._default.Elements$_T0@@4 ($LS $ly@@16) (Lit |xs#0@@16|)) (ite (_module.List.Nil_q (Lit |xs#0@@16|)) (|Set#Empty| BoxType) (let ((|tail#2@@1| (Lit (_module.List.tail (Lit |xs#0@@16|)))))
(let ((|x#2@@0| (Lit (_module.List.head (Lit |xs#0@@16|)))))
(|Set#Union| (|Set#UnionOne| (|Set#Empty| BoxType) |x#2@@0|) (_module.__default.Elements _module._default.Elements$_T0@@4 ($LS $ly@@16) |tail#2@@1|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |921|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0@@4 ($LS $ly@@16) (Lit |xs#0@@16|)))
))))
(assert (forall ((_module._default.NoDuplicates$_T0 T@U) ($ly@@17 T@U) (|xs#0@@17| T@U) ) (!  (=> (and (and (= (type _module._default.NoDuplicates$_T0) TyType) (= (type $ly@@17) LayerTypeType)) (= (type |xs#0@@17|) DatatypeTypeType)) (and (=> (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0 ($LS $ly@@17) |xs#0@@17|) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0 $ly@@17 |xs#0@@17|)) (=> (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0 $ly@@17 |xs#0@@17|) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0 ($LS $ly@@17) |xs#0@@17|))))
 :qid |unknown.0:0|
 :skolemid |924|
 :pattern ( (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0 ($LS $ly@@17) |xs#0@@17|))
)))
(assert (forall ((_module._default.NoDuplicates$_T0@@0 T@U) ($ly@@18 T@U) (|xs#0@@18| T@U) ) (!  (=> (and (and (= (type _module._default.NoDuplicates$_T0@@0) TyType) (= (type $ly@@18) LayerTypeType)) (= (type |xs#0@@18|) DatatypeTypeType)) (and (=> (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@0 $ly@@18 |xs#0@@18|) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@0 $LZ |xs#0@@18|)) (=> (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@0 $LZ |xs#0@@18|) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@0 $ly@@18 |xs#0@@18|))))
 :qid |unknown.0:0|
 :skolemid |925|
 :pattern ( (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@0 (AsFuelBottom $ly@@18) |xs#0@@18|))
)))
(assert  (=> (<= 9 $FunctionContextHeight) (forall ((_module._default.NoDuplicates$_T0@@1 T@U) ($ly@@19 T@U) (|xs#0@@19| T@U) ) (!  (=> (and (and (and (= (type _module._default.NoDuplicates$_T0@@1) TyType) (= (type $ly@@19) LayerTypeType)) (= (type |xs#0@@19|) DatatypeTypeType)) (or (|_module.__default.NoDuplicates#canCall| _module._default.NoDuplicates$_T0@@1 |xs#0@@19|) (and (not (= 9 $FunctionContextHeight)) ($Is |xs#0@@19| (Tclass._module.List _module._default.NoDuplicates$_T0@@1))))) true)
 :qid |unknown.0:0|
 :skolemid |926|
 :pattern ( (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@1 $ly@@19 |xs#0@@19|))
))))
(assert (forall ((_module._default.NoDuplicates$_T0@@2 T@U) ($ly@@20 T@U) (|xs#0@@20| T@U) ) (!  (=> (and (and (and (= (type _module._default.NoDuplicates$_T0@@2) TyType) (= (type $ly@@20) LayerTypeType)) (= (type |xs#0@@20|) DatatypeTypeType)) ($Is |xs#0@@20| (Tclass._module.List _module._default.NoDuplicates$_T0@@2))) (and (=> (|_module.__default.NoDuplicates#requires| _module._default.NoDuplicates$_T0@@2 $ly@@20 |xs#0@@20|) true) (=> true (|_module.__default.NoDuplicates#requires| _module._default.NoDuplicates$_T0@@2 $ly@@20 |xs#0@@20|))))
 :qid |unknown.0:0|
 :skolemid |927|
 :pattern ( (|_module.__default.NoDuplicates#requires| _module._default.NoDuplicates$_T0@@2 $ly@@20 |xs#0@@20|))
)))
(assert  (=> (<= 9 $FunctionContextHeight) (forall ((_module._default.NoDuplicates$_T0@@3 T@U) ($ly@@21 T@U) (|xs#0@@21| T@U) ) (!  (=> (and (and (and (= (type _module._default.NoDuplicates$_T0@@3) TyType) (= (type $ly@@21) LayerTypeType)) (= (type |xs#0@@21|) DatatypeTypeType)) (or (|_module.__default.NoDuplicates#canCall| _module._default.NoDuplicates$_T0@@3 |xs#0@@21|) (and (not (= 9 $FunctionContextHeight)) ($Is |xs#0@@21| (Tclass._module.List _module._default.NoDuplicates$_T0@@3))))) (and (=> (not (_module.List.Nil_q |xs#0@@21|)) (let ((|tail#1@@2| (_module.List.tail |xs#0@@21|)))
(let ((|x#1| (_module.List.head |xs#0@@21|)))
 (and (|_module.__default.Elements#canCall| _module._default.NoDuplicates$_T0@@3 |tail#1@@2|) (=> (not (U_2_bool (MapType0Select (_module.__default.Elements _module._default.NoDuplicates$_T0@@3 ($LS $LZ) |tail#1@@2|) |x#1|))) (|_module.__default.NoDuplicates#canCall| _module._default.NoDuplicates$_T0@@3 |tail#1@@2|)))))) (and (=> (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@3 ($LS $ly@@21) |xs#0@@21|) (ite (_module.List.Nil_q |xs#0@@21|) true (let ((|tail#0@@2| (_module.List.tail |xs#0@@21|)))
(let ((|x#0@@3| (_module.List.head |xs#0@@21|)))
 (and (not (U_2_bool (MapType0Select (_module.__default.Elements _module._default.NoDuplicates$_T0@@3 ($LS $LZ) |tail#0@@2|) |x#0@@3|))) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@3 $ly@@21 |tail#0@@2|)))))) (=> (ite (_module.List.Nil_q |xs#0@@21|) true (let ((|tail#0@@3| (_module.List.tail |xs#0@@21|)))
(let ((|x#0@@4| (_module.List.head |xs#0@@21|)))
 (and (not (U_2_bool (MapType0Select (_module.__default.Elements _module._default.NoDuplicates$_T0@@3 ($LS $LZ) |tail#0@@3|) |x#0@@4|))) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@3 $ly@@21 |tail#0@@3|))))) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@3 ($LS $ly@@21) |xs#0@@21|)))))
 :qid |unknown.0:0|
 :skolemid |928|
 :pattern ( (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@3 ($LS $ly@@21) |xs#0@@21|))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall ((_module._default.NoDuplicates$_T0@@4 T@U) ($ly@@22 T@U) (|xs#0@@22| T@U) ) (!  (=> (and (and (and (= (type _module._default.NoDuplicates$_T0@@4) TyType) (= (type $ly@@22) LayerTypeType)) (= (type |xs#0@@22|) DatatypeTypeType)) (or (|_module.__default.NoDuplicates#canCall| _module._default.NoDuplicates$_T0@@4 (Lit |xs#0@@22|)) (and (not (= 9 $FunctionContextHeight)) ($Is |xs#0@@22| (Tclass._module.List _module._default.NoDuplicates$_T0@@4))))) (and (=> (not (U_2_bool (Lit (bool_2_U (_module.List.Nil_q (Lit |xs#0@@22|)))))) (let ((|tail#3@@2| (Lit (_module.List.tail (Lit |xs#0@@22|)))))
(let ((|x#3| (Lit (_module.List.head (Lit |xs#0@@22|)))))
 (and (|_module.__default.Elements#canCall| _module._default.NoDuplicates$_T0@@4 |tail#3@@2|) (=> (not (U_2_bool (MapType0Select (_module.__default.Elements _module._default.NoDuplicates$_T0@@4 ($LS $LZ) |tail#3@@2|) |x#3|))) (|_module.__default.NoDuplicates#canCall| _module._default.NoDuplicates$_T0@@4 |tail#3@@2|)))))) (and (=> (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@4 ($LS $ly@@22) (Lit |xs#0@@22|)) (ite (_module.List.Nil_q (Lit |xs#0@@22|)) true (let ((|tail#2@@2| (Lit (_module.List.tail (Lit |xs#0@@22|)))))
(let ((|x#2@@1| (Lit (_module.List.head (Lit |xs#0@@22|)))))
 (and (not (U_2_bool (MapType0Select (Lit (_module.__default.Elements _module._default.NoDuplicates$_T0@@4 ($LS $LZ) |tail#2@@2|)) |x#2@@1|))) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@4 ($LS $ly@@22) |tail#2@@2|)))))) (=> (ite (_module.List.Nil_q (Lit |xs#0@@22|)) true (let ((|tail#2@@3| (Lit (_module.List.tail (Lit |xs#0@@22|)))))
(let ((|x#2@@2| (Lit (_module.List.head (Lit |xs#0@@22|)))))
 (and (not (U_2_bool (MapType0Select (Lit (_module.__default.Elements _module._default.NoDuplicates$_T0@@4 ($LS $LZ) |tail#2@@3|)) |x#2@@2|))) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@4 ($LS $ly@@22) |tail#2@@3|))))) (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@4 ($LS $ly@@22) (Lit |xs#0@@22|))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |929|
 :pattern ( (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@4 ($LS $ly@@22) (Lit |xs#0@@22|)))
))))
(assert (forall ((arg0@@199 T@U) (arg1@@93 Int) (arg2@@48 Int) ) (! (= (type (_module.__default.IntRange arg0@@199 arg1@@93 arg2@@48)) (MapType0Type BoxType boolType))
...
(assert (forall ((arg0@@200 T@U) (arg1@@94 Int) (arg2@@49 Int) ) (! (= (type (|lambda#22| arg0@@200 arg1@@94 arg2@@49)) (MapType0Type BoxType boolType))
 :qid |funType:lambda#22|
 :pattern ( (|lambda#22| arg0@@200 arg1@@94 arg2@@49))
)))
...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($ly@@33 T@U) (|xs#0@@31| T@U) (|n#0@@3| Int) (|len#0@@9| Int) ) (!  (=> (and (and (= (type $ly@@33) LayerTypeType) (= (type |xs#0@@31|) DatatypeTypeType)) (or (|_module.__default.SMN#canCall| |xs#0@@31| |n#0@@3| |len#0@@9|) (and (not (= 12 $FunctionContextHeight)) (and ($Is |xs#0@@31| (Tclass._module.List TInt)) (= |len#0@@9| (_module.__default.Length TInt ($LS $LZ) |xs#0@@31|)))))) (and (=> (<= 2 |len#0@@9|) (and (|_module.__default.Split#canCall| |xs#0@@31| (+ |n#0@@3| (div |len#0@@9| 2))) (let ((|R#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@31| (+ |n#0@@3| (div |len#0@@9| 2)))))))
(let ((|L#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) |xs#0@@31| (+ |n#0@@3| (div |len#0@@9| 2)))))))
 (and (|_module.__default.Length#canCall| TInt |L#0@@0|) (let ((|llen#0| (_module.__default.Length TInt ($LS $LZ) |L#0@@0|)))
 (and (=> (< |llen#0| (div |len#0@@9| 2)) (|_module.__default.SMN#canCall| |L#0@@0| |n#0@@3| |llen#0|)) (=> (<= (div |len#0@@9| 2) |llen#0|) (|_module.__default.SMN#canCall| |R#0@@0| (+ |n#0@@3| |llen#0|) (- |len#0@@9| |llen#0|)))))))))) (= (_module.__default.SMN ($LS $ly@@33) |xs#0@@31| |n#0@@3| |len#0@@9|) (ite (<= 2 |len#0@@9|) (let ((|R#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@31| (+ |n#0@@3| (div |len#0@@9| 2)))))))
...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($ly@@34 T@U) (|xs#0@@32| T@U) (|n#0@@4| Int) (|len#0@@10| Int) ) (!  (=> (and (and (= (type $ly@@34) LayerTypeType) (= (type |xs#0@@32|) DatatypeTypeType)) (or (|_module.__default.SMN#canCall| |xs#0@@32| |n#0@@4| |len#0@@10|) (and (not (= 12 $FunctionContextHeight)) (and ($Is |xs#0@@32| (Tclass._module.List TInt)) (= |len#0@@10| (_module.__default.Length TInt ($LS $LZ) |xs#0@@32|)))))) (and (=> (<= 2 |len#0@@10|) (and (|_module.__default.Split#canCall| |xs#0@@32| (+ |n#0@@4| (div |len#0@@10| 2))) (let ((|R#1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@32| (+ |n#0@@4| (div |len#0@@10| 2)))))))
(let ((|L#1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) |xs#0@@32| (+ |n#0@@4| (div |len#0@@10| 2)))))))
 (and (|_module.__default.Length#canCall| TInt |L#1|) (let ((|llen#1| (_module.__default.Length TInt ($LS $LZ) |L#1|)))
 (and (=> (< |llen#1| (div |len#0@@10| 2)) (|_module.__default.SMN#canCall| |L#1| |n#0@@4| |llen#1|)) (=> (<= (div |len#0@@10| 2) |llen#1|) (|_module.__default.SMN#canCall| |R#1| (+ |n#0@@4| |llen#1|) (- |len#0@@10| |llen#1|)))))))))) (= (_module.__default.SMN ($LS $ly@@34) |xs#0@@32| |n#0@@4| |len#0@@10|) (ite (<= 2 |len#0@@10|) (let ((|R#1@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@32| (+ |n#0@@4| (div |len#0@@10| 2)))))))
...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($ly@@35 T@U) (|xs#0@@33| T@U) (|n#0@@5| Int) (|len#0@@11| Int) ) (!  (=> (and (and (= (type $ly@@35) LayerTypeType) (= (type |xs#0@@33|) DatatypeTypeType)) (or (|_module.__default.SMN#canCall| (Lit |xs#0@@33|) |n#0@@5| |len#0@@11|) (and (not (= 12 $FunctionContextHeight)) (and ($Is |xs#0@@33| (Tclass._module.List TInt)) (= |len#0@@11| (_module.__default.Length TInt ($LS $LZ) (Lit |xs#0@@33|))))))) (and (=> (<= 2 |len#0@@11|) (and (|_module.__default.Split#canCall| (Lit |xs#0@@33|) (+ |n#0@@5| (div |len#0@@11| 2))) (let ((|R#2@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit (_module.__default.Split ($LS $LZ) (Lit |xs#0@@33|) (+ |n#0@@5| (div |len#0@@11| 2))))))))
(let ((|L#2@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit (_module.__default.Split ($LS $LZ) (Lit |xs#0@@33|) (+ |n#0@@5| (div |len#0@@11| 2))))))))
 (and (|_module.__default.Length#canCall| TInt |L#2@@0|) (let ((|llen#2| (_module.__default.Length TInt ($LS $LZ) |L#2@@0|)))
 (and (=> (< |llen#2| (div |len#0@@11| 2)) (|_module.__default.SMN#canCall| |L#2@@0| |n#0@@5| |llen#2|)) (=> (<= (div |len#0@@11| 2) |llen#2|) (|_module.__default.SMN#canCall| |R#2@@0| (+ |n#0@@5| |llen#2|) (- |len#0@@11| |llen#2|)))))))))) (= (_module.__default.SMN ($LS $ly@@35) (Lit |xs#0@@33|) |n#0@@5| |len#0@@11|) (ite (<= 2 |len#0@@11|) (let ((|R#2@@1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit (_module.__default.Split ($LS $LZ) (Lit |xs#0@@33|) (+ |n#0@@5| (div |len#0@@11| 2))))))))
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($ly@@40 T@U) (|xs#0@@38| T@U) (|n#0@@10| Int) (|len#0@@16| Int) ) (!  (=> (and (and (= (type $ly@@40) LayerTypeType) (= (type |xs#0@@38|) DatatypeTypeType)) (or (|_module.__default.SMN_k#canCall| |xs#0@@38| |n#0@@10| |len#0@@16|) (and (not (= 14 $FunctionContextHeight)) (and ($Is |xs#0@@38| (Tclass._module.List TInt)) (= |len#0@@16| (_module.__default.Length TInt ($LS $LZ) |xs#0@@38|)))))) (and (and (|$IsA#_module.List| |xs#0@@38|) (=> (not (|_module.List#Equal| |xs#0@@38| |#_module.List.Nil|)) (let ((|half#0| (div (+ |len#0@@16| 1) 2)))
 (and (|_module.__default.Split#canCall| |xs#0@@38| (+ |n#0@@10| |half#0|)) (let ((|R#0@@2| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@38| (+ |n#0@@10| |half#0|))))))
(let ((|L#0@@2| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) |xs#0@@38| (+ |n#0@@10| |half#0|))))))
 (and (|_module.__default.Length#canCall| TInt |L#0@@2|) (let ((|llen#0@@1| (_module.__default.Length TInt ($LS $LZ) |L#0@@2|)))
 (and (=> (< |llen#0@@1| |half#0|) (|_module.__default.SMN_k#canCall| |L#0@@2| |n#0@@10| |llen#0@@1|)) (=> (<= |half#0| |llen#0@@1|) (|_module.__default.SMN_k#canCall| |R#0@@2| (+ |n#0@@10| |llen#0@@1|) (- |len#0@@16| |llen#0@@1|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@40) |xs#0@@38| |n#0@@10| |len#0@@16|) (ite (|_module.List#Equal| |xs#0@@38| |#_module.List.Nil|) |n#0@@10| (let ((|half#0@@0| (div (+ |len#0@@16| 1) 2)))
(let ((|R#0@@3| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@38| (+ |n#0@@10| |half#0@@0|))))))
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($ly@@41 T@U) (|xs#0@@39| T@U) (|n#0@@11| Int) (|len#0@@17| Int) ) (!  (=> (and (and (= (type $ly@@41) LayerTypeType) (= (type |xs#0@@39|) DatatypeTypeType)) (or (|_module.__default.SMN_k#canCall| |xs#0@@39| |n#0@@11| |len#0@@17|) (and (not (= 14 $FunctionContextHeight)) (and ($Is |xs#0@@39| (Tclass._module.List TInt)) (= |len#0@@17| (_module.__default.Length TInt ($LS $LZ) |xs#0@@39|)))))) (and (and (|$IsA#_module.List| |xs#0@@39|) (=> (not (|_module.List#Equal| |xs#0@@39| |#_module.List.Nil|)) (let ((|half#1| (div (+ |len#0@@17| 1) 2)))
 (and (|_module.__default.Split#canCall| |xs#0@@39| (+ |n#0@@11| |half#1|)) (let ((|R#1@@1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@39| (+ |n#0@@11| |half#1|))))))
(let ((|L#1@@1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) |xs#0@@39| (+ |n#0@@11| |half#1|))))))
 (and (|_module.__default.Length#canCall| TInt |L#1@@1|) (let ((|llen#1@@1| (_module.__default.Length TInt ($LS $LZ) |L#1@@1|)))
 (and (=> (< |llen#1@@1| |half#1|) (|_module.__default.SMN_k#canCall| |L#1@@1| |n#0@@11| |llen#1@@1|)) (=> (<= |half#1| |llen#1@@1|) (|_module.__default.SMN_k#canCall| |R#1@@1| (+ |n#0@@11| |llen#1@@1|) (- |len#0@@17| |llen#1@@1|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@41) |xs#0@@39| |n#0@@11| |len#0@@17|) (ite (|_module.List#Equal| |xs#0@@39| |#_module.List.Nil|) |n#0@@11| (let ((|half#1@@0| (div (+ |len#0@@17| 1) 2)))
(let ((|R#1@@2| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@39| (+ |n#0@@11| |half#1@@0|))))))
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($ly@@42 T@U) (|xs#0@@40| T@U) (|n#0@@12| Int) (|len#0@@18| Int) ) (!  (=> (and (and (= (type $ly@@42) LayerTypeType) (= (type |xs#0@@40|) DatatypeTypeType)) (or (|_module.__default.SMN_k#canCall| (Lit |xs#0@@40|) |n#0@@12| |len#0@@18|) (and (not (= 14 $FunctionContextHeight)) (and ($Is |xs#0@@40| (Tclass._module.List TInt)) (= |len#0@@18| (_module.__default.Length TInt ($LS $LZ) (Lit |xs#0@@40|))))))) (and (and (|$IsA#_module.List| (Lit |xs#0@@40|)) (=> (not (|_module.List#Equal| |xs#0@@40| |#_module.List.Nil|)) (let ((|half#2| (div (+ |len#0@@18| 1) 2)))
 (and (|_module.__default.Split#canCall| (Lit |xs#0@@40|) (+ |n#0@@12| |half#2|)) (let ((|R#2@@2| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) (Lit |xs#0@@40|) (+ |n#0@@12| |half#2|))))))
(let ((|L#2@@2| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) (Lit |xs#0@@40|) (+ |n#0@@12| |half#2|))))))
 (and (|_module.__default.Length#canCall| TInt |L#2@@2|) (let ((|llen#2@@1| (_module.__default.Length TInt ($LS $LZ) |L#2@@2|)))
 (and (=> (< |llen#2@@1| |half#2|) (|_module.__default.SMN_k#canCall| |L#2@@2| |n#0@@12| |llen#2@@1|)) (=> (<= |half#2| |llen#2@@1|) (|_module.__default.SMN_k#canCall| |R#2@@2| (+ |n#0@@12| |llen#2@@1|) (- |len#0@@18| |llen#2@@1|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@42) (Lit |xs#0@@40|) |n#0@@12| |len#0@@18|) (ite (|_module.List#Equal| |xs#0@@40| |#_module.List.Nil|) |n#0@@12| (let ((|half#2@@0| (div (+ |len#0@@18| 1) 2)))
(let ((|R#2@@3| ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit (_module.__default.Split ($LS $LZ) (Lit |xs#0@@40|) (+ |n#0@@12| |half#2@@0|)))))))
...
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($ly@@47 T@U) (|xs#0@@45| T@U) (|n#0@@17| Int) (|len#0@@23| Int) ) (!  (=> (and (and (= (type $ly@@47) LayerTypeType) (= (type |xs#0@@45|) DatatypeTypeType)) (or (|_module.__default.SMN_k_k#canCall| |xs#0@@45| |n#0@@17| |len#0@@23|) (and (not (= 15 $FunctionContextHeight)) (and ($Is |xs#0@@45| (Tclass._module.List TInt)) (= |len#0@@23| (_module.__default.Length TInt ($LS $LZ) |xs#0@@45|)))))) (and (and (|$IsA#_module.List| |xs#0@@45|) (=> (not (|_module.List#Equal| |xs#0@@45| |#_module.List.Nil|)) (let ((|half#0@@1| (+ (div |len#0@@23| 2) 1)))
 (and (|_module.__default.Split#canCall| |xs#0@@45| (+ |n#0@@17| |half#0@@1|)) (let ((|R#0@@4| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@45| (+ |n#0@@17| |half#0@@1|))))))
(let ((|L#0@@4| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) |xs#0@@45| (+ |n#0@@17| |half#0@@1|))))))
 (and (|_module.__default.Length#canCall| TInt |L#0@@4|) (let ((|llen#0@@3| (_module.__default.Length TInt ($LS $LZ) |L#0@@4|)))
 (and (=> (< |llen#0@@3| |half#0@@1|) (|_module.__default.SMN_k_k#canCall| |L#0@@4| |n#0@@17| |llen#0@@3|)) (=> (<= |half#0@@1| |llen#0@@3|) (|_module.__default.SMN_k_k#canCall| |R#0@@4| (+ |n#0@@17| |llen#0@@3|) (- |len#0@@23| |llen#0@@3|)))))))))))) (= (_module.__default.SMN_k_k ($LS $ly@@47) |xs#0@@45| |n#0@@17| |len#0@@23|) (ite (|_module.List#Equal| |xs#0@@45| |#_module.List.Nil|) |n#0@@17| (let ((|half#0@@2| (+ (div |len#0@@23| 2) 1)))
(let ((|R#0@@5| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@45| (+ |n#0@@17| |half#0@@2|))))))
...
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($ly@@48 T@U) (|xs#0@@46| T@U) (|n#0@@18| Int) (|len#0@@24| Int) ) (!  (=> (and (and (= (type $ly@@48) LayerTypeType) (= (type |xs#0@@46|) DatatypeTypeType)) (or (|_module.__default.SMN_k_k#canCall| |xs#0@@46| |n#0@@18| |len#0@@24|) (and (not (= 15 $FunctionContextHeight)) (and ($Is |xs#0@@46| (Tclass._module.List TInt)) (= |len#0@@24| (_module.__default.Length TInt ($LS $LZ) |xs#0@@46|)))))) (and (and (|$IsA#_module.List| |xs#0@@46|) (=> (not (|_module.List#Equal| |xs#0@@46| |#_module.List.Nil|)) (let ((|half#1@@1| (+ (div |len#0@@24| 2) 1)))
 (and (|_module.__default.Split#canCall| |xs#0@@46| (+ |n#0@@18| |half#1@@1|)) (let ((|R#1@@3| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@46| (+ |n#0@@18| |half#1@@1|))))))
(let ((|L#1@@3| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) |xs#0@@46| (+ |n#0@@18| |half#1@@1|))))))
 (and (|_module.__default.Length#canCall| TInt |L#1@@3|) (let ((|llen#1@@3| (_module.__default.Length TInt ($LS $LZ) |L#1@@3|)))
 (and (=> (< |llen#1@@3| |half#1@@1|) (|_module.__default.SMN_k_k#canCall| |L#1@@3| |n#0@@18| |llen#1@@3|)) (=> (<= |half#1@@1| |llen#1@@3|) (|_module.__default.SMN_k_k#canCall| |R#1@@3| (+ |n#0@@18| |llen#1@@3|) (- |len#0@@24| |llen#1@@3|)))))))))))) (= (_module.__default.SMN_k_k ($LS $ly@@48) |xs#0@@46| |n#0@@18| |len#0@@24|) (ite (|_module.List#Equal| |xs#0@@46| |#_module.List.Nil|) |n#0@@18| (let ((|half#1@@2| (+ (div |len#0@@24| 2) 1)))
(let ((|R#1@@4| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) |xs#0@@46| (+ |n#0@@18| |half#1@@2|))))))
...
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($ly@@49 T@U) (|xs#0@@47| T@U) (|n#0@@19| Int) (|len#0@@25| Int) ) (!  (=> (and (and (= (type $ly@@49) LayerTypeType) (= (type |xs#0@@47|) DatatypeTypeType)) (or (|_module.__default.SMN_k_k#canCall| (Lit |xs#0@@47|) |n#0@@19| |len#0@@25|) (and (not (= 15 $FunctionContextHeight)) (and ($Is |xs#0@@47| (Tclass._module.List TInt)) (= |len#0@@25| (_module.__default.Length TInt ($LS $LZ) (Lit |xs#0@@47|))))))) (and (and (|$IsA#_module.List| (Lit |xs#0@@47|)) (=> (not (|_module.List#Equal| |xs#0@@47| |#_module.List.Nil|)) (let ((|half#2@@1| (+ (div |len#0@@25| 2) 1)))
 (and (|_module.__default.Split#canCall| (Lit |xs#0@@47|) (+ |n#0@@19| |half#2@@1|)) (let ((|R#2@@4| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) (Lit |xs#0@@47|) (+ |n#0@@19| |half#2@@1|))))))
(let ((|L#2@@4| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) (Lit |xs#0@@47|) (+ |n#0@@19| |half#2@@1|))))))
 (and (|_module.__default.Length#canCall| TInt |L#2@@4|) (let ((|llen#2@@3| (_module.__default.Length TInt ($LS $LZ) |L#2@@4|)))
 (and (=> (< |llen#2@@3| |half#2@@1|) (|_module.__default.SMN_k_k#canCall| |L#2@@4| |n#0@@19| |llen#2@@3|)) (=> (<= |half#2@@1| |llen#2@@3|) (|_module.__default.SMN_k_k#canCall| |R#2@@4| (+ |n#0@@19| |llen#2@@3|) (- |len#0@@25| |llen#2@@3|)))))))))))) (= (_module.__default.SMN_k_k ($LS $ly@@49) (Lit |xs#0@@47|) |n#0@@19| |len#0@@25|) (ite (|_module.List#Equal| |xs#0@@47| |#_module.List.Nil|) |n#0@@19| (let ((|half#2@@2| (+ (div |len#0@@25| 2) 1)))
(let ((|R#2@@5| ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit (_module.__default.Split ($LS $LZ) (Lit |xs#0@@47|) (+ |n#0@@19| |half#2@@2|)))))))
...
(assert  (and (and (and (and (and (and (and (forall ((arg0@@201 T@T) (arg1@@95 T@T) ) (! (= (Ctor (MapType5Type arg0@@201 arg1@@95)) 26)
 :qid |ctor:MapType5Type|
)) (forall ((arg0@@202 T@T) (arg1@@96 T@T) ) (! (= (MapType5TypeInv0 (MapType5Type arg0@@202 arg1@@96)) arg0@@202)
 :qid |typeInv:MapType5TypeInv0|
 :pattern ( (MapType5Type arg0@@202 arg1@@96))
))) (forall ((arg0@@203 T@T) (arg1@@97 T@T) ) (! (= (MapType5TypeInv1 (MapType5Type arg0@@203 arg1@@97)) arg1@@97)
 :qid |typeInv:MapType5TypeInv1|
 :pattern ( (MapType5Type arg0@@203 arg1@@97))
))) (forall ((arg0@@204 T@U) (arg1@@98 T@U) (arg2@@50 T@U) ) (! (let ((aVar1@@5 (MapType5TypeInv1 (type arg0@@204))))
(= (type (MapType5Select arg0@@204 arg1@@98 arg2@@50)) aVar1@@5))
 :qid |funType:MapType5Select|
 :pattern ( (MapType5Select arg0@@204 arg1@@98 arg2@@50))
))) (forall ((arg0@@205 T@U) (arg1@@99 T@U) (arg2@@51 T@U) (arg3@@25 T@U) ) (! (let ((aVar1@@6 (type arg3@@25)))
(let ((aVar0@@3 (type arg1@@99)))
(= (type (MapType5Store arg0@@205 arg1@@99 arg2@@51 arg3@@25)) (MapType5Type aVar0@@3 aVar1@@6))))
 :qid |funType:MapType5Store|
 :pattern ( (MapType5Store arg0@@205 arg1@@99 arg2@@51 arg3@@25))
 ...
 :weight 0
)))) (forall ((arg0@@206 T@U) (arg1@@100 T@U) (arg2@@52 T@U) (arg3@@26 Bool) ) (! (= (type (|lambda#0| arg0@@206 arg1@@100 arg2@@52 arg3@@26)) (MapType5Type refType boolType))
 :qid |funType:lambda#0|
 :pattern ( (|lambda#0| arg0@@206 arg1@@100 arg2@@52 arg3@@26))
))))
...
(assert (forall ((arg0@@207 T@U) (arg1@@101 T@U) (arg2@@53 T@U) (arg3@@27 Bool) ) (! (= (type (|lambda#1| arg0@@207 arg1@@101 arg2@@53 arg3@@27)) (MapType5Type refType boolType))
 :qid |funType:lambda#1|
 :pattern ( (|lambda#1| arg0@@207 arg1@@101 arg2@@53 arg3@@27))
)))
...
(assert (forall ((arg0@@208 T@U) (arg1@@102 T@U) (arg2@@54 T@U) (arg3@@28 Bool) ) (! (= (type (|lambda#2| arg0@@208 arg1@@102 arg2@@54 arg3@@28)) (MapType5Type refType boolType))
 :qid |funType:lambda#2|
 :pattern ( (|lambda#2| arg0@@208 arg1@@102 arg2@@54 arg3@@28))
)))
...
(assert (forall ((arg0@@209 T@U) (arg1@@103 T@U) (arg2@@55 T@U) (arg3@@29 Bool) ) (! (= (type (|lambda#3| arg0@@209 arg1@@103 arg2@@55 arg3@@29)) (MapType5Type refType boolType))
 :qid |funType:lambda#3|
 :pattern ( (|lambda#3| arg0@@209 arg1@@103 arg2@@55 arg3@@29))
)))
...
(assert (forall ((arg0@@210 T@U) (arg1@@104 T@U) (arg2@@56 Int) ) (! (= (type (|lambda#4| arg0@@210 arg1@@104 arg2@@56)) (MapType0Type BoxType boolType))
 :qid |funType:lambda#4|
 :pattern ( (|lambda#4| arg0@@210 arg1@@104 arg2@@56))
)))
(assert (forall ((|$y#8| T@U) (|l#0@@3| T@U) (|l#1@@3| T@U) (|l#2@@3| Int) ) (!  (=> (and (and (= (type |$y#8|) BoxType) (= (type |l#0@@3|) TyType)) (= (type |l#1@@3|) (MapType0Type BoxType boolType))) (= (U_2_bool (MapType0Select (|lambda#4| |l#0@@3| |l#1@@3| |l#2@@3|) |$y#8|))  (and ($IsBox |$y#8| |l#0@@3|) (and (U_2_bool (MapType0Select |l#1@@3| |$y#8|)) (< (U_2_int ($Unbox intType |$y#8|)) |l#2@@3|)))))
 :qid |SMNDafny.50:23|
 :skolemid |1023|
 :pattern ( (MapType0Select (|lambda#4| |l#0@@3| |l#1@@3| |l#2@@3|) |$y#8|))
)))
(assert (forall ((arg0@@211 T@U) (arg1@@105 T@U) (arg2@@57 Int) ) (! (= (type (|lambda#5| arg0@@211 arg1@@105 arg2@@57)) (MapType0Type BoxType boolType))
 :qid |funType:lambda#5|
 :pattern ( (|lambda#5| arg0@@211 arg1@@105 arg2@@57))
)))
(assert (forall ((|$y#7| T@U) (|l#0@@4| T@U) (|l#1@@4| T@U) (|l#2@@4| Int) ) (!  (=> (and (and (= (type |$y#7|) BoxType) (= (type |l#0@@4|) TyType)) (= (type |l#1@@4|) (MapType0Type BoxType boolType))) (= (U_2_bool (MapType0Select (|lambda#5| |l#0@@4| |l#1@@4| |l#2@@4|) |$y#7|))  (and ($IsBox |$y#7| |l#0@@4|) (and (U_2_bool (MapType0Select |l#1@@4| |$y#7|)) (<= |l#2@@4| (U_2_int ($Unbox intType |$y#7|)))))))
 :qid |SMNDafny.51:23|
 :skolemid |1024|
 :pattern ( (MapType0Select (|lambda#5| |l#0@@4| |l#1@@4| |l#2@@4|) |$y#7|))
)))
(assert (forall ((arg0@@212 T@U) (arg1@@106 T@U) (arg2@@58 T@U) (arg3@@30 Bool) ) (! (= (type (|lambda#12| arg0@@212 arg1@@106 arg2@@58 arg3@@30)) (MapType5Type refType boolType))
 :qid |funType:lambda#12|
 :pattern ( (|lambda#12| arg0@@212 arg1@@106 arg2@@58 arg3@@30))
)))
(assert (forall (($o@@13 T@U) ($f@@3 T@U) (|l#0@@5| T@U) (|l#1@@5| T@U) (|l#2@@5| T@U) (|l#3@@3| Bool) ) (! (let ((alpha@@10 (FieldTypeInv0 (type $f@@3))))
 (=> (and (and (and (and (= (type $o@@13) refType) (= (type $f@@3) (FieldType alpha@@10))) (= (type |l#0@@5|) refType)) (= (type |l#1@@5|) (MapType0Type refType MapType1Type))) (= (type |l#2@@5|) (FieldType boolType))) (= (U_2_bool (MapType5Select (|lambda#12| |l#0@@5| |l#1@@5| |l#2@@5| |l#3@@3|) $o@@13 $f@@3))  (=> (and (not (= $o@@13 |l#0@@5|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@5| $o@@13) |l#2@@5|))) |l#3@@3|))))
 :qid |SMNDafny.47:7|
 :skolemid |1025|
 :pattern ( (MapType5Select (|lambda#12| |l#0@@5| |l#1@@5| |l#2@@5| |l#3@@3|) $o@@13 $f@@3))
)))
(assert (forall ((arg0@@213 T@U) (arg1@@107 T@U) (arg2@@59 T@U) (arg3@@31 Bool) ) (! (= (type (|lambda#15| arg0@@213 arg1@@107 arg2@@59 arg3@@31)) (MapType5Type refType boolType))
 :qid |funType:lambda#15|
 :pattern ( (|lambda#15| arg0@@213 arg1@@107 arg2@@59 arg3@@31))
)))
(assert (forall (($o@@14 T@U) ($f@@4 T@U) (|l#0@@6| T@U) (|l#1@@6| T@U) (|l#2@@6| T@U) (|l#3@@4| Bool) ) (! (let ((alpha@@11 (FieldTypeInv0 (type $f@@4))))
 (=> (and (and (and (and (= (type $o@@14) refType) (= (type $f@@4) (FieldType alpha@@11))) (= (type |l#0@@6|) refType)) (= (type |l#1@@6|) (MapType0Type refType MapType1Type))) (= (type |l#2@@6|) (FieldType boolType))) (= (U_2_bool (MapType5Select (|lambda#15| |l#0@@6| |l#1@@6| |l#2@@6| |l#3@@4|) $o@@14 $f@@4))  (=> (and (not (= $o@@14 |l#0@@6|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@6| $o@@14) |l#2@@6|))) |l#3@@4|))))
 :qid |SMNDafny.60:10|
 :skolemid |1026|
 :pattern ( (MapType5Select (|lambda#15| |l#0@@6| |l#1@@6| |l#2@@6| |l#3@@4|) $o@@14 $f@@4))
)))
(assert (forall ((arg0@@214 T@U) (arg1@@108 T@U) (arg2@@60 T@U) (arg3@@32 Bool) ) (! (= (type (|lambda#16| arg0@@214 arg1@@108 arg2@@60 arg3@@32)) (MapType5Type refType boolType))
 :qid |funType:lambda#16|
 :pattern ( (|lambda#16| arg0@@214 arg1@@108 arg2@@60 arg3@@32))
)))
(assert (forall (($o@@15 T@U) ($f@@5 T@U) (|l#0@@7| T@U) (|l#1@@7| T@U) (|l#2@@7| T@U) (|l#3@@5| Bool) ) (! (let ((alpha@@12 (FieldTypeInv0 (type $f@@5))))
 (=> (and (and (and (and (= (type $o@@15) refType) (= (type $f@@5) (FieldType alpha@@12))) (= (type |l#0@@7|) refType)) (= (type |l#1@@7|) (MapType0Type refType MapType1Type))) (= (type |l#2@@7|) (FieldType boolType))) (= (U_2_bool (MapType5Select (|lambda#16| |l#0@@7| |l#1@@7| |l#2@@7| |l#3@@5|) $o@@15 $f@@5))  (=> (and (not (= $o@@15 |l#0@@7|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@7| $o@@15) |l#2@@7|))) |l#3@@5|))))
 :qid |SMNDafny.60:10|
 :skolemid |1027|
 :pattern ( (MapType5Select (|lambda#16| |l#0@@7| |l#1@@7| |l#2@@7| |l#3@@5|) $o@@15 $f@@5))
)))
(assert (forall ((arg0@@215 T@U) (arg1@@109 T@U) (arg2@@61 T@U) (arg3@@33 Bool) ) (! (= (type (|lambda#17| arg0@@215 arg1@@109 arg2@@61 arg3@@33)) (MapType5Type refType boolType))
 :qid |funType:lambda#17|
 :pattern ( (|lambda#17| arg0@@215 arg1@@109 arg2@@61 arg3@@33))
)))
(assert (forall (($o@@16 T@U) ($f@@6 T@U) (|l#0@@8| T@U) (|l#1@@8| T@U) (|l#2@@8| T@U) (|l#3@@6| Bool) ) (! (let ((alpha@@13 (FieldTypeInv0 (type $f@@6))))
 (=> (and (and (and (and (= (type $o@@16) refType) (= (type $f@@6) (FieldType alpha@@13))) (= (type |l#0@@8|) refType)) (= (type |l#1@@8|) (MapType0Type refType MapType1Type))) (= (type |l#2@@8|) (FieldType boolType))) (= (U_2_bool (MapType5Select (|lambda#17| |l#0@@8| |l#1@@8| |l#2@@8| |l#3@@6|) $o@@16 $f@@6))  (=> (and (not (= $o@@16 |l#0@@8|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@8| $o@@16) |l#2@@8|))) |l#3@@6|))))
 :qid |SMNDafny.67:7|
 :skolemid |1028|
 :pattern ( (MapType5Select (|lambda#17| |l#0@@8| |l#1@@8| |l#2@@8| |l#3@@6|) $o@@16 $f@@6))
)))
(assert (forall ((arg0@@216 T@U) (arg1@@110 T@U) (arg2@@62 T@U) (arg3@@34 Bool) ) (! (= (type (|lambda#18| arg0@@216 arg1@@110 arg2@@62 arg3@@34)) (MapType5Type refType boolType))
 :qid |funType:lambda#18|
 :pattern ( (|lambda#18| arg0@@216 arg1@@110 arg2@@62 arg3@@34))
)))
...
(assert (forall ((arg0@@217 T@U) (arg1@@111 T@U) (arg2@@63 T@U) (arg3@@35 Bool) ) (! (= (type (|lambda#19| arg0@@217 arg1@@111 arg2@@63 arg3@@35)) (MapType5Type refType boolType))
 :qid |funType:lambda#19|
 :pattern ( (|lambda#19| arg0@@217 arg1@@111 arg2@@63 arg3@@35))
)))
...
(assert (forall ((arg0@@218 T@U) (arg1@@112 T@U) (arg2@@64 T@U) (arg3@@36 Bool) ) (! (= (type (|lambda#20| arg0@@218 arg1@@112 arg2@@64 arg3@@36)) (MapType5Type refType boolType))
 :qid |funType:lambda#20|
 :pattern ( (|lambda#20| arg0@@218 arg1@@112 arg2@@64 arg3@@36))
)))
...
(assert (forall ((arg0@@219 T@U) (arg1@@113 T@U) (arg2@@65 T@U) (arg3@@37 Bool) ) (! (= (type (|lambda#21| arg0@@219 arg1@@113 arg2@@65 arg3@@37)) (MapType5Type refType boolType))
 :qid |funType:lambda#21|
 :pattern ( (|lambda#21| arg0@@219 arg1@@113 arg2@@65 arg3@@37))
)))
...
(assert (forall ((arg0@@220 T@U) (arg1@@114 T@U) (arg2@@66 T@U) (arg3@@38 Bool) ) (! (= (type (|lambda#24| arg0@@220 arg1@@114 arg2@@66 arg3@@38)) (MapType5Type refType boolType))
 :qid |funType:lambda#24|
 :pattern ( (|lambda#24| arg0@@220 arg1@@114 arg2@@66 arg3@@38))
)))
...
(assert (forall ((arg0@@221 T@U) (arg1@@115 T@U) (arg2@@67 T@U) (arg3@@39 Bool) ) (! (= (type (|lambda#25| arg0@@221 arg1@@115 arg2@@67 arg3@@39)) (MapType5Type refType boolType))
 :qid |funType:lambda#25|
 :pattern ( (|lambda#25| arg0@@221 arg1@@115 arg2@@67 arg3@@39))
)))
...
(assert (forall ((arg0@@222 T@U) (arg1@@116 T@U) (arg2@@68 T@U) (arg3@@40 Bool) ) (! (= (type (|lambda#27| arg0@@222 arg1@@116 arg2@@68 arg3@@40)) (MapType5Type refType boolType))
 :qid |funType:lambda#27|
 :pattern ( (|lambda#27| arg0@@222 arg1@@116 arg2@@68 arg3@@40))
)))
...
(assert (forall ((arg0@@223 T@U) (arg1@@117 T@U) (arg2@@69 T@U) (arg3@@41 Bool) ) (! (= (type (|lambda#28| arg0@@223 arg1@@117 arg2@@69 arg3@@41)) (MapType5Type refType boolType))
 :qid |funType:lambda#28|
 :pattern ( (|lambda#28| arg0@@223 arg1@@117 arg2@@69 arg3@@41))
)))
...
(assert (forall ((arg0@@224 T@U) (arg1@@118 T@U) (arg2@@70 T@U) (arg3@@42 Bool) ) (! (= (type (|lambda#29| arg0@@224 arg1@@118 arg2@@70 arg3@@42)) (MapType5Type refType boolType))
 :qid |funType:lambda#29|
 :pattern ( (|lambda#29| arg0@@224 arg1@@118 arg2@@70 arg3@@42))
)))
...
(assert (forall ((arg0@@225 T@U) (arg1@@119 T@U) (arg2@@71 T@U) (arg3@@43 Bool) ) (! (= (type (|lambda#30| arg0@@225 arg1@@119 arg2@@71 arg3@@43)) (MapType5Type refType boolType))
 :qid |funType:lambda#30|
 :pattern ( (|lambda#30| arg0@@225 arg1@@119 arg2@@71 arg3@@43))
)))
...
(assert (forall ((arg0@@226 T@U) (arg1@@120 T@U) (arg2@@72 T@U) (arg3@@44 Bool) ) (! (= (type (|lambda#31| arg0@@226 arg1@@120 arg2@@72 arg3@@44)) (MapType5Type refType boolType))
 :qid |funType:lambda#31|
 :pattern ( (|lambda#31| arg0@@226 arg1@@120 arg2@@72 arg3@@44))
)))
...
(assert (forall ((arg0@@227 T@U) (arg1@@121 T@U) (arg2@@73 T@U) (arg3@@45 Bool) ) (! (= (type (|lambda#32| arg0@@227 arg1@@121 arg2@@73 arg3@@45)) (MapType5Type refType boolType))
 :qid |funType:lambda#32|
 :pattern ( (|lambda#32| arg0@@227 arg1@@121 arg2@@73 arg3@@45))
)))
...
(assert (forall ((arg0@@228 T@U) (arg1@@122 T@U) (arg2@@74 T@U) (arg3@@46 Bool) ) (! (= (type (|lambda#33| arg0@@228 arg1@@122 arg2@@74 arg3@@46)) (MapType5Type refType boolType))
 :qid |funType:lambda#33|
 :pattern ( (|lambda#33| arg0@@228 arg1@@122 arg2@@74 arg3@@46))
)))
...
(assert (forall ((arg0@@229 T@U) (arg1@@123 T@U) (arg2@@75 T@U) (arg3@@47 Bool) ) (! (= (type (|lambda#34| arg0@@229 arg1@@123 arg2@@75 arg3@@47)) (MapType5Type refType boolType))
 :qid |funType:lambda#34|
 :pattern ( (|lambda#34| arg0@@229 arg1@@123 arg2@@75 arg3@@47))
)))
...
(assert (forall ((arg0@@230 T@U) (arg1@@124 T@U) (arg2@@76 T@U) (arg3@@48 Bool) ) (! (= (type (|lambda#35| arg0@@230 arg1@@124 arg2@@76 arg3@@48)) (MapType5Type refType boolType))
 :qid |funType:lambda#35|
 :pattern ( (|lambda#35| arg0@@230 arg1@@124 arg2@@76 arg3@@48))
)))
...
(assert (forall ((arg0@@231 T@U) (arg1@@125 T@U) (arg2@@77 T@U) (arg3@@49 Bool) ) (! (= (type (|lambda#36| arg0@@231 arg1@@125 arg2@@77 arg3@@49)) (MapType5Type refType boolType))
 :qid |funType:lambda#36|
 :pattern ( (|lambda#36| arg0@@231 arg1@@125 arg2@@77 arg3@@49))
)))
...
(assert (forall ((arg0@@232 T@U) (arg1@@126 T@U) (arg2@@78 T@U) (arg3@@50 Bool) ) (! (= (type (|lambda#37| arg0@@232 arg1@@126 arg2@@78 arg3@@50)) (MapType5Type refType boolType))
 :qid |funType:lambda#37|
 :pattern ( (|lambda#37| arg0@@232 arg1@@126 arg2@@78 arg3@@50))
)))
...
(assert (forall ((arg0@@233 T@U) (arg1@@127 T@U) (arg2@@79 T@U) (arg3@@51 Bool) ) (! (= (type (|lambda#38| arg0@@233 arg1@@127 arg2@@79 arg3@@51)) (MapType5Type refType boolType))
 :qid |funType:lambda#38|
 :pattern ( (|lambda#38| arg0@@233 arg1@@127 arg2@@79 arg3@@51))
)))
...
(declare-fun _module._default.Elements$_T0@@5 () T@U)
(declare-fun |_mcc#0#0| () T@U)
(declare-fun |_mcc#1#0| () T@U)
(declare-fun |tail#4@0| () T@U)
...
(assert  (and (and (and (and (and (and (and (and (and (and (= (type |xs#0@@48|) DatatypeTypeType) (= (type _module._default.Elements$_T0@@5) TyType)) (= (type |_mcc#0#0|) BoxType)) (= (type |_mcc#1#0|) DatatypeTypeType)) (= (type |tail#4@0|) DatatypeTypeType)) (= (type |let#0#0#0|) DatatypeTypeType)) (= (type |x#4@0|) BoxType)) (= (type |let#1#0#0|) BoxType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type $_Frame@0) (MapType5Type refType boolType))) (= (type $_Frame@0@@0) (MapType5Type refType boolType))))
(push 1)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Elements)
(assert (not
(let ((anon7_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (! (or %lbl%@1 |b$reqreads#0@1|) :lblneg @1))))
(let ((anon10_Then_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (and (= |xs#0@@48| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.Elements$_T0@@5)) (=> (and (and ($Is |_mcc#1#0| (Tclass._module.List _module._default.Elements$_T0@@5)) ($Is |tail#4@0| (Tclass._module.List _module._default.Elements$_T0@@5))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is |let#0#0#0| (Tclass._module.List _module._default.Elements$_T0@@5)))) (=> (and (and (and (= |tail#4@0| |let#0#0#0|) ($IsBox |x#4@0| _module._default.Elements$_T0@@5)) (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.Elements$_T0@@5))) (and (and (= |x#4@0| |let#1#0#0|) ($IsAlloc |tail#4@0| (Tclass._module.List _module._default.Elements$_T0@@5) $Heap)) (and (=> |b$reqreads#0@0| (forall (($o@@35 T@U) ($f@@25 T@U) ) (! (let ((alpha@@32 (FieldTypeInv0 (type $f@@25))))
 (=> (and (and (= (type $o@@35) refType) (= (type $f@@25) (FieldType alpha@@32))) false) (U_2_bool (MapType5Select $_Frame@0 $o@@35 $f@@25))))
 :qid |SMNDafny.64:31|
 :skolemid |922|
 :no-pattern (type $o@@35)
 :no-pattern (type $f@@25)
 :no-pattern (U_2_int $o@@35)
 :no-pattern (U_2_bool $o@@35)
 :no-pattern (U_2_int $f@@25)
 :no-pattern (U_2_bool $f@@25)
))) (=> (forall (($o@@36 T@U) ($f@@26 T@U) ) (! (let ((alpha@@33 (FieldTypeInv0 (type $f@@26))))
 (=> (and (and (= (type $o@@36) refType) (= (type $f@@26) (FieldType alpha@@33))) false) (U_2_bool (MapType5Select $_Frame@0 $o@@36 $f@@26))))
 :qid |SMNDafny.64:31|
 :skolemid |922|
 :no-pattern (type $o@@36)
 :no-pattern (type $f@@26)
 :no-pattern (U_2_int $o@@36)
 :no-pattern (U_2_bool $o@@36)
 :no-pattern (U_2_int $f@@26)
 :no-pattern (U_2_bool $f@@26)
)) |b$reqreads#0@0|)))) (and (! (or %lbl%@3 (< (DtRank |tail#4@0|) (DtRank |xs#0@@48|))) :lblneg @3) (=> (< (DtRank |tail#4@0|) (DtRank |xs#0@@48|)) (=> (and (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@5 |tail#4@0|) (= (_module.__default.Elements _module._default.Elements$_T0@@5 ($LS $LZ) |xs#0@@48|) (|Set#Union| (|Set#UnionOne| (|Set#Empty| BoxType) |x#4@0|) (_module.__default.Elements _module._default.Elements$_T0@@5 ($LS $LZ) |tail#4@0|)))) (=> (and (and (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@5 |tail#4@0|) ($Is (_module.__default.Elements _module._default.Elements$_T0@@5 ($LS $LZ) |xs#0@@48|) (TSet _module._default.Elements$_T0@@5))) (and (=> |b$reqreads#0@1| |b$reqreads#0@0|) (=> |b$reqreads#0@0| |b$reqreads#0@1|))) anon7_correct))))))))))
(let ((anon9_Then_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (= |xs#0@@48| |#_module.List.Nil|) (=> (and (and (= (_module.__default.Elements _module._default.Elements$_T0@@5 ($LS $LZ) |xs#0@@48|) (Lit (|Set#Empty| BoxType))) ($Is (_module.__default.Elements _module._default.Elements$_T0@@5 ($LS $LZ) |xs#0@@48|) (TSet _module._default.Elements$_T0@@5))) (and (=> |b$reqreads#0@1| true) (=> true |b$reqreads#0@1|))) anon7_correct)))))
(let ((anon10_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) true)))
(let ((anon9_Else_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (not (= |xs#0@@48| |#_module.List.Nil|)) (and anon10_Then_correct anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (= $_Frame@0@@0 (|lambda#16| null $Heap alloc false)) (and anon9_Then_correct anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (! (and %lbl%+8 true) :lblpos +8) true)))
(let ((anon0_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= $_Frame@0 (|lambda#15| null $Heap alloc false)) (and anon8_Then_correct anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is |xs#0@@48| (Tclass._module.List _module._default.Elements$_T0@@5)) (= 8 $FunctionContextHeight))) anon0_correct))))
