...
tests = [
  ...
  "DDL-CP3", "DDL-CP1", "WDL1-CP3", "WDL1-CP1",
...
loc_wdl1 = os.path.join('Logs_solver7', '*.trace')
loc_wdl2 = os.path.join('Logs_solver72', '*.trace')
...
file_wdl1 = glob.glob(loc_wdl1)
file_wdl2 = glob.glob(loc_wdl2)
...
Expand_cp3_wdl1 = np.array(allinfo_Expand[tests[6]])
Expand_cp1_wdl1 = np.array(allinfo_Expand[tests[7]])
Expand_cp3_5 = np.array(allinfo_Expand[tests[8]])
Expand_cp1_5 = np.array(allinfo_Expand[tests[9]])
Expand_cp3_wdl2 = np.array(allinfo_Expand[tests[14]])
Expand_cp1_wdl2 = np.array(allinfo_Expand[tests[15]])
...
Expand_cp3_wdl1_mean = np.mean(Expand_cp3_wdl1)
Expand_cp3_wdl1_std = np.std(Expand_cp3_wdl1)
Expand_cp1_wdl1_mean = np.mean(Expand_cp1_wdl1)
Expand_cp1_wdl1_std = np.std(Expand_cp1_wdl1)
...
Expand_cp3_wdl2_mean = np.mean(Expand_cp3_wdl2)
Expand_cp3_wdl2_std = np.std(Expand_cp3_wdl2)
Expand_cp1_wdl2_mean = np.mean(Expand_cp1_wdl2)
Expand_cp1_wdl2_std = np.std(Expand_cp1_wdl2)
...
Remove_cp3_wdl1 = np.array(allinfo_Remove[tests[6]])
Remove_cp1_wdl1 = np.array(allinfo_Remove[tests[7]])
Remove_cp3_5 = np.array(allinfo_Remove[tests[8]])
Remove_cp1_5 = np.array(allinfo_Remove[tests[9]])
Remove_cp3_wdl2 = np.array(allinfo_Remove[tests[14]])
Remove_cp1_wdl2 = np.array(allinfo_Remove[tests[15]])
...
Remove_cp3_wdl1_mean = np.mean(Remove_cp3_wdl1)
Remove_cp3_wdl1_std = np.std(Remove_cp3_wdl1)
Remove_cp1_wdl1_mean = np.mean(Remove_cp1_wdl1)
Remove_cp1_wdl1_std = np.std(Remove_cp1_wdl1)
...
Remove_cp3_wdl2_mean = np.mean(Remove_cp3_wdl2)
Remove_cp3_wdl2_std = np.std(Remove_cp3_wdl2)
Remove_cp1_wdl2_mean = np.mean(Remove_cp1_wdl2)
Remove_cp1_wdl2_std = np.std(Remove_cp1_wdl2)
...
InsertAfter_cp3_wdl1 = np.array(allinfo_InsertAfter[tests[6]])
InsertAfter_cp1_wdl1 = np.array(allinfo_InsertAfter[tests[7]])
InsertAfter_cp3_5 = np.array(allinfo_InsertAfter[tests[8]])
InsertAfter_cp1_5 = np.array(allinfo_InsertAfter[tests[9]])
InsertAfter_cp3_wdl2 = np.array(allinfo_InsertAfter[tests[14]])
InsertAfter_cp1_wdl2 = np.array(allinfo_InsertAfter[tests[15]])
...
InsertAfter_cp3_wdl1_mean = np.mean(InsertAfter_cp3_wdl1)
InsertAfter_cp3_wdl1_std = np.std(InsertAfter_cp3_wdl1)
InsertAfter_cp1_wdl1_mean = np.mean(InsertAfter_cp1_wdl1)
InsertAfter_cp1_wdl1_std = np.std(InsertAfter_cp1_wdl1)
...
InsertAfter_cp3_wdl2_mean = np.mean(InsertAfter_cp3_wdl2)
InsertAfter_cp3_wdl2_std = np.std(InsertAfter_cp3_wdl2)
InsertAfter_cp1_wdl2_mean = np.mean(InsertAfter_cp1_wdl2)
InsertAfter_cp1_wdl2_std = np.std(InsertAfter_cp1_wdl2)
...
InsertBefore_cp3_wdl1 = np.array(allinfo_InsertBefore[tests[6]])
InsertBefore_cp1_wdl1 = np.array(allinfo_InsertBefore[tests[7]])
InsertBefore_cp3_5 = np.array(allinfo_InsertBefore[tests[8]])
InsertBefore_cp1_5 = np.array(allinfo_InsertBefore[tests[9]])
InsertBefore_cp3_wdl2 = np.array(allinfo_InsertBefore[tests[14]])
InsertBefore_cp1_wdl2 = np.array(allinfo_InsertBefore[tests[15]])
...
InsertBefore_cp3_wdl1_mean = np.mean(InsertBefore_cp3_wdl1)
InsertBefore_cp3_wdl1_std = np.std(InsertBefore_cp3_wdl1)
InsertBefore_cp1_wdl1_mean = np.mean(InsertBefore_cp1_wdl1)
InsertBefore_cp1_wdl1_std = np.std(InsertBefore_cp1_wdl1)
...
InsertBefore_cp3_wdl2_mean = np.mean(InsertBefore_cp3_wdl2)
InsertBefore_cp3_wdl2_std = np.std(InsertBefore_cp3_wdl2)
InsertBefore_cp1_wdl2_mean = np.mean(InsertBefore_cp1_wdl2)
InsertBefore_cp1_wdl2_std = np.std(InsertBefore_cp1_wdl2)
...
wdl1_cp3_mean = (Expand_cp3_wdl1_mean, Remove_cp3_wdl1_mean, InsertAfter_cp3_wdl1_mean, InsertBefore_cp3_wdl1_mean)
wdl1_cp1_mean = (Expand_cp1_wdl1_mean, Remove_cp1_wdl1_mean, InsertAfter_cp1_wdl1_mean, InsertBefore_cp1_wdl1_mean)
...
wdl2_cp3_mean = (Expand_cp3_wdl2_mean, Remove_cp3_wdl2_mean, InsertAfter_cp3_wdl2_mean, InsertBefore_cp3_wdl2_mean)
wdl2_cp1_mean = (Expand_cp1_wdl2_mean, Remove_cp1_wdl2_mean, InsertAfter_cp1_wdl2_mean, InsertBefore_cp1_wdl2_mean)
...
wdl1_cp3_std = (Expand_cp3_wdl1_std, Remove_cp3_wdl1_std, InsertAfter_cp3_wdl1_std, InsertBefore_cp3_wdl1_std)
wdl1_cp1_std = (Expand_cp1_wdl1_std, Remove_cp1_wdl1_std, InsertAfter_cp1_wdl1_std, InsertBefore_cp1_wdl1_std)
...
wdl2_cp3_std = (Expand_cp3_wdl2_std, Remove_cp3_wdl2_std, InsertAfter_cp3_wdl2_std, InsertBefore_cp3_wdl2_std)
wdl2_cp1_std = (Expand_cp1_wdl2_std, Remove_cp1_wdl2_std, InsertAfter_cp1_wdl2_std, InsertBefore_cp1_wdl2_std)
...
fig, ax = plt.subplots()
rects12 = ax.bar(ind - 6*width/8, orig_cp1_5_mean, width/8, yerr=orig_cp1_5_std,
...
rects1 = ax.bar(ind - 5*width/8, orig_cp1_mean, width/8, yerr=orig_cp1_std,
...
rects2 = ax.bar(ind - 4*width/8, sdl_cp1_mean, width/8, yerr=sdl_cp1_std,
...
rects3 = ax.bar(ind - 3*width/8, ddl_cp1_mean, width/8, yerr=ddl_cp1_std,
...
rects4 = ax.bar(ind - 2*width/8, wdl1_cp1_mean, width/8, yerr=wdl1_cp1_std,
                # label='WDL-CS1', error_kw=dict(ecolor='black', lw=1, capsize=3, capthick=1))
                label='WDL-EquSubst-CS1', color='yellowgreen', error_kw=dict(ecolor='black', lw=1, capsize=3, capthick=1))
rects41 = ax.bar(ind - 1*width/8, wdl2_cp1_mean, width/8, yerr=wdl2_cp1_std,
                # label='WDL-CS1', error_kw=dict(ecolor='black', lw=1, capsize=3, capthick=1))
                label='WDL-WtRelax-CS1', color='lightcoral', error_kw=dict(ecolor='black', lw=1, capsize=3, capthick=1))
...
rects8 = ax.bar(ind + 5*width/8, wdl1_cp3_mean, width/8, yerr=wdl1_cp3_std,
                # label='WDL-CS3', error_kw=dict(ecolor='black', lw=1, capsize=3, capthick=1))
                label='WDL-EquSubst-CS3', color='darkolivegreen', error_kw=dict(ecolor='black', lw=1, capsize=3, capthick=1))
rects81 = ax.bar(ind + 6*width/8, wdl2_cp3_mean, width/8, yerr=wdl2_cp3_std,
                # label='WDL-CS3', error_kw=dict(ecolor='black', lw=1, capsize=3, capthick=1))
                label='WDL-WtRelax-CS3', color='darkred', error_kw=dict(ecolor='black', lw=1, capsize=3, capthick=1))
