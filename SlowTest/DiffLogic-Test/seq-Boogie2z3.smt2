...
(let ((anon2_LoopBody_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (and (and (< i@0 len) (= a@2 (|Store_[$int]$bool| a@1 i@0 true))) (and (forall ((j@@0 Int) ) (!  (=> (= i@0 j@@0) (|Select_[$int]$bool| a@2 j@@0))
 :qid |seqBoogi.15:24|
 :skolemid |2|
)) (= i@1 (+ i@0 1)))) (and (! (or %lbl%@4  (and (<= 0 i@1) (<= i@1 len))) :lblneg @4) (=> (and (<= 0 i@1) (<= i@1 len)) (! (or %lbl%@5 (forall ((j@@1 Int) ) (!  (=> (and (<= 0 j@@1) (< j@@1 i@1)) (|Select_[$int]$bool| a@2 j@@1))
 :qid |seqBoogi.12:27|
 :skolemid |1|
))) :lblneg @5)))))))
(let ((anon2_LoopHead_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (<= 0 i@0) (=> (and (and (<= 0 i@0) (<= i@0 len)) (forall ((j@@2 Int) ) (!  (=> (and (<= 0 j@@2) (< j@@2 i@0)) (|Select_[$int]$bool| a@1 j@@2))
 :qid |seqBoogi.12:27|
 :skolemid |1|
))) (and anon2_LoopDone_correct anon2_LoopBody_correct))))))
(let ((anon0_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (= a@0 (|Store_[$int]$bool| a 0 true)) (and (! (or %lbl%@8  (and (<= 0 0) (<= 0 len))) :lblneg @8) (=> (and (<= 0 0) (<= 0 len)) (and (! (or %lbl%@9 (forall ((j@@3 Int) ) (!  (=> (and (<= 0 j@@3) (< j@@3 0)) (|Select_[$int]$bool| a@0 j@@3))
 :qid |seqBoogi.12:27|
 :skolemid |1|
))) :lblneg @9) (=> (forall ((j@@4 Int) ) (!  (=> (and (<= 0 j@@4) (< j@@4 0)) (|Select_[$int]$bool| a@0 j@@4))
 :qid |seqBoogi.12:27|
 :skolemid |1|
...
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (=> (and (= (|Select_[$int]$int| in 0) 0) (< 0 len)) anon0_correct))))
PreconditionGeneratedEntry_correct)))))))))
))
(check-sat)
(pop 1)
