// Dafny 2.3.0.10506
// Command Line Options: seq3_Dafny.dfy /compile:0 /trace /proverOpt:O:smt.arith.solver=3 /proverOpt:LOGIC=DLA /print:seq3-Dafny2Boogie.bpl /proverLog:seq3-Dafny2z3.smt2
...
implementation CheckWellformed$$_module.__default.Sequence(s#0: Seq Box, j#0: int, b#0: bool, c#0: bool) returns (t#0: Seq Box)
{
...
procedure Call$$_module.__default.Sequence(s#0: Seq Box where $Is(s#0, TSeq(TBool)) && $IsAlloc(s#0, TSeq(TBool), $Heap), 
    j#0: int, 
    b#0: bool, 
    c#0: bool)
   returns (t#0: Seq Box where $Is(t#0, TSeq(TBool)) && $IsAlloc(t#0, TSeq(TBool), $Heap));
...
procedure Impl$$_module.__default.Sequence(s#0: Seq Box where $Is(s#0, TSeq(TBool)) && $IsAlloc(s#0, TSeq(TBool), $Heap), 
    j#0: int, 
    b#0: bool, 
    c#0: bool)
   returns (t#0: Seq Box where $Is(t#0, TSeq(TBool)) && $IsAlloc(t#0, TSeq(TBool), $Heap), 
...
implementation Impl$$_module.__default.Sequence(s#0: Seq Box, j#0: int, b#0: bool, c#0: bool)
