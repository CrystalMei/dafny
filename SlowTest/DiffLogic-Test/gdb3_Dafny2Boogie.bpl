// Dafny 2.3.0.10506
// Command Line Options: /compile:0 /trace gdb3_Dafny.dfy /proverOpt:O:smt.arith.solver=7 /print:gdb3_Dafny2Boogie.bpl /proverLog:gdb3_Dafny2z3.smt2
...
procedure CheckWellformed$$_module.__default.test(_module._default.test$X: Ty, 
    s#0: Seq Box
...
procedure Call$$_module.__default.test(_module._default.test$X: Ty, 
    s#0: Seq Box
       where $Is(s#0, TSeq(_module._default.test$X))
         && $IsAlloc(s#0, TSeq(_module._default.test$X), $Heap))
   returns (s'#0: Seq Box
...
procedure Impl$$_module.__default.test(_module._default.test$X: Ty, 
    s#0: Seq Box
       where $Is(s#0, TSeq(_module._default.test$X))
         && $IsAlloc(s#0, TSeq(_module._default.test$X), $Heap))
   returns (s'#0: Seq Box
...
implementation Impl$$_module.__default.test(_module._default.test$X: Ty, s#0: Seq Box)
