...
(declare-fun |lambda#37| (Int Int Int) T@U)
(declare-fun |lambda#38| (T@U) T@U)
(declare-fun |lambda#39| (Bool) T@U)
...
(declare-fun |lambda#61| (Int T@U Int) T@U)
(declare-fun |lambda#62| (T@U Int Int) T@U)
...
(declare-fun |lambda#86| (T@U Int Int T@U Int T@U Int T@U) T@U)
...
(declare-fun |lambda#111| (Int Int Int T@U T@U Int T@U) T@U)
...
(declare-fun |lambda#136| (Int Int T@U Int T@U Int T@U) T@U)
...
(assert  (=> (<= 45 $FunctionContextHeight) (forall ((_module._default.SeqIndex$X T@U) (|s#0| T@U) (|i#0| Int) ) (!  (=> (and (and (= (type _module._default.SeqIndex$X) TyType) (= (type |s#0|) (SeqType BoxType))) (or (|_module.__default.SeqIndex#canCall| _module._default.SeqIndex$X |s#0| |i#0|) (and (not (= 45 $FunctionContextHeight)) (and ($Is |s#0| (TSeq _module._default.SeqIndex$X)) (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |s#0|))))))) (and (|Seq#Contains| |s#0| (_module.__default.SeqIndex _module._default.SeqIndex$X |s#0| |i#0|)) ($IsBox (_module.__default.SeqIndex _module._default.SeqIndex$X |s#0| |i#0|) _module._default.SeqIndex$X)))
 :qid |unknown.0:0|
 :skolemid |1015|
...
(assert  (=> (<= 45 $FunctionContextHeight) (forall ((_module._default.SeqIndex$X@@1 T@U) (|s#0@@1| T@U) (|i#0@@1| Int) ) (!  (=> (and (and (= (type _module._default.SeqIndex$X@@1) TyType) (= (type |s#0@@1|) (SeqType BoxType))) (or (|_module.__default.SeqIndex#canCall| _module._default.SeqIndex$X@@1 |s#0@@1| |i#0@@1|) (and (not (= 45 $FunctionContextHeight)) (and ($Is |s#0@@1| (TSeq _module._default.SeqIndex$X@@1)) (and (<= 0 |i#0@@1|) (< |i#0@@1| (|Seq#Length| |s#0@@1|))))))) (= (_module.__default.SeqIndex _module._default.SeqIndex$X@@1 |s#0@@1| |i#0@@1|) (|Seq#Index| |s#0@@1| |i#0@@1|)))
 :qid |unknown.0:0|
 :skolemid |1017|
 :pattern ( (_module.__default.SeqIndex _module._default.SeqIndex$X@@1 |s#0@@1| |i#0@@1|))
))))
(assert  (=> (<= 45 $FunctionContextHeight) (forall ((_module._default.SeqIndex$X@@2 T@U) (|s#0@@2| T@U) (|i#0@@2| Int) ) (!  (=> (and (and (= (type _module._default.SeqIndex$X@@2) TyType) (= (type |s#0@@2|) (SeqType BoxType))) (or (|_module.__default.SeqIndex#canCall| _module._default.SeqIndex$X@@2 (Lit |s#0@@2|) |i#0@@2|) (and (not (= 45 $FunctionContextHeight)) (and ($Is |s#0@@2| (TSeq _module._default.SeqIndex$X@@2)) (and (<= 0 |i#0@@2|) (< |i#0@@2| (|Seq#Length| (Lit |s#0@@2|)))))))) (= (_module.__default.SeqIndex _module._default.SeqIndex$X@@2 (Lit |s#0@@2|) |i#0@@2|) (|Seq#Index| (Lit |s#0@@2|) |i#0@@2|)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1018|
...
(assert  (=> (<= 35 $FunctionContextHeight) (forall ((_module._default.SeqRemove$X T@U) (|s#0@@3| T@U) (|k#0| Int) ) (!  (=> (and (and (= (type _module._default.SeqRemove$X) TyType) (= (type |s#0@@3|) (SeqType BoxType))) (or (|_module.__default.SeqRemove#canCall| _module._default.SeqRemove$X |s#0@@3| |k#0|) (and (not (= 35 $FunctionContextHeight)) (and ($Is |s#0@@3| (TSeq _module._default.SeqRemove$X)) (and (<= 0 |k#0|) (< |k#0| (|Seq#Length| |s#0@@3|))))))) (and (and (= (_module.__default.Sub (|Seq#Length| |s#0@@3|) 1) (|Seq#Length| (_module.__default.SeqRemove _module._default.SeqRemove$X |s#0@@3| |k#0|))) (forall ((|i#0@@3| Int) ) (!  (=> true (=> (and (<= 0 |i#0@@3|) (< |i#0@@3| (|Seq#Length| (_module.__default.SeqRemove _module._default.SeqRemove$X |s#0@@3| |k#0|)))) (ite (< |i#0@@3| |k#0|) (= (|Seq#Index| (_module.__default.SeqRemove _module._default.SeqRemove$X |s#0@@3| |k#0|) |i#0@@3|) (|Seq#Index| |s#0@@3| |i#0@@3|)) (= (|Seq#Index| (_module.__default.SeqRemove _module._default.SeqRemove$X |s#0@@3| |k#0|) |i#0@@3|) (|Seq#Index| |s#0@@3| (_module.__default.Add |i#0@@3| 1))))))
 :qid |DLLDafny.19:18|
 :skolemid |1019|
...
(assert  (=> (<= 38 $FunctionContextHeight) (forall ((_module._default.SeqInsert$X T@U) (|s#0@@5| T@U) (|k#0@@1| Int) (|v#0| T@U) ) (!  (=> (and (and (and (= (type _module._default.SeqInsert$X) TyType) (= (type |s#0@@5|) (SeqType BoxType))) (= (type |v#0|) BoxType)) (or (|_module.__default.SeqInsert#canCall| _module._default.SeqInsert$X |s#0@@5| |k#0@@1| |v#0|) (and (not (= 38 $FunctionContextHeight)) (and (and ($Is |s#0@@5| (TSeq _module._default.SeqInsert$X)) ($IsBox |v#0| _module._default.SeqInsert$X)) (and (<= 0 |k#0@@1|) (<= |k#0@@1| (|Seq#Length| |s#0@@5|))))))) (and (and (= (|Seq#Length| (_module.__default.SeqInsert _module._default.SeqInsert$X |s#0@@5| |k#0@@1| |v#0|)) (_module.__default.Add (|Seq#Length| |s#0@@5|) 1)) (forall ((|i#0@@4| Int) ) (!  (=> true (=> (and (<= 0 |i#0@@4|) (< |i#0@@4| (|Seq#Length| (_module.__default.SeqInsert _module._default.SeqInsert$X |s#0@@5| |k#0@@1| |v#0|)))) (ite (< |i#0@@4| |k#0@@1|) (= (|Seq#Index| (_module.__default.SeqInsert _module._default.SeqInsert$X |s#0@@5| |k#0@@1| |v#0|) |i#0@@4|) (|Seq#Index| |s#0@@5| |i#0@@4|)) (ite (= |i#0@@4| |k#0@@1|) (= (|Seq#Index| (_module.__default.SeqInsert _module._default.SeqInsert$X |s#0@@5| |k#0@@1| |v#0|) |i#0@@4|) |v#0|) (= (|Seq#Index| (_module.__default.SeqInsert _module._default.SeqInsert$X |s#0@@5| |k#0@@1| |v#0|) |i#0@@4|) (|Seq#Index| |s#0@@5| (_module.__default.Sub |i#0@@4| 1)))))))
 :qid |DLLDafny.26:18|
 :skolemid |1024|
...
(assert  (=> (<= 24 $FunctionContextHeight) (forall ((_module._default.SeqUpdate$X@@1 T@U) (|s#0@@9| T@U) (|k#0@@5| Int) (|v#0@@3| T@U) ) (!  (=> (and (and (and (= (type _module._default.SeqUpdate$X@@1) TyType) (= (type |s#0@@9|) (SeqType BoxType))) (= (type |v#0@@3|) BoxType)) (or (|_module.__default.SeqUpdate#canCall| _module._default.SeqUpdate$X@@1 |s#0@@9| |k#0@@5| |v#0@@3|) (and (not (= 24 $FunctionContextHeight)) (and (and ($Is |s#0@@9| (TSeq _module._default.SeqUpdate$X@@1)) ($IsBox |v#0@@3| _module._default.SeqUpdate$X@@1)) (and (<= 0 |k#0@@5|) (< |k#0@@5| (|Seq#Length| |s#0@@9|))))))) (= (_module.__default.SeqUpdate _module._default.SeqUpdate$X@@1 |s#0@@9| |k#0@@5| |v#0@@3|) (|Seq#Update| |s#0@@9| |k#0@@5| |v#0@@3|)))
 :qid |unknown.0:0|
 :skolemid |1041|
 :pattern ( (_module.__default.SeqUpdate _module._default.SeqUpdate$X@@1 |s#0@@9| |k#0@@5| |v#0@@3|))
))))
(assert  (=> (<= 24 $FunctionContextHeight) (forall ((_module._default.SeqUpdate$X@@2 T@U) (|s#0@@10| T@U) (|k#0@@6| Int) (|v#0@@4| T@U) ) (!  (=> (and (and (and (= (type _module._default.SeqUpdate$X@@2) TyType) (= (type |s#0@@10|) (SeqType BoxType))) (= (type |v#0@@4|) BoxType)) (or (|_module.__default.SeqUpdate#canCall| _module._default.SeqUpdate$X@@2 (Lit |s#0@@10|) |k#0@@6| |v#0@@4|) (and (not (= 24 $FunctionContextHeight)) (and (and ($Is |s#0@@10| (TSeq _module._default.SeqUpdate$X@@2)) ($IsBox |v#0@@4| _module._default.SeqUpdate$X@@2)) (and (<= 0 |k#0@@6|) (< |k#0@@6| (|Seq#Length| (Lit |s#0@@10|)))))))) (= (_module.__default.SeqUpdate _module._default.SeqUpdate$X@@2 (Lit |s#0@@10|) |k#0@@6| |v#0@@4|) (|Seq#Update| (Lit |s#0@@10|) |k#0@@6| |v#0@@4|)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1042|
 :pattern ( (_module.__default.SeqUpdate _module._default.SeqUpdate$X@@2 (Lit |s#0@@10|) |k#0@@6| |v#0@@4|))
))))
(assert  (=> (<= 24 $FunctionContextHeight) (forall ((_module._default.SeqUpdate$X@@3 T@U) (|s#0@@11| T@U) (|k#0@@7| Int) (|v#0@@5| T@U) ) (!  (=> (and (and (and (= (type _module._default.SeqUpdate$X@@3) TyType) (= (type |s#0@@11|) (SeqType BoxType))) (= (type |v#0@@5|) BoxType)) (or (|_module.__default.SeqUpdate#canCall| _module._default.SeqUpdate$X@@3 (Lit |s#0@@11|) |k#0@@7| (Lit |v#0@@5|)) (and (not (= 24 $FunctionContextHeight)) (and (and ($Is |s#0@@11| (TSeq _module._default.SeqUpdate$X@@3)) ($IsBox |v#0@@5| _module._default.SeqUpdate$X@@3)) (and (<= 0 |k#0@@7|) (< |k#0@@7| (|Seq#Length| (Lit |s#0@@11|)))))))) (= (_module.__default.SeqUpdate _module._default.SeqUpdate$X@@3 (Lit |s#0@@11|) |k#0@@7| (Lit |v#0@@5|)) (|Seq#Update| (Lit |s#0@@11|) |k#0@@7| (Lit |v#0@@5|))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1043|
 :pattern ( (_module.__default.SeqUpdate _module._default.SeqUpdate$X@@3 (Lit |s#0@@11|) |k#0@@7| (Lit |v#0@@5|)))
))))
...
(assert  (=> (<= 18 $FunctionContextHeight) (forall ((_module._default.seq_get$A T@U) (|s#0@@12| T@U) (|i#0@@7| Int) ) (!  (=> (and (and (= (type _module._default.seq_get$A) TyType) (= (type |s#0@@12|) (SeqType BoxType))) (or (|_module.__default.seq__get#canCall| _module._default.seq_get$A |s#0@@12| |i#0@@7|) (and (not (= 18 $FunctionContextHeight)) (and ($Is |s#0@@12| (TSeq _module._default.seq_get$A)) (and (<= 0 |i#0@@7|) (< |i#0@@7| (|Seq#Length| |s#0@@12|))))))) (and (= (_module.__default.seq__get _module._default.seq_get$A |s#0@@12| |i#0@@7|) (|Seq#Index| |s#0@@12| |i#0@@7|)) ($IsBox (_module.__default.seq__get _module._default.seq_get$A |s#0@@12| |i#0@@7|) _module._default.seq_get$A)))
 :qid |unknown.0:0|
 :skolemid |1046|
 :pattern ( (_module.__default.seq__get _module._default.seq_get$A |s#0@@12| |i#0@@7|))
))))
(assert (forall ((_module._default.seq_get$A@@0 T@U) (|s#0@@13| T@U) (|i#0@@8| Int) ) (!  (=> (and (and (= (type _module._default.seq_get$A@@0) TyType) (= (type |s#0@@13|) (SeqType BoxType))) ($Is |s#0@@13| (TSeq _module._default.seq_get$A@@0))) (and (=> (|_module.__default.seq__get#requires| _module._default.seq_get$A@@0 |s#0@@13| |i#0@@8|) (and (<= 0 |i#0@@8|) (< |i#0@@8| (|Seq#Length| |s#0@@13|)))) (=> (and (<= 0 |i#0@@8|) (< |i#0@@8| (|Seq#Length| |s#0@@13|))) (|_module.__default.seq__get#requires| _module._default.seq_get$A@@0 |s#0@@13| |i#0@@8|))))
 :qid |unknown.0:0|
 :skolemid |1047|
 :pattern ( (|_module.__default.seq__get#requires| _module._default.seq_get$A@@0 |s#0@@13| |i#0@@8|))
)))
...
(assert  (=> (<= 47 $FunctionContextHeight) (forall ((_module._default.seq_set$A T@U) (|s1#0| T@U) (|i#0@@9| Int) (|a#0@@9| T@U) ) (!  (=> (and (and (and (= (type _module._default.seq_set$A) TyType) (= (type |s1#0|) (SeqType BoxType))) (= (type |a#0@@9|) BoxType)) (or (|_module.__default.seq__set#canCall| _module._default.seq_set$A |s1#0| |i#0@@9| |a#0@@9|) (and (not (= 47 $FunctionContextHeight)) (and (and ($Is |s1#0| (TSeq _module._default.seq_set$A)) ($IsBox |a#0@@9| _module._default.seq_set$A)) (and (<= 0 |i#0@@9|) (< |i#0@@9| (|Seq#Length| |s1#0|))))))) (and (|Seq#Equal| (_module.__default.seq__set _module._default.seq_set$A |s1#0| |i#0@@9| |a#0@@9|) (|Seq#Update| |s1#0| |i#0@@9| |a#0@@9|)) ($Is (_module.__default.seq__set _module._default.seq_set$A |s1#0| |i#0@@9| |a#0@@9|) (TSeq _module._default.seq_set$A))))
 :qid |unknown.0:0|
 :skolemid |1048|
...
(assert  (=> (<= 22 $FunctionContextHeight) (forall ((_module._default.seq_length$A T@U) (|s#0@@14| T@U) ) (!  (=> (and (and (= (type _module._default.seq_length$A) TyType) (= (type |s#0@@14|) (SeqType BoxType))) (or (|_module.__default.seq_length#canCall| _module._default.seq_length$A |s#0@@14|) (and (not (= 22 $FunctionContextHeight)) ($Is |s#0@@14| (TSeq _module._default.seq_length$A))))) (= (_module.__default.seq_length _module._default.seq_length$A |s#0@@14|) (|Seq#Length| |s#0@@14|)))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( (_module.__default.seq_length _module._default.seq_length$A |s#0@@14|))
))))
(assert (forall ((_module._default.seq_length$A@@0 T@U) (|s#0@@15| T@U) ) (!  (=> (and (and (= (type _module._default.seq_length$A@@0) TyType) (= (type |s#0@@15|) (SeqType BoxType))) ($Is |s#0@@15| (TSeq _module._default.seq_length$A@@0))) (and (=> (|_module.__default.seq_length#requires| _module._default.seq_length$A@@0 |s#0@@15|) true) (=> true (|_module.__default.seq_length#requires| _module._default.seq_length$A@@0 |s#0@@15|))))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( (|_module.__default.seq_length#requires| _module._default.seq_length$A@@0 |s#0@@15|))
)))
...
(assert  (=> (<= 48 $FunctionContextHeight) (forall ((_module._default.seq_empty$A T@U) ) (!  (=> (and (= (type _module._default.seq_empty$A) TyType) (or (|_module.__default.seq_empty#canCall| _module._default.seq_empty$A) (not (= 48 $FunctionContextHeight)))) (and (= (|Seq#Length| (_module.__default.seq_empty _module._default.seq_empty$A)) 0) ($Is (_module.__default.seq_empty _module._default.seq_empty$A) (TSeq _module._default.seq_empty$A))))
 :qid |unknown.0:0|
 :skolemid |1052|
...
(assert  (=> (<= 28 $FunctionContextHeight) (forall ((_module._default.seq_alloc$A T@U) (|length#0| Int) (|a#0@@11| T@U) ) (!  (=> (and (and (= (type _module._default.seq_alloc$A) TyType) (= (type |a#0@@11|) BoxType)) (or (|_module.__default.seq_alloc#canCall| _module._default.seq_alloc$A |length#0| |a#0@@11|) (and (not (= 28 $FunctionContextHeight)) ($IsBox |a#0@@11| _module._default.seq_alloc$A)))) (and (and (= (|Seq#Length| (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@11|)) |length#0|) (forall ((|i#0@@11| Int) ) (!  (=> true (=> (and (<= 0 |i#0@@11|) (< |i#0@@11| (|Seq#Length| (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@11|)))) (= (|Seq#Index| (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@11|) |i#0@@11|) |a#0@@11|)))
 :qid |DLLDafny.66:18|
 :skolemid |1054|
...
(assert  (=> (<= 49 $FunctionContextHeight) (forall ((_module._default.seq_unleash$A T@U) (|s1#0@@1| T@U) ) (!  (=> (and (and (= (type _module._default.seq_unleash$A) TyType) (= (type |s1#0@@1|) (SeqType BoxType))) (or (|_module.__default.seq_unleash#canCall| _module._default.seq_unleash$A |s1#0@@1|) (and (not (= 49 $FunctionContextHeight)) ($Is |s1#0@@1| (TSeq _module._default.seq_unleash$A))))) (and (|Seq#Equal| |s1#0@@1| (_module.__default.seq_unleash _module._default.seq_unleash$A |s1#0@@1|)) ($Is (_module.__default.seq_unleash _module._default.seq_unleash$A |s1#0@@1|) (TSeq _module._default.seq_unleash$A))))
 :qid |unknown.0:0|
 :skolemid |1061|
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall ((_module._default.Invs$A T@U) (|nodes#0| T@U) (|freeStack#0| Int) (|s#0@@18| T@U) (|f#0@@19| T@U) (|g#0| T@U) ) (!  (=> (and (and (and (and (and (= (type _module._default.Invs$A) TyType) (= (type |nodes#0|) (SeqType BoxType))) (= (type |s#0@@18|) (SeqType BoxType))) (= (type |f#0@@19|) (SeqType BoxType))) (= (type |g#0|) (SeqType BoxType))) (or (|_module.__default.Invs#canCall| _module._default.Invs$A |nodes#0| |freeStack#0| |s#0@@18| |f#0@@19| |g#0|) (and (not (= 11 $FunctionContextHeight)) (and (and (and ($Is |nodes#0| (TSeq (Tclass._module.Node _module._default.Invs$A))) ($Is |s#0@@18| (TSeq _module._default.Invs$A))) ($Is |f#0@@19| (TSeq TInt))) ($Is |g#0| (TSeq TInt)))))) true)
 :qid |unknown.0:0|
 :skolemid |1071|
 :pattern ( (_module.__default.Invs _module._default.Invs$A |nodes#0| |freeStack#0| |s#0@@18| |f#0@@19| |g#0|))
))))
(assert (forall ((_module._default.Invs$A@@0 T@U) (|nodes#0@@0| T@U) (|freeStack#0@@0| Int) (|s#0@@19| T@U) (|f#0@@20| T@U) (|g#0@@0| T@U) ) (!  (=> (and (and (and (and (and (= (type _module._default.Invs$A@@0) TyType) (= (type |nodes#0@@0|) (SeqType BoxType))) (= (type |s#0@@19|) (SeqType BoxType))) (= (type |f#0@@20|) (SeqType BoxType))) (= (type |g#0@@0|) (SeqType BoxType))) (and (and (and ($Is |nodes#0@@0| (TSeq (Tclass._module.Node _module._default.Invs$A@@0))) ($Is |s#0@@19| (TSeq _module._default.Invs$A@@0))) ($Is |f#0@@20| (TSeq TInt))) ($Is |g#0@@0| (TSeq TInt)))) (and (=> (|_module.__default.Invs#requires| _module._default.Invs$A@@0 |nodes#0@@0| |freeStack#0@@0| |s#0@@19| |f#0@@20| |g#0@@0|) true) (=> true (|_module.__default.Invs#requires| _module._default.Invs$A@@0 |nodes#0@@0| |freeStack#0@@0| |s#0@@19| |f#0@@20| |g#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |1072|
 :pattern ( (|_module.__default.Invs#requires| _module._default.Invs$A@@0 |nodes#0@@0| |freeStack#0@@0| |s#0@@19| |f#0@@20| |g#0@@0|))
)))
(assert  (=> (<= 11 $FunctionContextHeight) (forall ((_module._default.Invs$A@@1 T@U) (|nodes#0@@1| T@U) (|freeStack#0@@1| Int) (|s#0@@20| T@U) (|f#0@@21| T@U) (|g#0@@1| T@U) ) (!  (=> (and (and (and (and (and (= (type _module._default.Invs$A@@1) TyType) (= (type |nodes#0@@1|) (SeqType BoxType))) (= (type |s#0@@20|) (SeqType BoxType))) (= (type |f#0@@21|) (SeqType BoxType))) (= (type |g#0@@1|) (SeqType BoxType))) (or (|_module.__default.Invs#canCall| _module._default.Invs$A@@1 |nodes#0@@1| |freeStack#0@@1| |s#0@@20| |f#0@@21| |g#0@@1|) (and (not (= 11 $FunctionContextHeight)) (and (and (and ($Is |nodes#0@@1| (TSeq (Tclass._module.Node _module._default.Invs$A@@1))) ($Is |s#0@@20| (TSeq _module._default.Invs$A@@1))) ($Is |f#0@@21| (TSeq TInt))) ($Is |g#0@@1| (TSeq TInt)))))) (and (=> (= (|Seq#Length| |f#0@@21|) (|Seq#Length| |s#0@@20|)) (=> (= (|Seq#Length| |g#0@@1|) (|Seq#Length| |nodes#0@@1|)) (=> (> (|Seq#Length| |nodes#0@@1|) 0) (=> (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| 0))) (- 0 1)) (=> (<= 0 |freeStack#0@@1|) (=> (< |freeStack#0@@1| (|Seq#Length| |nodes#0@@1|)) (=> (forall ((|i#0@@12| Int) ) (!  (=> true (and (=> (and (<= 0 |i#0@@12|) (< |i#0@@12| (|Seq#Length| |f#0@@21|))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@12|))))) (=> (and (<= 0 |i#0@@12|) (< |i#0@@12| (|Seq#Length| |f#0@@21|))) (< (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@12|))) (|Seq#Length| |nodes#0@@1|)))))
 :qid |DLLDafny.111:14|
 :skolemid |1094|
...
)) (=> (forall ((|p#0| Int) ) (!  (=> true (and (=> (and (<= 0 |p#0|) (< |p#0| (|Seq#Length| |g#0@@1|))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0|))))) (=> (and (<= 0 |p#0|) (< |p#0| (|Seq#Length| |g#0@@1|))) (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0|))) (|Seq#Length| |s#0@@20|)))))
 :qid |DLLDafny.113:14|
 :skolemid |1092|
 ...
 :pattern ( (|Seq#Index| |s#0@@20| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#4@@0|)))))
...
))) (forall ((|p#0@@0| Int) ) (!  (=> true (and (=> (and (<= 0 |p#0@@0|) (< |p#0@@0| (|Seq#Length| |g#0@@1|))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0@@0|))))) (=> (and (<= 0 |p#0@@0|) (< |p#0@@0| (|Seq#Length| |g#0@@1|))) (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0@@0|))) (|Seq#Length| |s#0@@20|)))))
 :qid |DLLDafny.113:14|
 :skolemid |1075|
 ...
 :pattern ( (|Seq#Index| |s#0@@20| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#4@@1|)))))
...
))) (forall ((|p#0@@1| Int) ) (!  (=> true (and (=> (and (<= 0 |p#0@@1|) (< |p#0@@1| (|Seq#Length| |g#0@@1|))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0@@1|))))) (=> (and (<= 0 |p#0@@1|) (< |p#0@@1| (|Seq#Length| |g#0@@1|))) (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0@@1|))) (|Seq#Length| |s#0@@20|)))))
 :qid |DLLDafny.113:14|
 :skolemid |1075|
 ...
 :pattern ( (|Seq#Index| |s#0@@20| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#4@@2|)))))
...
))) (_module.__default.Invs _module._default.Invs$A@@1 |nodes#0@@1| |freeStack#0@@1| |s#0@@20| |f#0@@21| |g#0@@1|)))))
 :qid |unknown.0:0|
 :skolemid |1095|
 :pattern ( (_module.__default.Invs _module._default.Invs$A@@1 |nodes#0@@1| |freeStack#0@@1| |s#0@@20| |f#0@@21| |g#0@@1|))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall ((_module._default.Invs$A@@2 T@U) (|nodes#0@@2| T@U) (|freeStack#0@@2| Int) (|s#0@@21| T@U) (|f#0@@22| T@U) (|g#0@@2| T@U) ) (!  (=> (and (and (and (and (and (= (type _module._default.Invs$A@@2) TyType) (= (type |nodes#0@@2|) (SeqType BoxType))) (= (type |s#0@@21|) (SeqType BoxType))) (= (type |f#0@@22|) (SeqType BoxType))) (= (type |g#0@@2|) (SeqType BoxType))) (or (|_module.__default.Invs#canCall| _module._default.Invs$A@@2 (Lit |nodes#0@@2|) |freeStack#0@@2| (Lit |s#0@@21|) (Lit |f#0@@22|) (Lit |g#0@@2|)) (and (not (= 11 $FunctionContextHeight)) (and (and (and ($Is |nodes#0@@2| (TSeq (Tclass._module.Node _module._default.Invs$A@@2))) ($Is |s#0@@21| (TSeq _module._default.Invs$A@@2))) ($Is |f#0@@22| (TSeq TInt))) ($Is |g#0@@2| (TSeq TInt)))))) (and (=> (= (|Seq#Length| (Lit |f#0@@22|)) (|Seq#Length| (Lit |s#0@@21|))) (=> (= (|Seq#Length| (Lit |g#0@@2|)) (|Seq#Length| (Lit |nodes#0@@2|))) (=> (> (|Seq#Length| (Lit |nodes#0@@2|)) 0) (=> (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) 0))) (- 0 1)) (=> (<= 0 |freeStack#0@@2|) (=> (< |freeStack#0@@2| (|Seq#Length| (Lit |nodes#0@@2|))) (=> (forall ((|i#2@@1| Int) ) (!  (=> true (and (=> (and (<= 0 |i#2@@1|) (< |i#2@@1| (|Seq#Length| (Lit |f#0@@22|)))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@1|))))) (=> (and (<= 0 |i#2@@1|) (< |i#2@@1| (|Seq#Length| (Lit |f#0@@22|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@1|))) (|Seq#Length| (Lit |nodes#0@@2|))))))
 :qid |DLLDafny.111:14|
 :skolemid |1117|
...
)) (=> (forall ((|p#7| Int) ) (!  (=> true (and (=> (and (<= 0 |p#7|) (< |p#7| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7|))))) (=> (and (<= 0 |p#7|) (< |p#7| (|Seq#Length| (Lit |g#0@@2|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7|))) (|Seq#Length| (Lit |s#0@@21|))))))
 :qid |DLLDafny.113:14|
 :skolemid |1115|
 ...
 :pattern ( (|Seq#Index| |s#0@@21| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@2| |p#11@@0|)))))
...
)))))))))))))))))))) (and (=> (_module.__default.Invs _module._default.Invs$A@@2 (Lit |nodes#0@@2|) |freeStack#0@@2| (Lit |s#0@@21|) (Lit |f#0@@22|) (Lit |g#0@@2|)) (and (and (and (and (and (and (and (and (and (and (and (and (and (= (|Seq#Length| (Lit |f#0@@22|)) (|Seq#Length| (Lit |s#0@@21|))) (= (|Seq#Length| (Lit |g#0@@2|)) (|Seq#Length| (Lit |nodes#0@@2|)))) (> (|Seq#Length| (Lit |nodes#0@@2|)) 0)) (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) 0))) (- 0 1))) (and (<= 0 |freeStack#0@@2|) (< |freeStack#0@@2| (|Seq#Length| (Lit |nodes#0@@2|))))) (forall ((|i#2@@2| Int) ) (!  (=> true (and (=> (and (<= 0 |i#2@@2|) (< |i#2@@2| (|Seq#Length| (Lit |f#0@@22|)))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@2|))))) (=> (and (<= 0 |i#2@@2|) (< |i#2@@2| (|Seq#Length| (Lit |f#0@@22|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@2|))) (|Seq#Length| (Lit |nodes#0@@2|))))))
 :qid |DLLDafny.111:14|
 :skolemid |1096|
...
))) (forall ((|p#7@@0| Int) ) (!  (=> true (and (=> (and (<= 0 |p#7@@0|) (< |p#7@@0| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7@@0|))))) (=> (and (<= 0 |p#7@@0|) (< |p#7@@0| (|Seq#Length| (Lit |g#0@@2|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7@@0|))) (|Seq#Length| (Lit |s#0@@21|))))))
 :qid |DLLDafny.113:14|
 :skolemid |1098|
 ...
 :pattern ( (|Seq#Index| |s#0@@21| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@2| |p#11@@1|)))))
...
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (= (|Seq#Length| (Lit |f#0@@22|)) (|Seq#Length| (Lit |s#0@@21|))) (= (|Seq#Length| (Lit |g#0@@2|)) (|Seq#Length| (Lit |nodes#0@@2|)))) (> (|Seq#Length| (Lit |nodes#0@@2|)) 0)) (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) 0))) (- 0 1))) (and (<= 0 |freeStack#0@@2|) (< |freeStack#0@@2| (|Seq#Length| (Lit |nodes#0@@2|))))) (forall ((|i#2@@3| Int) ) (!  (=> true (and (=> (and (<= 0 |i#2@@3|) (< |i#2@@3| (|Seq#Length| (Lit |f#0@@22|)))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@3|))))) (=> (and (<= 0 |i#2@@3|) (< |i#2@@3| (|Seq#Length| (Lit |f#0@@22|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@3|))) (|Seq#Length| (Lit |nodes#0@@2|))))))
 :qid |DLLDafny.111:14|
 :skolemid |1096|
...
))) (forall ((|p#7@@1| Int) ) (!  (=> true (and (=> (and (<= 0 |p#7@@1|) (< |p#7@@1| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7@@1|))))) (=> (and (<= 0 |p#7@@1|) (< |p#7@@1| (|Seq#Length| (Lit |g#0@@2|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7@@1|))) (|Seq#Length| (Lit |s#0@@21|))))))
 :qid |DLLDafny.113:14|
 :skolemid |1098|
 ...
 :pattern ( (|Seq#Index| |s#0@@21| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@2| |p#11@@2|)))))
...
))) (_module.__default.Invs _module._default.Invs$A@@2 (Lit |nodes#0@@2|) |freeStack#0@@2| (Lit |s#0@@21|) (Lit |f#0@@22|) (Lit |g#0@@2|))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1118|
 :pattern ( (_module.__default.Invs _module._default.Invs$A@@2 (Lit |nodes#0@@2|) |freeStack#0@@2| (Lit |s#0@@21|) (Lit |f#0@@22|) (Lit |g#0@@2|)))
))))
...
(assert (forall ((arg0@@290 T@U) (arg1@@157 T@U) (arg2@@107 T@U) (arg3@@77 Bool) ) (! (= (type (|lambda#32| arg0@@290 arg1@@157 arg2@@107 arg3@@77)) (MapType6Type refType boolType))
 :qid |funType:lambda#32|
 :pattern ( (|lambda#32| arg0@@290 arg1@@157 arg2@@107 arg3@@77))
)))
...
(assert (forall ((arg0@@291 T@U) (arg1@@158 T@U) (arg2@@108 T@U) (arg3@@78 Bool) ) (! (= (type (|lambda#33| arg0@@291 arg1@@158 arg2@@108 arg3@@78)) (MapType6Type refType boolType))
 :qid |funType:lambda#33|
 :pattern ( (|lambda#33| arg0@@291 arg1@@158 arg2@@108 arg3@@78))
)))
(assert (forall (($o@@42 T@U) ($f@@32 T@U) (|l#0@@68| T@U) (|l#1@@32| T@U) (|l#2@@32| T@U) (|l#3@@32| Bool) ) (! (let ((alpha@@39 (FieldTypeInv0 (type $f@@32))))
 (=> (and (and (and (and (= (type $o@@42) refType) (= (type $f@@32) (FieldType alpha@@39))) (= (type |l#0@@68|) refType)) (= (type |l#1@@32|) (MapType0Type refType MapType1Type))) (= (type |l#2@@32|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#33| |l#0@@68| |l#1@@32| |l#2@@32| |l#3@@32|) $o@@42 $f@@32))  (=> (and (not (= $o@@42 |l#0@@68|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@32| $o@@42) |l#2@@32|))) |l#3@@32|))))
 :qid |DLLDafny.204:8|
 :skolemid |1720|
 :pattern ( (MapType6Select (|lambda#33| |l#0@@68| |l#1@@32| |l#2@@32| |l#3@@32|) $o@@42 $f@@32))
)))
(assert (forall ((arg0@@292 T@U) (arg1@@159 T@U) (arg2@@109 T@U) (arg3@@79 Bool) ) (! (= (type (|lambda#34| arg0@@292 arg1@@159 arg2@@109 arg3@@79)) (MapType6Type refType boolType))
 :qid |funType:lambda#34|
 :pattern ( (|lambda#34| arg0@@292 arg1@@159 arg2@@109 arg3@@79))
)))
(assert (forall (($o@@43 T@U) ($f@@33 T@U) (|l#0@@69| T@U) (|l#1@@33| T@U) (|l#2@@33| T@U) (|l#3@@33| Bool) ) (! (let ((alpha@@40 (FieldTypeInv0 (type $f@@33))))
 (=> (and (and (and (and (= (type $o@@43) refType) (= (type $f@@33) (FieldType alpha@@40))) (= (type |l#0@@69|) refType)) (= (type |l#1@@33|) (MapType0Type refType MapType1Type))) (= (type |l#2@@33|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#34| |l#0@@69| |l#1@@33| |l#2@@33| |l#3@@33|) $o@@43 $f@@33))  (=> (and (not (= $o@@43 |l#0@@69|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@33| $o@@43) |l#2@@33|))) |l#3@@33|))))
 :qid |DLLDafny.204:8|
 :skolemid |1721|
 :pattern ( (MapType6Select (|lambda#34| |l#0@@69| |l#1@@33| |l#2@@33| |l#3@@33|) $o@@43 $f@@33))
)))
(assert (forall ((arg0@@293 T@U) (arg1@@160 T@U) (arg2@@110 T@U) (arg3@@80 Bool) ) (! (= (type (|lambda#35| arg0@@293 arg1@@160 arg2@@110 arg3@@80)) (MapType6Type refType boolType))
 :qid |funType:lambda#35|
 :pattern ( (|lambda#35| arg0@@293 arg1@@160 arg2@@110 arg3@@80))
)))
(assert (forall (($o@@44 T@U) ($f@@34 T@U) (|l#0@@70| T@U) (|l#1@@34| T@U) (|l#2@@34| T@U) (|l#3@@34| Bool) ) (! (let ((alpha@@41 (FieldTypeInv0 (type $f@@34))))
 (=> (and (and (and (and (= (type $o@@44) refType) (= (type $f@@34) (FieldType alpha@@41))) (= (type |l#0@@70|) refType)) (= (type |l#1@@34|) (MapType0Type refType MapType1Type))) (= (type |l#2@@34|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#35| |l#0@@70| |l#1@@34| |l#2@@34| |l#3@@34|) $o@@44 $f@@34))  (=> (and (not (= $o@@44 |l#0@@70|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@34| $o@@44) |l#2@@34|))) |l#3@@34|))))
 :qid |DLLDafny.227:14|
 :skolemid |1722|
 :pattern ( (MapType6Select (|lambda#35| |l#0@@70| |l#1@@34| |l#2@@34| |l#3@@34|) $o@@44 $f@@34))
)))
(assert (forall ((arg0@@294 T@U) (arg1@@161 T@U) (arg2@@111 T@U) (arg3@@81 Bool) ) (! (= (type (|lambda#36| arg0@@294 arg1@@161 arg2@@111 arg3@@81)) (MapType6Type refType boolType))
 :qid |funType:lambda#36|
 :pattern ( (|lambda#36| arg0@@294 arg1@@161 arg2@@111 arg3@@81))
)))
(assert (forall (($o@@45 T@U) ($f@@35 T@U) (|l#0@@71| T@U) (|l#1@@35| T@U) (|l#2@@35| T@U) (|l#3@@35| Bool) ) (! (let ((alpha@@42 (FieldTypeInv0 (type $f@@35))))
 (=> (and (and (and (and (= (type $o@@45) refType) (= (type $f@@35) (FieldType alpha@@42))) (= (type |l#0@@71|) refType)) (= (type |l#1@@35|) (MapType0Type refType MapType1Type))) (= (type |l#2@@35|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#36| |l#0@@71| |l#1@@35| |l#2@@35| |l#3@@35|) $o@@45 $f@@35))  (=> (and (not (= $o@@45 |l#0@@71|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@35| $o@@45) |l#2@@35|))) |l#3@@35|))))
 :qid |DLLDafny.227:14|
 :skolemid |1723|
 :pattern ( (MapType6Select (|lambda#36| |l#0@@71| |l#1@@35| |l#2@@35| |l#3@@35|) $o@@45 $f@@35))
)))
(assert (forall ((arg0@@295 Int) (arg1@@162 Int) (arg2@@112 Int) ) (! (= (type (|lambda#37| arg0@@295 arg1@@162 arg2@@112)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#37|
 :pattern ( (|lambda#37| arg0@@295 arg1@@162 arg2@@112))
)))
(assert (forall ((|$l#1#heap#0| T@U) (|$l#1#p#0| T@U) (|l#0@@72| Int) (|l#1@@36| Int) (|l#2@@36| Int) ) (!  (=> (and (= (type |$l#1#heap#0|) (MapType0Type refType MapType1Type)) (= (type |$l#1#p#0|) BoxType)) (= (MapType2Select (|lambda#37| |l#0@@72| |l#1@@36| |l#2@@36|) |$l#1#heap#0| |$l#1#p#0|) ($Box (int_2_U (ite (= (U_2_int ($Unbox intType |$l#1#p#0|)) |l#0@@72|) |l#1@@36| |l#2@@36|)))))
 :qid |DafnyPre.515:12|
 :skolemid |1724|
 :pattern ( (MapType2Select (|lambda#37| |l#0@@72| |l#1@@36| |l#2@@36|) |$l#1#heap#0| |$l#1#p#0|))
)))
(assert (forall ((arg0@@296 T@U) ) (! (= (type (|lambda#38| arg0@@296)) (MapType2Type (MapType0Type refType MapType1Type) BoxType boolType))
 :qid |funType:lambda#38|
 :pattern ( (|lambda#38| arg0@@296))
)))
(assert (forall ((|$l#1#heap#0@@0| T@U) (|$l#1#p#0@@0| T@U) (|l#0@@73| T@U) ) (!  (=> (and (and (= (type |$l#1#heap#0@@0|) (MapType0Type refType MapType1Type)) (= (type |$l#1#p#0@@0|) BoxType)) (= (type |l#0@@73|) TyType)) (= (U_2_bool (MapType2Select (|lambda#38| |l#0@@73|) |$l#1#heap#0@@0| |$l#1#p#0@@0|)) ($IsBox |$l#1#p#0@@0| |l#0@@73|)))
 :qid |DafnyPre.515:12|
 :skolemid |1725|
 :pattern ( (MapType2Select (|lambda#38| |l#0@@73|) |$l#1#heap#0@@0| |$l#1#p#0@@0|))
)))
(assert (forall ((arg0@@297 Bool) ) (! (= (type (|lambda#39| arg0@@297)) (MapType0Type refType boolType))
 :qid |funType:lambda#39|
 :pattern ( (|lambda#39| arg0@@297))
)))
(assert (forall ((|$l#1#o#0| T@U) (|l#0@@74| Bool) ) (!  (=> (= (type |$l#1#o#0|) refType) (= (U_2_bool (MapType0Select (|lambda#39| |l#0@@74|) |$l#1#o#0|)) |l#0@@74|))
 :qid |unknown.0:0|
 :skolemid |1726|
 :pattern ( (MapType0Select (|lambda#39| |l#0@@74|) |$l#1#o#0|))
)))
(assert (forall ((arg0@@298 T@U) ) (! (= (type (|lambda#40| arg0@@298)) (MapType2Type (MapType0Type refType MapType1Type) BoxType (MapType0Type BoxType boolType)))
 :qid |funType:lambda#40|
 :pattern ( (|lambda#40| arg0@@298))
)))
(assert (forall ((|$l#1#heap#0@@1| T@U) (|$l#1#p#0@@1| T@U) (|l#0@@75| T@U) ) (!  (=> (and (and (= (type |$l#1#heap#0@@1|) (MapType0Type refType MapType1Type)) (= (type |$l#1#p#0@@1|) BoxType)) (= (type |l#0@@75|) (MapType0Type BoxType boolType))) (= (MapType2Select (|lambda#40| |l#0@@75|) |$l#1#heap#0@@1| |$l#1#p#0@@1|) |l#0@@75|))
 :qid |DafnyPre.515:12|
 :skolemid |1727|
 :pattern ( (MapType2Select (|lambda#40| |l#0@@75|) |$l#1#heap#0@@1| |$l#1#p#0@@1|))
)))
(assert (forall ((arg0@@299 T@U) ) (! (= (type (|lambda#41| arg0@@299)) (MapType0Type LayerTypeType HandleTypeType))
 :qid |funType:lambda#41|
 :pattern ( (|lambda#41| arg0@@299))
)))
(assert (forall ((|$l#1#ly#0| T@U) (|l#0@@76| T@U) ) (!  (=> (and (= (type |$l#1#ly#0|) LayerTypeType) (= (type |l#0@@76|) HandleTypeType)) (= (MapType0Select (|lambda#41| |l#0@@76|) |$l#1#ly#0|) |l#0@@76|))
 :qid |unknown.0:0|
 :skolemid |1728|
 :pattern ( (MapType0Select (|lambda#41| |l#0@@76|) |$l#1#ly#0|))
)))
(assert (forall ((arg0@@300 T@U) (arg1@@163 T@U) (arg2@@113 T@U) (arg3@@82 Bool) ) (! (= (type (|lambda#57| arg0@@300 arg1@@163 arg2@@113 arg3@@82)) (MapType6Type refType boolType))
 :qid |funType:lambda#57|
 :pattern ( (|lambda#57| arg0@@300 arg1@@163 arg2@@113 arg3@@82))
)))
(assert (forall (($o@@46 T@U) ($f@@36 T@U) (|l#0@@77| T@U) (|l#1@@37| T@U) (|l#2@@37| T@U) (|l#3@@36| Bool) ) (! (let ((alpha@@43 (FieldTypeInv0 (type $f@@36))))
 (=> (and (and (and (and (= (type $o@@46) refType) (= (type $f@@36) (FieldType alpha@@43))) (= (type |l#0@@77|) refType)) (= (type |l#1@@37|) (MapType0Type refType MapType1Type))) (= (type |l#2@@37|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#57| |l#0@@77| |l#1@@37| |l#2@@37| |l#3@@36|) $o@@46 $f@@36))  (=> (and (not (= $o@@46 |l#0@@77|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@37| $o@@46) |l#2@@37|))) |l#3@@36|))))
 :qid |DLLDafny.235:23|
 :skolemid |1729|
 :pattern ( (MapType6Select (|lambda#57| |l#0@@77| |l#1@@37| |l#2@@37| |l#3@@36|) $o@@46 $f@@36))
)))
(assert (forall ((arg0@@301 T@U) (arg1@@164 T@U) (arg2@@114 T@U) (arg3@@83 Bool) ) (! (= (type (|lambda#58| arg0@@301 arg1@@164 arg2@@114 arg3@@83)) (MapType6Type refType boolType))
 :qid |funType:lambda#58|
 :pattern ( (|lambda#58| arg0@@301 arg1@@164 arg2@@114 arg3@@83))
)))
(assert (forall (($o@@47 T@U) ($f@@37 T@U) (|l#0@@78| T@U) (|l#1@@38| T@U) (|l#2@@38| T@U) (|l#3@@37| Bool) ) (! (let ((alpha@@44 (FieldTypeInv0 (type $f@@37))))
 (=> (and (and (and (and (= (type $o@@47) refType) (= (type $f@@37) (FieldType alpha@@44))) (= (type |l#0@@78|) refType)) (= (type |l#1@@38|) (MapType0Type refType MapType1Type))) (= (type |l#2@@38|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#58| |l#0@@78| |l#1@@38| |l#2@@38| |l#3@@37|) $o@@47 $f@@37))  (=> (and (not (= $o@@47 |l#0@@78|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@38| $o@@47) |l#2@@38|))) |l#3@@37|))))
 :qid |DLLDafny.239:8|
 :skolemid |1730|
 :pattern ( (MapType6Select (|lambda#58| |l#0@@78| |l#1@@38| |l#2@@38| |l#3@@37|) $o@@47 $f@@37))
)))
(assert (forall ((arg0@@302 T@U) (arg1@@165 T@U) (arg2@@115 T@U) (arg3@@84 Bool) ) (! (= (type (|lambda#59| arg0@@302 arg1@@165 arg2@@115 arg3@@84)) (MapType6Type refType boolType))
 :qid |funType:lambda#59|
 :pattern ( (|lambda#59| arg0@@302 arg1@@165 arg2@@115 arg3@@84))
)))
(assert (forall (($o@@48 T@U) ($f@@38 T@U) (|l#0@@79| T@U) (|l#1@@39| T@U) (|l#2@@39| T@U) (|l#3@@38| Bool) ) (! (let ((alpha@@45 (FieldTypeInv0 (type $f@@38))))
 (=> (and (and (and (and (= (type $o@@48) refType) (= (type $f@@38) (FieldType alpha@@45))) (= (type |l#0@@79|) refType)) (= (type |l#1@@39|) (MapType0Type refType MapType1Type))) (= (type |l#2@@39|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#59| |l#0@@79| |l#1@@39| |l#2@@39| |l#3@@38|) $o@@48 $f@@38))  (=> (and (not (= $o@@48 |l#0@@79|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@39| $o@@48) |l#2@@39|))) |l#3@@38|))))
 :qid |DLLDafny.257:14|
 :skolemid |1731|
 :pattern ( (MapType6Select (|lambda#59| |l#0@@79| |l#1@@39| |l#2@@39| |l#3@@38|) $o@@48 $f@@38))
)))
(assert (forall ((arg0@@303 T@U) (arg1@@166 T@U) (arg2@@116 T@U) (arg3@@85 Bool) ) (! (= (type (|lambda#60| arg0@@303 arg1@@166 arg2@@116 arg3@@85)) (MapType6Type refType boolType))
 :qid |funType:lambda#60|
 :pattern ( (|lambda#60| arg0@@303 arg1@@166 arg2@@116 arg3@@85))
)))
(assert (forall (($o@@49 T@U) ($f@@39 T@U) (|l#0@@80| T@U) (|l#1@@40| T@U) (|l#2@@40| T@U) (|l#3@@39| Bool) ) (! (let ((alpha@@46 (FieldTypeInv0 (type $f@@39))))
 (=> (and (and (and (and (= (type $o@@49) refType) (= (type $f@@39) (FieldType alpha@@46))) (= (type |l#0@@80|) refType)) (= (type |l#1@@40|) (MapType0Type refType MapType1Type))) (= (type |l#2@@40|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#60| |l#0@@80| |l#1@@40| |l#2@@40| |l#3@@39|) $o@@49 $f@@39))  (=> (and (not (= $o@@49 |l#0@@80|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@40| $o@@49) |l#2@@40|))) |l#3@@39|))))
 :qid |DLLDafny.257:14|
 :skolemid |1732|
 :pattern ( (MapType6Select (|lambda#60| |l#0@@80| |l#1@@40| |l#2@@40| |l#3@@39|) $o@@49 $f@@39))
)))
(assert (forall ((arg0@@304 Int) (arg1@@167 T@U) (arg2@@117 Int) ) (! (= (type (|lambda#61| arg0@@304 arg1@@167 arg2@@117)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#61|
 :pattern ( (|lambda#61| arg0@@304 arg1@@167 arg2@@117))
)))
(assert (forall ((|$l#1#heap#0@@2| T@U) (|$l#1#x#0| T@U) (|l#0@@81| Int) (|l#1@@41| T@U) (|l#2@@41| Int) ) (!  (=> (and (and (= (type |$l#1#heap#0@@2|) (MapType0Type refType MapType1Type)) (= (type |$l#1#x#0|) BoxType)) (= (type |l#1@@41|) (SeqType BoxType))) (= (MapType2Select (|lambda#61| |l#0@@81| |l#1@@41| |l#2@@41|) |$l#1#heap#0@@2| |$l#1#x#0|) ($Box (int_2_U (ite (< (U_2_int ($Unbox intType |$l#1#x#0|)) |l#0@@81|) (U_2_int ($Unbox intType (|Seq#Index| |l#1@@41| (U_2_int ($Unbox intType |$l#1#x#0|))))) |l#2@@41|)))))
 :qid |DafnyPre.515:12|
 :skolemid |1733|
 :pattern ( (MapType2Select (|lambda#61| |l#0@@81| |l#1@@41| |l#2@@41|) |$l#1#heap#0@@2| |$l#1#x#0|))
)))
(assert (forall ((arg0@@305 T@U) (arg1@@168 Int) (arg2@@118 Int) ) (! (= (type (|lambda#62| arg0@@305 arg1@@168 arg2@@118)) (MapType2Type (MapType0Type refType MapType1Type) BoxType boolType))
 :qid |funType:lambda#62|
 :pattern ( (|lambda#62| arg0@@305 arg1@@168 arg2@@118))
)))
(assert (forall ((|$l#1#heap#0@@3| T@U) (|$l#1#x#0@@0| T@U) (|l#0@@82| T@U) (|l#1@@42| Int) (|l#2@@42| Int) ) (!  (=> (and (and (= (type |$l#1#heap#0@@3|) (MapType0Type refType MapType1Type)) (= (type |$l#1#x#0@@0|) BoxType)) (= (type |l#0@@82|) TyType)) (= (U_2_bool (MapType2Select (|lambda#62| |l#0@@82| |l#1@@42| |l#2@@42|) |$l#1#heap#0@@3| |$l#1#x#0@@0|))  (and ($IsBox |$l#1#x#0@@0| |l#0@@82|) (and (<= |l#1@@42| (U_2_int ($Unbox intType |$l#1#x#0@@0|))) (< (U_2_int ($Unbox intType |$l#1#x#0@@0|)) |l#2@@42|)))))
 :qid |DafnyPre.515:12|
 :skolemid |1734|
 :pattern ( (MapType2Select (|lambda#62| |l#0@@82| |l#1@@42| |l#2@@42|) |$l#1#heap#0@@3| |$l#1#x#0@@0|))
)))
(assert (forall ((arg0@@306 T@U) (arg1@@169 T@U) (arg2@@119 T@U) (arg3@@86 Bool) ) (! (= (type (|lambda#81| arg0@@306 arg1@@169 arg2@@119 arg3@@86)) (MapType6Type refType boolType))
 :qid |funType:lambda#81|
 :pattern ( (|lambda#81| arg0@@306 arg1@@169 arg2@@119 arg3@@86))
)))
...
(assert (forall ((arg0@@307 T@U) (arg1@@170 T@U) (arg2@@120 T@U) (arg3@@87 Bool) ) (! (= (type (|lambda#82| arg0@@307 arg1@@170 arg2@@120 arg3@@87)) (MapType6Type refType boolType))
 :qid |funType:lambda#82|
 :pattern ( (|lambda#82| arg0@@307 arg1@@170 arg2@@120 arg3@@87))
)))
(assert (forall (($o@@51 T@U) ($f@@41 T@U) (|l#0@@84| T@U) (|l#1@@44| T@U) (|l#2@@44| T@U) (|l#3@@41| Bool) ) (! (let ((alpha@@48 (FieldTypeInv0 (type $f@@41))))
 (=> (and (and (and (and (= (type $o@@51) refType) (= (type $f@@41) (FieldType alpha@@48))) (= (type |l#0@@84|) refType)) (= (type |l#1@@44|) (MapType0Type refType MapType1Type))) (= (type |l#2@@44|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#82| |l#0@@84| |l#1@@44| |l#2@@44| |l#3@@41|) $o@@51 $f@@41))  (=> (and (not (= $o@@51 |l#0@@84|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@44| $o@@51) |l#2@@44|))) |l#3@@41|))))
 :qid |DLLDafny.270:8|
 :skolemid |1736|
 :pattern ( (MapType6Select (|lambda#82| |l#0@@84| |l#1@@44| |l#2@@44| |l#3@@41|) $o@@51 $f@@41))
)))
(assert (forall ((arg0@@308 T@U) (arg1@@171 T@U) (arg2@@121 T@U) (arg3@@88 Bool) ) (! (= (type (|lambda#83| arg0@@308 arg1@@171 arg2@@121 arg3@@88)) (MapType6Type refType boolType))
 :qid |funType:lambda#83|
 :pattern ( (|lambda#83| arg0@@308 arg1@@171 arg2@@121 arg3@@88))
)))
(assert (forall (($o@@52 T@U) ($f@@42 T@U) (|l#0@@85| T@U) (|l#1@@45| T@U) (|l#2@@45| T@U) (|l#3@@42| Bool) ) (! (let ((alpha@@49 (FieldTypeInv0 (type $f@@42))))
 (=> (and (and (and (and (= (type $o@@52) refType) (= (type $f@@42) (FieldType alpha@@49))) (= (type |l#0@@85|) refType)) (= (type |l#1@@45|) (MapType0Type refType MapType1Type))) (= (type |l#2@@45|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#83| |l#0@@85| |l#1@@45| |l#2@@45| |l#3@@42|) $o@@52 $f@@42))  (=> (and (not (= $o@@52 |l#0@@85|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@45| $o@@52) |l#2@@45|))) |l#3@@42|))))
 :qid |DLLDafny.270:8|
 :skolemid |1737|
 :pattern ( (MapType6Select (|lambda#83| |l#0@@85| |l#1@@45| |l#2@@45| |l#3@@42|) $o@@52 $f@@42))
)))
(assert (forall ((arg0@@309 T@U) (arg1@@172 T@U) (arg2@@122 T@U) (arg3@@89 Bool) ) (! (= (type (|lambda#84| arg0@@309 arg1@@172 arg2@@122 arg3@@89)) (MapType6Type refType boolType))
 :qid |funType:lambda#84|
 :pattern ( (|lambda#84| arg0@@309 arg1@@172 arg2@@122 arg3@@89))
)))
(assert (forall (($o@@53 T@U) ($f@@43 T@U) (|l#0@@86| T@U) (|l#1@@46| T@U) (|l#2@@46| T@U) (|l#3@@43| Bool) ) (! (let ((alpha@@50 (FieldTypeInv0 (type $f@@43))))
 (=> (and (and (and (and (= (type $o@@53) refType) (= (type $f@@43) (FieldType alpha@@50))) (= (type |l#0@@86|) refType)) (= (type |l#1@@46|) (MapType0Type refType MapType1Type))) (= (type |l#2@@46|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#84| |l#0@@86| |l#1@@46| |l#2@@46| |l#3@@43|) $o@@53 $f@@43))  (=> (and (not (= $o@@53 |l#0@@86|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@46| $o@@53) |l#2@@46|))) |l#3@@43|))))
 :qid |DLLDafny.290:14|
 :skolemid |1738|
 :pattern ( (MapType6Select (|lambda#84| |l#0@@86| |l#1@@46| |l#2@@46| |l#3@@43|) $o@@53 $f@@43))
)))
(assert (forall ((arg0@@310 T@U) (arg1@@173 T@U) (arg2@@123 T@U) (arg3@@90 Bool) ) (! (= (type (|lambda#85| arg0@@310 arg1@@173 arg2@@123 arg3@@90)) (MapType6Type refType boolType))
 :qid |funType:lambda#85|
 :pattern ( (|lambda#85| arg0@@310 arg1@@173 arg2@@123 arg3@@90))
)))
(assert (forall (($o@@54 T@U) ($f@@44 T@U) (|l#0@@87| T@U) (|l#1@@47| T@U) (|l#2@@47| T@U) (|l#3@@44| Bool) ) (! (let ((alpha@@51 (FieldTypeInv0 (type $f@@44))))
 (=> (and (and (and (and (= (type $o@@54) refType) (= (type $f@@44) (FieldType alpha@@51))) (= (type |l#0@@87|) refType)) (= (type |l#1@@47|) (MapType0Type refType MapType1Type))) (= (type |l#2@@47|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#85| |l#0@@87| |l#1@@47| |l#2@@47| |l#3@@44|) $o@@54 $f@@44))  (=> (and (not (= $o@@54 |l#0@@87|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@47| $o@@54) |l#2@@47|))) |l#3@@44|))))
 :qid |DLLDafny.290:14|
 :skolemid |1739|
 :pattern ( (MapType6Select (|lambda#85| |l#0@@87| |l#1@@47| |l#2@@47| |l#3@@44|) $o@@54 $f@@44))
)))
(assert (forall ((arg0@@311 T@U) (arg1@@174 Int) (arg2@@124 Int) (arg3@@91 T@U) (arg4@@30 Int) (arg5@@19 T@U) (arg6@@15 Int) (arg7@@4 T@U) ) (! (= (type (|lambda#86| arg0@@311 arg1@@174 arg2@@124 arg3@@91 arg4@@30 arg5@@19 arg6@@15 arg7@@4)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#86|
 :pattern ( (|lambda#86| arg0@@311 arg1@@174 arg2@@124 arg3@@91 arg4@@30 arg5@@19 arg6@@15 arg7@@4))
)))
(assert (forall ((|$l#1#heap#0@@4| T@U) (|$l#1#x#0@@1| T@U) (|l#0@@88| T@U) (|l#1@@48| Int) (|l#2@@48| Int) (|l#3@@45| T@U) (|l#4| Int) (|l#5| T@U) (|l#6| Int) (|l#7| T@U) ) (!  (=> (and (and (and (and (and (= (type |$l#1#heap#0@@4|) (MapType0Type refType MapType1Type)) (= (type |$l#1#x#0@@1|) BoxType)) (= (type |l#0@@88|) (SeqType BoxType))) (= (type |l#3@@45|) (SeqType BoxType))) (= (type |l#5|) (SeqType BoxType))) (= (type |l#7|) (SeqType BoxType))) (= (MapType2Select (|lambda#86| |l#0@@88| |l#1@@48| |l#2@@48| |l#3@@45| |l#4| |l#5| |l#6| |l#7|) |$l#1#heap#0@@4| |$l#1#x#0@@1|) ($Box (int_2_U (ite (= (U_2_int ($Unbox intType (|Seq#Index| |l#0@@88| (U_2_int ($Unbox intType |$l#1#x#0@@1|))))) |l#1@@48|) |l#2@@48| (ite (> (U_2_int ($Unbox intType (|Seq#Index| |l#3@@45| (U_2_int ($Unbox intType |$l#1#x#0@@1|))))) |l#4|) (_module.__default.Sub (U_2_int ($Unbox intType (|Seq#Index| |l#5| (U_2_int ($Unbox intType |$l#1#x#0@@1|))))) |l#6|) (U_2_int ($Unbox intType (|Seq#Index| |l#7| (U_2_int ($Unbox intType |$l#1#x#0@@1|)))))))))))
 :qid |DafnyPre.515:12|
 :skolemid |1740|
 :pattern ( (MapType2Select (|lambda#86| |l#0@@88| |l#1@@48| |l#2@@48| |l#3@@45| |l#4| |l#5| |l#6| |l#7|) |$l#1#heap#0@@4| |$l#1#x#0@@1|))
)))
(assert (forall ((arg0@@312 T@U) (arg1@@175 T@U) (arg2@@125 T@U) (arg3@@92 Bool) ) (! (= (type (|lambda#106| arg0@@312 arg1@@175 arg2@@125 arg3@@92)) (MapType6Type refType boolType))
 :qid |funType:lambda#106|
 :pattern ( (|lambda#106| arg0@@312 arg1@@175 arg2@@125 arg3@@92))
)))
...
(assert (forall ((arg0@@313 T@U) (arg1@@176 T@U) (arg2@@126 T@U) (arg3@@93 Bool) ) (! (= (type (|lambda#107| arg0@@313 arg1@@176 arg2@@126 arg3@@93)) (MapType6Type refType boolType))
 :qid |funType:lambda#107|
 :pattern ( (|lambda#107| arg0@@313 arg1@@176 arg2@@126 arg3@@93))
)))
(assert (forall (($o@@56 T@U) ($f@@46 T@U) (|l#0@@90| T@U) (|l#1@@50| T@U) (|l#2@@50| T@U) (|l#3@@47| Bool) ) (! (let ((alpha@@53 (FieldTypeInv0 (type $f@@46))))
 (=> (and (and (and (and (= (type $o@@56) refType) (= (type $f@@46) (FieldType alpha@@53))) (= (type |l#0@@90|) refType)) (= (type |l#1@@50|) (MapType0Type refType MapType1Type))) (= (type |l#2@@50|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#107| |l#0@@90| |l#1@@50| |l#2@@50| |l#3@@47|) $o@@56 $f@@46))  (=> (and (not (= $o@@56 |l#0@@90|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@50| $o@@56) |l#2@@50|))) |l#3@@47|))))
 :qid |DLLDafny.303:8|
 :skolemid |1742|
 :pattern ( (MapType6Select (|lambda#107| |l#0@@90| |l#1@@50| |l#2@@50| |l#3@@47|) $o@@56 $f@@46))
)))
(assert (forall ((arg0@@314 T@U) (arg1@@177 T@U) (arg2@@127 T@U) (arg3@@94 Bool) ) (! (= (type (|lambda#108| arg0@@314 arg1@@177 arg2@@127 arg3@@94)) (MapType6Type refType boolType))
 :qid |funType:lambda#108|
 :pattern ( (|lambda#108| arg0@@314 arg1@@177 arg2@@127 arg3@@94))
)))
(assert (forall (($o@@57 T@U) ($f@@47 T@U) (|l#0@@91| T@U) (|l#1@@51| T@U) (|l#2@@51| T@U) (|l#3@@48| Bool) ) (! (let ((alpha@@54 (FieldTypeInv0 (type $f@@47))))
 (=> (and (and (and (and (= (type $o@@57) refType) (= (type $f@@47) (FieldType alpha@@54))) (= (type |l#0@@91|) refType)) (= (type |l#1@@51|) (MapType0Type refType MapType1Type))) (= (type |l#2@@51|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#108| |l#0@@91| |l#1@@51| |l#2@@51| |l#3@@48|) $o@@57 $f@@47))  (=> (and (not (= $o@@57 |l#0@@91|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@51| $o@@57) |l#2@@51|))) |l#3@@48|))))
 :qid |DLLDafny.303:8|
 :skolemid |1743|
 :pattern ( (MapType6Select (|lambda#108| |l#0@@91| |l#1@@51| |l#2@@51| |l#3@@48|) $o@@57 $f@@47))
)))
(assert (forall ((arg0@@315 T@U) (arg1@@178 T@U) (arg2@@128 T@U) (arg3@@95 Bool) ) (! (= (type (|lambda#109| arg0@@315 arg1@@178 arg2@@128 arg3@@95)) (MapType6Type refType boolType))
 :qid |funType:lambda#109|
 :pattern ( (|lambda#109| arg0@@315 arg1@@178 arg2@@128 arg3@@95))
)))
(assert (forall (($o@@58 T@U) ($f@@48 T@U) (|l#0@@92| T@U) (|l#1@@52| T@U) (|l#2@@52| T@U) (|l#3@@49| Bool) ) (! (let ((alpha@@55 (FieldTypeInv0 (type $f@@48))))
 (=> (and (and (and (and (= (type $o@@58) refType) (= (type $f@@48) (FieldType alpha@@55))) (= (type |l#0@@92|) refType)) (= (type |l#1@@52|) (MapType0Type refType MapType1Type))) (= (type |l#2@@52|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#109| |l#0@@92| |l#1@@52| |l#2@@52| |l#3@@49|) $o@@58 $f@@48))  (=> (and (not (= $o@@58 |l#0@@92|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@52| $o@@58) |l#2@@52|))) |l#3@@49|))))
 :qid |DLLDafny.329:14|
 :skolemid |1744|
 :pattern ( (MapType6Select (|lambda#109| |l#0@@92| |l#1@@52| |l#2@@52| |l#3@@49|) $o@@58 $f@@48))
)))
(assert (forall ((arg0@@316 T@U) (arg1@@179 T@U) (arg2@@129 T@U) (arg3@@96 Bool) ) (! (= (type (|lambda#110| arg0@@316 arg1@@179 arg2@@129 arg3@@96)) (MapType6Type refType boolType))
 :qid |funType:lambda#110|
 :pattern ( (|lambda#110| arg0@@316 arg1@@179 arg2@@129 arg3@@96))
)))
(assert (forall (($o@@59 T@U) ($f@@49 T@U) (|l#0@@93| T@U) (|l#1@@53| T@U) (|l#2@@53| T@U) (|l#3@@50| Bool) ) (! (let ((alpha@@56 (FieldTypeInv0 (type $f@@49))))
 (=> (and (and (and (and (= (type $o@@59) refType) (= (type $f@@49) (FieldType alpha@@56))) (= (type |l#0@@93|) refType)) (= (type |l#1@@53|) (MapType0Type refType MapType1Type))) (= (type |l#2@@53|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#110| |l#0@@93| |l#1@@53| |l#2@@53| |l#3@@50|) $o@@59 $f@@49))  (=> (and (not (= $o@@59 |l#0@@93|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@53| $o@@59) |l#2@@53|))) |l#3@@50|))))
 :qid |DLLDafny.329:14|
 :skolemid |1745|
 :pattern ( (MapType6Select (|lambda#110| |l#0@@93| |l#1@@53| |l#2@@53| |l#3@@50|) $o@@59 $f@@49))
)))
(assert (forall ((arg0@@317 Int) (arg1@@180 Int) (arg2@@130 Int) (arg3@@97 T@U) (arg4@@31 T@U) (arg5@@20 Int) (arg6@@16 T@U) ) (! (= (type (|lambda#111| arg0@@317 arg1@@180 arg2@@130 arg3@@97 arg4@@31 arg5@@20 arg6@@16)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#111|
 :pattern ( (|lambda#111| arg0@@317 arg1@@180 arg2@@130 arg3@@97 arg4@@31 arg5@@20 arg6@@16))
)))
(assert (forall ((|$l#1#heap#0@@5| T@U) (|$l#1#x#0@@2| T@U) (|l#0@@94| Int) (|l#1@@54| Int) (|l#2@@54| Int) (|l#3@@51| T@U) (|l#4@@0| T@U) (|l#5@@0| Int) (|l#6@@0| T@U) ) (!  (=> (and (and (and (and (= (type |$l#1#heap#0@@5|) (MapType0Type refType MapType1Type)) (= (type |$l#1#x#0@@2|) BoxType)) (= (type |l#3@@51|) (SeqType BoxType))) (= (type |l#4@@0|) (SeqType BoxType))) (= (type |l#6@@0|) (SeqType BoxType))) (= (MapType2Select (|lambda#111| |l#0@@94| |l#1@@54| |l#2@@54| |l#3@@51| |l#4@@0| |l#5@@0| |l#6@@0|) |$l#1#heap#0@@5| |$l#1#x#0@@2|) ($Box (int_2_U (ite (= (U_2_int ($Unbox intType |$l#1#x#0@@2|)) |l#0@@94|) |l#1@@54| (ite (< |l#2@@54| (U_2_int ($Unbox intType (|Seq#Index| |l#3@@51| (U_2_int ($Unbox intType |$l#1#x#0@@2|)))))) (_module.__default.Add (U_2_int ($Unbox intType (|Seq#Index| |l#4@@0| (U_2_int ($Unbox intType |$l#1#x#0@@2|))))) |l#5@@0|) (U_2_int ($Unbox intType (|Seq#Index| |l#6@@0| (U_2_int ($Unbox intType |$l#1#x#0@@2|)))))))))))
 :qid |DafnyPre.515:12|
 :skolemid |1746|
 :pattern ( (MapType2Select (|lambda#111| |l#0@@94| |l#1@@54| |l#2@@54| |l#3@@51| |l#4@@0| |l#5@@0| |l#6@@0|) |$l#1#heap#0@@5| |$l#1#x#0@@2|))
)))
(assert (forall ((arg0@@318 T@U) (arg1@@181 T@U) (arg2@@131 T@U) (arg3@@98 Bool) ) (! (= (type (|lambda#131| arg0@@318 arg1@@181 arg2@@131 arg3@@98)) (MapType6Type refType boolType))
 :qid |funType:lambda#131|
 :pattern ( (|lambda#131| arg0@@318 arg1@@181 arg2@@131 arg3@@98))
)))
...
(assert (forall ((arg0@@319 T@U) (arg1@@182 T@U) (arg2@@132 T@U) (arg3@@99 Bool) ) (! (= (type (|lambda#132| arg0@@319 arg1@@182 arg2@@132 arg3@@99)) (MapType6Type refType boolType))
 :qid |funType:lambda#132|
 :pattern ( (|lambda#132| arg0@@319 arg1@@182 arg2@@132 arg3@@99))
)))
(assert (forall (($o@@61 T@U) ($f@@51 T@U) (|l#0@@96| T@U) (|l#1@@56| T@U) (|l#2@@56| T@U) (|l#3@@53| Bool) ) (! (let ((alpha@@58 (FieldTypeInv0 (type $f@@51))))
 (=> (and (and (and (and (= (type $o@@61) refType) (= (type $f@@51) (FieldType alpha@@58))) (= (type |l#0@@96|) refType)) (= (type |l#1@@56|) (MapType0Type refType MapType1Type))) (= (type |l#2@@56|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#132| |l#0@@96| |l#1@@56| |l#2@@56| |l#3@@53|) $o@@61 $f@@51))  (=> (and (not (= $o@@61 |l#0@@96|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@56| $o@@61) |l#2@@56|))) |l#3@@53|))))
 :qid |DLLDafny.342:8|
 :skolemid |1748|
 :pattern ( (MapType6Select (|lambda#132| |l#0@@96| |l#1@@56| |l#2@@56| |l#3@@53|) $o@@61 $f@@51))
)))
(assert (forall ((arg0@@320 T@U) (arg1@@183 T@U) (arg2@@133 T@U) (arg3@@100 Bool) ) (! (= (type (|lambda#133| arg0@@320 arg1@@183 arg2@@133 arg3@@100)) (MapType6Type refType boolType))
 :qid |funType:lambda#133|
 :pattern ( (|lambda#133| arg0@@320 arg1@@183 arg2@@133 arg3@@100))
)))
(assert (forall (($o@@62 T@U) ($f@@52 T@U) (|l#0@@97| T@U) (|l#1@@57| T@U) (|l#2@@57| T@U) (|l#3@@54| Bool) ) (! (let ((alpha@@59 (FieldTypeInv0 (type $f@@52))))
 (=> (and (and (and (and (= (type $o@@62) refType) (= (type $f@@52) (FieldType alpha@@59))) (= (type |l#0@@97|) refType)) (= (type |l#1@@57|) (MapType0Type refType MapType1Type))) (= (type |l#2@@57|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#133| |l#0@@97| |l#1@@57| |l#2@@57| |l#3@@54|) $o@@62 $f@@52))  (=> (and (not (= $o@@62 |l#0@@97|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@57| $o@@62) |l#2@@57|))) |l#3@@54|))))
 :qid |DLLDafny.342:8|
 :skolemid |1749|
 :pattern ( (MapType6Select (|lambda#133| |l#0@@97| |l#1@@57| |l#2@@57| |l#3@@54|) $o@@62 $f@@52))
)))
(assert (forall ((arg0@@321 T@U) (arg1@@184 T@U) (arg2@@134 T@U) (arg3@@101 Bool) ) (! (= (type (|lambda#134| arg0@@321 arg1@@184 arg2@@134 arg3@@101)) (MapType6Type refType boolType))
 :qid |funType:lambda#134|
 :pattern ( (|lambda#134| arg0@@321 arg1@@184 arg2@@134 arg3@@101))
)))
(assert (forall (($o@@63 T@U) ($f@@53 T@U) (|l#0@@98| T@U) (|l#1@@58| T@U) (|l#2@@58| T@U) (|l#3@@55| Bool) ) (! (let ((alpha@@60 (FieldTypeInv0 (type $f@@53))))
 (=> (and (and (and (and (= (type $o@@63) refType) (= (type $f@@53) (FieldType alpha@@60))) (= (type |l#0@@98|) refType)) (= (type |l#1@@58|) (MapType0Type refType MapType1Type))) (= (type |l#2@@58|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#134| |l#0@@98| |l#1@@58| |l#2@@58| |l#3@@55|) $o@@63 $f@@53))  (=> (and (not (= $o@@63 |l#0@@98|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@58| $o@@63) |l#2@@58|))) |l#3@@55|))))
 :qid |DLLDafny.379:14|
 :skolemid |1750|
 :pattern ( (MapType6Select (|lambda#134| |l#0@@98| |l#1@@58| |l#2@@58| |l#3@@55|) $o@@63 $f@@53))
)))
(assert (forall ((arg0@@322 T@U) (arg1@@185 T@U) (arg2@@135 T@U) (arg3@@102 Bool) ) (! (= (type (|lambda#135| arg0@@322 arg1@@185 arg2@@135 arg3@@102)) (MapType6Type refType boolType))
 :qid |funType:lambda#135|
 :pattern ( (|lambda#135| arg0@@322 arg1@@185 arg2@@135 arg3@@102))
)))
(assert (forall (($o@@64 T@U) ($f@@54 T@U) (|l#0@@99| T@U) (|l#1@@59| T@U) (|l#2@@59| T@U) (|l#3@@56| Bool) ) (! (let ((alpha@@61 (FieldTypeInv0 (type $f@@54))))
 (=> (and (and (and (and (= (type $o@@64) refType) (= (type $f@@54) (FieldType alpha@@61))) (= (type |l#0@@99|) refType)) (= (type |l#1@@59|) (MapType0Type refType MapType1Type))) (= (type |l#2@@59|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#135| |l#0@@99| |l#1@@59| |l#2@@59| |l#3@@56|) $o@@64 $f@@54))  (=> (and (not (= $o@@64 |l#0@@99|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@59| $o@@64) |l#2@@59|))) |l#3@@56|))))
 :qid |DLLDafny.379:14|
 :skolemid |1751|
 :pattern ( (MapType6Select (|lambda#135| |l#0@@99| |l#1@@59| |l#2@@59| |l#3@@56|) $o@@64 $f@@54))
)))
(assert (forall ((arg0@@323 Int) (arg1@@186 Int) (arg2@@136 T@U) (arg3@@103 Int) (arg4@@32 T@U) (arg5@@21 Int) (arg6@@17 T@U) ) (! (= (type (|lambda#136| arg0@@323 arg1@@186 arg2@@136 arg3@@103 arg4@@32 arg5@@21 arg6@@17)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#136|
 :pattern ( (|lambda#136| arg0@@323 arg1@@186 arg2@@136 arg3@@103 arg4@@32 arg5@@21 arg6@@17))
)))
(assert (forall ((|$l#1#heap#0@@6| T@U) (|$l#1#x#0@@3| T@U) (|l#0@@100| Int) (|l#1@@60| Int) (|l#2@@60| T@U) (|l#3@@57| Int) (|l#4@@1| T@U) (|l#5@@1| Int) (|l#6@@1| T@U) ) (!  (=> (and (and (and (and (= (type |$l#1#heap#0@@6|) (MapType0Type refType MapType1Type)) (= (type |$l#1#x#0@@3|) BoxType)) (= (type |l#2@@60|) (SeqType BoxType))) (= (type |l#4@@1|) (SeqType BoxType))) (= (type |l#6@@1|) (SeqType BoxType))) (= (MapType2Select (|lambda#136| |l#0@@100| |l#1@@60| |l#2@@60| |l#3@@57| |l#4@@1| |l#5@@1| |l#6@@1|) |$l#1#heap#0@@6| |$l#1#x#0@@3|) ($Box (int_2_U (ite (= (U_2_int ($Unbox intType |$l#1#x#0@@3|)) |l#0@@100|) |l#1@@60| (ite (>= (U_2_int ($Unbox intType (|Seq#Index| |l#2@@60| (U_2_int ($Unbox intType |$l#1#x#0@@3|))))) |l#3@@57|) (_module.__default.Add (U_2_int ($Unbox intType (|Seq#Index| |l#4@@1| (U_2_int ($Unbox intType |$l#1#x#0@@3|))))) |l#5@@1|) (U_2_int ($Unbox intType (|Seq#Index| |l#6@@1| (U_2_int ($Unbox intType |$l#1#x#0@@3|)))))))))))
 :qid |DafnyPre.515:12|
 :skolemid |1752|
 :pattern ( (MapType2Select (|lambda#136| |l#0@@100| |l#1@@60| |l#2@@60| |l#3@@57| |l#4@@1| |l#5@@1| |l#6@@1|) |$l#1#heap#0@@6| |$l#1#x#0@@3|))
)))
(assert (forall ((arg0@@324 T@U) (arg1@@187 T@U) (arg2@@137 T@U) (arg3@@104 Bool) ) (! (= (type (|lambda#156| arg0@@324 arg1@@187 arg2@@137 arg3@@104)) (MapType6Type refType boolType))
 :qid |funType:lambda#156|
 :pattern ( (|lambda#156| arg0@@324 arg1@@187 arg2@@137 arg3@@104))
)))
...
(assert (forall ((arg0@@325 T@U) (arg1@@188 T@U) (arg2@@138 T@U) (arg3@@105 Bool) ) (! (= (type (|lambda#157| arg0@@325 arg1@@188 arg2@@138 arg3@@105)) (MapType6Type refType boolType))
 :qid |funType:lambda#157|
 :pattern ( (|lambda#157| arg0@@325 arg1@@188 arg2@@138 arg3@@105))
)))
(assert (forall (($o@@66 T@U) ($f@@56 T@U) (|l#0@@102| T@U) (|l#1@@62| T@U) (|l#2@@62| T@U) (|l#3@@59| Bool) ) (! (let ((alpha@@63 (FieldTypeInv0 (type $f@@56))))
 (=> (and (and (and (and (= (type $o@@66) refType) (= (type $f@@56) (FieldType alpha@@63))) (= (type |l#0@@102|) refType)) (= (type |l#1@@62|) (MapType0Type refType MapType1Type))) (= (type |l#2@@62|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#157| |l#0@@102| |l#1@@62| |l#2@@62| |l#3@@59|) $o@@66 $f@@56))  (=> (and (not (= $o@@66 |l#0@@102|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@62| $o@@66) |l#2@@62|))) |l#3@@59|))))
 :qid |DLLDafny.392:8|
 :skolemid |1754|
 :pattern ( (MapType6Select (|lambda#157| |l#0@@102| |l#1@@62| |l#2@@62| |l#3@@59|) $o@@66 $f@@56))
)))
(assert (forall ((arg0@@326 T@U) (arg1@@189 T@U) (arg2@@139 T@U) (arg3@@106 Bool) ) (! (= (type (|lambda#158| arg0@@326 arg1@@189 arg2@@139 arg3@@106)) (MapType6Type refType boolType))
 :qid |funType:lambda#158|
 :pattern ( (|lambda#158| arg0@@326 arg1@@189 arg2@@139 arg3@@106))
)))
(assert (forall (($o@@67 T@U) ($f@@57 T@U) (|l#0@@103| T@U) (|l#1@@63| T@U) (|l#2@@63| T@U) (|l#3@@60| Bool) ) (! (let ((alpha@@64 (FieldTypeInv0 (type $f@@57))))
 (=> (and (and (and (and (= (type $o@@67) refType) (= (type $f@@57) (FieldType alpha@@64))) (= (type |l#0@@103|) refType)) (= (type |l#1@@63|) (MapType0Type refType MapType1Type))) (= (type |l#2@@63|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#158| |l#0@@103| |l#1@@63| |l#2@@63| |l#3@@60|) $o@@67 $f@@57))  (=> (and (not (= $o@@67 |l#0@@103|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@63| $o@@67) |l#2@@63|))) |l#3@@60|))))
 :qid |DLLDafny.392:8|
 :skolemid |1755|
 :pattern ( (MapType6Select (|lambda#158| |l#0@@103| |l#1@@63| |l#2@@63| |l#3@@60|) $o@@67 $f@@57))
)))
(assert (forall ((arg0@@327 T@U) (arg1@@190 T@U) (arg2@@140 T@U) (arg3@@107 Bool) ) (! (= (type (|lambda#159| arg0@@327 arg1@@190 arg2@@140 arg3@@107)) (MapType6Type refType boolType))
 :qid |funType:lambda#159|
 :pattern ( (|lambda#159| arg0@@327 arg1@@190 arg2@@140 arg3@@107))
)))
(assert (forall (($o@@68 T@U) ($f@@58 T@U) (|l#0@@104| T@U) (|l#1@@64| T@U) (|l#2@@64| T@U) (|l#3@@61| Bool) ) (! (let ((alpha@@65 (FieldTypeInv0 (type $f@@58))))
 (=> (and (and (and (and (= (type $o@@68) refType) (= (type $f@@58) (FieldType alpha@@65))) (= (type |l#0@@104|) refType)) (= (type |l#1@@64|) (MapType0Type refType MapType1Type))) (= (type |l#2@@64|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#159| |l#0@@104| |l#1@@64| |l#2@@64| |l#3@@61|) $o@@68 $f@@58))  (=> (and (not (= $o@@68 |l#0@@104|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@64| $o@@68) |l#2@@64|))) |l#3@@61|))))
 :qid |DLLDafny.425:8|
 :skolemid |1756|
 :pattern ( (MapType6Select (|lambda#159| |l#0@@104| |l#1@@64| |l#2@@64| |l#3@@61|) $o@@68 $f@@58))
)))
(assert (forall ((arg0@@328 T@U) (arg1@@191 T@U) (arg2@@141 T@U) (arg3@@108 Bool) ) (! (= (type (|lambda#160| arg0@@328 arg1@@191 arg2@@141 arg3@@108)) (MapType6Type refType boolType))
 :qid |funType:lambda#160|
 :pattern ( (|lambda#160| arg0@@328 arg1@@191 arg2@@141 arg3@@108))
)))
(assert (forall (($o@@69 T@U) ($f@@59 T@U) (|l#0@@105| T@U) (|l#1@@65| T@U) (|l#2@@65| T@U) (|l#3@@62| Bool) ) (! (let ((alpha@@66 (FieldTypeInv0 (type $f@@59))))
 (=> (and (and (and (and (= (type $o@@69) refType) (= (type $f@@59) (FieldType alpha@@66))) (= (type |l#0@@105|) refType)) (= (type |l#1@@65|) (MapType0Type refType MapType1Type))) (= (type |l#2@@65|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#160| |l#0@@105| |l#1@@65| |l#2@@65| |l#3@@62|) $o@@69 $f@@59))  (=> (and (not (= $o@@69 |l#0@@105|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@65| $o@@69) |l#2@@65|))) |l#3@@62|))))
 :qid |DLLDafny.435:8|
 :skolemid |1757|
 :pattern ( (MapType6Select (|lambda#160| |l#0@@105| |l#1@@65| |l#2@@65| |l#3@@62|) $o@@69 $f@@59))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (type $_Frame@0) (MapType6Type refType boolType)) (= (type $Heap@@1) (MapType0Type refType MapType1Type))) (= (type |nodes#0@0|) (SeqType BoxType))) (= (type _module._default.Remove$A) TyType)) (= (type |s#0@0|) (SeqType BoxType))) (= (type |f#0@0|) (SeqType BoxType))) (= (type |g#0@0|) (SeqType BoxType))) (= (type |let#0#0#0|) DatatypeTypeType)) (= (type |l#0@@106|) DatatypeTypeType)) (= (type |s'#0@0|) (SeqType BoxType))) (= (type |f'#0@0|) (SeqType BoxType))) (= (Ctor TType) 28)) (forall ((arg0@@329 T@U) ) (! (= (type (type@@0 arg0@@329)) TType)
 :qid |funType:type|
 :pattern ( (type@@0 arg0@@329))
))) (= (type |call4formal@g'#0|) (SeqType BoxType))) (= (type $Heap@0) (MapType0Type refType MapType1Type))) (= (type |call4formal@g'#0@0|) (SeqType BoxType))) (= (type |node#0@0|) DatatypeTypeType)) (= (type |node_prev#0@0|) DatatypeTypeType)) (= (type |dt_update_tmp#0#0@0|) DatatypeTypeType)) (= (type |let#1#0#0|) DatatypeTypeType)) (= (type |##v#0@0|) DatatypeTypeType)) (= (type |nodes#0@1|) (SeqType BoxType))) (= (type |node_next#0@0|) DatatypeTypeType)) (= (type |dt_update_tmp#1#0@0|) DatatypeTypeType)) (= (type |let#3#0#0|) DatatypeTypeType)) (= (type |##v#1@0|) DatatypeTypeType)) (= (type |nodes#0@2|) (SeqType BoxType))) (= (type |##v#2@0|) DatatypeTypeType)) (= (type |nodes#0@3|) (SeqType BoxType))) (= (type |l'#0@0|) DatatypeTypeType)) (= (type |l'#0|) DatatypeTypeType)) (= (type |s'#0|) (SeqType BoxType))) (= (type |f'#0|) (SeqType BoxType))) (= (type |g'#0|) (SeqType BoxType))) (= (type |$rhs##0|) (SeqType BoxType))) (= (type |node#0|) DatatypeTypeType)) (= (type |node_prev#0|) DatatypeTypeType)) (= (type |node_next#0|) DatatypeTypeType)))
(push 1)
(set-info :boogie-vc-id Impl$$_module.__default.Remove)
(assert (not
(let ((anon0_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (=> (= $_Frame@0 (|lambda#108| null $Heap@@1 alloc false)) (=> (and (and (and (and ($Is |nodes#0@0| (TSeq (Tclass._module.Node _module._default.Remove$A))) ($IsAlloc |nodes#0@0| (TSeq (Tclass._module.Node _module._default.Remove$A)) $Heap@@1)) (and ($Is |s#0@0| (TSeq _module._default.Remove$A)) ($IsAlloc |s#0@0| (TSeq _module._default.Remove$A) $Heap@@1))) (and (and ($Is |f#0@0| (TSeq TInt)) ($IsAlloc |f#0@0| (TSeq TInt) $Heap@@1)) (and ($Is |g#0@0| (TSeq TInt)) ($IsAlloc |g#0@0| (TSeq TInt) $Heap@@1)))) (and (and (and (= |let#0#0#0| |l#0@@106|) ($Is |let#0#0#0| (Tclass._module.DList _module._default.Remove$A))) (and (_module.DList.DList_q |let#0#0#0|) (_module.DList.DList_q |let#0#0#0|))) (and (and (_module.DList.DList_q |let#0#0#0|) (_module.DList.DList_q |let#0#0#0|)) (and (_module.DList.DList_q |let#0#0#0|) (= (|#_module.DList.DList| |nodes#0@0| |freeStack#0@0| |s#0@0| |f#0@0| |g#0@0|) |let#0#0#0|))))) (and (! (or %lbl%@1  (and (<= 0 |p#0@@30|) (< |p#0@@30| (|Seq#Length| |g#0@0|)))) :lblneg @1) (=> (and (<= 0 |p#0@@30|) (< |p#0@@30| (|Seq#Length| |g#0@0|))) (=> (= |index#0@0| (U_2_int ($Unbox intType (|Seq#Index| |g#0@0| |p#0@@30|)))) (=> (and ($IsAlloc |s#0@0| (TSeq _module._default.Remove$A) $Heap@@1) ($IsAlloc (int_2_U |index#0@0|) TInt $Heap@@1)) (and (! (or %lbl%@2 (<= 0 |index#0@0|)) :lblneg @2) (and (! (or %lbl%@3 (< |index#0@0| (|Seq#Length| |s#0@0|))) :lblneg @3) (=> (and (and (and (<= 0 |index#0@0|) (< |index#0@0| (|Seq#Length| |s#0@0|))) (|_module.__default.SeqRemove#canCall| _module._default.Remove$A |s#0@0| |index#0@0|)) (and (and (|_module.__default.SeqRemove#canCall| _module._default.Remove$A |s#0@0| |index#0@0|) (= |s'#0@0| (_module.__default.SeqRemove _module._default.Remove$A |s#0@0| |index#0@0|))) (and ($IsAlloc |f#0@0| (TSeq TInt) $Heap@@1) ($IsAlloc (int_2_U |index#0@0|) TInt $Heap@@1)))) (and (! (or %lbl%@4 (<= 0 |index#0@0|)) :lblneg @4) (and (! (or %lbl%@5 (< |index#0@0| (|Seq#Length| |f#0@0|))) :lblneg @5) (=> (and (and (and (<= 0 |index#0@0|) (< |index#0@0| (|Seq#Length| |f#0@0|))) (|_module.__default.SeqRemove#canCall| TInt |f#0@0| |index#0@0|)) (and (|_module.__default.SeqRemove#canCall| TInt |f#0@0| |index#0@0|) (= |f'#0@0| (_module.__default.SeqRemove TInt |f#0@0| |index#0@0|)))) (and (! (or %lbl%@6 (forall (($o@@71 T@U) ($f@@61 T@U) ) (! (let ((alpha@@67 (FieldTypeInv0 (type $f@@61))))
 (=> (and (and (= (type $o@@71) refType) (= (type $f@@61) (FieldType alpha@@67))) false) (U_2_bool (MapType6Select $_Frame@0 $o@@71 $f@@61))))
 :qid |DLLDafny.319:33|
 :skolemid |1487|
 :no-pattern (type $o@@71)
...
))) :lblneg @6) (=> (forall (($o@@72 T@U) ($f@@62 T@U) ) (! (let ((alpha@@68 (FieldTypeInv0 (type $f@@62))))
 (=> (and (and (= (type $o@@72) refType) (= (type $f@@62) (FieldType alpha@@68))) false) (U_2_bool (MapType6Select $_Frame@0 $o@@72 $f@@62))))
 :qid |DLLDafny.319:33|
 :skolemid |1487|
 :no-pattern (type@@0 $o@@70)
 :no-pattern (type@@0 $f@@60)
 :no-pattern (type $o@@72)
