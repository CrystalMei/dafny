...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@1| Int) (|y#0| Int) ) (!  (=> (or (|_module.__default.add#canCall| |x#0@@1| |y#0|) (not (= 0 $FunctionContextHeight))) true)
 :qid |seq2Dafn.3:21|
 :skolemid |808|
 :pattern ( (_module.__default.add |x#0@@1| |y#0|))
))))
(assert (forall ((|x#0@@2| Int) (|y#0@@0| Int) ) (!  (and (=> (|_module.__default.add#requires| |x#0@@2| |y#0@@0|) true) (=> true (|_module.__default.add#requires| |x#0@@2| |y#0@@0|)))
 :qid |seq2Dafn.3:21|
 :skolemid |809|
 :pattern ( (|_module.__default.add#requires| |x#0@@2| |y#0@@0|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@3| Int) (|y#0@@1| Int) ) (!  (=> (or (|_module.__default.add#canCall| |x#0@@3| |y#0@@1|) (not (= 0 $FunctionContextHeight))) (= (_module.__default.add |x#0@@3| |y#0@@1|) (+ |x#0@@3| |y#0@@1|)))
 :qid |seq2Dafn.3:21|
 :skolemid |810|
 :pattern ( (_module.__default.add |x#0@@3| |y#0@@1|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@4| Int) (|y#0@@2| Int) ) (!  (=> (or (|_module.__default.add#canCall| |x#0@@4| |y#0@@2|) (not (= 0 $FunctionContextHeight))) (= (_module.__default.add |x#0@@4| |y#0@@2|) (+ |x#0@@4| |y#0@@2|)))
 :qid |seq2Dafn.3:21|
 :weight 3
 :skolemid |811|
 :pattern ( (_module.__default.add |x#0@@4| |y#0@@2|))
))))
...
(assert  (and (and (and (and (and (= (type $Heap) (MapType0Type refType MapType1Type)) (= (type |s#0|) (SeqType BoxType))) (= (type $_Frame@0) (MapType4Type refType boolType))) (= (Ctor TType) 26)) (forall ((arg0@@171 T@U) ) (! (= (type (type@@0 arg0@@171)) TType)
 :qid |funType:type|
...
(let ((anon5_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (=> (and (and (and (<= 0 |i#0@0|) (< |i#0@0| |j#0@0|)) (< |j#0@0| 5)) (and (= |l##0@0| 0) (= |h##0@0| 5))) (and (! (or %lbl%@1 (forall (($o@@11 T@U) ($f@@1 T@U) ) (! (let ((alpha@@7 (FieldTypeInv0 (type $f@@1))))
 ...
 :no-pattern (type $f@@1)
 :no-pattern (U_2_int $o@@11)
 :no-pattern (U_2_bool $o@@11)
...
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (<= |l##0@0| |i#0@0|) (=> (<= |l##0@0| |j#0@0|) (|_module.__default.add#canCall| |i#0@0| |j#0@0|)))) (and (and (=> (and (<= |l##0@0| |i#0@0|) (<= |l##0@0| |j#0@0|)) (<= (+ |l##0@0| |l##0@0|) (_module.__default.add |i#0@0| |j#0@0|))) (=> (< |i#0@0| |h##0@0|) (=> (< |j#0@0| |h##0@0|) (|_module.__default.add#canCall| |i#0@0| |j#0@0|)))) (and (=> (and (< |i#0@0| |h##0@0|) (< |j#0@0| |h##0@0|)) (< (_module.__default.add |i#0@0| |j#0@0|) (+ |h##0@0| |h##0@0|))) (= $Heap $Heap@0)))) (and (! (or %lbl%@2 (<= 0 (_module.__default.add |i#0@0| |j#0@0|))) :lblneg @2) (=> (<= 0 (_module.__default.add |i#0@0| |j#0@0|)) (! (or %lbl%@3 (< (_module.__default.add |i#0@0| |j#0@0|) 10)) :lblneg @3))))))))))
(let ((anon16_Else_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (not (and (<= 0 |i#0@0|) (< |i#0@0| |j#0@0|))) anon5_correct))))
(let ((anon16_Then_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (and (<= 0 |i#0@0|) (< |i#0@0| |j#0@0|)) anon5_correct))))
(let ((anon15_Else_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (< |i#0@0| 0) (and anon16_Then_correct anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (<= 0 |i#0@0|) (and anon16_Then_correct anon16_Else_correct)))))
(let ((anon14_Then_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (and anon15_Then_correct anon15_Else_correct))))
(let ((anon13_correct  (=> (! (and %lbl%+9 true) :lblpos +9) true)))
(let ((anon19_Else_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (not (and (and (<= 0 |i#2@0|) (< |i#2@0| |j#2@0|)) (< |j#2@0| 5))) anon13_correct))))
(let ((anon19_Then_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (and (and (and (and (<= 0 |i#2@0|) (< |i#2@0| |j#2@0|)) (< |j#2@0| 5)) ($IsAlloc (int_2_U |i#2@0|) TInt $Heap)) (and ($IsAlloc (int_2_U |j#2@0|) TInt $Heap) (|_module.__default.add#canCall| |i#2@0| |j#2@0|))) (and (! (or %lbl%@12  (and (<= 0 (_module.__default.add |i#2@0| |j#2@0|)) (< (_module.__default.add |i#2@0| |j#2@0|) (|Seq#Length| |s#0|)))) :lblneg @12) (=> (and (<= 0 (_module.__default.add |i#2@0| |j#2@0|)) (< (_module.__default.add |i#2@0| |j#2@0|) (|Seq#Length| |s#0|))) (and (! (or %lbl%@13  (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |s#0|)))) :lblneg @13) (=> (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |s#0|))) (and (! (or %lbl%@14  (and (<= 0 |j#2@0|) (< |j#2@0| (|Seq#Length| |s#0|)))) :lblneg @14) (=> (and (<= 0 |j#2@0|) (< |j#2@0| (|Seq#Length| |s#0|))) anon13_correct))))))))))
(let ((anon18_Else_correct  (=> (! (and %lbl%+15 true) :lblpos +15) (=> (not (and (<= 0 |i#2@0|) (< |i#2@0| |j#2@0|))) (and anon19_Then_correct anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (! (and %lbl%+16 true) :lblpos +16) (=> (and (<= 0 |i#2@0|) (< |i#2@0| |j#2@0|)) (and anon19_Then_correct anon19_Else_correct)))))
...
(let ((anon0_correct  (=> (! (and %lbl%+20 true) :lblpos +20) (=> (= $_Frame@0 (|lambda#0| null $Heap alloc false)) (and anon14_Then_correct anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+21 true) :lblpos +21) (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is |s#0| (TSeq TInt)) ($IsAlloc |s#0| (TSeq TInt) $Heap)) (and (= 3 $FunctionContextHeight) (< 10 (|Seq#Length| |s#0|)))) anon0_correct)))))
PreconditionGeneratedEntry_correct))))))))))))))))
))
(check-sat)
(get-info :reason-unknown)
(labels)
(assert (or %lbl%@12 %lbl%@2))
(check-sat)
(get-info :reason-unknown)
(labels)
(assert (or %lbl%@12 %lbl%@3))
(check-sat)
(get-info :reason-unknown)
(labels)
(assert %lbl%@2)
