...
(assert (forall ((arg0@@150 T@U) (arg1@@70 T@U) (arg2@@23 T@U) (arg3@@6 Bool) ) (! (= (type (|lambda#2| arg0@@150 arg1@@70 arg2@@23 arg3@@6)) (MapType3Type refType boolType))
 :qid |funType:lambda#2|
 :pattern ( (|lambda#2| arg0@@150 arg1@@70 arg2@@23 arg3@@6))
)))
(assert (forall (($o@@11 T@U) ($f@@1 T@U) (|l#0@@1| T@U) (|l#1@@1| T@U) (|l#2@@1| T@U) (|l#3@@1| Bool) ) (! (let ((alpha@@8 (FieldTypeInv0 (type $f@@1))))
 (=> (and (and (and (and (= (type $o@@11) refType) (= (type $f@@1) (FieldType alpha@@8))) (= (type |l#0@@1|) refType)) (= (type |l#1@@1|) (MapType0Type refType MapType1Type))) (= (type |l#2@@1|) (FieldType boolType))) (= (U_2_bool (MapType3Select (|lambda#2| |l#0@@1| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@11 $f@@1))  (=> (and (not (= $o@@11 |l#0@@1|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@1| $o@@11) |l#2@@1|))) |l#3@@1|))))
 :qid |dltestDa.11:8|
 :skolemid |781|
 :pattern ( (MapType3Select (|lambda#2| |l#0@@1| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@11 $f@@1))
)))
...
(assert  (and (= (type $_Frame@0) (MapType3Type refType boolType)) (= (type $Heap) (MapType0Type refType MapType1Type))))
(push 1)
(set-info :boogie-vc-id Impl$$_module.__default.P1__lemma__instance)
(assert (not
(let ((anon2_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (=> (=> (< |i#0| |j#0|) (< (Mul |k#0| |i#0|) (Mul |k#0| |j#0|))) (! (or %lbl%@1  (=> (< |i#0| |j#0|) (< (Mul |k#0| |i#0|) (Mul |k#0| |j#0|)))) :lblneg @1)))))
(let ((anon3_Else_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (<= |j#0| |i#0|) anon2_correct))))
(let ((anon3_Then_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (< |i#0| |j#0|) anon2_correct))))
(let ((anon0_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (= $_Frame@0 (|lambda#0| null $Heap alloc false)) (and anon3_Then_correct anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 2 $FunctionContextHeight) (> |k#0| 0))) anon0_correct))))
...
(assert  (and (= (type $_Frame@0) (MapType3Type refType boolType)) (= (type $Heap) (MapType0Type refType MapType1Type))))
(push 1)
(set-info :boogie-vc-id Impl$$_module.__default.P1__lemma__forall)
(assert (not
(let ((anon4_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (=> (forall ((|i#3| Int) (|j#3| Int) (|k#3| Int) ) (!  (=> true (=> (and (< |i#3| |j#3|) (> |k#3| 0)) (< (Mul |k#3| |i#3|) (Mul |k#3| |j#3|))))
 :qid |dltestDa.9:21|
 :skolemid |774|
 :pattern ( (Mul |k#3| |j#3|) (Mul |k#3| |i#3|))
)) (! (or %lbl%@1 (forall ((|i#1| Int) (|j#1| Int) (|k#1| Int) ) (!  (=> true (=> (and (< |i#1| |j#1|) (> |k#1| 0)) (< (Mul |k#1| |i#1|) (Mul |k#1| |j#1|))))
 :qid |dltestDa.8:20|
 :skolemid |773|
 :pattern ( (Mul |k#1| |j#1|) (Mul |k#1| |i#1|))
))) :lblneg @1)))))
(let ((anon6_Else_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (not (and (< |i#2@0| |j#2@0|) (> |k#2@0| 0))) anon4_correct))))
(let ((anon6_Then_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (and (< |i#2@0| |j#2@0|) (> |k#2@0| 0)) anon4_correct))))
(let ((anon5_Else_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (<= |j#2@0| |i#2@0|) (and anon6_Then_correct anon6_Else_correct)))))
(let ((anon5_Then_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (< |i#2@0| |j#2@0|) (and anon6_Then_correct anon6_Else_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (= $_Frame@0 (|lambda#1| null $Heap alloc false)) (and anon5_Then_correct anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) anon0_correct))))
PreconditionGeneratedEntry_correct)))))))
))
(check-sat)
(pop 1)
...
(declare-fun %lbl%+4 () Bool)
(declare-fun %lbl%@5 () Bool)
(declare-fun $o@@12 () T@U)
(declare-fun $f@@2 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun %lbl%+6 () Bool)
(declare-fun $FunctionContextHeight () Int)
(assert  (and (and (and (and (= (type $_Frame@0) (MapType3Type refType boolType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (Ctor TType) 25)) (forall ((arg0@@151 T@U) ) (! (= (type (type@@0 arg0@@151)) TType)
 :qid |funType:type|
 :pattern ( (type@@0 arg0@@151))
))) (= (type $Heap@0) (MapType0Type refType MapType1Type))))
(push 1)
(set-info :boogie-vc-id Impl$$_module.__default.P1)
(assert (not
(let ((anon2_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (! (or %lbl%@1  (=> (< |x#0@0| |y#0@0|) (< (Mul (LitInt 2) |x#0@0|) (Mul (LitInt 2) |y#0@0|)))) :lblneg @1))))
(let ((anon3_Else_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (<= |y#0@0| |x#0@0|) anon2_correct))))
(let ((anon3_Then_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (< |x#0@0| |y#0@0|) anon2_correct))))
(let ((anon0_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (= $_Frame@0 (|lambda#2| null $Heap alloc false)) (and (! (or %lbl%@5 (forall (($o@@13 T@U) ($f@@3 T@U) ) (! (let ((alpha@@9 (FieldTypeInv0 (type $f@@3))))
 (=> (and (and (= (type $o@@13) refType) (= (type $f@@3) (FieldType alpha@@9))) false) (U_2_bool (MapType3Select $_Frame@0 $o@@13 $f@@3))))
 :qid |dltestDa.22:20|
 :skolemid |778|
...
))) :lblneg @5) (=> (forall (($o@@14 T@U) ($f@@4 T@U) ) (! (let ((alpha@@10 (FieldTypeInv0 (type $f@@4))))
 (=> (and (and (= (type $o@@14) refType) (= (type $f@@4) (FieldType alpha@@10))) false) (U_2_bool (MapType3Select $_Frame@0 $o@@14 $f@@4))))
 :qid |dltestDa.22:20|
 :skolemid |778|
 :no-pattern (type@@0 $o@@12)
 :no-pattern (type@@0 $f@@2)
 :no-pattern (type $o@@14)
 :no-pattern (type $f@@4)
 :no-pattern (U_2_int $o@@14)
 :no-pattern (U_2_bool $o@@14)
...
)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall ((|i#1| Int) (|j#1| Int) (|k#1| Int) ) (!  (=> true (=> (and (< |i#1| |j#1|) (> |k#1| 0)) (< (Mul |k#1| |i#1|) (Mul |k#1| |j#1|))))
 :qid |dltestDa.8:20|
 :skolemid |772|
 :pattern ( (Mul |k#1| |j#1|) (Mul |k#1| |i#1|))
)) (= $Heap $Heap@0))) (and anon3_Then_correct anon3_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 1 $FunctionContextHeight)) anon0_correct))))
PreconditionGeneratedEntry_correct)))))
))
(check-sat)
(pop 1)
