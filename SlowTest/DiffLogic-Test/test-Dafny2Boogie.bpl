// Dafny 2.3.0.10506
// Command Line Options: test_Dafny.dfy /compile:0 /proverOpt:LOGIC=DLA /print:test-Dafny2Boogie.bpl
...
procedure CheckWellformed$$_module.__default.myAdd(a#0: int, b#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.myAdd(a#0: int, b#0: int);
  modifies $Heap, $Tick;
