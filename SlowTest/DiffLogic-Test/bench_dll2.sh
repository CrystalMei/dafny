...
mkdir -p $Default_Log
dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 > $Default_Log/CP3-S0.trace;
echo "CP3, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:random-seed=${i}00 > $Default_Log/CP3-S${i}00.trace;
    echo "CP3, Seed${i}00, done";
done
echo "Original, CP3, done";

dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:smt.CASE_SPLIT=1 > $Default_Log/CP1-S0.trace;
echo "CP1, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.CASE_SPLIT=1 > $Default_Log/CP1-S${i}00.trace;
    echo "CP1, Seed${i}00, done";
done
...
# modified solver 1
mkdir -p $Solver1_Log
dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:smt.arith.solver=1 > $Solver1_Log/CP3-S0.trace;
echo "CP3, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.arith.solver=1 > $Solver1_Log/CP3-S${i}00.trace;
    echo "CP3, Seed${i}00, done";
done
echo "SDL, CP3, done";
dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:smt.CASE_SPLIT=1 /proverOpt:O:smt.arith.solver=1 > $Solver1_Log/CP1-S0.trace;
echo "CP1, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.arith.solver=1 /proverOpt:O:smt.CASE_SPLIT=1 > $Solver1_Log/CP1-S${i}00.trace;
    echo "CP1, Seed${i}00, done";
done
echo "SDL, CP1, done";
...
# modified solver 7
mkdir -p $Solver7_Log
dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:smt.arith.solver=7 > $Solver7_Log/CP3-S0.trace;
echo "CP3, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.arith.solver=7 > $Solver7_Log/CP3-S${i}00.trace;
    echo "CP3, Seed${i}00, done";
done
echo "WDL, CP3, done";
dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:smt.CASE_SPLIT=1 /proverOpt:O:smt.arith.solver=7 > $Solver7_Log/CP1-S0.trace;
echo "CP1, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.arith.solver=7 /proverOpt:O:smt.CASE_SPLIT=1 > $Solver7_Log/CP1-S${i}00.trace;
    echo "CP1, Seed${i}00, done";
done
echo "WDL, CP1, done";
...
# modified solver 3
mkdir -p $Solver3_Log
dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:smt.arith.solver=3 > $Solver3_Log/CP3-S0.trace;
echo "CP3, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.arith.solver=3 > $Solver3_Log/CP3-S${i}00.trace;
    echo "CP3, Seed${i}00, done";
done
echo "DDL, CP3, done";
dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:smt.CASE_SPLIT=1 /proverOpt:O:smt.arith.solver=3 > $Solver3_Log/CP1-S0.trace;
echo "CP1, no Seed, done";
for i in $seeds; do
    dafny /compile:0 DLL_Dafny_WDL3_correctedge.dfy /restartProver /trace /timeLimit:100 /errorLimit:1 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.arith.solver=3 /proverOpt:O:smt.CASE_SPLIT=1 > $Solver3_Log/CP1-S${i}00.trace;
    echo "CP1, Seed${i}00, done";
done
echo "DDL, CP1, done";