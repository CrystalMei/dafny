...
(assert (not
(let ((anon8_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (and (! (or %lbl%@1  (=> (and (and (>= |x#0@0| (LitInt 0)) (>= |y#0@0| (LitInt 0))) (< |x#0@0| |y#0@0|)) (< (Mul (LitInt 2) |x#0@0|) (Mul (LitInt 2) |y#0@0|)))) :lblneg @1) (=> (=> (and (and (>= |x#0@0| (LitInt 0)) (>= |y#0@0| (LitInt 0))) (< |x#0@0| |y#0@0|)) (< (Mul (LitInt 2) |x#0@0|) (Mul (LitInt 2) |y#0@0|))) (! (or %lbl%@2 (> (+ |x#0@0| |y#0@0|) 10)) :lblneg @2))))))
(let ((anon12_Else_correct  (=> (! (and %lbl%+3 true) :lblpos +3) (=> (not (and (and (>= |x#0@0| (LitInt 0)) (>= |y#0@0| (LitInt 0))) (< |x#0@0| |y#0@0|))) anon8_correct))))
(let ((anon12_Then_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (and (and (>= |x#0@0| (LitInt 0)) (>= |y#0@0| (LitInt 0))) (< |x#0@0| |y#0@0|)) anon8_correct))))
(let ((anon11_Else_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (=> (not (and (>= |x#0@0| (LitInt 0)) (>= |y#0@0| (LitInt 0)))) (and anon12_Then_correct anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (! (and %lbl%+6 true) :lblpos +6) (=> (and (>= |x#0@0| (LitInt 0)) (>= |y#0@0| (LitInt 0))) (and anon12_Then_correct anon12_Else_correct)))))
(let ((anon10_Else_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (> (LitInt 0) |x#0@0|) (and anon11_Then_correct anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (>= |x#0@0| (LitInt 0)) (and anon11_Then_correct anon11_Else_correct)))))
(let ((anon2_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (and (! (or %lbl%@10  (=> (< |x#0@0| |y#0@0|) (< (Mul (LitInt 2) |x#0@0|) (Mul (LitInt 2) |y#0@0|)))) :lblneg @10) (=> (=> (< |x#0@0| |y#0@0|) (< (Mul (LitInt 2) |x#0@0|) (Mul (LitInt 2) |y#0@0|))) (and anon10_Then_correct anon10_Else_correct))))))
(let ((anon9_Else_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (<= |y#0@0| |x#0@0|) anon2_correct))))
(let ((anon9_Then_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (=> (< |x#0@0| |y#0@0|) anon2_correct))))
(let ((anon0_correct  (=> (! (and %lbl%+13 true) :lblpos +13) (=> (= $_Frame@0 (|lambda#0| null $Heap alloc false)) (and anon9_Then_correct anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) anon0_correct))))
