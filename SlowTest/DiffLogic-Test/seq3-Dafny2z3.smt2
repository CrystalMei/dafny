...
(assert (forall ((arg0@@149 T@U) (arg1@@69 T@U) (arg2@@22 T@U) (arg3@@5 Bool) ) (! (= (type (|lambda#1| arg0@@149 arg1@@69 arg2@@22 arg3@@5)) (MapType3Type refType boolType))
 :qid |funType:lambda#1|
 :pattern ( (|lambda#1| arg0@@149 arg1@@69 arg2@@22 arg3@@5))
)))
(assert (forall (($o@@10 T@U) ($f@@0 T@U) (|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ) (! (let ((alpha@@7 (FieldTypeInv0 (type $f@@0))))
 (=> (and (and (and (and (= (type $o@@10) refType) (= (type $f@@0) (FieldType alpha@@7))) (= (type |l#0@@0|) refType)) (= (type |l#1@@0|) (MapType0Type refType MapType1Type))) (= (type |l#2@@0|) (FieldType boolType))) (= (U_2_bool (MapType3Select (|lambda#1| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@10 $f@@0))  (=> (and (not (= $o@@10 |l#0@@0|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@0| $o@@10) |l#2@@0|))) |l#3@@0|))))
 :qid |seq3Dafn.1:8|
 :skolemid |763|
 :pattern ( (MapType3Select (|lambda#1| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@10 $f@@0))
)))
...
(assert  (and (and (and (and (and (= (type |t#0@0|) (SeqType BoxType)) (= (type |s#0|) (SeqType BoxType))) (= (type $Heap@0) (MapType0Type refType MapType1Type))) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type $_Frame@0) (MapType3Type refType boolType))) (= (type |t#0|) (SeqType BoxType))))
(push 1)
...
(let ((anon7_Else_correct  (=> (! (and %lbl%+2 true) :lblpos +2) (=> (and (=> (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| 8))) (not (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 8))))) (=> (not (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 8)))) (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| 8))))) (and (! (or %lbl%@3  (and (<= 0 9) (< 9 (|Seq#Length| |t#0@0|)))) :lblneg @3) (=> (and (<= 0 9) (< 9 (|Seq#Length| |t#0@0|))) (and (! (or %lbl%@4  (and (<= 0 9) (< 9 (|Seq#Length| |s#0|)))) :lblneg @4) (=> (and (<= 0 9) (< 9 (|Seq#Length| |s#0|))) (=> (and (=> (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| 9))) (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 9)))) (=> (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 9))) (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| 9))))) anon5_correct)))))))))
(let ((anon7_Then_correct  (=> (! (and %lbl%+5 true) :lblpos +5) (and (! (or %lbl%@6  (and (<= 0 8) (< 8 (|Seq#Length| |t#0@0|)))) :lblneg @6) (=> (and (<= 0 8) (< 8 (|Seq#Length| |t#0@0|))) (and (! (or %lbl%@7  (and (<= 0 8) (< 8 (|Seq#Length| |s#0|)))) :lblneg @7) (=> (and (<= 0 8) (< 8 (|Seq#Length| |s#0|))) (=> (and (=> (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| 8))) (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 8)))) (=> (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 8))) (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| 8))))) anon5_correct))))))))
(let ((anon2_correct  (=> (! (and %lbl%+8 true) :lblpos +8) (=> (and (<= 8 |j#0|) (< |j#0| (|Seq#Length| |s#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@11 T@U) ) (!  (=> (= (type $o@@11) refType) (=> (and (not (= $o@@11 null)) (U_2_bool (MapType1Select (MapType0Select $Heap $o@@11) alloc))) (= (MapType0Select $Heap@0 $o@@11) (MapType0Select $Heap $o@@11))))
 :qid |seq3Dafn.1:8|
 :skolemid |759|
 :pattern ( (MapType0Select $Heap@0 $o@@11))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is |t#0@0| (TSeq TBool)) ($IsAlloc |t#0@0| (TSeq TBool) $Heap@0)) (= (|Seq#Length| |t#0@0|) (|Seq#Length| |s#0|)))) (and anon7_Then_correct anon7_Else_correct))))))
...
(let ((anon0_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (and (= $_Frame@0 (|lambda#0| null $Heap alloc false)) (<= 10 (|Seq#Length| |s#0|))) (and anon6_Then_correct anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+12 true) :lblpos +12) (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is |s#0| (TSeq TBool)) ($IsAlloc |s#0| (TSeq TBool) $Heap))) (and (and ($Is |t#0| (TSeq TBool)) ($IsAlloc |t#0| (TSeq TBool) $Heap)) (= 0 $FunctionContextHeight))) anon0_correct))))
...
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(assert  (and (and (and (and (and (and (= (type |t#0@2|) (SeqType BoxType)) (= (type |s#0|) (SeqType BoxType))) (= (type |t#0@0|) (SeqType BoxType))) (= (type |t#0@1|) (SeqType BoxType))) (= (type $_Frame@0) (MapType3Type refType boolType))) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type |t#0|) (SeqType BoxType))))
(push 1)
(set-info :boogie-vc-id Impl$$_module.__default.Sequence)
(assert (not
(let ((GeneratedUnifiedExit_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (and (! (or %lbl%@1 (= (|Seq#Length| |t#0@2|) (|Seq#Length| |s#0|))) :lblneg @1) (=> (= (|Seq#Length| |t#0@2|) (|Seq#Length| |s#0|)) (and (! (or %lbl%@2  (or (and (=> (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| 8))) (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 8)))) (=> (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 8))) (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| 8))))) (and (=> (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| 9))) (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 9)))) (=> (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 9))) (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| 9))))))) :lblneg @2) (=> (or (and (=> (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| 8))) (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 8)))) (=> (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 8))) (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| 8))))) (and (=> (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| 9))) (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 9)))) (=> (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| 9))) (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| 9)))))) (! (or %lbl%@3  (and (=> (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| |j#0|))) |b#0|) (=> |b#0| (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@2| |j#0|)))))) :lblneg @3))))))))
(let ((anon3_Else_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (not |c#0@@3|) (and (! (or %lbl%@5  (and (<= 0 |j#0|) (<= |j#0| (|Seq#Length| |s#0|)))) :lblneg @5) (=> (and (<= 0 |j#0|) (<= |j#0| (|Seq#Length| |s#0|))) (and (! (or %lbl%@6  (and (<= 0 (+ |j#0| 1)) (<= (+ |j#0| 1) (|Seq#Length| |s#0|)))) :lblneg @6) (=> (and (<= 0 (+ |j#0| 1)) (<= (+ |j#0| 1) (|Seq#Length| |s#0|))) (=> (and (= |t#0@1| (|Seq#Append| (|Seq#Append| (|Seq#Take| |s#0| |j#0|) (|Seq#Build| (|Seq#Empty| BoxType) ($Box (bool_2_U |b#0|)))) (|Seq#Drop| |s#0| (+ |j#0| 1)))) (= |t#0@2| |t#0@1|)) GeneratedUnifiedExit_correct)))))))))
(let ((anon3_Then_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> |c#0@@3| (and (! (or %lbl%@8  (and (<= 0 |j#0|) (< |j#0| (|Seq#Length| |s#0|)))) :lblneg @8) (=> (and (<= 0 |j#0|) (< |j#0| (|Seq#Length| |s#0|))) (=> (and (= |t#0@0| (|Seq#Update| |s#0| |j#0| ($Box (bool_2_U |b#0|)))) (= |t#0@2| |t#0@0|)) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (= $_Frame@0 (|lambda#1| null $Heap alloc false)) (and anon3_Then_correct anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is |s#0| (TSeq TBool)) ($IsAlloc |s#0| (TSeq TBool) $Heap)) (and ($Is |t#0| (TSeq TBool)) ($IsAlloc |t#0| (TSeq TBool) $Heap))) (and (and (= 0 $FunctionContextHeight) (<= 10 (|Seq#Length| |s#0|))) (and (<= 8 |j#0|) (< |j#0| (|Seq#Length| |s#0|))))) anon0_correct)))))
PreconditionGeneratedEntry_correct)))))
))
(check-sat)
