// Dafny 2.3.0.10506
// Command Line Options: /compile:0 /trace DLL_Dafny.dfy /print:DLL-Dafny2Boogie.bpl /proverLog:DLL-Dafny2z3.smt2 /proverOpt:O:smt.arith.solver=0 /proc:*Index
...
procedure CheckWellformed$$_module.__default.lt__is__leq();
  free requires 36 == $FunctionContextHeight;
  modifies $Heap, $Tick;



procedure Call$$_module.__default.lt__is__leq();
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures true;
  ensures (forall i#1: int, j#1: int :: true ==> i#1 < j#1 ==> i#1 <= j#1);
  free ensures true;
  ensures (forall i#3: int, j#3: int :: true ==> i#3 < j#3 ==> i#3 != j#3);
  // frame condition
...
implementation CheckWellformed$$_module.__default.seq__get(_module._default.seq_get$A: Ty, s#0: Seq Box, i#0: int) returns (a#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(9,16): initial state"} true;
   ...
   returns (s2#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(13,16): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (LitInt(0) <= i#0)
    {
...
axiom 18 <= $FunctionContextHeight
   ==> (forall _module._default.seq_length$A: Ty, s#0: Seq Box :: 
    ...
    _module.__default.seq_length#canCall(_module._default.seq_length$A, s#0)
         || (18 != $FunctionContextHeight && $Is(s#0, TSeq(_module._default.seq_length$A)))
       ==> _module.__default.seq_length(_module._default.seq_length$A, s#0)
         == Seq#Length(s#0));
...
implementation {:extern "LinearExtern", "seq_length"} CheckWellformed$$_module.__default.seq_length(_module._default.seq_length$A: Ty, s#0: Seq Box) returns (n#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(17,55): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
...
implementation {:extern "LinearExtern", "seq_empty"} CheckWellformed$$_module.__default.seq_empty(_module._default.seq_empty$A: Ty) returns (s#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(21,54): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
...
axiom 21 <= $FunctionContextHeight
   ==> (forall _module._default.seq_alloc$A: Ty, length#0: int, a#0: Box :: 
    ...
    _module.__default.seq_alloc#canCall(_module._default.seq_alloc$A, length#0, a#0)
         || (21 != $FunctionContextHeight && $IsBox(a#0, _module._default.seq_alloc$A))
   ...
   returns (s#0: Seq Box)
{
  ...
  var i#2: int;
    ...
    assume {:captureState "DLL_Dafny.dfy(24,54): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
...
axiom 4 <= $FunctionContextHeight
   ==> (forall _module._default.seq_free$A: Ty, s#0: Seq Box :: 
    ...
    _module.__default.seq_free#canCall(_module._default.seq_free$A, s#0)
         || (4 != $FunctionContextHeight && $Is(s#0, TSeq(_module._default.seq_free$A)))
...
implementation {:extern "LinearExtern", "seq_unleash"} CheckWellformed$$_module.__default.seq_unleash(_module._default.seq_unleash$A: Ty, s1#0: Seq Box) returns (s2#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(30,56): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
   ...
   returns (s2#0: Seq Box)
{
  ...
  var j#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(33,7): initial state"} true;
    assume newlen#0 >= LitInt(0);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
    ...
    havoc s2#0;
    assume {:captureState "DLL_Dafny.dfy(35,15): post-state"} true;
   ...
   returns (dest#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(38,7): initial state"} true;
    if (LitInt(0) <= from#0)
    {
    }

    assume LitInt(0) <= from#0 && from#0 <= Seq#Length(source#0);
    if (LitInt(0) <= to#0)
    {
    }

    assume LitInt(0) <= to#0 && to#0 <= Seq#Length(source#0);
    assume from#0 <= to#0;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc dest#0;
    assume {:captureState "DLL_Dafny.dfy(43,27): post-state"} true;
...
procedure Call$$_module.__default.AllocAndCopy(_module._default.AllocAndCopy$A: Ty, 
  ...
  requires from#0 <= Seq#Length(source#0);
  requires LitInt(0) <= to#0;
...
axiom 6 < $FunctionContextHeight ==> $Is(_module.__default.unused(), TInt);
...
axiom 5 < $FunctionContextHeight ==> $Is(_module.__default.sentinel(), TInt);
          ...
          (forall i#1: int :: 
            ...
            true
              ...
              LitInt(0) <= i#1 && i#1 < Seq#Length(f#0)
               ==> 
              LitInt(0) <= $Unbox(Seq#Index(f#0, i#1)): int
                         ...
                         && ((forall p#5: int :: 
                            ...
                            true
                              ...
                              LitInt(0) <= p#5
                                 ...
                                 && _module.__default.sentinel() <= $Unbox(Seq#Index(g#0, p#5)): int
                               ==> _module.Node.next($Unbox(Seq#Index(nodes#0, p#5)): DatatypeType)
                                 == (if $Unbox(Seq#Index(g#0, p#5)): int + 1 < Seq#Length(f#0)
                                   then $Unbox(Seq#Index(f#0, $Unbox(Seq#Index(g#0, p#5)): int + 1)): int
                                   else 0))
                           ==> (forall p#6: int :: 
                            ...
                            LitInt(0) <= p#6
                              ...
                              _module.__default.sentinel() <= $Unbox(Seq#Index(g#0, p#6)): int
                               ==> 
                              $Unbox(Seq#Index(g#0, p#6)): int < Seq#Length(s#0)
                               ==> 
                              Seq#Length(f#0) >= LitInt(0)
                               ==> 
                              Lit(true)
                               ==> ($Unbox(Seq#Index(g#0, p#6)): int > 0
                                   ==> 
                                  LitInt(0) <= $Unbox(Seq#Index(g#0, p#6)): int - 1
                                   ==> 
                                  $Unbox(Seq#Index(g#0, p#6)): int - 1 < Seq#Length(f#0)
                ...
                $Unbox(Seq#Index(g#0, p#6)): int < Seq#Length(s#0)
                 ...
                 ==> true
                   && (if $Unbox(Seq#Index(g#0, p#6)): int > 0
                     then LitInt(0) <= $Unbox(Seq#Index(g#0, p#6)): int - 1
                         && $Unbox(Seq#Index(g#0, p#6)): int - 1 < Seq#Length(f#0)
                       ==> _module.Node.prev($Unbox(Seq#Index(nodes#0, p#6)): DatatypeType)
                         == $Unbox(Seq#Index(f#0, $Unbox(Seq#Index(g#0, p#6)): int - 1)): int
                     else (if $Unbox(Seq#Index(g#0, p#6)): int == LitInt(0) || Seq#Length(f#0) == LitInt(0)
                       then _module.Node.prev($Unbox(Seq#Index(nodes#0, p#6)): DatatypeType) == LitInt(0)
                       else LitInt(0) <= Seq#Length(f#0) - 1
                         ==> _module.Node.prev($Unbox(Seq#Index(nodes#0, p#6)): DatatypeType)
                           == $Unbox(Seq#Index(f#0, Seq#Length(f#0) - 1)): int)))));
          ...
          (forall i#3: int :: 
            ...
            true
              ...
              LitInt(0) <= i#3 && i#3 < Seq#Length(Lit(f#0))
               ==> 
              LitInt(0) <= $Unbox(Seq#Index(Lit(f#0), i#3)): int
                            ...
                            true
                              ...
                              LitInt(0) <= p#12
                               ...
                               ==> _module.Node.next($Unbox(Seq#Index(Lit(nodes#0), p#12)): DatatypeType)
                                 == (if $Unbox(Seq#Index(Lit(g#0), p#12)): int + 1 < Seq#Length(Lit(f#0))
                                   then $Unbox(Seq#Index(Lit(f#0), $Unbox(Seq#Index(Lit(g#0), p#12)): int + 1)): int
                                   else 0))
                           ==> (forall p#13: int :: 
                            ...
                            LitInt(0) <= p#13
                              ...
                              _module.__default.sentinel() <= $Unbox(Seq#Index(Lit(g#0), p#13)): int
                               ==> 
                              $Unbox(Seq#Index(Lit(g#0), p#13)): int < Seq#Length(Lit(s#0))
                               ==> 
                              ...
                              Lit(true)
                               ==> ($Unbox(Seq#Index(Lit(g#0), p#13)): int > 0
                                   ==> 
                                  LitInt(0) <= $Unbox(Seq#Index(Lit(g#0), p#13)): int - 1
                                   ==> 
                                  $Unbox(Seq#Index(Lit(g#0), p#13)): int - 1 < Seq#Length(Lit(f#0))
                ...
                $Unbox(Seq#Index(Lit(g#0), p#13)): int < Seq#Length(Lit(s#0))
                 ...
                 ==> true
                   && (if $Unbox(Seq#Index(Lit(g#0), p#13)): int > 0
                     then LitInt(0) <= $Unbox(Seq#Index(Lit(g#0), p#13)): int - 1
                         && $Unbox(Seq#Index(Lit(g#0), p#13)): int - 1 < Seq#Length(Lit(f#0))
                       ==> _module.Node.prev($Unbox(Seq#Index(Lit(nodes#0), p#13)): DatatypeType)
                         == $Unbox(Seq#Index(Lit(f#0), $Unbox(Seq#Index(Lit(g#0), p#13)): int - 1)): int
                     else (if $Unbox(Seq#Index(Lit(g#0), p#13)): int == LitInt(0)
                         || Seq#Length(Lit(f#0)) == LitInt(0)
                       then _module.Node.prev($Unbox(Seq#Index(Lit(nodes#0), p#13)): DatatypeType)
                         == LitInt(0)
                       else LitInt(0) <= Seq#Length(Lit(f#0)) - 1
                         ==> _module.Node.prev($Unbox(Seq#Index(Lit(nodes#0), p#13)): DatatypeType)
                           == $Unbox(Seq#Index(Lit(f#0), Seq#Length(Lit(f#0)) - 1)): int)))));
    ...
    g#0: Seq Box)
{
  ...
  var p#25: int;
    ...
    assume {:captureState "DLL_Dafny.dfy(58,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
                   ...
                   ==> $Unbox(Seq#Index(f#0, i#6)): int < Seq#Length(nodes#0))))
        {
            ...
            if (LitInt(0) <= i#5 && i#5 < Seq#Length(f#0))
            {
                ...
                if (LitInt(0) <= $Unbox(Seq#Index(f#0, i#5)): int)
                {
                    assert 0 <= i#5 && i#5 < Seq#Length(f#0);
           ...
           && (forall i#7: int :: 
            ...
            true
              ...
              LitInt(0) <= i#7 && i#7 < Seq#Length(f#0)
               ==> 
              LitInt(0) <= $Unbox(Seq#Index(f#0, i#7)): int
                  ...
                  #_module.Option.Some(Seq#Index(s#0, $Unbox(Seq#Index(g#0, p#24)): int)))))
        {
               ...
               && _module.__default.sentinel() <= $Unbox(Seq#Index(g#0, p#23)): int)
            {
                ...
                assert 0 <= p#23 && p#23 < Seq#Length(g#0);
                if ($Unbox(Seq#Index(g#0, p#23)): int + 1 < Seq#Length(f#0))
                {
                    assert 0 <= p#23 && p#23 < Seq#Length(g#0);
                    assert 0 <= $Unbox(Seq#Index(g#0, p#23)): int + 1
                       && $Unbox(Seq#Index(g#0, p#23)): int + 1 < Seq#Length(f#0);
                }
                else
                {
                }
           ...
           && (forall p#26: int :: 
            ...
            true
              ...
              LitInt(0) <= p#26
               ...
               ==> _module.Node.next($Unbox(Seq#Index(nodes#0, p#26)): DatatypeType)
                 == (if $Unbox(Seq#Index(g#0, p#26)): int + 1 < Seq#Length(f#0)
                   then $Unbox(Seq#Index(f#0, $Unbox(Seq#Index(g#0, p#26)): int + 1)): int
                   else 0)))
        {
            havoc p#25;
            // Begin Comprehension WF check
            ...
            {
                assert 0 <= p#25 && p#25 < Seq#Length(g#0);
                if ($Unbox(Seq#Index(g#0, p#25)): int < Seq#Length(s#0))
                {
                }
                   ...
                   && Seq#Length(f#0) >= LitInt(0))
                {
                    if (Lit(true))
                    {
                        ...
                        {
                            assert 0 <= p#25 && p#25 < Seq#Length(g#0);
                            if (LitInt(0) <= $Unbox(Seq#Index(g#0, p#25)): int - 1)
                            {
                                assert 0 <= p#25 && p#25 < Seq#Length(g#0);
                            }

                            if (LitInt(0) <= $Unbox(Seq#Index(g#0, p#25)): int - 1
                               && $Unbox(Seq#Index(g#0, p#25)): int - 1 < Seq#Length(f#0))
                            {
                                assert 0 <= p#25 && p#25 < Seq#Length(nodes#0);
                                assume _module.Node.Node_q($Unbox(Seq#Index(nodes#0, p#25)): DatatypeType);
                                assert 0 <= p#25 && p#25 < Seq#Length(g#0);
                                assert 0 <= $Unbox(Seq#Index(g#0, p#25)): int - 1
                                   && $Unbox(Seq#Index(g#0, p#25)): int - 1 < Seq#Length(f#0);
                            }
                        }
                        else
                        {
                            ...
                            {
                                if (LitInt(0) <= Seq#Length(f#0) - 1)
                                {
                                    assert 0 <= p#25 && p#25 < Seq#Length(nodes#0);
                                    assume _module.Node.Node_q($Unbox(Seq#Index(nodes#0, p#25)): DatatypeType);
                                    assert 0 <= Seq#Length(f#0) - 1 && Seq#Length(f#0) - 1 < Seq#Length(f#0);
                                }
                            }
                        }
                    }
             ...
             && (forall p#27: int :: 
              ...
              true
                ...
                LitInt(0) <= p#27
                 ...
                 ==> 
                $Unbox(Seq#Index(g#0, p#27)): int < Seq#Length(s#0)
                   && Seq#Length(f#0) >= LitInt(0)
                 ==> true
                   && (if $Unbox(Seq#Index(g#0, p#27)): int > 0
                     then LitInt(0) <= $Unbox(Seq#Index(g#0, p#27)): int - 1
                         && $Unbox(Seq#Index(g#0, p#27)): int - 1 < Seq#Length(f#0)
                       ==> _module.Node.prev($Unbox(Seq#Index(nodes#0, p#27)): DatatypeType)
                         == $Unbox(Seq#Index(f#0, $Unbox(Seq#Index(g#0, p#27)): int - 1)): int
                     else (if $Unbox(Seq#Index(g#0, p#27)): int == LitInt(0) || Seq#Length(f#0) == LitInt(0)
                       then _module.Node.prev($Unbox(Seq#Index(nodes#0, p#27)): DatatypeType) == LitInt(0)
                       else LitInt(0) <= Seq#Length(f#0) - 1
                         ==> _module.Node.prev($Unbox(Seq#Index(nodes#0, p#27)): DatatypeType)
                           == $Unbox(Seq#Index(f#0, Seq#Length(f#0) - 1)): int))));
                            ...
                            LitInt(0) <= p#27 && p#27 < Seq#Length(g#0)
                              ...
                              Lit(true)
                               ==> ($Unbox(Seq#Index(g#0, p#27)): int > 0
                                   ==> 
                                  LitInt(0) <= $Unbox(Seq#Index(g#0, p#27)): int - 1
                                     && $Unbox(Seq#Index(g#0, p#27)): int - 1 < Seq#Length(f#0)
...
implementation CheckWellformed$$_module.__default.Inv(_module._default.Inv$A: Ty, l#0: DatatypeType)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(91,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
   ...
   ==> (forall _module._default.ValidPtr$A: Ty, l#0: DatatypeType, p#0: int :: 
    ...
    _module.__default.ValidPtr#canCall(_module._default.ValidPtr$A, l#0, p#0)
       ...
       ==> (_module.__default.ValidPtr(_module._default.ValidPtr$A, l#0, p#0)
         ...
         && (_module.__default.ValidPtr(_module._default.ValidPtr$A, l#0, p#0) ==> p#0 != 0));
...
procedure CheckWellformed$$_module.__default.ValidPtr(_module._default.ValidPtr$A: Ty, 
  ...
  modifies $Heap, $Tick;
  ensures b#0 ==> (0 < p#0 ==> LitInt(0) <= p#0) ==> 0 < p#0;
  ensures b#0
     ==> 
    (0 < p#0
     ==> LitInt(0) <= p#0)
   ...
   returns (b#0: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(101,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        if (*)
        {
            ...
            if (*)
            {
                ...
                assume 0 < p#0 ==> LitInt(0) <= p#0;
                if (0 < p#0)
                {
                    assume _module.DList.DList_q(l#0);
                }

                assume 0 < p#0 && p#0 < Seq#Length(_module.DList.g(l#0));
                assume _module.DList.DList_q(l#0);
                assert 0 <= p#0 && p#0 < Seq#Length(_module.DList.g(l#0));
                assume $Unbox(Seq#Index(_module.DList.g(l#0), p#0)): int >= LitInt(0);
            }
            else
            {
                assume (0 < p#0
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        // ----- assume statement ----- DLL_Dafny.dfy(108,3)
        if (0 < p#0)
        {
        }
        ...
        assume true;
        assume 0 < p#0 ==> LitInt(0) <= p#0;
        // ----- assume statement ----- DLL_Dafny.dfy(109,3)
        if (0 < p#0)
        {
        }
...
implementation CheckWellformed$$_module.__default.MaybePtr(_module._default.MaybePtr$A: Ty, l#0: DatatypeType, p#0: int)
{
  ...
  var b$reqreads#0: bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(113,10): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    _module.__default.Index#canCall(_module._default.Index$A, l#0, p#0)
       ...
       ==> _module.__default.Inv#canCall(_module._default.Index$A, l#0)
         ...
         && (_module.__default.Inv(_module._default.Index$A, l#0)
           ...
           ==> _module.DList.DList_q(l#0))
         && _module.__default.Index(_module._default.Index$A, l#0, p#0)
           == (var i#0 := (if _module.__default.Inv(_module._default.Index$A, l#0)
                   && _module.__default.MaybePtr(_module._default.Index$A, l#0, p#0)
    ...
    _module.__default.Index#canCall(_module._default.Index$A, Lit(l#0), LitInt(p#0))
       ...
       ==> _module.__default.Inv#canCall(_module._default.Index$A, Lit(l#0))
         ...
         && _module.__default.Index(_module._default.Index$A, Lit(l#0), LitInt(p#0))
           == (var i#1 := (if _module.__default.Inv(_module._default.Index$A, Lit(l#0))
                   && _module.__default.MaybePtr(_module._default.Index$A, Lit(l#0), LitInt(p#0))
...
procedure CheckWellformed$$_module.__default.Index(_module._default.Index$A: Ty, 
  ...
  ensures _module.__default.Inv(_module._default.Index$A, l#0)
       && _module.__default.ValidPtr(_module._default.Index$A, l#0, p#0)
     ==> i#2 < Seq#Length(_module.__default.Seq(_module._default.Index$A, l#0));
  ensures _module.__default.Inv(_module._default.Index$A, l#0) && p#0 == LitInt(0)
     ==> i#2 == LitInt(0 - 1);



implementation CheckWellformed$$_module.__default.Index(_module._default.Index$A: Ty, l#0: DatatypeType, p#0: int) returns (i#2: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##l#0: DatatypeType;
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(118,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
        ...
        if (*)
        {
            ...
            assume i#2 < Seq#Length(_module.__default.Seq(_module._default.Index$A, l#0));
        }
        else
        {
            assume _module.__default.Inv(_module._default.Index$A, l#0)
    ...
    else
    {
        ...
        ##l#6 := l#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##l#6, Tclass._module.DList(_module._default.Index$A), $Heap);
        b$reqreads#0 := (forall<alpha> $o: ref, $f: Field alpha :: false ==> $_Frame[$o, $f]);
        assume _module.__default.Inv#canCall(_module._default.Index$A, l#0);
        if (_module.__default.Inv(_module._default.Index$A, l#0))
        {
            ##l#7 := l#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##l#7, Tclass._module.DList(_module._default.Index$A), $Heap);
            ##p#2 := p#0;
            // assume allocatedness for argument to function
        ...
        if (_module.__default.Inv(_module._default.Index$A, l#0)
           && _module.__default.MaybePtr(_module._default.Index$A, l#0, p#0))
        {
            // ----- assume statement ----- DLL_Dafny.dfy(125,7)
            if (0 < p#0)
            {
            }
            ...
            assume true;
            assume 0 < p#0 ==> LitInt(0) <= p#0;
            // ----- assume statement ----- DLL_Dafny.dfy(126,7)
            if (0 < p#0)
            {
            }
            ...
            assume true;
            assume 0 < p#0 ==> p#0 != 0;
            // ----- assert statement ----- DLL_Dafny.dfy(127,7)
            if (p#0 != LitInt(0))
            {
                if (0 < p#0)
                {
            ...
            assume p#0 != LitInt(0) ==> 0 < p#0 ==> _module.DList.DList_q(l#0);
            assert p#0 == LitInt(0) || (0 < p#0 && p#0 < Seq#Length(_module.DList.g(l#0)));
            // ----- assume statement ----- DLL_Dafny.dfy(128,7)
            if (LitInt(0) <= p#0)
            {
                assume _module.DList.DList_q(l#0);
            }

            assume LitInt(0) <= p#0 ==> _module.DList.DList_q(l#0);
            assume LitInt(0) <= p#0 && p#0 < Seq#Length(_module.DList.g(l#0));
            assume _module.DList.DList_q(l#0);
            assert 0 <= p#0 && p#0 < Seq#Length(_module.DList.g(l#0));
            assume let#0#0#0 == $Unbox(Seq#Index(_module.DList.g(l#0), p#0)): int;
            assume _module.DList.DList_q(l#0);
            // CheckWellformedWithResult: any expression
        ...
        {
            assume let#0#0#0 == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, TInt);
        }

        assume i#3 == let#0#0#0;
        assume _module.__default.Index(_module._default.Index$A, l#0, p#0) == i#3;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(_module.__default.Index(_module._default.Index$A, l#0, p#0), TInt);
        assume _module.__default.Index(_module._default.Index$A, l#0, p#0) == i#2;
        assert b$reqreads#0;
        assert b$reqreads#1;
    }
}
...
implementation CheckWellformed$$_module.__default.IndexHi(_module._default.IndexHi$A: Ty, l#0: DatatypeType, p#0: int) returns (i#0: int)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(135,9): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    if (*)
    {
    ...
    else
    {
        $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
          $o != null && read($Heap, $o, alloc) ==> false);
        // ----- assume statement ----- DLL_Dafny.dfy(139,3)
        if (0 < p#0)
        {
        }
...
implementation CheckWellformed$$_module.__default.Get(_module._default.Get$A: Ty, l#0: DatatypeType, p#0: int) returns (a#0: Box)
{
  ...
  var b$reqreads#2: bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(143,16): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##l#0 := l#0;
    // assume allocatedness for argument to function
   ...
   ==> (forall _module._default.Next$A: Ty, l#0: DatatypeType, p#0: int :: 
    ...
    _module.__default.Next#canCall(_module._default.Next$A, l#0, p#0)
       ...
       ==> _module.__default.MaybePtr(_module._default.Next$A, 
         ...
         && (p#0 != 0
             && _module.__default.Index(_module._default.Next$A, l#0, p#0) + 1
...
implementation CheckWellformed$$_module.__default.Next(_module._default.Next$A: Ty, l#0: DatatypeType, p#0: int) returns (p'#0: int)
{
  ...
  var b$reqreads#2: bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(151,16): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##l#0 := l#0;
    // assume allocatedness for argument to function
    ...
    if (*)
    {
        ...
        if (*)
        {
            ...
            assume _module.__default.Seq#canCall(_module._default.Next$A, l#0);
            assume _module.__default.Index(_module._default.Next$A, l#0, p#0) + 1
               < Seq#Length(_module.__default.Seq(_module._default.Next$A, l#0));
            ##l#8 := l#0;
            // assume allocatedness for argument to function
       ...
       ==> _module.__default.MaybePtr(_module._default.Prev$A, 
         ...
         && (p#0 == LitInt(0)
           ...
           ==> _module.__default.Index(_module._default.Prev$A, 
              l#0, 
              _module.__default.Prev(_module._default.Prev$A, l#0, p#0))
             == Seq#Length(_module.__default.Seq(_module._default.Prev$A, l#0)) - 1)
         && (p#0 == LitInt(0)
         ...
         && (p#0 != 0 && _module.__default.Index(_module._default.Prev$A, l#0, p#0) > 0
           ==> _module.__default.Index(_module._default.Prev$A, 
              l#0, 
              _module.__default.Prev(_module._default.Prev$A, l#0, p#0))
             == _module.__default.Index(_module._default.Prev$A, l#0, p#0) - 1)
         && (p#0 != 0
             && 
...
implementation CheckWellformed$$_module.__default.Prev(_module._default.Prev$A: Ty, l#0: DatatypeType, p#0: int) returns (p'#0: int)
{
  ...
  var b$reqreads#2: bool;
    ...
    assume {:captureState "DLL_Dafny.dfy(163,16): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    ##l#0 := l#0;
    // assume allocatedness for argument to function
   ...
   returns (b#0: Seq Box)
{
  ...
  var i#2: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(175,7): initial state"} true;
    if (0 < k#0)
    {
    }
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc b#0;
    assume {:captureState "DLL_Dafny.dfy(177,14): post-state"} true;
    ...
    if (*)
    {
        ...
        assume _module.Node#Equal($Unbox(Seq#Index(b#0, i#2)): DatatypeType, 
          #_module.Node.Node(Lit(#_module.Option.None()), i#2 - 1, LitInt(0)));
    }
    else
    {
      ...
      true
        ...
        k#0 <= i#3 && i#3 < Seq#Length(a#0)
         ==> _module.Node#Equal($Unbox(Seq#Index(b#0, i#3)): DatatypeType, 
          #_module.Node.Node(Lit(#_module.Option.None()), i#3 - 1, LitInt(0))));
}
   ...
   returns (b#0: Seq Box, $_reverifyPost: bool)
{
  ...
  var ##a#0_0: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(180,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- DLL_Dafny.dfy(181,5)
    assume true;
    assume true;
    b#0 := a#0;
    assume {:captureState "DLL_Dafny.dfy(181,8)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(182,9)
    assume true;
    assume true;
    n#0 := k#0;
    assume {:captureState "DLL_Dafny.dfy(182,12)"} true;
    // ----- while statement ----- DLL_Dafny.dfy(184,3)
    // Assume Fuel Constant
    $PreLoopHeap$loop#0 := $Heap;
    $decr_init$loop#00 := _module.__default.seq_length(Tclass._module.Node(_module._default.BuildFreeStack$A), b#0)
       - n#0;
    havoc $w$loop#0;
    while (true)
      ...
      free invariant $w$loop#0
         ==> (forall i#7: int :: 
          { $Unbox(Seq#Index(b#0, i#7)): DatatypeType } 
          k#0 <= i#7 && i#7 < n#0
          ...
          true
            ...
            k#0 <= i#7 && i#7 < n#0
             ==> _module.Node#Equal($Unbox(Seq#Index(b#0, i#7)): DatatypeType, 
              #_module.Node.Node(Lit(#_module.Option.None()), i#7 - 1, LitInt(0))));
      ...
      free invariant _module.__default.seq_length(Tclass._module.Node(_module._default.BuildFreeStack$A), b#0)
             - n#0
           <= $decr_init$loop#00
         && (_module.__default.seq_length(Tclass._module.Node(_module._default.BuildFreeStack$A), b#0)
               - n#0
             == $decr_init$loop#00
           ==> true);
    {
        assume {:captureState "DLL_Dafny.dfy(184,2): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            if (k#0 <= n#0)
            {
        ...
        $decr$loop#00 := _module.__default.seq_length(Tclass._module.Node(_module._default.BuildFreeStack$A), b#0)
           - n#0;
        // ----- assignment statement ----- DLL_Dafny.dfy(190,7)
        assume true;
        ##s1#0_0 := b#0;
        // assume allocatedness for argument to function
        ...
        ##a#0_0 := #_module.Node.Node(Lit(#_module.Option.None()), n#0 - 1, LitInt(0));
        // assume allocatedness for argument to function
        assume $IsAlloc(##a#0_0, Tclass._module.Node(_module._default.BuildFreeStack$A), $Heap);
        ...
        assume _module.__default.seq__set#canCall(Tclass._module.Node(_module._default.BuildFreeStack$A), 
          b#0, 
          n#0, 
          $Box(#_module.Node.Node(Lit(#_module.Option.None()), n#0 - 1, LitInt(0))));
        assume _module.__default.seq__set#canCall(Tclass._module.Node(_module._default.BuildFreeStack$A), 
          b#0, 
          n#0, 
          $Box(#_module.Node.Node(Lit(#_module.Option.None()), n#0 - 1, LitInt(0))));
        b#0 := _module.__default.seq__set(Tclass._module.Node(_module._default.BuildFreeStack$A), 
          ...
          n#0, 
          $Box(#_module.Node.Node(Lit(#_module.Option.None()), n#0 - 1, LitInt(0))));
        assume {:captureState "DLL_Dafny.dfy(190,44)"} true;
        // ----- assignment statement ----- DLL_Dafny.dfy(191,7)
        assume true;
        assume true;
        n#0 := n#0 + 1;
        assume {:captureState "DLL_Dafny.dfy(191,14)"} true;
        // ----- loop termination check ----- DLL_Dafny.dfy(184,3)
        assert 0 <= $decr$loop#00
           || _module.__default.seq_length(Tclass._module.Node(_module._default.BuildFreeStack$A), b#0)
               - n#0
             == $decr$loop#00;
        assert _module.__default.seq_length(Tclass._module.Node(_module._default.BuildFreeStack$A), b#0)
             - n#0
           < $decr$loop#00;
        assume true;
        assume true;
           ...
           || (forall i#3: int :: 
            ...
            true
              ...
              LitInt(0) <= i#3 && i#3 < Seq#Length(_module.DList.f(l#0))
               ==> 
              LitInt(0) <= $Unbox(Seq#Index(_module.DList.f(l#0), i#3)): int
               ==> $Unbox(Seq#Index(_module.DList.g(l#0), $Unbox(Seq#Index(_module.DList.f(l#0), i#3)): int)): int
                 == i#3));
  ensures _module.__default.Inv#canCall(_module._default.Alloc$A, l#0)
     ==> _module.__default.Inv(_module._default.Alloc$A, l#0)
            ...
            true
              ...
              LitInt(0) <= p#12
                 ...
                 && _module.__default.sentinel()
                   <= $Unbox(Seq#Index(_module.DList.g(l#0), p#12)): int
               ==> _module.Node.next($Unbox(Seq#Index(_module.DList.nodes(l#0), p#12)): DatatypeType)
                 == (if $Unbox(Seq#Index(_module.DList.g(l#0), p#12)): int + 1
                     < Seq#Length(_module.DList.f(l#0))
                   then $Unbox(Seq#Index(_module.DList.f(l#0), $Unbox(Seq#Index(_module.DList.g(l#0), p#12)): int + 1)): int
                   else 0)));
  ensures _module.__default.Inv#canCall(_module._default.Alloc$A, l#0)
     ==> _module.__default.Inv(_module._default.Alloc$A, l#0)
       || (_module.__default.Invs#canCall(_module._default.Alloc$A, 
              ...
              $Unbox(Seq#Index(_module.DList.g(l#0), p#13)): int
               ...
               ==> true
                 && (if $Unbox(Seq#Index(_module.DList.g(l#0), p#13)): int > 0
                   then LitInt(0) <= $Unbox(Seq#Index(_module.DList.g(l#0), p#13)): int - 1
                       && $Unbox(Seq#Index(_module.DList.g(l#0), p#13)): int - 1
                         < Seq#Length(_module.DList.f(l#0))
                     ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#13)): DatatypeType)
                       == $Unbox(Seq#Index(_module.DList.f(l#0), $Unbox(Seq#Index(_module.DList.g(l#0), p#13)): int - 1)): int
                   else (if $Unbox(Seq#Index(_module.DList.g(l#0), p#13)): int == LitInt(0)
                       || Seq#Length(_module.DList.f(l#0)) == LitInt(0)
                     then _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#13)): DatatypeType)
                       == LitInt(0)
                     else LitInt(0) <= Seq#Length(_module.DList.f(l#0)) - 1
                       ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#13)): DatatypeType)
                         == $Unbox(Seq#Index(_module.DList.f(l#0), Seq#Length(_module.DList.f(l#0)) - 1)): int))));
  free ensures _module.__default.Seq#canCall(_module._default.Alloc$A, l#0);
  ensures Seq#Equal(_module.__default.Seq(_module._default.Alloc$A, l#0), Seq#Empty(): Seq Box);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
   ...
   returns (l#0: DatatypeType, $_reverifyPost: bool)
{
  ...
  var lambdaResult#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(200,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- DLL_Dafny.dfy(201,13)
    assume true;
    ...
    nodes#0 := _module.__default.seq_alloc(Tclass._module.Node(_module._default.Alloc$A), 
      initial_len#0, 
      $Box(Lit(#_module.Node.Node(Lit(#_module.Option.None()), LitInt(0), LitInt(0)))));
    assume {:captureState "DLL_Dafny.dfy(201,61)"} true;
    // ----- call statement ----- DLL_Dafny.dfy(202,26)
    assume true;
    ...
    nodes#0 := $rhs##0;
    assume {:captureState "DLL_Dafny.dfy(202,35)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(203,5)
    assume true;
    ...
    l#0 := #_module.DList.DList(nodes#0, 
      ...
      Seq#Create(TInt, 
        ...
        Lit(AtLayer((lambda $l#3#ly#0: LayerType :: 
            ...
            $LS($LZ)))));
    assume {:captureState "DLL_Dafny.dfy(203,104)"} true;
}
...
implementation CheckWellformed$$_module.__default.Expand(_module._default.Expand$A: Ty, l#0: DatatypeType) returns (l'#0: DatatypeType)
{
  ...
  var ##p#1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(212,7): initial state"} true;
    ##l#0 := l#0;
    // assume allocatedness for argument to function
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc l'#0;
    assume {:captureState "DLL_Dafny.dfy(214,13): post-state"} true;
    ##l#1 := l'#0;
    // assume allocatedness for argument to function
           ...
           || (forall i#1: int :: 
            ...
            true
              ...
              LitInt(0) <= i#1 && i#1 < Seq#Length(_module.DList.f(l#0))
               ==> 
              LitInt(0) <= $Unbox(Seq#Index(_module.DList.f(l#0), i#1)): int
               ==> $Unbox(Seq#Index(_module.DList.g(l#0), $Unbox(Seq#Index(_module.DList.f(l#0), i#1)): int)): int
                 == i#1));
  requires _module.__default.Inv#canCall(_module._default.Expand$A, l#0)
     ==> _module.__default.Inv(_module._default.Expand$A, l#0)
            ...
            true
              ...
              LitInt(0) <= p#5
                 ...
                 && _module.__default.sentinel()
                   <= $Unbox(Seq#Index(_module.DList.g(l#0), p#5)): int
               ==> _module.Node.next($Unbox(Seq#Index(_module.DList.nodes(l#0), p#5)): DatatypeType)
                 == (if $Unbox(Seq#Index(_module.DList.g(l#0), p#5)): int + 1
                     < Seq#Length(_module.DList.f(l#0))
                   then $Unbox(Seq#Index(_module.DList.f(l#0), $Unbox(Seq#Index(_module.DList.g(l#0), p#5)): int + 1)): int
                   else 0)));
  requires _module.__default.Inv#canCall(_module._default.Expand$A, l#0)
     ==> _module.__default.Inv(_module._default.Expand$A, l#0)
       || (_module.__default.Invs#canCall(_module._default.Expand$A, 
              ...
              $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int
               ...
               ==> true
                 && (if $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int > 0
                   then LitInt(0) <= $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int - 1
                       && $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int - 1
                         < Seq#Length(_module.DList.f(l#0))
                     ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#6)): DatatypeType)
                       == $Unbox(Seq#Index(_module.DList.f(l#0), $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int - 1)): int
                   else (if $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int == LitInt(0)
                       || Seq#Length(_module.DList.f(l#0)) == LitInt(0)
                     then _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#6)): DatatypeType)
                       == LitInt(0)
                     else LitInt(0) <= Seq#Length(_module.DList.f(l#0)) - 1
                       ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#6)): DatatypeType)
                         == $Unbox(Seq#Index(_module.DList.f(l#0), Seq#Length(_module.DList.f(l#0)) - 1)): int))));
           ...
           || (forall i#7: int :: 
            ...
            true
              ...
              LitInt(0) <= i#7 && i#7 < Seq#Length(_module.DList.f(l'#0))
               ==> 
              LitInt(0) <= $Unbox(Seq#Index(_module.DList.f(l'#0), i#7)): int
               ==> $Unbox(Seq#Index(_module.DList.g(l'#0), $Unbox(Seq#Index(_module.DList.f(l'#0), i#7)): int)): int
                 == i#7));
  ensures _module.__default.Inv#canCall(_module._default.Expand$A, l'#0)
     ==> _module.__default.Inv(_module._default.Expand$A, l'#0)
            ...
            true
              ...
              LitInt(0) <= p#26
                 ...
                 && _module.__default.sentinel()
                   <= $Unbox(Seq#Index(_module.DList.g(l'#0), p#26)): int
               ==> _module.Node.next($Unbox(Seq#Index(_module.DList.nodes(l'#0), p#26)): DatatypeType)
                 == (if $Unbox(Seq#Index(_module.DList.g(l'#0), p#26)): int + 1
                     < Seq#Length(_module.DList.f(l'#0))
                   then $Unbox(Seq#Index(_module.DList.f(l'#0), $Unbox(Seq#Index(_module.DList.g(l'#0), p#26)): int + 1)): int
                   else 0)));
  ensures _module.__default.Inv#canCall(_module._default.Expand$A, l'#0)
     ==> _module.__default.Inv(_module._default.Expand$A, l'#0)
       || (_module.__default.Invs#canCall(_module._default.Expand$A, 
              ...
              $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int
               ...
               ==> true
                 && (if $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int > 0
                   then LitInt(0) <= $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int - 1
                       && $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int - 1
                         < Seq#Length(_module.DList.f(l'#0))
                     ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l'#0), p#27)): DatatypeType)
                       == $Unbox(Seq#Index(_module.DList.f(l'#0), $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int - 1)): int
                   else (if $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int == LitInt(0)
                       || Seq#Length(_module.DList.f(l'#0)) == LitInt(0)
                     then _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l'#0), p#27)): DatatypeType)
                       == LitInt(0)
                     else LitInt(0) <= Seq#Length(_module.DList.f(l'#0)) - 1
                       ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l'#0), p#27)): DatatypeType)
                         == $Unbox(Seq#Index(_module.DList.f(l'#0), Seq#Length(_module.DList.f(l'#0)) - 1)): int))));
   ...
   returns (l'#0: DatatypeType, $_reverifyPost: bool)
{
  ...
  var lambdaResult#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(218,0): initial state"} true;
    $_reverifyPost := false;
    havoc nodes#0;
    ...
    // ----- assignment statement ----- DLL_Dafny.dfy(221,11)
    assume true;
    ##s#0 := nodes#0;
    // assume allocatedness for argument to function
    ...
    assume {:captureState "DLL_Dafny.dfy(221,30)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(224,12)
    assume true;
    assume true;
    len'#0 := len#0 + len#0;
    assume {:captureState "DLL_Dafny.dfy(224,23)"} true;
    // ----- call statement ----- DLL_Dafny.dfy(225,21)
    assume true;
    // TrCallStmt: Adding lhs Microsoft.Dafny.IdentifierExpr with type seq<Node<A>>
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    nodes#0 := $rhs##0;
    assume {:captureState "DLL_Dafny.dfy(225,59)"} true;
    // ----- call statement ----- DLL_Dafny.dfy(226,26)
    assume true;
    // TrCallStmt: Adding lhs Microsoft.Dafny.IdentifierExpr with type seq<Node<A>>
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    nodes#0 := $rhs##1;
    assume {:captureState "DLL_Dafny.dfy(226,41)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(227,6)
    assume true;
        ...
        Lit(AtLayer((lambda $l#3#ly#0: LayerType :: 
              Handle1((lambda $l#3#heap#0: Heap, $l#3#i#0: Box :: 
                ...
                (lambda $l#3#heap#0: Heap, $l#3#i#0: Box :: 
                  SetRef_to_SetBox((lambda $l#3#o#0: ref :: false))))), 
            $LS($LZ)))));
    assume {:captureState "DLL_Dafny.dfy(228,69)"} true;
}
...
implementation CheckWellformed$$_module.__default.Remove__SeqInit(g#0: Seq Box, index#0: int) returns (g'#0: Seq Box)
{
  ...
  var x#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(231,13): initial state"} true;
    havoc $Heap;
    assume old($Heap) == $Heap;
    havoc g'#0;
    assume {:captureState "DLL_Dafny.dfy(232,15): post-state"} true;
    ...
    if (*)
    {
        ...
        else
        {
            ...
            if (*)
            {
                ...
                assert 0 <= x#0 && x#0 < Seq#Length(g'#0);
                assert 0 <= x#0 && x#0 < Seq#Length(g#0);
                assume $Unbox(Seq#Index(g'#0, x#0)): int == $Unbox(Seq#Index(g#0, x#0)): int - 1;
            }
            else
            {
    ...
    else
    {
        assume LitInt(0) <= x#0 && x#0 < Seq#Length(g#0)
           ==> (if $Unbox(Seq#Index(g#0, x#0)): int == index#0
             ...
             else (if $Unbox(Seq#Index(g#0, x#0)): int > index#0
               then $Unbox(Seq#Index(g'#0, x#0)): int == $Unbox(Seq#Index(g#0, x#0)): int - 1
               else $Unbox(Seq#Index(g'#0, x#0)): int == $Unbox(Seq#Index(g#0, x#0)): int));
    }

    assume (forall x#1: int :: 
      { $Unbox(Seq#Index(g'#0, x#1)): int } 
      true
         ==> 
        LitInt(0) <= x#1 && x#1 < Seq#Length(g#0)
         ==> (if $Unbox(Seq#Index(g#0, x#1)): int == index#0
           ...
           else (if $Unbox(Seq#Index(g#0, x#1)): int > index#0
             then $Unbox(Seq#Index(g'#0, x#1)): int == $Unbox(Seq#Index(g#0, x#1)): int - 1
...
implementation Impl$$_module.__default.Remove__SeqInit(g#0: Seq Box, index#0: int) returns (g'#0: Seq Box, $_reverifyPost: bool)
{
  ...
  var lambdaResult#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(237,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- DLL_Dafny.dfy(238,8)
    assume true;
    assert 0 <= Seq#Length(g#0);
    havoc x#2;
    // Begin Comprehension WF check
    if (*)
    {
        ...
        if (LitInt(0) <= x#2 && x#2 < Seq#Length(g#0))
        {
            ...
            else
            {
                ...
                {
                    assert 0 <= x#2 && x#2 < Seq#Length(g#0);
                    assume lambdaResult#0 == $Unbox(Seq#Index(g#0, x#2)): int - 1;
                    assume true;
                    // CheckWellformedWithResult: any expression
                    assume $Is(lambdaResult#0, TInt);
                }
    ...
    // End Comprehension WF check
    assert {:subsumption 0} (forall seqinit#0#i0#0: int :: 
      0 <= seqinit#0#i0#0 && seqinit#0#i0#0 < Seq#Length(g#0)
         ==> Requires1(TInt, 
          TInt, 
          $Heap, 
          Lit(AtLayer((lambda $l#0#ly#0: LayerType :: 
                Handle1((lambda $l#0#heap#0: Heap, $l#0#x#0: Box :: 
                    $Box((if $Unbox(Seq#Index(g#0, $Unbox($l#0#x#0): int)): int == index#0
                         then _module.__default.unused()
                         else (if $Unbox(Seq#Index(g#0, $Unbox($l#0#x#0): int)): int > index#0
                           then $Unbox(Seq#Index(g#0, $Unbox($l#0#x#0): int)): int - 1
                           else $Unbox(Seq#Index(g#0, $Unbox($l#0#x#0): int)): int)))), 
                  (lambda $l#0#heap#0: Heap, $l#0#x#0: Box :: 
                    $IsBox($l#0#x#0, TInt)
                       && 
                      LitInt(0) <= $Unbox($l#0#x#0): int
                       && $Unbox($l#0#x#0): int < Seq#Length(g#0)), 
                  (lambda $l#0#heap#0: Heap, $l#0#x#0: Box :: 
                    SetRef_to_SetBox((lambda $l#0#o#0: ref :: false))))), 
              $LS($LZ))), 
          $Box(seqinit#0#i0#0)));
    ...
    g'#0 := Seq#Create(TInt, 
      ...
      Lit(AtLayer((lambda $l#2#ly#0: LayerType :: 
            Handle1((lambda $l#2#heap#0: Heap, $l#2#x#0: Box :: 
                $Box((if $Unbox(Seq#Index(g#0, $Unbox($l#2#x#0): int)): int == index#0
                     then _module.__default.unused()
                       ...
                       then $Unbox(Seq#Index(g#0, $Unbox($l#2#x#0): int)): int - 1
          ...
          $LS($LZ))));
    assume {:captureState "DLL_Dafny.dfy(239,80)"} true;
}
   ...
   returns (l'#0: DatatypeType)
{
  ...
  var ##p#8: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(243,7): initial state"} true;
    ##l#0 := l#0;
    // assume allocatedness for argument to function
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc l'#0;
    assume {:captureState "DLL_Dafny.dfy(246,13): post-state"} true;
    ##l#2 := l'#0;
    // assume allocatedness for argument to function
    ...
    assert 0 <= _module.__default.Index(_module._default.Remove$A, l#0, p#0)
       && _module.__default.Index(_module._default.Remove$A, l#0, p#0)
         <= Seq#Length(_module.__default.Seq(_module._default.Remove$A, l#0));
    ##l#6 := l#0;
    // assume allocatedness for argument to function
    ...
    assume $IsAlloc(##p#2, TInt, $Heap);
    assume _module.__default.Index#canCall(_module._default.Remove$A, l#0, p#0);
    assert 0 <= _module.__default.Index(_module._default.Remove$A, l#0, p#0) + 1
       && _module.__default.Index(_module._default.Remove$A, l#0, p#0) + 1
         <= Seq#Length(_module.__default.Seq(_module._default.Remove$A, l#0));
    assume Seq#Equal(_module.__default.Seq(_module._default.Remove$A, l'#0), 
      Seq#Append(Seq#Take(_module.__default.Seq(_module._default.Remove$A, l#0), 
          _module.__default.Index(_module._default.Remove$A, l#0, p#0)), 
        Seq#Drop(_module.__default.Seq(_module._default.Remove$A, l#0), 
          _module.__default.Index(_module._default.Remove$A, l#0, p#0) + 1)));
    havoc x#0;
    if (*)
    {
...
procedure Call$$_module.__default.Remove(_module._default.Remove$A: Ty, 
            ...
            true
              ...
              LitInt(0) <= p#6
                 ...
                 && _module.__default.sentinel()
                   <= $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int
               ==> _module.Node.next($Unbox(Seq#Index(_module.DList.nodes(l#0), p#6)): DatatypeType)
                 == (if $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int + 1
                     < Seq#Length(_module.DList.f(l#0))
                   then $Unbox(Seq#Index(_module.DList.f(l#0), $Unbox(Seq#Index(_module.DList.g(l#0), p#6)): int + 1)): int
                   else 0)));
  requires _module.__default.Inv#canCall(_module._default.Remove$A, l#0)
     ==> _module.__default.Inv(_module._default.Remove$A, l#0)
       || (_module.__default.Invs#canCall(_module._default.Remove$A, 
              ...
              $Unbox(Seq#Index(_module.DList.g(l#0), p#7)): int
               ...
               ==> true
                 && (if $Unbox(Seq#Index(_module.DList.g(l#0), p#7)): int > 0
                   then LitInt(0) <= $Unbox(Seq#Index(_module.DList.g(l#0), p#7)): int - 1
                       && $Unbox(Seq#Index(_module.DList.g(l#0), p#7)): int - 1
                         < Seq#Length(_module.DList.f(l#0))
                     ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#7)): DatatypeType)
                       == $Unbox(Seq#Index(_module.DList.f(l#0), $Unbox(Seq#Index(_module.DList.g(l#0), p#7)): int - 1)): int
                   else (if $Unbox(Seq#Index(_module.DList.g(l#0), p#7)): int == LitInt(0)
                       || Seq#Length(_module.DList.f(l#0)) == LitInt(0)
                     then _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#7)): DatatypeType)
                       == LitInt(0)
                     else LitInt(0) <= Seq#Length(_module.DList.f(l#0)) - 1
                       ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l#0), p#7)): DatatypeType)
                         == $Unbox(Seq#Index(_module.DList.f(l#0), Seq#Length(_module.DList.f(l#0)) - 1)): int))));
  requires _module.__default.ValidPtr#canCall(_module._default.Remove$A, l#0, p#0)
     ==> _module.__default.ValidPtr(_module._default.Remove$A, l#0, p#0)
       || ((0 < p#0 ==> LitInt(0) <= p#0) ==> (0 < p#0 ==> p#0 != 0) ==> 0 < p#0);
  requires _module.__default.ValidPtr#canCall(_module._default.Remove$A, l#0, p#0)
     ==> _module.__default.ValidPtr(_module._default.Remove$A, l#0, p#0)
       || (
        (0 < p#0
            ...
            true
              ...
              LitInt(0) <= p#27
                 ...
                 && _module.__default.sentinel()
                   <= $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int
               ==> _module.Node.next($Unbox(Seq#Index(_module.DList.nodes(l'#0), p#27)): DatatypeType)
                 == (if $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int + 1
                     < Seq#Length(_module.DList.f(l'#0))
                   then $Unbox(Seq#Index(_module.DList.f(l'#0), $Unbox(Seq#Index(_module.DList.g(l'#0), p#27)): int + 1)): int
                   else 0)));
  ensures _module.__default.Inv#canCall(_module._default.Remove$A, l'#0)
     ==> _module.__default.Inv(_module._default.Remove$A, l'#0)
       || (_module.__default.Invs#canCall(_module._default.Remove$A, 
              ...
              $Unbox(Seq#Index(_module.DList.g(l'#0), p#28)): int
               ...
               ==> true
                 && (if $Unbox(Seq#Index(_module.DList.g(l'#0), p#28)): int > 0
                   then LitInt(0) <= $Unbox(Seq#Index(_module.DList.g(l'#0), p#28)): int - 1
                       && $Unbox(Seq#Index(_module.DList.g(l'#0), p#28)): int - 1
                         < Seq#Length(_module.DList.f(l'#0))
                     ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l'#0), p#28)): DatatypeType)
                       == $Unbox(Seq#Index(_module.DList.f(l'#0), $Unbox(Seq#Index(_module.DList.g(l'#0), p#28)): int - 1)): int
                   else (if $Unbox(Seq#Index(_module.DList.g(l'#0), p#28)): int == LitInt(0)
                       || Seq#Length(_module.DList.f(l'#0)) == LitInt(0)
                     then _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l'#0), p#28)): DatatypeType)
                       == LitInt(0)
                     else LitInt(0) <= Seq#Length(_module.DList.f(l'#0)) - 1
                       ==> _module.Node.prev($Unbox(Seq#Index(_module.DList.nodes(l'#0), p#28)): DatatypeType)
                         == $Unbox(Seq#Index(_module.DList.f(l'#0), Seq#Length(_module.DList.f(l'#0)) - 1)): int))));
   ...
   returns (l'#0: DatatypeType, $_reverifyPost: bool)
{
  ...
  var ##a#2: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(250,0): initial state"} true;
    $_reverifyPost := false;
    havoc nodes#0;
    ...
    assume _module.DList.DList_q(let#0#0#0);
    assume #_module.DList.DList(nodes#0, freeStack#0, s#0, f#0, g#0) == let#0#0#0;
    // ----- assert statement ----- DLL_Dafny.dfy(252,3)
    assert {:subsumption 0} 0 <= p#0 && p#0 < Seq#Length(nodes#0);
    assume _module.Node.Node_q($Unbox(Seq#Index(nodes#0, p#0)): DatatypeType);
    assume _module.Node.Node_q($Unbox(Seq#Index(nodes#0, p#0)): DatatypeType);
    assert _module.Node.prev($Unbox(Seq#Index(nodes#0, p#0)): DatatypeType) != p#0;
    // ----- assignment statement ----- DLL_Dafny.dfy(254,19)
    assume true;
    assert 0 <= p#0 && p#0 < Seq#Length(g#0);
    assume true;
    index#0 := $Unbox(Seq#Index(g#0, p#0)): int;
    assume {:captureState "DLL_Dafny.dfy(254,25)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(255,16)
    assume true;
    assert 0 <= index#0 && index#0 <= Seq#Length(s#0);
    assert 0 <= index#0 + 1 && index#0 + 1 <= Seq#Length(s#0);
    assume true;
    s'#0 := Seq#Append(Seq#Take(s#0, index#0), Seq#Drop(s#0, index#0 + 1));
    assume {:captureState "DLL_Dafny.dfy(255,47)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(256,16)
    assume true;
    assert 0 <= index#0 && index#0 <= Seq#Length(f#0);
    assert 0 <= index#0 + 1 && index#0 + 1 <= Seq#Length(f#0);
    assume true;
    f'#0 := Seq#Append(Seq#Take(f#0, index#0), Seq#Drop(f#0, index#0 + 1));
    assume {:captureState "DLL_Dafny.dfy(256,47)"} true;
    // ----- call statement ----- DLL_Dafny.dfy(257,34)
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    g'#0 := $rhs##0;
    assume {:captureState "DLL_Dafny.dfy(257,43)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(260,12)
    assume true;
    ##s#0 := nodes#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##s#0, TSeq(Tclass._module.Node(_module._default.Remove$A)), $Heap);
    ##i#0 := p#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##i#0, TInt, $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#0;
    ...
    assume {:captureState "DLL_Dafny.dfy(260,31)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(261,17)
    assume true;
    assume _module.Node.Node_q(node#0);
    ##s#1 := nodes#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##s#1, TSeq(Tclass._module.Node(_module._default.Remove$A)), $Heap);
    ##i#1 := _module.Node.prev(node#0);
    // assume allocatedness for argument to function
    assume $IsAlloc(##i#1, TInt, $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#1;
    assert {:subsumption 0} ##i#1 < Seq#Length(##s#1);
    assume LitInt(0) <= ##i#1 && ##i#1 < Seq#Length(##s#1);
    ...
    node_prev#0 := $Unbox(_module.__default.seq__get(Tclass._module.Node(_module._default.Remove$A), 
        nodes#0, 
        _module.Node.prev(node#0))): DatatypeType;
    assume {:captureState "DLL_Dafny.dfy(261,44)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(262,9)
    assume true;
    assume _module.Node.Node_q(node#0);
    ...
    ##a#0 := (var dt_update_tmp#0#1 := node_prev#0; 
    ...
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#0, Tclass._module.Node(_module._default.Remove$A), $Heap);
      ...
      $Box((var dt_update_tmp#0#1 := node_prev#0; 
          (var dt_update#next#0#1 := _module.Node.next(node#0); 
            #_module.Node.Node(_module.Node.data(dt_update_tmp#0#1), 
              dt_update#next#0#1, 
              _module.Node.prev(dt_update_tmp#0#1))))));
    assume {:captureState "DLL_Dafny.dfy(262,67)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(263,17)
    assume true;
    assume _module.Node.Node_q(node#0);
    ##s#2 := nodes#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##s#2, TSeq(Tclass._module.Node(_module._default.Remove$A)), $Heap);
    ##i#3 := _module.Node.next(node#0);
    // assume allocatedness for argument to function
    assume $IsAlloc(##i#3, TInt, $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#3;
    assert {:subsumption 0} ##i#3 < Seq#Length(##s#2);
    assume LitInt(0) <= ##i#3 && ##i#3 < Seq#Length(##s#2);
    assume _module.__default.seq__get#canCall(Tclass._module.Node(_module._default.Remove$A), 
      nodes#0, 
    ...
    node_next#0 := $Unbox(_module.__default.seq__get(Tclass._module.Node(_module._default.Remove$A), 
        nodes#0, 
        _module.Node.next(node#0))): DatatypeType;
    assume {:captureState "DLL_Dafny.dfy(263,44)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(264,9)
    assume true;
    assume _module.Node.Node_q(node#0);
    ...
    ##a#1 := (var dt_update_tmp#1#1 := node_next#0; 
      ...
      $Box((var dt_update_tmp#1#1 := node_next#0; 
          (var dt_update#prev#0#1 := _module.Node.prev(node#0); 
            #_module.Node.Node(_module.Node.data(dt_update_tmp#1#1), 
              _module.Node.next(dt_update_tmp#1#1), 
              dt_update#prev#0#1)))));
    assume {:captureState "DLL_Dafny.dfy(264,67)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(265,9)
    assume true;
    ##s1#2 := nodes#0;
    // assume allocatedness for argument to function
    ...
    ##a#2 := #_module.Node.Node(Lit(#_module.Option.None()), freeStack#0, LitInt(0));
    // assume allocatedness for argument to function
    ...
    nodes#0 := _module.__default.seq__set(Tclass._module.Node(_module._default.Remove$A), 
      ...
      p#0, 
      $Box(#_module.Node.Node(Lit(#_module.Option.None()), freeStack#0, LitInt(0))));
    assume {:captureState "DLL_Dafny.dfy(265,54)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(266,6)
    assume true;
    assume true;
    l'#0 := #_module.DList.DList(nodes#0, p#0, s'#0, f'#0, g'#0);
    assume {:captureState "DLL_Dafny.dfy(266,35)"} true;
}
...
implementation CheckWellformed$$_module.__default.InsertAfter__SeqInit(g#0: Seq Box, p'#0: int, index#0: int, index'#0: int) returns (g'#0: Seq Box)
{
  ...
  var x#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(269,13): initial state"} true;
    havoc $Heap;
    assume old($Heap) == $Heap;
    havoc g'#0;
    assume {:captureState "DLL_Dafny.dfy(270,15): post-state"} true;
    assume Seq#Length(g'#0) == Seq#Length(g#0);
    havoc x#0;
    if (*)
    {
   ...
   returns (g'#0: Seq Box, $_reverifyPost: bool)
{
  ...
  var lambdaResult#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(275,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- DLL_Dafny.dfy(276,8)
    assume true;
    assert 0 <= Seq#Length(g#0);
    havoc x#2;
    // Begin Comprehension WF check
      ...
      Lit(AtLayer((lambda $l#2#ly#0: LayerType :: 
            Handle1((lambda $l#2#heap#0: Heap, $l#2#x#0: Box :: 
              ...
              (lambda $l#2#heap#0: Heap, $l#2#x#0: Box :: 
                SetRef_to_SetBox((lambda $l#2#o#0: ref :: false))))), 
          $LS($LZ))));
    assume {:captureState "DLL_Dafny.dfy(277,74)"} true;
}
   ...
   returns (l'#0: DatatypeType, p'#0: int)
{
  ...
  var ##p#11: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(281,7): initial state"} true;
    ##l#0 := l#0;
    // assume allocatedness for argument to function
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc l'#0, p'#0;
    assume {:captureState "DLL_Dafny.dfy(284,13): post-state"} true;
    ##l#2 := l'#0;
    // assume allocatedness for argument to function
    ...
    assert 0 <= _module.__default.Index(_module._default.InsertAfter$A, l#0, p#0) + 1
       && _module.__default.Index(_module._default.InsertAfter$A, l#0, p#0) + 1
         <= Seq#Length(_module.__default.Seq(_module._default.InsertAfter$A, l#0));
    ##l#6 := l#0;
    // assume allocatedness for argument to function
    ...
    assume Seq#Equal(_module.__default.Seq(_module._default.InsertAfter$A, l'#0), 
      Seq#Append(Seq#Append(Seq#Take(_module.__default.Seq(_module._default.InsertAfter$A, l#0), 
            _module.__default.Index(_module._default.InsertAfter$A, l#0, p#0) + 1), 
          Seq#Build(Seq#Empty(): Seq Box, a#0)), 
        Seq#Drop(_module.__default.Seq(_module._default.InsertAfter$A, l#0), 
          _module.__default.Index(_module._default.InsertAfter$A, l#0, p#0) + 1)));
    ##l#8 := l'#0;
    // assume allocatedness for argument to function
   ...
   returns (l'#0: DatatypeType, p'#0: int, $_reverifyPost: bool)
{
  ...
  var ##a#2: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(289,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- DLL_Dafny.dfy(290,6)
    assume true;
    assume true;
    l'#0 := l#0;
    assume {:captureState "DLL_Dafny.dfy(290,9)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(291,6)
    assume true;
    assume _module.DList.DList_q(l'#0);
    assume _module.DList.DList_q(l'#0);
    p'#0 := _module.DList.freeStack(l'#0);
    assume {:captureState "DLL_Dafny.dfy(291,20)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(292,16)
    assume true;
    assume _module.DList.DList_q(l'#0);
    ##s#0 := _module.DList.nodes(l'#0);
    // assume allocatedness for argument to function
    assume $IsAlloc(##s#0, TSeq(Tclass._module.Node(_module._default.InsertAfter$A)), $Heap);
    ##i#0 := p'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##i#0, TInt, $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#0;
    ...
    freeNode#0 := $Unbox(_module.__default.seq__get(Tclass._module.Node(_module._default.InsertAfter$A), 
        _module.DList.nodes(l'#0), 
        p'#0)): DatatypeType;
    assume {:captureState "DLL_Dafny.dfy(292,39)"} true;
    // ----- if statement ----- DLL_Dafny.dfy(293,3)
    if (p'#0 != LitInt(0))
    {
    ...
    {
        // ----- call statement ----- DLL_Dafny.dfy(294,17)
        assume true;
        ...
        // TrCallStmt: After ProcessCallStmt
        l'#0 := $rhs##0_0;
        assume {:captureState "DLL_Dafny.dfy(294,20)"} true;
        // ----- assignment statement ----- DLL_Dafny.dfy(295,8)
        assume true;
        assume _module.DList.DList_q(l'#0);
        assume _module.DList.DList_q(l'#0);
        p'#0 := _module.DList.freeStack(l'#0);
        assume {:captureState "DLL_Dafny.dfy(295,22)"} true;
        // ----- assignment statement ----- DLL_Dafny.dfy(296,14)
        assume true;
        assume _module.DList.DList_q(l'#0);
        ...
        freeNode#0 := $Unbox(_module.__default.seq__get(Tclass._module.Node(_module._default.InsertAfter$A), 
            _module.DList.nodes(l'#0), 
            p'#0)): DatatypeType;
        assume {:captureState "DLL_Dafny.dfy(296,37)"} true;
    }
    else
    {
    }
    ...
    assume _module.DList.DList_q(let#0#0#0);
    assume #_module.DList.DList(nodes#0, freeStack#0, s#0, f#0, g#0) == let#0#0#0;
    // ----- assignment statement ----- DLL_Dafny.dfy(299,19)
    assume true;
    assert 0 <= p#0 && p#0 < Seq#Length(g#0);
    assume true;
    index#0 := $Unbox(Seq#Index(g#0, p#0)): int;
    assume {:captureState "DLL_Dafny.dfy(299,25)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(300,20)
    assume true;
    assume true;
    index'#0 := index#0 + 1;
    assume {:captureState "DLL_Dafny.dfy(300,31)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(301,16)
    assume true;
    assert 0 <= index'#0 && index'#0 <= Seq#Length(s#0);
    assert 0 <= index'#0 && index'#0 <= Seq#Length(s#0);
    assume true;
    s'#0 := Seq#Append(Seq#Append(Seq#Take(s#0, index'#0), Seq#Build(Seq#Empty(): Seq Box, a#0)), 
      Seq#Drop(s#0, index'#0));
    assume {:captureState "DLL_Dafny.dfy(301,51)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(302,16)
    assume true;
    assert 0 <= index'#0 && index'#0 <= Seq#Length(f#0);
    assert 0 <= index'#0 && index'#0 <= Seq#Length(f#0);
    assume true;
    f'#0 := Seq#Append(Seq#Append(Seq#Take(f#0, index'#0), Seq#Build(Seq#Empty(): Seq Box, $Box(p'#0))), 
      Seq#Drop(f#0, index'#0));
    assume {:captureState "DLL_Dafny.dfy(302,52)"} true;
    // ----- call statement ----- DLL_Dafny.dfy(303,39)
    assume true;
    // TrCallStmt: Adding lhs Microsoft.Dafny.AutoGhostIdentifierExpr with type seq<int>
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    g'#0 := $rhs##0;
    assume {:captureState "DLL_Dafny.dfy(303,60)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(306,12)
    assume true;
    ##s#1 := nodes#0;
    // assume allocatedness for argument to function
    ...
    assume {:captureState "DLL_Dafny.dfy(306,31)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(307,13)
    assume true;
    assume _module.Node.Node_q(node#0);
    assume _module.Node.Node_q(node#0);
    node'#0 := #_module.Node.Node(#_module.Option.Some(a#0), _module.Node.next(node#0), p#0);
    assume {:captureState "DLL_Dafny.dfy(307,42)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(308,9)
    assume true;
    havoc dt_update_tmp#0#0;
    ...
    // assume allocatedness for argument to function
    assume $IsAlloc(##i#2, TInt, $Heap);
    ##a#0 := (var dt_update_tmp#0#1 := node#0; 
      (var dt_update#next#0#1 := p'#0; 
        #_module.Node.Node(_module.Node.data(dt_update_tmp#0#1), 
          dt_update#next#0#1, 
          _module.Node.prev(dt_update_tmp#0#1))));
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#0, Tclass._module.Node(_module._default.InsertAfter$A), $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#2;
    assert {:subsumption 0} ##i#2 < Seq#Length(##s1#0);
    assume LitInt(0) <= ##i#2 && ##i#2 < Seq#Length(##s1#0);
      ...
      $Box((var dt_update_tmp#0#1 := node#0; 
          (var dt_update#next#0#1 := p'#0; 
            #_module.Node.Node(_module.Node.data(dt_update_tmp#0#1), 
              dt_update#next#0#1, 
              _module.Node.prev(dt_update_tmp#0#1))))));
    assume {:captureState "DLL_Dafny.dfy(308,47)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(309,17)
    assume true;
    assume _module.Node.Node_q(node#0);
    ##s#2 := nodes#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##s#2, TSeq(Tclass._module.Node(_module._default.InsertAfter$A)), $Heap);
    ##i#3 := _module.Node.next(node#0);
    // assume allocatedness for argument to function
    assume $IsAlloc(##i#3, TInt, $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#3;
    ...
    node_next#0 := $Unbox(_module.__default.seq__get(Tclass._module.Node(_module._default.InsertAfter$A), 
        nodes#0, 
        _module.Node.next(node#0))): DatatypeType;
    assume {:captureState "DLL_Dafny.dfy(309,44)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(310,9)
    assume true;
    assume _module.Node.Node_q(node#0);
    havoc dt_update_tmp#1#0;
    ...
    ##a#1 := (var dt_update_tmp#1#1 := node_next#0; 
      (var dt_update#prev#0#1 := p'#0; 
        #_module.Node.Node(_module.Node.data(dt_update_tmp#1#1), 
          ...
          dt_update#prev#0#1)));
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#1, Tclass._module.Node(_module._default.InsertAfter$A), $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#4;
    assert {:subsumption 0} ##i#4 < Seq#Length(##s1#1);
    assume LitInt(0) <= ##i#4 && ##i#4 < Seq#Length(##s1#1);
    assume _module.__default.seq__set#canCall(Tclass._module.Node(_module._default.InsertAfter$A), 
      ...
      $Box((var dt_update_tmp#1#1 := node_next#0; 
          (var dt_update#prev#0#1 := p'#0; 
            #_module.Node.Node(_module.Node.data(dt_update_tmp#1#1), 
              _module.Node.next(dt_update_tmp#1#1), 
              dt_update#prev#0#1)))));
    assume {:captureState "DLL_Dafny.dfy(310,60)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(311,9)
    assume true;
    ##s1#2 := nodes#0;
    // assume allocatedness for argument to function
    ...
    ##a#2 := node'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#2, Tclass._module.Node(_module._default.InsertAfter$A), $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#5;
    assert {:subsumption 0} ##i#5 < Seq#Length(##s1#2);
    assume LitInt(0) <= ##i#5 && ##i#5 < Seq#Length(##s1#2);
    assume _module.__default.seq__set#canCall(Tclass._module.Node(_module._default.InsertAfter$A), 
...
implementation CheckWellformed$$_module.__default.InsertBefore__SeqInit(g#0: Seq Box, p'#0: int, index'#0: int) returns (g'#0: Seq Box)
{
  ...
  var x#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(315,13): initial state"} true;
    havoc $Heap;
    assume old($Heap) == $Heap;
    havoc g'#0;
    assume {:captureState "DLL_Dafny.dfy(316,15): post-state"} true;
    assume Seq#Length(g'#0) == Seq#Length(g#0);
    havoc x#0;
    if (*)
    {
   ...
   returns (g'#0: Seq Box, $_reverifyPost: bool)
{
  ...
  var lambdaResult#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(321,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- DLL_Dafny.dfy(322,8)
    assume true;
    assert 0 <= Seq#Length(g#0);
    havoc x#2;
    // Begin Comprehension WF check
      ...
      Lit(AtLayer((lambda $l#2#ly#0: LayerType :: 
            Handle1((lambda $l#2#heap#0: Heap, $l#2#x#0: Box :: 
              ...
              (lambda $l#2#heap#0: Heap, $l#2#x#0: Box :: 
                SetRef_to_SetBox((lambda $l#2#o#0: ref :: false))))), 
          $LS($LZ))));
    assume {:captureState "DLL_Dafny.dfy(323,76)"} true;
}
   ...
   returns (l'#0: DatatypeType, p'#0: int)
{
  ...
  var ##p#11: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(327,7): initial state"} true;
    ##l#0 := l#0;
    // assume allocatedness for argument to function
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc l'#0, p'#0;
    assume {:captureState "DLL_Dafny.dfy(330,13): post-state"} true;
    ##l#2 := l'#0;
    // assume allocatedness for argument to function
    ...
    assert 0 <= _module.__default.IndexHi(_module._default.InsertBefore$A, l#0, p#0)
       && _module.__default.IndexHi(_module._default.InsertBefore$A, l#0, p#0)
         <= Seq#Length(_module.__default.Seq(_module._default.InsertBefore$A, l#0));
    ##l#6 := l#0;
    // assume allocatedness for argument to function
    ...
    assume Seq#Equal(_module.__default.Seq(_module._default.InsertBefore$A, l'#0), 
      Seq#Append(Seq#Append(Seq#Take(_module.__default.Seq(_module._default.InsertBefore$A, l#0), 
            _module.__default.IndexHi(_module._default.InsertBefore$A, l#0, p#0)), 
          Seq#Build(Seq#Empty(): Seq Box, a#0)), 
        Seq#Drop(_module.__default.Seq(_module._default.InsertBefore$A, l#0), 
          _module.__default.IndexHi(_module._default.InsertBefore$A, l#0, p#0))));
    ##l#8 := l'#0;
    // assume allocatedness for argument to function
   ...
   returns (l'#0: DatatypeType, p'#0: int, $_reverifyPost: bool)
{
  ...
  var ##a#2: DatatypeType;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(335,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- DLL_Dafny.dfy(336,6)
    assume true;
    assume true;
    l'#0 := l#0;
    assume {:captureState "DLL_Dafny.dfy(336,9)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(337,6)
    assume true;
    assume _module.DList.DList_q(l'#0);
    assume _module.DList.DList_q(l'#0);
    p'#0 := _module.DList.freeStack(l'#0);
    assume {:captureState "DLL_Dafny.dfy(337,20)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(338,16)
    assume true;
    assume _module.DList.DList_q(l'#0);
    ##s#0 := _module.DList.nodes(l'#0);
    // assume allocatedness for argument to function
    assume $IsAlloc(##s#0, TSeq(Tclass._module.Node(_module._default.InsertBefore$A)), $Heap);
    ##i#0 := p'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##i#0, TInt, $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#0;
    ...
    freeNode#0 := $Unbox(_module.__default.seq__get(Tclass._module.Node(_module._default.InsertBefore$A), 
        _module.DList.nodes(l'#0), 
        p'#0)): DatatypeType;
    assume {:captureState "DLL_Dafny.dfy(338,39)"} true;
    // ----- if statement ----- DLL_Dafny.dfy(339,3)
    if (p'#0 != LitInt(0))
    {
        assume _module.Node.Node_q(freeNode#0);
    }
    ...
    if (p'#0 == LitInt(0) || _module.Option.Some_q(_module.Node.data(freeNode#0)))
    {
        // ----- call statement ----- DLL_Dafny.dfy(340,17)
        assume true;
        // TrCallStmt: Adding lhs Microsoft.Dafny.IdentifierExpr with type DList<A>
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        ...
        // TrCallStmt: After ProcessCallStmt
        l'#0 := $rhs##0_0;
        assume {:captureState "DLL_Dafny.dfy(340,20)"} true;
        // ----- assignment statement ----- DLL_Dafny.dfy(341,8)
        assume true;
        assume _module.DList.DList_q(l'#0);
        assume _module.DList.DList_q(l'#0);
        p'#0 := _module.DList.freeStack(l'#0);
        assume {:captureState "DLL_Dafny.dfy(341,22)"} true;
        // ----- assignment statement ----- DLL_Dafny.dfy(342,14)
        assume true;
        assume _module.DList.DList_q(l'#0);
        ##s#0_0 := _module.DList.nodes(l'#0);
        // assume allocatedness for argument to function
        ...
        freeNode#0 := $Unbox(_module.__default.seq__get(Tclass._module.Node(_module._default.InsertBefore$A), 
            _module.DList.nodes(l'#0), 
            p'#0)): DatatypeType;
        assume {:captureState "DLL_Dafny.dfy(342,37)"} true;
    }
    else
    {
    }
    ...
    assume _module.DList.DList_q(let#0#0#0);
    assume #_module.DList.DList(nodes#0, freeStack#0, s#0, f#0, g#0) == let#0#0#0;
    // ----- assignment statement ----- DLL_Dafny.dfy(345,20)
    assume true;
    ##l#17 := l#0;
    // assume allocatedness for argument to function
    ...
    assume {:captureState "DLL_Dafny.dfy(345,35)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(346,16)
    assume true;
    assert 0 <= index'#0 && index'#0 <= Seq#Length(s#0);
    assert 0 <= index'#0 && index'#0 <= Seq#Length(s#0);
    assume true;
    s'#0 := Seq#Append(Seq#Append(Seq#Take(s#0, index'#0), Seq#Build(Seq#Empty(): Seq Box, a#0)), 
      Seq#Drop(s#0, index'#0));
    assume {:captureState "DLL_Dafny.dfy(346,51)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(347,16)
    assume true;
    assert 0 <= index'#0 && index'#0 <= Seq#Length(f#0);
    assert 0 <= index'#0 && index'#0 <= Seq#Length(f#0);
    assume true;
    f'#0 := Seq#Append(Seq#Append(Seq#Take(f#0, index'#0), Seq#Build(Seq#Empty(): Seq Box, $Box(p'#0))), 
      Seq#Drop(f#0, index'#0));
    assume {:captureState "DLL_Dafny.dfy(347,52)"} true;
    // ----- call statement ----- DLL_Dafny.dfy(348,40)
    assume true;
    // TrCallStmt: Adding lhs Microsoft.Dafny.AutoGhostIdentifierExpr with type seq<int>
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    g'#0 := $rhs##0;
    assume {:captureState "DLL_Dafny.dfy(348,54)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(351,12)
    assume true;
    ##s#1 := nodes#0;
    // assume allocatedness for argument to function
    ...
    assume {:captureState "DLL_Dafny.dfy(351,31)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(352,13)
    assume true;
    assume _module.Node.Node_q(node#0);
    assume _module.Node.Node_q(node#0);
    node'#0 := #_module.Node.Node(#_module.Option.Some(a#0), p#0, _module.Node.prev(node#0));
    assume {:captureState "DLL_Dafny.dfy(352,42)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(353,9)
    assume true;
    havoc dt_update_tmp#0#0;
    ...
    ##a#0 := (var dt_update_tmp#0#1 := node#0; 
      (var dt_update#prev#0#1 := p'#0; 
        #_module.Node.Node(_module.Node.data(dt_update_tmp#0#1), 
          ...
          dt_update#prev#0#1)));
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#0, Tclass._module.Node(_module._default.InsertBefore$A), $Heap);
    assert {:subsumption 0} LitInt(0) <= ##i#2;
    assert {:subsumption 0} ##i#2 < Seq#Length(##s1#0);
    assume LitInt(0) <= ##i#2 && ##i#2 < Seq#Length(##s1#0);
      ...
      $Box((var dt_update_tmp#0#1 := node#0; 
          (var dt_update#prev#0#1 := p'#0; 
            #_module.Node.Node(_module.Node.data(dt_update_tmp#0#1), 
              _module.Node.next(dt_update_tmp#0#1), 
              dt_update#prev#0#1)))));
    assume {:captureState "DLL_Dafny.dfy(353,47)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(354,17)
    assume true;
    assume _module.Node.Node_q(node#0);
    ##s#2 := nodes#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##s#2, TSeq(Tclass._module.Node(_module._default.InsertBefore$A)), $Heap);
    ...
    node_prev#0 := $Unbox(_module.__default.seq__get(Tclass._module.Node(_module._default.InsertBefore$A), 
        nodes#0, 
        _module.Node.prev(node#0))): DatatypeType;
    assume {:captureState "DLL_Dafny.dfy(354,44)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(355,9)
    assume true;
    assume _module.Node.Node_q(node#0);
    havoc dt_update_tmp#1#0;
    ...
    // assume allocatedness for argument to function
    assume $IsAlloc(##i#4, TInt, $Heap);
    ##a#1 := (var dt_update_tmp#1#1 := node_prev#0; 
      (var dt_update#next#0#1 := p'#0; 
        #_module.Node.Node(_module.Node.data(dt_update_tmp#1#1), 
          dt_update#next#0#1, 
      ...
      $Box((var dt_update_tmp#1#1 := node_prev#0; 
          (var dt_update#next#0#1 := p'#0; 
            #_module.Node.Node(_module.Node.data(dt_update_tmp#1#1), 
              dt_update#next#0#1, 
              _module.Node.prev(dt_update_tmp#1#1))))));
    assume {:captureState "DLL_Dafny.dfy(355,60)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(356,9)
    assume true;
    ##s1#2 := nodes#0;
    // assume allocatedness for argument to function
    ...
    nodes#0 := _module.__default.seq__set(Tclass._module.Node(_module._default.InsertBefore$A), 
      ...
      p'#0, 
      $Box(node'#0));
    assume {:captureState "DLL_Dafny.dfy(356,36)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(357,6)
    assume true;
    assume _module.Node.Node_q(freeNode#0);
    assume _module.Node.Node_q(freeNode#0);
    l'#0 := #_module.DList.DList(nodes#0, _module.Node.next(freeNode#0), s'#0, f'#0, g'#0);
    assume {:captureState "DLL_Dafny.dfy(357,47)"} true;
}
   ...
   returns (l'#0: DatatypeType, $_reverifyPost: bool)
{
  ...
  var ##s#0: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "DLL_Dafny.dfy(362,0): initial state"} true;
    $_reverifyPost := false;
    havoc nodes#0;
    ...
    assume _module.DList.DList_q(let#0#0#0);
    assume #_module.DList.DList(nodes#0, freeStack#0, s#0, f#0, g#0) == let#0#0#0;
    // ----- call statement ----- DLL_Dafny.dfy(365,29)
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    nodes'#0 := $rhs##0;
    assume {:captureState "DLL_Dafny.dfy(365,57)"} true;
    // ----- assignment statement ----- DLL_Dafny.dfy(366,6)
    assume true;
    assume true;
    l'#0 := #_module.DList.DList(nodes'#0, freeStack#0, s#0, f#0, g#0);
    assume {:captureState "DLL_Dafny.dfy(366,41)"} true;
}
