...
(declare-fun |lambda#29| (Int Int Int) T@U)
(declare-fun |lambda#30| (T@U) T@U)
(declare-fun |lambda#31| (Bool) T@U)
(declare-fun |lambda#32| (T@U) T@U)
...
(declare-fun |lambda#42| (Int T@U Int) T@U)
(declare-fun |lambda#43| (T@U Int Int) T@U)
...
(declare-fun |lambda#55| (T@U Int Int T@U Int T@U Int T@U) T@U)
...
(declare-fun |lambda#70| (Int Int T@U Int T@U Int T@U) T@U)
...
(declare-fun |lambda#85| (Int Int T@U Int T@U Int T@U) T@U)
...
(assert (forall ((arg0@@240 T@U) (arg1@@108 T@U) (arg2@@64 Int) ) (! (= (type (_module.__default.seq__get arg0@@240 arg1@@108 arg2@@64)) BoxType)
 :qid |funType:_module.__default.seq__get|
 :pattern ( (_module.__default.seq__get arg0@@240 arg1@@108 arg2@@64))
)))
(assert  (=> (<= 14 $FunctionContextHeight) (forall ((_module._default.seq_get$A T@U) (|s#0| T@U) (|i#0| Int) ) (!  (=> (and (and (= (type _module._default.seq_get$A) TyType) (= (type |s#0|) (SeqType BoxType))) (or (|_module.__default.seq__get#canCall| _module._default.seq_get$A |s#0| |i#0|) (and (not (= 14 $FunctionContextHeight)) (and ($Is |s#0| (TSeq _module._default.seq_get$A)) (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |s#0|))))))) (and (= (_module.__default.seq__get _module._default.seq_get$A |s#0| |i#0|) (|Seq#Index| |s#0| |i#0|)) ($IsBox (_module.__default.seq__get _module._default.seq_get$A |s#0| |i#0|) _module._default.seq_get$A)))
 :qid |unknown.0:0|
 :skolemid |1006|
 :pattern ( (_module.__default.seq__get _module._default.seq_get$A |s#0| |i#0|))
))))
(assert (forall ((_module._default.seq_get$A@@0 T@U) (|s#0@@0| T@U) (|i#0@@0| Int) ) (!  (=> (and (and (= (type _module._default.seq_get$A@@0) TyType) (= (type |s#0@@0|) (SeqType BoxType))) ($Is |s#0@@0| (TSeq _module._default.seq_get$A@@0))) (and (=> (|_module.__default.seq__get#requires| _module._default.seq_get$A@@0 |s#0@@0| |i#0@@0|) (and (<= 0 |i#0@@0|) (< |i#0@@0| (|Seq#Length| |s#0@@0|)))) (=> (and (<= 0 |i#0@@0|) (< |i#0@@0| (|Seq#Length| |s#0@@0|))) (|_module.__default.seq__get#requires| _module._default.seq_get$A@@0 |s#0@@0| |i#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |1007|
 :pattern ( (|_module.__default.seq__get#requires| _module._default.seq_get$A@@0 |s#0@@0| |i#0@@0|))
)))
(assert (forall ((arg0@@241 T@U) (arg1@@109 T@U) (arg2@@65 Int) (arg3@@41 T@U) ) (! (= (type (_module.__default.seq__set arg0@@241 arg1@@109 arg2@@65 arg3@@41)) (SeqType BoxType))
 :qid |funType:_module.__default.seq__set|
 :pattern ( (_module.__default.seq__set arg0@@241 arg1@@109 arg2@@65 arg3@@41))
)))
(assert  (=> (<= 19 $FunctionContextHeight) (forall ((_module._default.seq_set$A T@U) (|s1#0| T@U) (|i#0@@1| Int) (|a#0| T@U) ) (!  (=> (and (and (and (= (type _module._default.seq_set$A) TyType) (= (type |s1#0|) (SeqType BoxType))) (= (type |a#0|) BoxType)) (or (|_module.__default.seq__set#canCall| _module._default.seq_set$A |s1#0| |i#0@@1| |a#0|) (and (not (= 19 $FunctionContextHeight)) (and (and ($Is |s1#0| (TSeq _module._default.seq_set$A)) ($IsBox |a#0| _module._default.seq_set$A)) (and (<= 0 |i#0@@1|) (< |i#0@@1| (|Seq#Length| |s1#0|))))))) (and (|Seq#Equal| (_module.__default.seq__set _module._default.seq_set$A |s1#0| |i#0@@1| |a#0|) (|Seq#Update| |s1#0| |i#0@@1| |a#0|)) ($Is (_module.__default.seq__set _module._default.seq_set$A |s1#0| |i#0@@1| |a#0|) (TSeq _module._default.seq_set$A))))
 :qid |unknown.0:0|
 :skolemid |1008|
 :pattern ( (_module.__default.seq__set _module._default.seq_set$A |s1#0| |i#0@@1| |a#0|))
))))
(assert (forall ((_module._default.seq_set$A@@0 T@U) (|s1#0@@0| T@U) (|i#0@@2| Int) (|a#0@@0| T@U) ) (!  (=> (and (and (and (= (type _module._default.seq_set$A@@0) TyType) (= (type |s1#0@@0|) (SeqType BoxType))) (= (type |a#0@@0|) BoxType)) (and ($Is |s1#0@@0| (TSeq _module._default.seq_set$A@@0)) ($IsBox |a#0@@0| _module._default.seq_set$A@@0))) (and (=> (|_module.__default.seq__set#requires| _module._default.seq_set$A@@0 |s1#0@@0| |i#0@@2| |a#0@@0|) (and (<= 0 |i#0@@2|) (< |i#0@@2| (|Seq#Length| |s1#0@@0|)))) (=> (and (<= 0 |i#0@@2|) (< |i#0@@2| (|Seq#Length| |s1#0@@0|))) (|_module.__default.seq__set#requires| _module._default.seq_set$A@@0 |s1#0@@0| |i#0@@2| |a#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |1009|
 :pattern ( (|_module.__default.seq__set#requires| _module._default.seq_set$A@@0 |s1#0@@0| |i#0@@2| |a#0@@0|))
)))
(assert  (=> (<= 18 $FunctionContextHeight) (forall ((_module._default.seq_length$A T@U) (|s#0@@1| T@U) ) (!  (=> (and (and (= (type _module._default.seq_length$A) TyType) (= (type |s#0@@1|) (SeqType BoxType))) (or (|_module.__default.seq_length#canCall| _module._default.seq_length$A |s#0@@1|) (and (not (= 18 $FunctionContextHeight)) ($Is |s#0@@1| (TSeq _module._default.seq_length$A))))) (= (_module.__default.seq_length _module._default.seq_length$A |s#0@@1|) (|Seq#Length| |s#0@@1|)))
 :qid |unknown.0:0|
 :skolemid |1010|
 :pattern ( (_module.__default.seq_length _module._default.seq_length$A |s#0@@1|))
))))
(assert (forall ((_module._default.seq_length$A@@0 T@U) (|s#0@@2| T@U) ) (!  (=> (and (and (= (type _module._default.seq_length$A@@0) TyType) (= (type |s#0@@2|) (SeqType BoxType))) ($Is |s#0@@2| (TSeq _module._default.seq_length$A@@0))) (and (=> (|_module.__default.seq_length#requires| _module._default.seq_length$A@@0 |s#0@@2|) true) (=> true (|_module.__default.seq_length#requires| _module._default.seq_length$A@@0 |s#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |1011|
 :pattern ( (|_module.__default.seq_length#requires| _module._default.seq_length$A@@0 |s#0@@2|))
)))
(assert (forall ((arg0@@242 T@U) ) (! (= (type (_module.__default.seq_empty arg0@@242)) (SeqType BoxType))
 :qid |funType:_module.__default.seq_empty|
 :pattern ( (_module.__default.seq_empty arg0@@242))
)))
(assert  (=> (<= 34 $FunctionContextHeight) (forall ((_module._default.seq_empty$A T@U) ) (!  (=> (and (= (type _module._default.seq_empty$A) TyType) (or (|_module.__default.seq_empty#canCall| _module._default.seq_empty$A) (not (= 34 $FunctionContextHeight)))) (and (= (|Seq#Length| (_module.__default.seq_empty _module._default.seq_empty$A)) 0) ($Is (_module.__default.seq_empty _module._default.seq_empty$A) (TSeq _module._default.seq_empty$A))))
 :qid |unknown.0:0|
 :skolemid |1012|
...
(assert (forall ((arg0@@243 T@U) (arg1@@110 Int) (arg2@@66 T@U) ) (! (= (type (_module.__default.seq_alloc arg0@@243 arg1@@110 arg2@@66)) (SeqType BoxType))
 :qid |funType:_module.__default.seq_alloc|
 :pattern ( (_module.__default.seq_alloc arg0@@243 arg1@@110 arg2@@66))
)))
(assert  (=> (<= 21 $FunctionContextHeight) (forall ((_module._default.seq_alloc$A T@U) (|length#0| Int) (|a#0@@1| T@U) ) (!  (=> (and (and (= (type _module._default.seq_alloc$A) TyType) (= (type |a#0@@1|) BoxType)) (or (|_module.__default.seq_alloc#canCall| _module._default.seq_alloc$A |length#0| |a#0@@1|) (and (not (= 21 $FunctionContextHeight)) ($IsBox |a#0@@1| _module._default.seq_alloc$A)))) (and (and (= (|Seq#Length| (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@1|)) |length#0|) (forall ((|i#0@@3| Int) ) (!  (=> true (=> (and (<= 0 |i#0@@3|) (< |i#0@@3| (|Seq#Length| (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@1|)))) (= (|Seq#Index| (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@1|) |i#0@@3|) |a#0@@1|)))
 :qid |DLLDafny.26:18|
 :skolemid |1014|
 :pattern ( (|Seq#Index| (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@1|) |i#0@@3|))
))) ($Is (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@1|) (TSeq _module._default.seq_alloc$A))))
 :qid |unknown.0:0|
 :skolemid |1015|
 :pattern ( (_module.__default.seq_alloc _module._default.seq_alloc$A |length#0| |a#0@@1|))
))))
(assert (forall ((_module._default.seq_alloc$A@@0 T@U) (|length#0@@0| Int) (|a#0@@2| T@U) ) (!  (=> (and (and (= (type _module._default.seq_alloc$A@@0) TyType) (= (type |a#0@@2|) BoxType)) ($IsBox |a#0@@2| _module._default.seq_alloc$A@@0)) (and (=> (|_module.__default.seq_alloc#requires| _module._default.seq_alloc$A@@0 |length#0@@0| |a#0@@2|) true) (=> true (|_module.__default.seq_alloc#requires| _module._default.seq_alloc$A@@0 |length#0@@0| |a#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |1016|
 :pattern ( (|_module.__default.seq_alloc#requires| _module._default.seq_alloc$A@@0 |length#0@@0| |a#0@@2|))
)))
(assert (forall ((arg0@@244 T@U) (arg1@@111 T@U) ) (! (= (type (_module.__default.seq_free arg0@@244 arg1@@111)) DatatypeTypeType)
 :qid |funType:_module.__default.seq_free|
 :pattern ( (_module.__default.seq_free arg0@@244 arg1@@111))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((_module._default.seq_free$A T@U) (|s#0@@3| T@U) ) (!  (=> (and (and (= (type _module._default.seq_free$A) TyType) (= (type |s#0@@3|) (SeqType BoxType))) (or (|_module.__default.seq_free#canCall| _module._default.seq_free$A |s#0@@3|) (and (not (= 4 $FunctionContextHeight)) ($Is |s#0@@3| (TSeq _module._default.seq_free$A))))) ($Is (_module.__default.seq_free _module._default.seq_free$A |s#0@@3|) Tclass._System.Tuple0))
 :qid |unknown.0:0|
 :skolemid |1019|
 :pattern ( (_module.__default.seq_free _module._default.seq_free$A |s#0@@3|))
))))
(assert (forall ((_module._default.seq_free$A@@0 T@U) (|s#0@@4| T@U) ) (!  (=> (and (and (= (type _module._default.seq_free$A@@0) TyType) (= (type |s#0@@4|) (SeqType BoxType))) ($Is |s#0@@4| (TSeq _module._default.seq_free$A@@0))) (and (=> (|_module.__default.seq_free#requires| _module._default.seq_free$A@@0 |s#0@@4|) true) (=> true (|_module.__default.seq_free#requires| _module._default.seq_free$A@@0 |s#0@@4|))))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( (|_module.__default.seq_free#requires| _module._default.seq_free$A@@0 |s#0@@4|))
)))
(assert (forall ((arg0@@245 T@U) (arg1@@112 T@U) ) (! (= (type (_module.__default.seq_unleash arg0@@245 arg1@@112)) (SeqType BoxType))
 :qid |funType:_module.__default.seq_unleash|
 :pattern ( (_module.__default.seq_unleash arg0@@245 arg1@@112))
)))
(assert  (=> (<= 35 $FunctionContextHeight) (forall ((_module._default.seq_unleash$A T@U) (|s1#0@@1| T@U) ) (!  (=> (and (and (= (type _module._default.seq_unleash$A) TyType) (= (type |s1#0@@1|) (SeqType BoxType))) (or (|_module.__default.seq_unleash#canCall| _module._default.seq_unleash$A |s1#0@@1|) (and (not (= 35 $FunctionContextHeight)) ($Is |s1#0@@1| (TSeq _module._default.seq_unleash$A))))) (and (|Seq#Equal| |s1#0@@1| (_module.__default.seq_unleash _module._default.seq_unleash$A |s1#0@@1|)) ($Is (_module.__default.seq_unleash _module._default.seq_unleash$A |s1#0@@1|) (TSeq _module._default.seq_unleash$A))))
 :qid |unknown.0:0|
 :skolemid |1021|
...
(assert  (=> (< 6 $FunctionContextHeight) ($Is (int_2_U (- 0 2)) TInt)))
(assert  (=> (< 6 $FunctionContextHeight) (forall (($h@@35 T@U) ) (!  (=> (and (= (type $h@@35) (MapType0Type refType MapType1Type)) ($IsGoodHeap $h@@35)) ($IsAlloc (int_2_U (- 0 2)) TInt $h@@35))
 :qid |DafnyPre.515:12|
 :skolemid |1029|
 :pattern ( ($IsAlloc (int_2_U (- 0 2)) TInt $h@@35))
))))
(assert  (=> (< 5 $FunctionContextHeight) ($Is (int_2_U (- 0 1)) TInt)))
(assert  (=> (< 5 $FunctionContextHeight) (forall (($h@@36 T@U) ) (!  (=> (and (= (type $h@@36) (MapType0Type refType MapType1Type)) ($IsGoodHeap $h@@36)) ($IsAlloc (int_2_U (- 0 1)) TInt $h@@36))
 :qid |DafnyPre.515:12|
 :skolemid |1030|
 :pattern ( ($IsAlloc (int_2_U (- 0 1)) TInt $h@@36))
))))
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((_module._default.Invs$A T@U) (|nodes#0| T@U) (|freeStack#0| Int) (|s#0@@5| T@U) (|f#0@@19| T@U) (|g#0| T@U) ) (!  (=> (and (and (and (and (and (= (type _module._default.Invs$A) TyType) (= (type |nodes#0|) (SeqType BoxType))) (= (type |s#0@@5|) (SeqType BoxType))) (= (type |f#0@@19|) (SeqType BoxType))) (= (type |g#0|) (SeqType BoxType))) (or (|_module.__default.Invs#canCall| _module._default.Invs$A |nodes#0| |freeStack#0| |s#0@@5| |f#0@@19| |g#0|) (and (not (= 7 $FunctionContextHeight)) (and (and (and ($Is |nodes#0| (TSeq (Tclass._module.Node _module._default.Invs$A))) ($Is |s#0@@5| (TSeq _module._default.Invs$A))) ($Is |f#0@@19| (TSeq TInt))) ($Is |g#0| (TSeq TInt)))))) true)
 :qid |unknown.0:0|
 :skolemid |1031|
 :pattern ( (_module.__default.Invs _module._default.Invs$A |nodes#0| |freeStack#0| |s#0@@5| |f#0@@19| |g#0|))
))))
(assert (forall ((_module._default.Invs$A@@0 T@U) (|nodes#0@@0| T@U) (|freeStack#0@@0| Int) (|s#0@@6| T@U) (|f#0@@20| T@U) (|g#0@@0| T@U) ) (!  (=> (and (and (and (and (and (= (type _module._default.Invs$A@@0) TyType) (= (type |nodes#0@@0|) (SeqType BoxType))) (= (type |s#0@@6|) (SeqType BoxType))) (= (type |f#0@@20|) (SeqType BoxType))) (= (type |g#0@@0|) (SeqType BoxType))) (and (and (and ($Is |nodes#0@@0| (TSeq (Tclass._module.Node _module._default.Invs$A@@0))) ($Is |s#0@@6| (TSeq _module._default.Invs$A@@0))) ($Is |f#0@@20| (TSeq TInt))) ($Is |g#0@@0| (TSeq TInt)))) (and (=> (|_module.__default.Invs#requires| _module._default.Invs$A@@0 |nodes#0@@0| |freeStack#0@@0| |s#0@@6| |f#0@@20| |g#0@@0|) true) (=> true (|_module.__default.Invs#requires| _module._default.Invs$A@@0 |nodes#0@@0| |freeStack#0@@0| |s#0@@6| |f#0@@20| |g#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( (|_module.__default.Invs#requires| _module._default.Invs$A@@0 |nodes#0@@0| |freeStack#0@@0| |s#0@@6| |f#0@@20| |g#0@@0|))
)))
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((_module._default.Invs$A@@1 T@U) (|nodes#0@@1| T@U) (|freeStack#0@@1| Int) (|s#0@@7| T@U) (|f#0@@21| T@U) (|g#0@@1| T@U) ) (!  (=> (and (and (and (and (and (= (type _module._default.Invs$A@@1) TyType) (= (type |nodes#0@@1|) (SeqType BoxType))) (= (type |s#0@@7|) (SeqType BoxType))) (= (type |f#0@@21|) (SeqType BoxType))) (= (type |g#0@@1|) (SeqType BoxType))) (or (|_module.__default.Invs#canCall| _module._default.Invs$A@@1 |nodes#0@@1| |freeStack#0@@1| |s#0@@7| |f#0@@21| |g#0@@1|) (and (not (= 7 $FunctionContextHeight)) (and (and (and ($Is |nodes#0@@1| (TSeq (Tclass._module.Node _module._default.Invs$A@@1))) ($Is |s#0@@7| (TSeq _module._default.Invs$A@@1))) ($Is |f#0@@21| (TSeq TInt))) ($Is |g#0@@1| (TSeq TInt)))))) (and (=> (= (|Seq#Length| |f#0@@21|) (|Seq#Length| |s#0@@7|)) (=> (= (|Seq#Length| |g#0@@1|) (|Seq#Length| |nodes#0@@1|)) (=> (> (|Seq#Length| |nodes#0@@1|) 0) (=> (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| 0))) (- 0 1)) (=> (<= 0 |freeStack#0@@1|) (=> (< |freeStack#0@@1| (|Seq#Length| |nodes#0@@1|)) (=> (forall ((|i#0@@4| Int) ) (!  (=> true (and (=> (and (<= 0 |i#0@@4|) (< |i#0@@4| (|Seq#Length| |f#0@@21|))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@4|))))) (=> (and (<= 0 |i#0@@4|) (< |i#0@@4| (|Seq#Length| |f#0@@21|))) (< (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@4|))) (|Seq#Length| |nodes#0@@1|)))))
 :qid |DLLDafny.65:14|
 :skolemid |1054|
 :pattern ( ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@4|)))
)) (=> (forall ((|i#1| Int) ) (!  (=> true (=> (and (<= 0 |i#1|) (< |i#1| (|Seq#Length| |f#0@@21|))) (=> (<= 0 (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1|)))) (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1|)))))) |i#1|))))
 :qid |DLLDafny.66:14|
 :skolemid |1053|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1|))))))
)) (=> (forall ((|p#0| Int) ) (!  (=> true (and (=> (and (<= 0 |p#0|) (< |p#0| (|Seq#Length| |g#0@@1|))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0|))))) (=> (and (<= 0 |p#0|) (< |p#0| (|Seq#Length| |g#0@@1|))) (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0|))) (|Seq#Length| |s#0@@7|)))))
 :qid |DLLDafny.67:14|
 :skolemid |1052|
 ...
 :pattern ( (|Seq#Index| |s#0@@7| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#4@@0|)))))
)) (and (forall ((|p#5| Int) ) (!  (=> (<= 0 |p#5|) (=> (< |p#5| (|Seq#Length| |g#0@@1|)) (=> (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5|)))) (_module.Node.Node_q ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#5|))))))
 :qid |DLLDafny.78:14|
 :skolemid |1045|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| |p#5|)))
 :pattern ( (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#5|))))
)) (=> (forall ((|p#5@@0| Int) ) (!  (=> true (=> (and (and (<= 0 |p#5@@0|) (< |p#5@@0| (|Seq#Length| |g#0@@1|))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@0|))))) (= (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#5@@0|))) (ite (< (+ (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@0|))) 1) (|Seq#Length| |f#0@@21|)) (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| (+ (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@0|))) 1)))) 0))))
 :qid |DLLDafny.78:14|
 :skolemid |1047|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@0|)))
 :pattern ( (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#5@@0|))))
)) (forall ((|p#6| Int) ) (!  (=> (<= 0 |p#6|) (=> (< |p#6| (|Seq#Length| |g#0@@1|)) (=> (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|)))) (=> (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|))) (|Seq#Length| |s#0@@7|)) (=> (>= (|Seq#Length| |f#0@@21|) 0) (=> (U_2_bool (Lit (bool_2_U true))) (and (=> (> (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|))) 0) (=> (<= 0 (- (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|))) 1)) (=> (< (- (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|))) 1) (|Seq#Length| |f#0@@21|)) (_module.Node.Node_q ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6|)))))) (=> (>= 0 (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|)))) (and (=> (or (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|))) 0) (= (|Seq#Length| |f#0@@21|) 0)) (_module.Node.Node_q ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6|)))) (=> (not (or (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|))) 0) (= (|Seq#Length| |f#0@@21|) 0))) (=> (<= 0 (- (|Seq#Length| |f#0@@21|) 1)) (_module.Node.Node_q ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6|))))))))))))))
 :qid |DLLDafny.83:14|
 :skolemid |1046|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| |p#6|)))
 :pattern ( (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6|))))
)))))))))))))))))))) (and (=> (_module.__default.Invs _module._default.Invs$A@@1 |nodes#0@@1| |freeStack#0@@1| |s#0@@7| |f#0@@21| |g#0@@1|) (and (and (and (and (and (and (and (and (and (and (and (and (and (= (|Seq#Length| |f#0@@21|) (|Seq#Length| |s#0@@7|)) (= (|Seq#Length| |g#0@@1|) (|Seq#Length| |nodes#0@@1|))) (> (|Seq#Length| |nodes#0@@1|) 0)) (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| 0))) (- 0 1))) (and (<= 0 |freeStack#0@@1|) (< |freeStack#0@@1| (|Seq#Length| |nodes#0@@1|)))) (forall ((|i#0@@5| Int) ) (!  (=> true (and (=> (and (<= 0 |i#0@@5|) (< |i#0@@5| (|Seq#Length| |f#0@@21|))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@5|))))) (=> (and (<= 0 |i#0@@5|) (< |i#0@@5| (|Seq#Length| |f#0@@21|))) (< (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@5|))) (|Seq#Length| |nodes#0@@1|)))))
 :qid |DLLDafny.65:14|
 :skolemid |1033|
 :pattern ( ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@5|)))
))) (forall ((|i#1@@0| Int) ) (!  (=> true (=> (and (<= 0 |i#1@@0|) (< |i#1@@0| (|Seq#Length| |f#0@@21|))) (=> (<= 0 (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1@@0|)))) (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1@@0|)))))) |i#1@@0|))))
 :qid |DLLDafny.66:14|
 :skolemid |1034|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1@@0|))))))
))) (forall ((|p#0@@0| Int) ) (!  (=> true (and (=> (and (<= 0 |p#0@@0|) (< |p#0@@0| (|Seq#Length| |g#0@@1|))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0@@0|))))) (=> (and (<= 0 |p#0@@0|) (< |p#0@@0| (|Seq#Length| |g#0@@1|))) (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0@@0|))) (|Seq#Length| |s#0@@7|)))))
 :qid |DLLDafny.67:14|
 :skolemid |1035|
 ...
 :pattern ( (|Seq#Index| |s#0@@7| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#4@@1|)))))
))) (forall ((|p#5@@1| Int) ) (!  (=> true (=> (and (and (<= 0 |p#5@@1|) (< |p#5@@1| (|Seq#Length| |g#0@@1|))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@1|))))) (= (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#5@@1|))) (ite (< (+ (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@1|))) 1) (|Seq#Length| |f#0@@21|)) (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| (+ (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@1|))) 1)))) 0))))
 :qid |DLLDafny.78:14|
 :skolemid |1040|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@1|)))
 :pattern ( (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#5@@1|))))
))) (forall ((|p#6@@0| Int) ) (!  (=> true (=> (and (and (<= 0 |p#6@@0|) (< |p#6@@0| (|Seq#Length| |g#0@@1|))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@0|))))) (=> (and (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@0|))) (|Seq#Length| |s#0@@7|)) (>= (|Seq#Length| |f#0@@21|) 0)) (and true (ite (> (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@0|))) 0)  (=> (and (<= 0 (- (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@0|))) 1)) (< (- (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@0|))) 1) (|Seq#Length| |f#0@@21|))) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6@@0|))) (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| (- (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@0|))) 1)))))) (ite  (or (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@0|))) 0) (= (|Seq#Length| |f#0@@21|) 0)) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6@@0|))) 0)  (=> (<= 0 (- (|Seq#Length| |f#0@@21|) 1)) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6@@0|))) (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| (- (|Seq#Length| |f#0@@21|) 1))))))))))))
 :qid |DLLDafny.83:14|
 :skolemid |1041|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@0|)))
 :pattern ( (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6@@0|))))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (= (|Seq#Length| |f#0@@21|) (|Seq#Length| |s#0@@7|)) (= (|Seq#Length| |g#0@@1|) (|Seq#Length| |nodes#0@@1|))) (> (|Seq#Length| |nodes#0@@1|) 0)) (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| 0))) (- 0 1))) (and (<= 0 |freeStack#0@@1|) (< |freeStack#0@@1| (|Seq#Length| |nodes#0@@1|)))) (forall ((|i#0@@6| Int) ) (!  (=> true (and (=> (and (<= 0 |i#0@@6|) (< |i#0@@6| (|Seq#Length| |f#0@@21|))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@6|))))) (=> (and (<= 0 |i#0@@6|) (< |i#0@@6| (|Seq#Length| |f#0@@21|))) (< (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@6|))) (|Seq#Length| |nodes#0@@1|)))))
 :qid |DLLDafny.65:14|
 :skolemid |1033|
 :pattern ( ($Unbox intType (|Seq#Index| |f#0@@21| |i#0@@6|)))
))) (forall ((|i#1@@1| Int) ) (!  (=> true (=> (and (<= 0 |i#1@@1|) (< |i#1@@1| (|Seq#Length| |f#0@@21|))) (=> (<= 0 (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1@@1|)))) (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1@@1|)))))) |i#1@@1|))))
 :qid |DLLDafny.66:14|
 :skolemid |1034|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| |i#1@@1|))))))
))) (forall ((|p#0@@1| Int) ) (!  (=> true (and (=> (and (<= 0 |p#0@@1|) (< |p#0@@1| (|Seq#Length| |g#0@@1|))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0@@1|))))) (=> (and (<= 0 |p#0@@1|) (< |p#0@@1| (|Seq#Length| |g#0@@1|))) (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#0@@1|))) (|Seq#Length| |s#0@@7|)))))
 :qid |DLLDafny.67:14|
 :skolemid |1035|
 ...
 :pattern ( (|Seq#Index| |s#0@@7| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#4@@2|)))))
))) (forall ((|p#5@@2| Int) ) (!  (=> true (=> (and (and (<= 0 |p#5@@2|) (< |p#5@@2| (|Seq#Length| |g#0@@1|))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@2|))))) (= (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#5@@2|))) (ite (< (+ (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@2|))) 1) (|Seq#Length| |f#0@@21|)) (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| (+ (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@2|))) 1)))) 0))))
 :qid |DLLDafny.78:14|
 :skolemid |1040|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| |p#5@@2|)))
 :pattern ( (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#5@@2|))))
))) (forall ((|p#6@@1| Int) ) (!  (=> true (=> (and (and (<= 0 |p#6@@1|) (< |p#6@@1| (|Seq#Length| |g#0@@1|))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@1|))))) (=> (and (< (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@1|))) (|Seq#Length| |s#0@@7|)) (>= (|Seq#Length| |f#0@@21|) 0)) (and true (ite (> (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@1|))) 0)  (=> (and (<= 0 (- (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@1|))) 1)) (< (- (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@1|))) 1) (|Seq#Length| |f#0@@21|))) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6@@1|))) (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| (- (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@1|))) 1)))))) (ite  (or (= (U_2_int ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@1|))) 0) (= (|Seq#Length| |f#0@@21|) 0)) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6@@1|))) 0)  (=> (<= 0 (- (|Seq#Length| |f#0@@21|) 1)) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6@@1|))) (U_2_int ($Unbox intType (|Seq#Index| |f#0@@21| (- (|Seq#Length| |f#0@@21|) 1))))))))))))
 :qid |DLLDafny.83:14|
 :skolemid |1041|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@1| |p#6@@1|)))
 :pattern ( (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@1| |p#6@@1|))))
))) (_module.__default.Invs _module._default.Invs$A@@1 |nodes#0@@1| |freeStack#0@@1| |s#0@@7| |f#0@@21| |g#0@@1|)))))
 :qid |unknown.0:0|
 :skolemid |1055|
 :pattern ( (_module.__default.Invs _module._default.Invs$A@@1 |nodes#0@@1| |freeStack#0@@1| |s#0@@7| |f#0@@21| |g#0@@1|))
))))
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((_module._default.Invs$A@@2 T@U) (|nodes#0@@2| T@U) (|freeStack#0@@2| Int) (|s#0@@8| T@U) (|f#0@@22| T@U) (|g#0@@2| T@U) ) (!  (=> (and (and (and (and (and (= (type _module._default.Invs$A@@2) TyType) (= (type |nodes#0@@2|) (SeqType BoxType))) (= (type |s#0@@8|) (SeqType BoxType))) (= (type |f#0@@22|) (SeqType BoxType))) (= (type |g#0@@2|) (SeqType BoxType))) (or (|_module.__default.Invs#canCall| _module._default.Invs$A@@2 (Lit |nodes#0@@2|) |freeStack#0@@2| (Lit |s#0@@8|) (Lit |f#0@@22|) (Lit |g#0@@2|)) (and (not (= 7 $FunctionContextHeight)) (and (and (and ($Is |nodes#0@@2| (TSeq (Tclass._module.Node _module._default.Invs$A@@2))) ($Is |s#0@@8| (TSeq _module._default.Invs$A@@2))) ($Is |f#0@@22| (TSeq TInt))) ($Is |g#0@@2| (TSeq TInt)))))) (and (=> (= (|Seq#Length| (Lit |f#0@@22|)) (|Seq#Length| (Lit |s#0@@8|))) (=> (= (|Seq#Length| (Lit |g#0@@2|)) (|Seq#Length| (Lit |nodes#0@@2|))) (=> (> (|Seq#Length| (Lit |nodes#0@@2|)) 0) (=> (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) 0))) (- 0 1)) (=> (<= 0 |freeStack#0@@2|) (=> (< |freeStack#0@@2| (|Seq#Length| (Lit |nodes#0@@2|))) (=> (forall ((|i#2| Int) ) (!  (=> true (and (=> (and (<= 0 |i#2|) (< |i#2| (|Seq#Length| (Lit |f#0@@22|)))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2|))))) (=> (and (<= 0 |i#2|) (< |i#2| (|Seq#Length| (Lit |f#0@@22|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2|))) (|Seq#Length| (Lit |nodes#0@@2|))))))
 :qid |DLLDafny.65:14|
 :skolemid |1077|
 :pattern ( ($Unbox intType (|Seq#Index| |f#0@@22| |i#2|)))
)) (=> (forall ((|i#3| Int) ) (!  (=> true (=> (and (<= 0 |i#3|) (< |i#3| (|Seq#Length| (Lit |f#0@@22|)))) (=> (<= 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#3|)))) (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#3|)))))) |i#3|))))
 :qid |DLLDafny.66:14|
 :skolemid |1076|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@22| |i#3|))))))
)) (=> (forall ((|p#7| Int) ) (!  (=> true (and (=> (and (<= 0 |p#7|) (< |p#7| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7|))))) (=> (and (<= 0 |p#7|) (< |p#7| (|Seq#Length| (Lit |g#0@@2|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7|))) (|Seq#Length| (Lit |s#0@@8|))))))
 :qid |DLLDafny.67:14|
 :skolemid |1075|
 ...
 :pattern ( (|Seq#Index| |s#0@@8| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@2| |p#11@@0|)))))
)) (and (forall ((|p#12| Int) ) (!  (=> (<= 0 |p#12|) (=> (< |p#12| (|Seq#Length| (Lit |g#0@@2|))) (=> (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12|)))) (_module.Node.Node_q ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#12|))))))
 :qid |DLLDafny.78:14|
 :skolemid |1068|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| |p#12|)))
 :pattern ( (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@2| |p#12|))))
)) (=> (forall ((|p#12@@0| Int) ) (!  (=> true (=> (and (and (<= 0 |p#12@@0|) (< |p#12@@0| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@0|))))) (= (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#12@@0|))) (ite (< (+ (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@0|))) 1) (|Seq#Length| (Lit |f#0@@22|))) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) (+ (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@0|))) 1)))) 0))))
 :qid |DLLDafny.78:14|
 :skolemid |1070|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| |p#12@@0|)))
 :pattern ( (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@2| |p#12@@0|))))
)) (forall ((|p#13| Int) ) (!  (=> (<= 0 |p#13|) (=> (< |p#13| (|Seq#Length| (Lit |g#0@@2|))) (=> (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13|)))) (=> (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13|))) (|Seq#Length| (Lit |s#0@@8|))) (=> (>= (|Seq#Length| (Lit |f#0@@22|)) 0) (=> (U_2_bool (Lit (bool_2_U true))) (and (=> (> (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13|))) 0) (=> (<= 0 (- (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13|))) 1)) (=> (< (- (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13|))) 1) (|Seq#Length| (Lit |f#0@@22|))) (_module.Node.Node_q ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13|)))))) (=> (>= 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13|)))) (and (=> (or (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13|))) 0) (= (|Seq#Length| (Lit |f#0@@22|)) 0)) (_module.Node.Node_q ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13|)))) (=> (not (or (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13|))) 0) (= (|Seq#Length| (Lit |f#0@@22|)) 0))) (=> (<= 0 (- (|Seq#Length| (Lit |f#0@@22|)) 1)) (_module.Node.Node_q ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13|))))))))))))))
 :qid |DLLDafny.83:14|
 :skolemid |1069|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| |p#13|)))
 :pattern ( (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@2| |p#13|))))
)))))))))))))))))))) (and (=> (_module.__default.Invs _module._default.Invs$A@@2 (Lit |nodes#0@@2|) |freeStack#0@@2| (Lit |s#0@@8|) (Lit |f#0@@22|) (Lit |g#0@@2|)) (and (and (and (and (and (and (and (and (and (and (and (and (and (= (|Seq#Length| (Lit |f#0@@22|)) (|Seq#Length| (Lit |s#0@@8|))) (= (|Seq#Length| (Lit |g#0@@2|)) (|Seq#Length| (Lit |nodes#0@@2|)))) (> (|Seq#Length| (Lit |nodes#0@@2|)) 0)) (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) 0))) (- 0 1))) (and (<= 0 |freeStack#0@@2|) (< |freeStack#0@@2| (|Seq#Length| (Lit |nodes#0@@2|))))) (forall ((|i#2@@0| Int) ) (!  (=> true (and (=> (and (<= 0 |i#2@@0|) (< |i#2@@0| (|Seq#Length| (Lit |f#0@@22|)))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@0|))))) (=> (and (<= 0 |i#2@@0|) (< |i#2@@0| (|Seq#Length| (Lit |f#0@@22|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@0|))) (|Seq#Length| (Lit |nodes#0@@2|))))))
 :qid |DLLDafny.65:14|
 :skolemid |1056|
 :pattern ( ($Unbox intType (|Seq#Index| |f#0@@22| |i#2@@0|)))
))) (forall ((|i#3@@0| Int) ) (!  (=> true (=> (and (<= 0 |i#3@@0|) (< |i#3@@0| (|Seq#Length| (Lit |f#0@@22|)))) (=> (<= 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#3@@0|)))) (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#3@@0|)))))) |i#3@@0|))))
 :qid |DLLDafny.66:14|
 :skolemid |1057|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@22| |i#3@@0|))))))
))) (forall ((|p#7@@0| Int) ) (!  (=> true (and (=> (and (<= 0 |p#7@@0|) (< |p#7@@0| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7@@0|))))) (=> (and (<= 0 |p#7@@0|) (< |p#7@@0| (|Seq#Length| (Lit |g#0@@2|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7@@0|))) (|Seq#Length| (Lit |s#0@@8|))))))
 :qid |DLLDafny.67:14|
 :skolemid |1058|
 ...
 :pattern ( (|Seq#Index| |s#0@@8| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@2| |p#11@@1|)))))
))) (forall ((|p#12@@1| Int) ) (!  (=> true (=> (and (and (<= 0 |p#12@@1|) (< |p#12@@1| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@1|))))) (= (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#12@@1|))) (ite (< (+ (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@1|))) 1) (|Seq#Length| (Lit |f#0@@22|))) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) (+ (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@1|))) 1)))) 0))))
 :qid |DLLDafny.78:14|
 :skolemid |1063|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| |p#12@@1|)))
 :pattern ( (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@2| |p#12@@1|))))
))) (forall ((|p#13@@0| Int) ) (!  (=> true (=> (and (and (<= 0 |p#13@@0|) (< |p#13@@0| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@0|))))) (=> (and (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@0|))) (|Seq#Length| (Lit |s#0@@8|))) (>= (|Seq#Length| (Lit |f#0@@22|)) 0)) (and true (ite (> (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@0|))) 0)  (=> (and (<= 0 (- (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@0|))) 1)) (< (- (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@0|))) 1) (|Seq#Length| (Lit |f#0@@22|)))) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13@@0|))) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) (- (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@0|))) 1)))))) (ite  (or (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@0|))) 0) (= (|Seq#Length| (Lit |f#0@@22|)) 0)) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13@@0|))) 0)  (=> (<= 0 (- (|Seq#Length| (Lit |f#0@@22|)) 1)) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13@@0|))) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) (- (|Seq#Length| (Lit |f#0@@22|)) 1))))))))))))
 :qid |DLLDafny.83:14|
 :skolemid |1064|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| |p#13@@0|)))
 :pattern ( (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@2| |p#13@@0|))))
)))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (= (|Seq#Length| (Lit |f#0@@22|)) (|Seq#Length| (Lit |s#0@@8|))) (= (|Seq#Length| (Lit |g#0@@2|)) (|Seq#Length| (Lit |nodes#0@@2|)))) (> (|Seq#Length| (Lit |nodes#0@@2|)) 0)) (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) 0))) (- 0 1))) (and (<= 0 |freeStack#0@@2|) (< |freeStack#0@@2| (|Seq#Length| (Lit |nodes#0@@2|))))) (forall ((|i#2@@1| Int) ) (!  (=> true (and (=> (and (<= 0 |i#2@@1|) (< |i#2@@1| (|Seq#Length| (Lit |f#0@@22|)))) (< 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@1|))))) (=> (and (<= 0 |i#2@@1|) (< |i#2@@1| (|Seq#Length| (Lit |f#0@@22|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#2@@1|))) (|Seq#Length| (Lit |nodes#0@@2|))))))
 :qid |DLLDafny.65:14|
 :skolemid |1056|
 :pattern ( ($Unbox intType (|Seq#Index| |f#0@@22| |i#2@@1|)))
))) (forall ((|i#3@@1| Int) ) (!  (=> true (=> (and (<= 0 |i#3@@1|) (< |i#3@@1| (|Seq#Length| (Lit |f#0@@22|)))) (=> (<= 0 (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#3@@1|)))) (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) |i#3@@1|)))))) |i#3@@1|))))
 :qid |DLLDafny.66:14|
 :skolemid |1057|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| (U_2_int ($Unbox intType (|Seq#Index| |f#0@@22| |i#3@@1|))))))
))) (forall ((|p#7@@1| Int) ) (!  (=> true (and (=> (and (<= 0 |p#7@@1|) (< |p#7@@1| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 2) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7@@1|))))) (=> (and (<= 0 |p#7@@1|) (< |p#7@@1| (|Seq#Length| (Lit |g#0@@2|)))) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#7@@1|))) (|Seq#Length| (Lit |s#0@@8|))))))
 :qid |DLLDafny.67:14|
 :skolemid |1058|
 ...
 :pattern ( (|Seq#Index| |s#0@@8| (U_2_int ($Unbox intType (|Seq#Index| |g#0@@2| |p#11@@2|)))))
))) (forall ((|p#12@@2| Int) ) (!  (=> true (=> (and (and (<= 0 |p#12@@2|) (< |p#12@@2| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@2|))))) (= (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#12@@2|))) (ite (< (+ (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@2|))) 1) (|Seq#Length| (Lit |f#0@@22|))) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) (+ (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#12@@2|))) 1)))) 0))))
 :qid |DLLDafny.78:14|
 :skolemid |1063|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| |p#12@@2|)))
 :pattern ( (_module.Node.next ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@2| |p#12@@2|))))
))) (forall ((|p#13@@1| Int) ) (!  (=> true (=> (and (and (<= 0 |p#13@@1|) (< |p#13@@1| (|Seq#Length| (Lit |g#0@@2|)))) (<= (- 0 1) (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@1|))))) (=> (and (< (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@1|))) (|Seq#Length| (Lit |s#0@@8|))) (>= (|Seq#Length| (Lit |f#0@@22|)) 0)) (and true (ite (> (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@1|))) 0)  (=> (and (<= 0 (- (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@1|))) 1)) (< (- (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@1|))) 1) (|Seq#Length| (Lit |f#0@@22|)))) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13@@1|))) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) (- (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@1|))) 1)))))) (ite  (or (= (U_2_int ($Unbox intType (|Seq#Index| (Lit |g#0@@2|) |p#13@@1|))) 0) (= (|Seq#Length| (Lit |f#0@@22|)) 0)) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13@@1|))) 0)  (=> (<= 0 (- (|Seq#Length| (Lit |f#0@@22|)) 1)) (= (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| (Lit |nodes#0@@2|) |p#13@@1|))) (U_2_int ($Unbox intType (|Seq#Index| (Lit |f#0@@22|) (- (|Seq#Length| (Lit |f#0@@22|)) 1))))))))))))
 :qid |DLLDafny.83:14|
 :skolemid |1064|
 :pattern ( ($Unbox intType (|Seq#Index| |g#0@@2| |p#13@@1|)))
 :pattern ( (_module.Node.prev ($Unbox DatatypeTypeType (|Seq#Index| |nodes#0@@2| |p#13@@1|))))
))) (_module.__default.Invs _module._default.Invs$A@@2 (Lit |nodes#0@@2|) |freeStack#0@@2| (Lit |s#0@@8|) (Lit |f#0@@22|) (Lit |g#0@@2|))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1078|
 :pattern ( (_module.__default.Invs _module._default.Invs$A@@2 (Lit |nodes#0@@2|) |freeStack#0@@2| (Lit |s#0@@8|) (Lit |f#0@@22|) (Lit |g#0@@2|)))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall ((_module._default.Inv$A T@U) (|l#0| T@U) ) (!  (=> (and (and (= (type _module._default.Inv$A) TyType) (= (type |l#0|) DatatypeTypeType)) (or (|_module.__default.Inv#canCall| _module._default.Inv$A |l#0|) (and (not (= 8 $FunctionContextHeight)) ($Is |l#0| (Tclass._module.DList _module._default.Inv$A))))) true)
 :qid |unknown.0:0|
 :skolemid |1137|
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall ((_module._default.Seq$A@@1 T@U) (|l#0@@5| T@U) ) (!  (=> (and (and (= (type _module._default.Seq$A@@1) TyType) (= (type |l#0@@5|) DatatypeTypeType)) (or (|_module.__default.Seq#canCall| _module._default.Seq$A@@1 |l#0@@5|) (and (not (= 9 $FunctionContextHeight)) ($Is |l#0@@5| (Tclass._module.DList _module._default.Seq$A@@1))))) (and (_module.DList.DList_q |l#0@@5|) (= (_module.__default.Seq _module._default.Seq$A@@1 |l#0@@5|) (_module.DList.s |l#0@@5|))))
 :qid |unknown.0:0|
 :skolemid |1144|
 :pattern ( (_module.__default.Seq _module._default.Seq$A@@1 |l#0@@5|))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall ((_module._default.Seq$A@@2 T@U) (|l#0@@6| T@U) ) (!  (=> (and (and (= (type _module._default.Seq$A@@2) TyType) (= (type |l#0@@6|) DatatypeTypeType)) (or (|_module.__default.Seq#canCall| _module._default.Seq$A@@2 (Lit |l#0@@6|)) (and (not (= 9 $FunctionContextHeight)) ($Is |l#0@@6| (Tclass._module.DList _module._default.Seq$A@@2))))) (and (_module.DList.DList_q (Lit |l#0@@6|)) (= (_module.__default.Seq _module._default.Seq$A@@2 (Lit |l#0@@6|)) (Lit (_module.DList.s (Lit |l#0@@6|))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1145|
 :pattern ( (_module.__default.Seq _module._default.Seq$A@@2 (Lit |l#0@@6|)))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall ((_module._default.ValidPtr$A T@U) (|l#0@@7| T@U) (|p#0@@2| Int) ) (!  (=> (and (and (= (type _module._default.ValidPtr$A) TyType) (= (type |l#0@@7|) DatatypeTypeType)) (or (|_module.__default.ValidPtr#canCall| _module._default.ValidPtr$A |l#0@@7| |p#0@@2|) (and (not (= 10 $FunctionContextHeight)) ($Is |l#0@@7| (Tclass._module.DList _module._default.ValidPtr$A))))) (and (=> (_module.__default.ValidPtr _module._default.ValidPtr$A |l#0@@7| |p#0@@2|) (=> (=> (< 0 |p#0@@2|) (<= 0 |p#0@@2|)) (and (and (< 0 |p#0@@2|) (< |p#0@@2| (|Seq#Length| (_module.DList.g |l#0@@7|)))) (>= (U_2_int ($Unbox intType (|Seq#Index| (_module.DList.g |l#0@@7|) |p#0@@2|))) 0)))) (=> (_module.__default.ValidPtr _module._default.ValidPtr$A |l#0@@7| |p#0@@2|) (not (= |p#0@@2| 0)))))
 :qid |unknown.0:0|
 :skolemid |1146|
...
(assert  (=> (<= 10 $FunctionContextHeight) (forall ((_module._default.ValidPtr$A@@1 T@U) (|l#0@@9| T@U) (|p#0@@4| Int) ) (!  (=> (and (and (= (type _module._default.ValidPtr$A@@1) TyType) (= (type |l#0@@9|) DatatypeTypeType)) (or (|_module.__default.ValidPtr#canCall| _module._default.ValidPtr$A@@1 |l#0@@9| |p#0@@4|) (and (not (= 10 $FunctionContextHeight)) ($Is |l#0@@9| (Tclass._module.DList _module._default.ValidPtr$A@@1))))) (and (=> (< 0 |p#0@@4|) (and (_module.DList.DList_q |l#0@@9|) (=> (< |p#0@@4| (|Seq#Length| (_module.DList.g |l#0@@9|))) (_module.DList.DList_q |l#0@@9|)))) (and (=> (_module.__default.ValidPtr _module._default.ValidPtr$A@@1 |l#0@@9| |p#0@@4|) (and (and (< 0 |p#0@@4|) (< |p#0@@4| (|Seq#Length| (_module.DList.g |l#0@@9|)))) (>= (U_2_int ($Unbox intType (|Seq#Index| (_module.DList.g |l#0@@9|) |p#0@@4|))) 0))) (=> (and (and (< 0 |p#0@@4|) (< |p#0@@4| (|Seq#Length| (_module.DList.g |l#0@@9|)))) (>= (U_2_int ($Unbox intType (|Seq#Index| (_module.DList.g |l#0@@9|) |p#0@@4|))) 0)) (_module.__default.ValidPtr _module._default.ValidPtr$A@@1 |l#0@@9| |p#0@@4|)))))
 :qid |unknown.0:0|
 :skolemid |1148|
 :pattern ( (_module.__default.ValidPtr _module._default.ValidPtr$A@@1 |l#0@@9| |p#0@@4|))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall ((_module._default.ValidPtr$A@@2 T@U) (|l#0@@10| T@U) (|p#0@@5| Int) ) (!  (=> (and (and (= (type _module._default.ValidPtr$A@@2) TyType) (= (type |l#0@@10|) DatatypeTypeType)) (or (|_module.__default.ValidPtr#canCall| _module._default.ValidPtr$A@@2 (Lit |l#0@@10|) |p#0@@5|) (and (not (= 10 $FunctionContextHeight)) ($Is |l#0@@10| (Tclass._module.DList _module._default.ValidPtr$A@@2))))) (and (=> (U_2_bool (Lit (bool_2_U (< 0 |p#0@@5|)))) (and (_module.DList.DList_q (Lit |l#0@@10|)) (=> (< |p#0@@5| (|Seq#Length| (Lit (_module.DList.g (Lit |l#0@@10|))))) (_module.DList.DList_q (Lit |l#0@@10|))))) (and (=> (_module.__default.ValidPtr _module._default.ValidPtr$A@@2 (Lit |l#0@@10|) |p#0@@5|) (and (and (< 0 |p#0@@5|) (< |p#0@@5| (|Seq#Length| (Lit (_module.DList.g (Lit |l#0@@10|)))))) (>= (U_2_int ($Unbox intType (|Seq#Index| (Lit (_module.DList.g (Lit |l#0@@10|))) |p#0@@5|))) 0))) (=> (and (and (< 0 |p#0@@5|) (< |p#0@@5| (|Seq#Length| (Lit (_module.DList.g (Lit |l#0@@10|)))))) (>= (U_2_int ($Unbox intType (|Seq#Index| (Lit (_module.DList.g (Lit |l#0@@10|))) |p#0@@5|))) 0)) (_module.__default.ValidPtr _module._default.ValidPtr$A@@2 (Lit |l#0@@10|) |p#0@@5|)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1149|
 :pattern ( (_module.__default.ValidPtr _module._default.ValidPtr$A@@2 (Lit |l#0@@10|) |p#0@@5|))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall ((_module._default.MaybePtr$A T@U) (|l#0@@11| T@U) (|p#0@@6| Int) ) (!  (=> (and (and (= (type _module._default.MaybePtr$A) TyType) (= (type |l#0@@11|) DatatypeTypeType)) (or (|_module.__default.MaybePtr#canCall| _module._default.MaybePtr$A |l#0@@11| |p#0@@6|) (and (not (= 11 $FunctionContextHeight)) ($Is |l#0@@11| (Tclass._module.DList _module._default.MaybePtr$A))))) true)
 :qid |unknown.0:0|
 :skolemid |1150|
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall ((_module._default.MaybePtr$A@@1 T@U) (|l#0@@13| T@U) (|p#0@@8| Int) ) (!  (=> (and (and (= (type _module._default.MaybePtr$A@@1) TyType) (= (type |l#0@@13|) DatatypeTypeType)) (or (|_module.__default.MaybePtr#canCall| _module._default.MaybePtr$A@@1 |l#0@@13| |p#0@@8|) (and (not (= 11 $FunctionContextHeight)) ($Is |l#0@@13| (Tclass._module.DList _module._default.MaybePtr$A@@1))))) (and (=> (not (= |p#0@@8| 0)) (|_module.__default.ValidPtr#canCall| _module._default.MaybePtr$A@@1 |l#0@@13| |p#0@@8|)) (and (=> (_module.__default.MaybePtr _module._default.MaybePtr$A@@1 |l#0@@13| |p#0@@8|) (or (= |p#0@@8| 0) (_module.__default.ValidPtr _module._default.MaybePtr$A@@1 |l#0@@13| |p#0@@8|))) (=> (or (= |p#0@@8| 0) (_module.__default.ValidPtr _module._default.MaybePtr$A@@1 |l#0@@13| |p#0@@8|)) (_module.__default.MaybePtr _module._default.MaybePtr$A@@1 |l#0@@13| |p#0@@8|)))))
 :qid |unknown.0:0|
 :skolemid |1152|
 :pattern ( (_module.__default.MaybePtr _module._default.MaybePtr$A@@1 |l#0@@13| |p#0@@8|))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall ((_module._default.MaybePtr$A@@2 T@U) (|l#0@@14| T@U) (|p#0@@9| Int) ) (!  (=> (and (and (= (type _module._default.MaybePtr$A@@2) TyType) (= (type |l#0@@14|) DatatypeTypeType)) (or (|_module.__default.MaybePtr#canCall| _module._default.MaybePtr$A@@2 (Lit |l#0@@14|) |p#0@@9|) (and (not (= 11 $FunctionContextHeight)) ($Is |l#0@@14| (Tclass._module.DList _module._default.MaybePtr$A@@2))))) (and (=> (not (= |p#0@@9| 0)) (|_module.__default.ValidPtr#canCall| _module._default.MaybePtr$A@@2 (Lit |l#0@@14|) |p#0@@9|)) (and (=> (_module.__default.MaybePtr _module._default.MaybePtr$A@@2 (Lit |l#0@@14|) |p#0@@9|) (or (= |p#0@@9| 0) (_module.__default.ValidPtr _module._default.MaybePtr$A@@2 (Lit |l#0@@14|) |p#0@@9|))) (=> (or (= |p#0@@9| 0) (_module.__default.ValidPtr _module._default.MaybePtr$A@@2 (Lit |l#0@@14|) |p#0@@9|)) (_module.__default.MaybePtr _module._default.MaybePtr$A@@2 (Lit |l#0@@14|) |p#0@@9|)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1153|
 :pattern ( (_module.__default.MaybePtr _module._default.MaybePtr$A@@2 (Lit |l#0@@14|) |p#0@@9|))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall ((_module._default.Index$A T@U) (|l#0@@15| T@U) (|p#0@@10| Int) ) (!  (=> (and (and (= (type _module._default.Index$A) TyType) (= (type |l#0@@15|) DatatypeTypeType)) (or (|_module.__default.Index#canCall| _module._default.Index$A |l#0@@15| |p#0@@10|) (and (not (= 12 $FunctionContextHeight)) ($Is |l#0@@15| (Tclass._module.DList _module._default.Index$A))))) (and (and (=> (and (_module.__default.Inv _module._default.Index$A |l#0@@15|) (_module.__default.ValidPtr _module._default.Index$A |l#0@@15| |p#0@@10|)) (<= 0 (_module.__default.Index _module._default.Index$A |l#0@@15| |p#0@@10|))) (=> (and (_module.__default.Inv _module._default.Index$A |l#0@@15|) (_module.__default.ValidPtr _module._default.Index$A |l#0@@15| |p#0@@10|)) (< (_module.__default.Index _module._default.Index$A |l#0@@15| |p#0@@10|) (|Seq#Length| (_module.__default.Seq _module._default.Index$A |l#0@@15|))))) (=> (and (_module.__default.Inv _module._default.Index$A |l#0@@15|) (= |p#0@@10| 0)) (= (_module.__default.Index _module._default.Index$A |l#0@@15| |p#0@@10|) (- 0 1)))))
 :qid |unknown.0:0|
 :skolemid |1155|
...
(assert  (=> (<= 12 $FunctionContextHeight) (forall ((_module._default.Index$A@@1 T@U) (|l#0@@17| T@U) (|p#0@@12| Int) ) (!  (=> (and (and (= (type _module._default.Index$A@@1) TyType) (= (type |l#0@@17|) DatatypeTypeType)) (or (|_module.__default.Index#canCall| _module._default.Index$A@@1 |l#0@@17| |p#0@@12|) (and (not (= 12 $FunctionContextHeight)) ($Is |l#0@@17| (Tclass._module.DList _module._default.Index$A@@1))))) (and (and (and (|_module.__default.Inv#canCall| _module._default.Index$A@@1 |l#0@@17|) (=> (_module.__default.Inv _module._default.Index$A@@1 |l#0@@17|) (|_module.__default.MaybePtr#canCall| _module._default.Index$A@@1 |l#0@@17| |p#0@@12|))) (=> (and (_module.__default.Inv _module._default.Index$A@@1 |l#0@@17|) (_module.__default.MaybePtr _module._default.Index$A@@1 |l#0@@17| |p#0@@12|)) (_module.DList.DList_q |l#0@@17|))) (= (_module.__default.Index _module._default.Index$A@@1 |l#0@@17| |p#0@@12|) (let ((|i#0@@7| (ite  (and (_module.__default.Inv _module._default.Index$A@@1 |l#0@@17|) (_module.__default.MaybePtr _module._default.Index$A@@1 |l#0@@17| |p#0@@12|)) (U_2_int ($Unbox intType (|Seq#Index| (_module.DList.g |l#0@@17|) |p#0@@12|))) 0)))
|i#0@@7|))))
 :qid |unknown.0:0|
 :skolemid |1157|
 :pattern ( (_module.__default.Index _module._default.Index$A@@1 |l#0@@17| |p#0@@12|))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall ((_module._default.Index$A@@2 T@U) (|l#0@@18| T@U) (|p#0@@13| Int) ) (!  (=> (and (and (= (type _module._default.Index$A@@2) TyType) (= (type |l#0@@18|) DatatypeTypeType)) (or (|_module.__default.Index#canCall| _module._default.Index$A@@2 (Lit |l#0@@18|) |p#0@@13|) (and (not (= 12 $FunctionContextHeight)) ($Is |l#0@@18| (Tclass._module.DList _module._default.Index$A@@2))))) (and (and (and (|_module.__default.Inv#canCall| _module._default.Index$A@@2 (Lit |l#0@@18|)) (=> (U_2_bool (Lit (bool_2_U (_module.__default.Inv _module._default.Index$A@@2 (Lit |l#0@@18|))))) (|_module.__default.MaybePtr#canCall| _module._default.Index$A@@2 (Lit |l#0@@18|) |p#0@@13|))) (=> (U_2_bool (Lit (bool_2_U  (and (_module.__default.Inv _module._default.Index$A@@2 (Lit |l#0@@18|)) (_module.__default.MaybePtr _module._default.Index$A@@2 (Lit |l#0@@18|) |p#0@@13|))))) (_module.DList.DList_q (Lit |l#0@@18|)))) (= (_module.__default.Index _module._default.Index$A@@2 (Lit |l#0@@18|) |p#0@@13|) (let ((|i#1@@2| (ite  (and (_module.__default.Inv _module._default.Index$A@@2 (Lit |l#0@@18|)) (_module.__default.MaybePtr _module._default.Index$A@@2 (Lit |l#0@@18|) |p#0@@13|)) (U_2_int ($Unbox intType (|Seq#Index| (Lit (_module.DList.g (Lit |l#0@@18|))) |p#0@@13|))) 0)))
|i#1@@2|))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1158|
...
(assert  (=> (<= 13 $FunctionContextHeight) (forall ((_module._default.IndexHi$A@@1 T@U) (|l#0@@21| T@U) (|p#0@@16| Int) ) (!  (=> (and (and (= (type _module._default.IndexHi$A@@1) TyType) (= (type |l#0@@21|) DatatypeTypeType)) (or (|_module.__default.IndexHi#canCall| _module._default.IndexHi$A@@1 |l#0@@21| |p#0@@16|) (and (not (= 13 $FunctionContextHeight)) ($Is |l#0@@21| (Tclass._module.DList _module._default.IndexHi$A@@1))))) (and (and (and (and (|_module.__default.Inv#canCall| _module._default.IndexHi$A@@1 |l#0@@21|) (=> (_module.__default.Inv _module._default.IndexHi$A@@1 |l#0@@21|) (|_module.__default.ValidPtr#canCall| _module._default.IndexHi$A@@1 |l#0@@21| |p#0@@16|))) (=> (and (_module.__default.Inv _module._default.IndexHi$A@@1 |l#0@@21|) (_module.__default.ValidPtr _module._default.IndexHi$A@@1 |l#0@@21| |p#0@@16|)) (_module.DList.DList_q |l#0@@21|))) (=> (not (and (_module.__default.Inv _module._default.IndexHi$A@@1 |l#0@@21|) (_module.__default.ValidPtr _module._default.IndexHi$A@@1 |l#0@@21| |p#0@@16|))) (_module.DList.DList_q |l#0@@21|))) (= (_module.__default.IndexHi _module._default.IndexHi$A@@1 |l#0@@21| |p#0@@16|) (ite  (and (_module.__default.Inv _module._default.IndexHi$A@@1 |l#0@@21|) (_module.__default.ValidPtr _module._default.IndexHi$A@@1 |l#0@@21| |p#0@@16|)) (U_2_int ($Unbox intType (|Seq#Index| (_module.DList.g |l#0@@21|) |p#0@@16|))) (|Seq#Length| (_module.DList.s |l#0@@21|))))))
 :qid |unknown.0:0|
 :skolemid |1163|
 :pattern ( (_module.__default.IndexHi _module._default.IndexHi$A@@1 |l#0@@21| |p#0@@16|))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall ((_module._default.IndexHi$A@@2 T@U) (|l#0@@22| T@U) (|p#0@@17| Int) ) (!  (=> (and (and (= (type _module._default.IndexHi$A@@2) TyType) (= (type |l#0@@22|) DatatypeTypeType)) (or (|_module.__default.IndexHi#canCall| _module._default.IndexHi$A@@2 (Lit |l#0@@22|) |p#0@@17|) (and (not (= 13 $FunctionContextHeight)) ($Is |l#0@@22| (Tclass._module.DList _module._default.IndexHi$A@@2))))) (and (and (and (and (|_module.__default.Inv#canCall| _module._default.IndexHi$A@@2 (Lit |l#0@@22|)) (=> (U_2_bool (Lit (bool_2_U (_module.__default.Inv _module._default.IndexHi$A@@2 (Lit |l#0@@22|))))) (|_module.__default.ValidPtr#canCall| _module._default.IndexHi$A@@2 (Lit |l#0@@22|) |p#0@@17|))) (=> (U_2_bool (Lit (bool_2_U  (and (_module.__default.Inv _module._default.IndexHi$A@@2 (Lit |l#0@@22|)) (_module.__default.ValidPtr _module._default.IndexHi$A@@2 (Lit |l#0@@22|) |p#0@@17|))))) (_module.DList.DList_q (Lit |l#0@@22|)))) (=> (not (U_2_bool (Lit (bool_2_U  (and (_module.__default.Inv _module._default.IndexHi$A@@2 (Lit |l#0@@22|)) (_module.__default.ValidPtr _module._default.IndexHi$A@@2 (Lit |l#0@@22|) |p#0@@17|)))))) (_module.DList.DList_q (Lit |l#0@@22|)))) (= (_module.__default.IndexHi _module._default.IndexHi$A@@2 (Lit |l#0@@22|) |p#0@@17|) (ite  (and (_module.__default.Inv _module._default.IndexHi$A@@2 (Lit |l#0@@22|)) (_module.__default.ValidPtr _module._default.IndexHi$A@@2 (Lit |l#0@@22|) |p#0@@17|)) (U_2_int ($Unbox intType (|Seq#Index| (Lit (_module.DList.g (Lit |l#0@@22|))) |p#0@@17|))) (|Seq#Length| (Lit (_module.DList.s (Lit |l#0@@22|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1164|
 :pattern ( (_module.__default.IndexHi _module._default.IndexHi$A@@2 (Lit |l#0@@22|) |p#0@@17|))
))))
(assert (forall ((arg0@@247 T@U) (arg1@@114 T@U) (arg2@@67 Int) ) (! (= (type (_module.__default.Get arg0@@247 arg1@@114 arg2@@67)) BoxType)
 :qid |funType:_module.__default.Get|
 :pattern ( (_module.__default.Get arg0@@247 arg1@@114 arg2@@67))
)))
(assert  (=> (<= 15 $FunctionContextHeight) (forall ((_module._default.Get$A T@U) (|l#0@@23| T@U) (|p#0@@18| Int) ) (!  (=> (and (and (= (type _module._default.Get$A) TyType) (= (type |l#0@@23|) DatatypeTypeType)) (or (|_module.__default.Get#canCall| _module._default.Get$A |l#0@@23| |p#0@@18|) (and (not (= 15 $FunctionContextHeight)) (and ($Is |l#0@@23| (Tclass._module.DList _module._default.Get$A)) (and (_module.__default.Inv _module._default.Get$A |l#0@@23|) (_module.__default.ValidPtr _module._default.Get$A |l#0@@23| |p#0@@18|)))))) (and (= (_module.__default.Get _module._default.Get$A |l#0@@23| |p#0@@18|) (|Seq#Index| (_module.__default.Seq _module._default.Get$A |l#0@@23|) (_module.__default.Index _module._default.Get$A |l#0@@23| |p#0@@18|))) ($IsBox (_module.__default.Get _module._default.Get$A |l#0@@23| |p#0@@18|) _module._default.Get$A)))
 :qid |unknown.0:0|
 :skolemid |1167|
...
(assert  (=> (<= 15 $FunctionContextHeight) (forall ((_module._default.Get$A@@1 T@U) (|l#0@@25| T@U) (|p#0@@20| Int) ) (!  (=> (and (and (= (type _module._default.Get$A@@1) TyType) (= (type |l#0@@25|) DatatypeTypeType)) (or (|_module.__default.Get#canCall| _module._default.Get$A@@1 |l#0@@25| |p#0@@20|) (and (not (= 15 $FunctionContextHeight)) (and ($Is |l#0@@25| (Tclass._module.DList _module._default.Get$A@@1)) (and (_module.__default.Inv _module._default.Get$A@@1 |l#0@@25|) (_module.__default.ValidPtr _module._default.Get$A@@1 |l#0@@25| |p#0@@20|)))))) (and (and (and (_module.DList.DList_q |l#0@@25|) (|_module.__default.seq__get#canCall| (Tclass._module.Node _module._default.Get$A@@1) (_module.DList.nodes |l#0@@25|) |p#0@@20|)) (_module.Node.Node_q ($Unbox DatatypeTypeType (_module.__default.seq__get (Tclass._module.Node _module._default.Get$A@@1) (_module.DList.nodes |l#0@@25|) |p#0@@20|)))) (= (_module.__default.Get _module._default.Get$A@@1 |l#0@@25| |p#0@@20|) (_module.Option.value (_module.Node.data ($Unbox DatatypeTypeType (_module.__default.seq__get (Tclass._module.Node _module._default.Get$A@@1) (_module.DList.nodes |l#0@@25|) |p#0@@20|)))))))
 :qid |unknown.0:0|
 :skolemid |1169|
 :pattern ( (_module.__default.Get _module._default.Get$A@@1 |l#0@@25| |p#0@@20|))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall ((_module._default.Get$A@@2 T@U) (|l#0@@26| T@U) (|p#0@@21| Int) ) (!  (=> (and (and (= (type _module._default.Get$A@@2) TyType) (= (type |l#0@@26|) DatatypeTypeType)) (or (|_module.__default.Get#canCall| _module._default.Get$A@@2 (Lit |l#0@@26|) |p#0@@21|) (and (not (= 15 $FunctionContextHeight)) (and ($Is |l#0@@26| (Tclass._module.DList _module._default.Get$A@@2)) (and (U_2_bool (Lit (bool_2_U (_module.__default.Inv _module._default.Get$A@@2 (Lit |l#0@@26|))))) (U_2_bool (Lit (bool_2_U (_module.__default.ValidPtr _module._default.Get$A@@2 (Lit |l#0@@26|) |p#0@@21|))))))))) (and (and (and (_module.DList.DList_q (Lit |l#0@@26|)) (|_module.__default.seq__get#canCall| (Tclass._module.Node _module._default.Get$A@@2) (Lit (_module.DList.nodes (Lit |l#0@@26|))) |p#0@@21|)) (_module.Node.Node_q ($Unbox DatatypeTypeType (_module.__default.seq__get (Tclass._module.Node _module._default.Get$A@@2) (Lit (_module.DList.nodes (Lit |l#0@@26|))) |p#0@@21|)))) (= (_module.__default.Get _module._default.Get$A@@2 (Lit |l#0@@26|) |p#0@@21|) (_module.Option.value (_module.Node.data ($Unbox DatatypeTypeType (_module.__default.seq__get (Tclass._module.Node _module._default.Get$A@@2) (Lit (_module.DList.nodes (Lit |l#0@@26|))) |p#0@@21|)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1170|
 :pattern ( (_module.__default.Get _module._default.Get$A@@2 (Lit |l#0@@26|) |p#0@@21|))
))))
(assert  (=> (<= 16 $FunctionContextHeight) (forall ((_module._default.Next$A T@U) (|l#0@@27| T@U) (|p#0@@22| Int) ) (!  (=> (and (and (= (type _module._default.Next$A) TyType) (= (type |l#0@@27|) DatatypeTypeType)) (or (|_module.__default.Next#canCall| _module._default.Next$A |l#0@@27| |p#0@@22|) (and (not (= 16 $FunctionContextHeight)) (and ($Is |l#0@@27| (Tclass._module.DList _module._default.Next$A)) (and (_module.__default.Inv _module._default.Next$A |l#0@@27|) (_module.__default.MaybePtr _module._default.Next$A |l#0@@27| |p#0@@22|)))))) (and (and (and (and (_module.__default.MaybePtr _module._default.Next$A |l#0@@27| (_module.__default.Next _module._default.Next$A |l#0@@27| |p#0@@22|)) (=> (and (= |p#0@@22| 0) (> (|Seq#Length| (_module.__default.Seq _module._default.Next$A |l#0@@27|)) 0)) (= (_module.__default.Index _module._default.Next$A |l#0@@27| (_module.__default.Next _module._default.Next$A |l#0@@27| |p#0@@22|)) 0))) (=> (and (= |p#0@@22| 0) (= (|Seq#Length| (_module.__default.Seq _module._default.Next$A |l#0@@27|)) 0)) (= (_module.__default.Next _module._default.Next$A |l#0@@27| |p#0@@22|) 0))) (=> (and (not (= |p#0@@22| 0)) (< (+ (_module.__default.Index _module._default.Next$A |l#0@@27| |p#0@@22|) 1) (|Seq#Length| (_module.__default.Seq _module._default.Next$A |l#0@@27|)))) (= (_module.__default.Index _module._default.Next$A |l#0@@27| (_module.__default.Next _module._default.Next$A |l#0@@27| |p#0@@22|)) (+ (_module.__default.Index _module._default.Next$A |l#0@@27| |p#0@@22|) 1)))) (=> (and (not (= |p#0@@22| 0)) (= (+ (_module.__default.Index _module._default.Next$A |l#0@@27| |p#0@@22|) 1) (|Seq#Length| (_module.__default.Seq _module._default.Next$A |l#0@@27|)))) (= (_module.__default.Next _module._default.Next$A |l#0@@27| |p#0@@22|) 0))))
 :qid |unknown.0:0|
 :skolemid |1174|
...
(= (type (MapType6Store arg0@@252 arg1@@119 arg2@@69 arg3@@42)) (MapType6Type aVar0@@4 aVar1@@7))))
 ...
 :weight 0
)))) (forall ((arg0@@253 T@U) (arg1@@120 T@U) (arg2@@70 T@U) (arg3@@43 Bool) ) (! (= (type (|lambda#0| arg0@@253 arg1@@120 arg2@@70 arg3@@43)) (MapType6Type refType boolType))
 :qid |funType:lambda#0|
 :pattern ( (|lambda#0| arg0@@253 arg1@@120 arg2@@70 arg3@@43))
))))
...
(assert (forall ((arg0@@254 T@U) (arg1@@121 T@U) (arg2@@71 T@U) (arg3@@44 Bool) ) (! (= (type (|lambda#1| arg0@@254 arg1@@121 arg2@@71 arg3@@44)) (MapType6Type refType boolType))
 :qid |funType:lambda#1|
 :pattern ( (|lambda#1| arg0@@254 arg1@@121 arg2@@71 arg3@@44))
)))
...
(assert (forall ((arg0@@255 T@U) (arg1@@122 T@U) (arg2@@72 T@U) (arg3@@45 Bool) ) (! (= (type (|lambda#2| arg0@@255 arg1@@122 arg2@@72 arg3@@45)) (MapType6Type refType boolType))
 :qid |funType:lambda#2|
 :pattern ( (|lambda#2| arg0@@255 arg1@@122 arg2@@72 arg3@@45))
)))
...
(assert (forall ((arg0@@256 T@U) (arg1@@123 T@U) (arg2@@73 T@U) (arg3@@46 Bool) ) (! (= (type (|lambda#3| arg0@@256 arg1@@123 arg2@@73 arg3@@46)) (MapType6Type refType boolType))
 :qid |funType:lambda#3|
 :pattern ( (|lambda#3| arg0@@256 arg1@@123 arg2@@73 arg3@@46))
)))
...
(assert (forall ((arg0@@257 T@U) (arg1@@124 T@U) (arg2@@74 T@U) (arg3@@47 Bool) ) (! (= (type (|lambda#4| arg0@@257 arg1@@124 arg2@@74 arg3@@47)) (MapType6Type refType boolType))
 :qid |funType:lambda#4|
 :pattern ( (|lambda#4| arg0@@257 arg1@@124 arg2@@74 arg3@@47))
)))
...
(assert (forall ((arg0@@258 T@U) (arg1@@125 T@U) (arg2@@75 T@U) (arg3@@48 Bool) ) (! (= (type (|lambda#5| arg0@@258 arg1@@125 arg2@@75 arg3@@48)) (MapType6Type refType boolType))
 :qid |funType:lambda#5|
 :pattern ( (|lambda#5| arg0@@258 arg1@@125 arg2@@75 arg3@@48))
)))
...
(assert (forall ((arg0@@259 T@U) (arg1@@126 T@U) (arg2@@76 T@U) (arg3@@49 Bool) ) (! (= (type (|lambda#6| arg0@@259 arg1@@126 arg2@@76 arg3@@49)) (MapType6Type refType boolType))
 :qid |funType:lambda#6|
 :pattern ( (|lambda#6| arg0@@259 arg1@@126 arg2@@76 arg3@@49))
)))
...
(assert (forall ((arg0@@260 T@U) (arg1@@127 T@U) (arg2@@77 T@U) (arg3@@50 Bool) ) (! (= (type (|lambda#7| arg0@@260 arg1@@127 arg2@@77 arg3@@50)) (MapType6Type refType boolType))
 :qid |funType:lambda#7|
 :pattern ( (|lambda#7| arg0@@260 arg1@@127 arg2@@77 arg3@@50))
)))
...
(assert (forall ((arg0@@261 T@U) (arg1@@128 T@U) (arg2@@78 T@U) (arg3@@51 Bool) ) (! (= (type (|lambda#8| arg0@@261 arg1@@128 arg2@@78 arg3@@51)) (MapType6Type refType boolType))
 :qid |funType:lambda#8|
 :pattern ( (|lambda#8| arg0@@261 arg1@@128 arg2@@78 arg3@@51))
)))
...
(assert (forall ((arg0@@262 T@U) (arg1@@129 T@U) (arg2@@79 T@U) (arg3@@52 Bool) ) (! (= (type (|lambda#9| arg0@@262 arg1@@129 arg2@@79 arg3@@52)) (MapType6Type refType boolType))
 :qid |funType:lambda#9|
 :pattern ( (|lambda#9| arg0@@262 arg1@@129 arg2@@79 arg3@@52))
)))
...
(assert (forall ((arg0@@263 T@U) (arg1@@130 T@U) (arg2@@80 T@U) (arg3@@53 Bool) ) (! (= (type (|lambda#10| arg0@@263 arg1@@130 arg2@@80 arg3@@53)) (MapType6Type refType boolType))
 :qid |funType:lambda#10|
 :pattern ( (|lambda#10| arg0@@263 arg1@@130 arg2@@80 arg3@@53))
)))
...
(assert (forall ((arg0@@264 T@U) (arg1@@131 T@U) (arg2@@81 T@U) (arg3@@54 Bool) ) (! (= (type (|lambda#11| arg0@@264 arg1@@131 arg2@@81 arg3@@54)) (MapType6Type refType boolType))
 :qid |funType:lambda#11|
 :pattern ( (|lambda#11| arg0@@264 arg1@@131 arg2@@81 arg3@@54))
)))
...
(assert (forall ((arg0@@265 T@U) (arg1@@132 T@U) (arg2@@82 T@U) (arg3@@55 Bool) ) (! (= (type (|lambda#12| arg0@@265 arg1@@132 arg2@@82 arg3@@55)) (MapType6Type refType boolType))
 :qid |funType:lambda#12|
 :pattern ( (|lambda#12| arg0@@265 arg1@@132 arg2@@82 arg3@@55))
)))
...
(assert (forall ((arg0@@266 T@U) (arg1@@133 T@U) (arg2@@83 T@U) (arg3@@56 Bool) ) (! (= (type (|lambda#13| arg0@@266 arg1@@133 arg2@@83 arg3@@56)) (MapType6Type refType boolType))
 :qid |funType:lambda#13|
 :pattern ( (|lambda#13| arg0@@266 arg1@@133 arg2@@83 arg3@@56))
)))
...
(assert (forall ((arg0@@267 T@U) (arg1@@134 T@U) (arg2@@84 T@U) (arg3@@57 Bool) ) (! (= (type (|lambda#14| arg0@@267 arg1@@134 arg2@@84 arg3@@57)) (MapType6Type refType boolType))
 :qid |funType:lambda#14|
 :pattern ( (|lambda#14| arg0@@267 arg1@@134 arg2@@84 arg3@@57))
)))
...
(assert (forall ((arg0@@268 T@U) (arg1@@135 T@U) (arg2@@85 T@U) (arg3@@58 Bool) ) (! (= (type (|lambda#15| arg0@@268 arg1@@135 arg2@@85 arg3@@58)) (MapType6Type refType boolType))
 :qid |funType:lambda#15|
 :pattern ( (|lambda#15| arg0@@268 arg1@@135 arg2@@85 arg3@@58))
)))
...
(assert (forall ((arg0@@269 T@U) (arg1@@136 T@U) (arg2@@86 T@U) (arg3@@59 Bool) ) (! (= (type (|lambda#16| arg0@@269 arg1@@136 arg2@@86 arg3@@59)) (MapType6Type refType boolType))
 :qid |funType:lambda#16|
 :pattern ( (|lambda#16| arg0@@269 arg1@@136 arg2@@86 arg3@@59))
)))
...
(assert (forall ((arg0@@270 T@U) (arg1@@137 T@U) (arg2@@87 T@U) (arg3@@60 Bool) ) (! (= (type (|lambda#17| arg0@@270 arg1@@137 arg2@@87 arg3@@60)) (MapType6Type refType boolType))
 :qid |funType:lambda#17|
 :pattern ( (|lambda#17| arg0@@270 arg1@@137 arg2@@87 arg3@@60))
)))
...
(assert (forall ((arg0@@271 T@U) (arg1@@138 T@U) (arg2@@88 T@U) (arg3@@61 Bool) ) (! (= (type (|lambda#18| arg0@@271 arg1@@138 arg2@@88 arg3@@61)) (MapType6Type refType boolType))
 :qid |funType:lambda#18|
 :pattern ( (|lambda#18| arg0@@271 arg1@@138 arg2@@88 arg3@@61))
)))
...
(assert (forall ((arg0@@272 T@U) (arg1@@139 T@U) (arg2@@89 T@U) (arg3@@62 Bool) ) (! (= (type (|lambda#19| arg0@@272 arg1@@139 arg2@@89 arg3@@62)) (MapType6Type refType boolType))
 :qid |funType:lambda#19|
 :pattern ( (|lambda#19| arg0@@272 arg1@@139 arg2@@89 arg3@@62))
)))
...
(assert (forall ((arg0@@273 T@U) (arg1@@140 T@U) (arg2@@90 T@U) (arg3@@63 Bool) ) (! (= (type (|lambda#20| arg0@@273 arg1@@140 arg2@@90 arg3@@63)) (MapType6Type refType boolType))
 :qid |funType:lambda#20|
 :pattern ( (|lambda#20| arg0@@273 arg1@@140 arg2@@90 arg3@@63))
)))
...
(assert (forall ((arg0@@274 T@U) (arg1@@141 T@U) (arg2@@91 T@U) (arg3@@64 Bool) ) (! (= (type (|lambda#21| arg0@@274 arg1@@141 arg2@@91 arg3@@64)) (MapType6Type refType boolType))
 :qid |funType:lambda#21|
 :pattern ( (|lambda#21| arg0@@274 arg1@@141 arg2@@91 arg3@@64))
)))
...
(assert (forall ((arg0@@275 T@U) (arg1@@142 T@U) (arg2@@92 T@U) (arg3@@65 Bool) ) (! (= (type (|lambda#22| arg0@@275 arg1@@142 arg2@@92 arg3@@65)) (MapType6Type refType boolType))
 :qid |funType:lambda#22|
 :pattern ( (|lambda#22| arg0@@275 arg1@@142 arg2@@92 arg3@@65))
)))
...
(assert (forall ((arg0@@276 T@U) (arg1@@143 T@U) (arg2@@93 T@U) (arg3@@66 Bool) ) (! (= (type (|lambda#23| arg0@@276 arg1@@143 arg2@@93 arg3@@66)) (MapType6Type refType boolType))
 :qid |funType:lambda#23|
 :pattern ( (|lambda#23| arg0@@276 arg1@@143 arg2@@93 arg3@@66))
)))
...
(assert (forall ((arg0@@277 T@U) (arg1@@144 T@U) (arg2@@94 T@U) (arg3@@67 Bool) ) (! (= (type (|lambda#24| arg0@@277 arg1@@144 arg2@@94 arg3@@67)) (MapType6Type refType boolType))
 :qid |funType:lambda#24|
 :pattern ( (|lambda#24| arg0@@277 arg1@@144 arg2@@94 arg3@@67))
)))
...
(assert (forall ((arg0@@278 T@U) (arg1@@145 T@U) (arg2@@95 T@U) (arg3@@68 Bool) ) (! (= (type (|lambda#25| arg0@@278 arg1@@145 arg2@@95 arg3@@68)) (MapType6Type refType boolType))
 :qid |funType:lambda#25|
 :pattern ( (|lambda#25| arg0@@278 arg1@@145 arg2@@95 arg3@@68))
)))
...
(assert (forall ((arg0@@279 T@U) (arg1@@146 T@U) (arg2@@96 T@U) (arg3@@69 Bool) ) (! (= (type (|lambda#26| arg0@@279 arg1@@146 arg2@@96 arg3@@69)) (MapType6Type refType boolType))
 :qid |funType:lambda#26|
 :pattern ( (|lambda#26| arg0@@279 arg1@@146 arg2@@96 arg3@@69))
)))
...
(assert (forall ((arg0@@280 T@U) (arg1@@147 T@U) (arg2@@97 T@U) (arg3@@70 Bool) ) (! (= (type (|lambda#27| arg0@@280 arg1@@147 arg2@@97 arg3@@70)) (MapType6Type refType boolType))
 :qid |funType:lambda#27|
 :pattern ( (|lambda#27| arg0@@280 arg1@@147 arg2@@97 arg3@@70))
)))
...
(assert (forall ((arg0@@281 T@U) (arg1@@148 T@U) (arg2@@98 T@U) (arg3@@71 Bool) ) (! (= (type (|lambda#28| arg0@@281 arg1@@148 arg2@@98 arg3@@71)) (MapType6Type refType boolType))
 :qid |funType:lambda#28|
 :pattern ( (|lambda#28| arg0@@281 arg1@@148 arg2@@98 arg3@@71))
)))
...
(assert (forall ((arg0@@282 Int) (arg1@@149 Int) (arg2@@99 Int) ) (! (= (type (|lambda#29| arg0@@282 arg1@@149 arg2@@99)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#29|
 :pattern ( (|lambda#29| arg0@@282 arg1@@149 arg2@@99))
)))
(assert (forall ((|$l#0#heap#0| T@U) (|$l#0#p#0| T@U) (|l#0@@64| Int) (|l#1@@28| Int) (|l#2@@28| Int) ) (!  (=> (and (= (type |$l#0#heap#0|) (MapType0Type refType MapType1Type)) (= (type |$l#0#p#0|) BoxType)) (= (MapType2Select (|lambda#29| |l#0@@64| |l#1@@28| |l#2@@28|) |$l#0#heap#0| |$l#0#p#0|) ($Box (int_2_U (ite (= (U_2_int ($Unbox intType |$l#0#p#0|)) |l#0@@64|) |l#1@@28| |l#2@@28|)))))
 :qid |DafnyPre.515:12|
 :skolemid |1632|
 :pattern ( (MapType2Select (|lambda#29| |l#0@@64| |l#1@@28| |l#2@@28|) |$l#0#heap#0| |$l#0#p#0|))
)))
(assert (forall ((arg0@@283 T@U) ) (! (= (type (|lambda#30| arg0@@283)) (MapType2Type (MapType0Type refType MapType1Type) BoxType boolType))
 :qid |funType:lambda#30|
 :pattern ( (|lambda#30| arg0@@283))
)))
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#p#0@@0| T@U) (|l#0@@65| T@U) ) (!  (=> (and (and (= (type |$l#0#heap#0@@0|) (MapType0Type refType MapType1Type)) (= (type |$l#0#p#0@@0|) BoxType)) (= (type |l#0@@65|) TyType)) (= (U_2_bool (MapType2Select (|lambda#30| |l#0@@65|) |$l#0#heap#0@@0| |$l#0#p#0@@0|)) ($IsBox |$l#0#p#0@@0| |l#0@@65|)))
 :qid |DafnyPre.515:12|
 :skolemid |1633|
 :pattern ( (MapType2Select (|lambda#30| |l#0@@65|) |$l#0#heap#0@@0| |$l#0#p#0@@0|))
)))
(assert (forall ((arg0@@284 Bool) ) (! (= (type (|lambda#31| arg0@@284)) (MapType0Type refType boolType))
 :qid |funType:lambda#31|
 :pattern ( (|lambda#31| arg0@@284))
)))
(assert (forall ((|$l#0#o#0| T@U) (|l#0@@66| Bool) ) (!  (=> (= (type |$l#0#o#0|) refType) (= (U_2_bool (MapType0Select (|lambda#31| |l#0@@66|) |$l#0#o#0|)) |l#0@@66|))
 :qid |unknown.0:0|
 :skolemid |1634|
 :pattern ( (MapType0Select (|lambda#31| |l#0@@66|) |$l#0#o#0|))
)))
(assert (forall ((arg0@@285 T@U) ) (! (= (type (|lambda#32| arg0@@285)) (MapType2Type (MapType0Type refType MapType1Type) BoxType (MapType0Type BoxType boolType)))
 :qid |funType:lambda#32|
 :pattern ( (|lambda#32| arg0@@285))
)))
(assert (forall ((|$l#0#heap#0@@1| T@U) (|$l#0#p#0@@1| T@U) (|l#0@@67| T@U) ) (!  (=> (and (and (= (type |$l#0#heap#0@@1|) (MapType0Type refType MapType1Type)) (= (type |$l#0#p#0@@1|) BoxType)) (= (type |l#0@@67|) (MapType0Type BoxType boolType))) (= (MapType2Select (|lambda#32| |l#0@@67|) |$l#0#heap#0@@1| |$l#0#p#0@@1|) |l#0@@67|))
 :qid |DafnyPre.515:12|
 :skolemid |1635|
 :pattern ( (MapType2Select (|lambda#32| |l#0@@67|) |$l#0#heap#0@@1| |$l#0#p#0@@1|))
)))
(assert (forall ((arg0@@286 T@U) ) (! (= (type (|lambda#33| arg0@@286)) (MapType0Type LayerTypeType HandleTypeType))
 :qid |funType:lambda#33|
 :pattern ( (|lambda#33| arg0@@286))
)))
(assert (forall ((|$l#0#ly#0| T@U) (|l#0@@68| T@U) ) (!  (=> (and (= (type |$l#0#ly#0|) LayerTypeType) (= (type |l#0@@68|) HandleTypeType)) (= (MapType0Select (|lambda#33| |l#0@@68|) |$l#0#ly#0|) |l#0@@68|))
 :qid |unknown.0:0|
 :skolemid |1636|
 :pattern ( (MapType0Select (|lambda#33| |l#0@@68|) |$l#0#ly#0|))
)))
(assert (forall ((arg0@@287 T@U) (arg1@@150 T@U) (arg2@@100 T@U) (arg3@@72 Bool) ) (! (= (type (|lambda#39| arg0@@287 arg1@@150 arg2@@100 arg3@@72)) (MapType6Type refType boolType))
 :qid |funType:lambda#39|
 :pattern ( (|lambda#39| arg0@@287 arg1@@150 arg2@@100 arg3@@72))
)))
(assert (forall (($o@@38 T@U) ($f@@28 T@U) (|l#0@@69| T@U) (|l#1@@29| T@U) (|l#2@@29| T@U) (|l#3@@28| Bool) ) (! (let ((alpha@@35 (FieldTypeInv0 (type $f@@28))))
 (=> (and (and (and (and (= (type $o@@38) refType) (= (type $f@@28) (FieldType alpha@@35))) (= (type |l#0@@69|) refType)) (= (type |l#1@@29|) (MapType0Type refType MapType1Type))) (= (type |l#2@@29|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#39| |l#0@@69| |l#1@@29| |l#2@@29| |l#3@@28|) $o@@38 $f@@28))  (=> (and (not (= $o@@38 |l#0@@69|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@29| $o@@38) |l#2@@29|))) |l#3@@28|))))
 :qid |DLLDafny.203:63|
 :skolemid |1637|
 :pattern ( (MapType6Select (|lambda#39| |l#0@@69| |l#1@@29| |l#2@@29| |l#3@@28|) $o@@38 $f@@28))
)))
(assert (forall ((arg0@@288 T@U) (arg1@@151 T@U) (arg2@@101 T@U) (arg3@@73 Bool) ) (! (= (type (|lambda#40| arg0@@288 arg1@@151 arg2@@101 arg3@@73)) (MapType6Type refType boolType))
 :qid |funType:lambda#40|
 :pattern ( (|lambda#40| arg0@@288 arg1@@151 arg2@@101 arg3@@73))
)))
(assert (forall (($o@@39 T@U) ($f@@29 T@U) (|l#0@@70| T@U) (|l#1@@30| T@U) (|l#2@@30| T@U) (|l#3@@29| Bool) ) (! (let ((alpha@@36 (FieldTypeInv0 (type $f@@29))))
 (=> (and (and (and (and (= (type $o@@39) refType) (= (type $f@@29) (FieldType alpha@@36))) (= (type |l#0@@70|) refType)) (= (type |l#1@@30|) (MapType0Type refType MapType1Type))) (= (type |l#2@@30|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#40| |l#0@@70| |l#1@@30| |l#2@@30| |l#3@@29|) $o@@39 $f@@29))  (=> (and (not (= $o@@39 |l#0@@70|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@30| $o@@39) |l#2@@30|))) |l#3@@29|))))
 :qid |DLLDafny.212:8|
 :skolemid |1638|
 :pattern ( (MapType6Select (|lambda#40| |l#0@@70| |l#1@@30| |l#2@@30| |l#3@@29|) $o@@39 $f@@29))
)))
(assert (forall ((arg0@@289 T@U) (arg1@@152 T@U) (arg2@@102 T@U) (arg3@@74 Bool) ) (! (= (type (|lambda#41| arg0@@289 arg1@@152 arg2@@102 arg3@@74)) (MapType6Type refType boolType))
 :qid |funType:lambda#41|
 :pattern ( (|lambda#41| arg0@@289 arg1@@152 arg2@@102 arg3@@74))
)))
(assert (forall (($o@@40 T@U) ($f@@30 T@U) (|l#0@@71| T@U) (|l#1@@31| T@U) (|l#2@@31| T@U) (|l#3@@30| Bool) ) (! (let ((alpha@@37 (FieldTypeInv0 (type $f@@30))))
 (=> (and (and (and (and (= (type $o@@40) refType) (= (type $f@@30) (FieldType alpha@@37))) (= (type |l#0@@71|) refType)) (= (type |l#1@@31|) (MapType0Type refType MapType1Type))) (= (type |l#2@@31|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#41| |l#0@@71| |l#1@@31| |l#2@@31| |l#3@@30|) $o@@40 $f@@30))  (=> (and (not (= $o@@40 |l#0@@71|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@31| $o@@40) |l#2@@31|))) |l#3@@30|))))
 :qid |DLLDafny.212:8|
 :skolemid |1639|
 :pattern ( (MapType6Select (|lambda#41| |l#0@@71| |l#1@@31| |l#2@@31| |l#3@@30|) $o@@40 $f@@30))
)))
(assert (forall ((arg0@@290 Int) (arg1@@153 T@U) (arg2@@103 Int) ) (! (= (type (|lambda#42| arg0@@290 arg1@@153 arg2@@103)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#42|
 :pattern ( (|lambda#42| arg0@@290 arg1@@153 arg2@@103))
)))
(assert (forall ((|$l#0#heap#0@@2| T@U) (|$l#0#i#0| T@U) (|l#0@@72| Int) (|l#1@@32| T@U) (|l#2@@32| Int) ) (!  (=> (and (and (= (type |$l#0#heap#0@@2|) (MapType0Type refType MapType1Type)) (= (type |$l#0#i#0|) BoxType)) (= (type |l#1@@32|) (SeqType BoxType))) (= (MapType2Select (|lambda#42| |l#0@@72| |l#1@@32| |l#2@@32|) |$l#0#heap#0@@2| |$l#0#i#0|) ($Box (int_2_U (ite (< (U_2_int ($Unbox intType |$l#0#i#0|)) |l#0@@72|) (U_2_int ($Unbox intType (|Seq#Index| |l#1@@32| (U_2_int ($Unbox intType |$l#0#i#0|))))) |l#2@@32|)))))
 :qid |DafnyPre.515:12|
 :skolemid |1640|
 :pattern ( (MapType2Select (|lambda#42| |l#0@@72| |l#1@@32| |l#2@@32|) |$l#0#heap#0@@2| |$l#0#i#0|))
)))
(assert (forall ((arg0@@291 T@U) (arg1@@154 Int) (arg2@@104 Int) ) (! (= (type (|lambda#43| arg0@@291 arg1@@154 arg2@@104)) (MapType2Type (MapType0Type refType MapType1Type) BoxType boolType))
 :qid |funType:lambda#43|
 :pattern ( (|lambda#43| arg0@@291 arg1@@154 arg2@@104))
)))
(assert (forall ((|$l#0#heap#0@@3| T@U) (|$l#0#i#0@@0| T@U) (|l#0@@73| T@U) (|l#1@@33| Int) (|l#2@@33| Int) ) (!  (=> (and (and (= (type |$l#0#heap#0@@3|) (MapType0Type refType MapType1Type)) (= (type |$l#0#i#0@@0|) BoxType)) (= (type |l#0@@73|) TyType)) (= (U_2_bool (MapType2Select (|lambda#43| |l#0@@73| |l#1@@33| |l#2@@33|) |$l#0#heap#0@@3| |$l#0#i#0@@0|))  (and ($IsBox |$l#0#i#0@@0| |l#0@@73|) (and (<= |l#1@@33| (U_2_int ($Unbox intType |$l#0#i#0@@0|))) (< (U_2_int ($Unbox intType |$l#0#i#0@@0|)) |l#2@@33|)))))
 :qid |DafnyPre.515:12|
 :skolemid |1641|
 :pattern ( (MapType2Select (|lambda#43| |l#0@@73| |l#1@@33| |l#2@@33|) |$l#0#heap#0@@3| |$l#0#i#0@@0|))
)))
(assert (forall ((arg0@@292 T@U) (arg1@@155 T@U) (arg2@@105 T@U) (arg3@@75 Bool) ) (! (= (type (|lambda#52| arg0@@292 arg1@@155 arg2@@105 arg3@@75)) (MapType6Type refType boolType))
 :qid |funType:lambda#52|
 :pattern ( (|lambda#52| arg0@@292 arg1@@155 arg2@@105 arg3@@75))
)))
(assert (forall (($o@@41 T@U) ($f@@31 T@U) (|l#0@@74| T@U) (|l#1@@34| T@U) (|l#2@@34| T@U) (|l#3@@31| Bool) ) (! (let ((alpha@@38 (FieldTypeInv0 (type $f@@31))))
 (=> (and (and (and (and (= (type $o@@41) refType) (= (type $f@@31) (FieldType alpha@@38))) (= (type |l#0@@74|) refType)) (= (type |l#1@@34|) (MapType0Type refType MapType1Type))) (= (type |l#2@@34|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#52| |l#0@@74| |l#1@@34| |l#2@@34| |l#3@@31|) $o@@41 $f@@31))  (=> (and (not (= $o@@41 |l#0@@74|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@34| $o@@41) |l#2@@34|))) |l#3@@31|))))
 :qid |DLLDafny.228:5|
 :skolemid |1642|
 :pattern ( (MapType6Select (|lambda#52| |l#0@@74| |l#1@@34| |l#2@@34| |l#3@@31|) $o@@41 $f@@31))
)))
(assert (forall ((arg0@@293 T@U) (arg1@@156 T@U) (arg2@@106 T@U) (arg3@@76 Bool) ) (! (= (type (|lambda#53| arg0@@293 arg1@@156 arg2@@106 arg3@@76)) (MapType6Type refType boolType))
 :qid |funType:lambda#53|
 :pattern ( (|lambda#53| arg0@@293 arg1@@156 arg2@@106 arg3@@76))
)))
(assert (forall (($o@@42 T@U) ($f@@32 T@U) (|l#0@@75| T@U) (|l#1@@35| T@U) (|l#2@@35| T@U) (|l#3@@32| Bool) ) (! (let ((alpha@@39 (FieldTypeInv0 (type $f@@32))))
 (=> (and (and (and (and (= (type $o@@42) refType) (= (type $f@@32) (FieldType alpha@@39))) (= (type |l#0@@75|) refType)) (= (type |l#1@@35|) (MapType0Type refType MapType1Type))) (= (type |l#2@@35|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#53| |l#0@@75| |l#1@@35| |l#2@@35| |l#3@@32|) $o@@42 $f@@32))  (=> (and (not (= $o@@42 |l#0@@75|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@35| $o@@42) |l#2@@35|))) |l#3@@32|))))
 :qid |DLLDafny.231:14|
 :skolemid |1643|
 :pattern ( (MapType6Select (|lambda#53| |l#0@@75| |l#1@@35| |l#2@@35| |l#3@@32|) $o@@42 $f@@32))
)))
(assert (forall ((arg0@@294 T@U) (arg1@@157 T@U) (arg2@@107 T@U) (arg3@@77 Bool) ) (! (= (type (|lambda#54| arg0@@294 arg1@@157 arg2@@107 arg3@@77)) (MapType6Type refType boolType))
 :qid |funType:lambda#54|
 :pattern ( (|lambda#54| arg0@@294 arg1@@157 arg2@@107 arg3@@77))
)))
(assert (forall (($o@@43 T@U) ($f@@33 T@U) (|l#0@@76| T@U) (|l#1@@36| T@U) (|l#2@@36| T@U) (|l#3@@33| Bool) ) (! (let ((alpha@@40 (FieldTypeInv0 (type $f@@33))))
 (=> (and (and (and (and (= (type $o@@43) refType) (= (type $f@@33) (FieldType alpha@@40))) (= (type |l#0@@76|) refType)) (= (type |l#1@@36|) (MapType0Type refType MapType1Type))) (= (type |l#2@@36|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#54| |l#0@@76| |l#1@@36| |l#2@@36| |l#3@@33|) $o@@43 $f@@33))  (=> (and (not (= $o@@43 |l#0@@76|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@36| $o@@43) |l#2@@36|))) |l#3@@33|))))
 :qid |DLLDafny.231:14|
 :skolemid |1644|
 :pattern ( (MapType6Select (|lambda#54| |l#0@@76| |l#1@@36| |l#2@@36| |l#3@@33|) $o@@43 $f@@33))
)))
(assert (forall ((arg0@@295 T@U) (arg1@@158 Int) (arg2@@108 Int) (arg3@@78 T@U) (arg4@@30 Int) (arg5@@19 T@U) (arg6@@15 Int) (arg7@@4 T@U) ) (! (= (type (|lambda#55| arg0@@295 arg1@@158 arg2@@108 arg3@@78 arg4@@30 arg5@@19 arg6@@15 arg7@@4)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#55|
 :pattern ( (|lambda#55| arg0@@295 arg1@@158 arg2@@108 arg3@@78 arg4@@30 arg5@@19 arg6@@15 arg7@@4))
)))
(assert (forall ((|$l#0#heap#0@@4| T@U) (|$l#0#x#0| T@U) (|l#0@@77| T@U) (|l#1@@37| Int) (|l#2@@37| Int) (|l#3@@34| T@U) (|l#4| Int) (|l#5| T@U) (|l#6| Int) (|l#7| T@U) ) (!  (=> (and (and (and (and (and (= (type |$l#0#heap#0@@4|) (MapType0Type refType MapType1Type)) (= (type |$l#0#x#0|) BoxType)) (= (type |l#0@@77|) (SeqType BoxType))) (= (type |l#3@@34|) (SeqType BoxType))) (= (type |l#5|) (SeqType BoxType))) (= (type |l#7|) (SeqType BoxType))) (= (MapType2Select (|lambda#55| |l#0@@77| |l#1@@37| |l#2@@37| |l#3@@34| |l#4| |l#5| |l#6| |l#7|) |$l#0#heap#0@@4| |$l#0#x#0|) ($Box (int_2_U (ite (= (U_2_int ($Unbox intType (|Seq#Index| |l#0@@77| (U_2_int ($Unbox intType |$l#0#x#0|))))) |l#1@@37|) |l#2@@37| (ite (> (U_2_int ($Unbox intType (|Seq#Index| |l#3@@34| (U_2_int ($Unbox intType |$l#0#x#0|))))) |l#4|) (- (U_2_int ($Unbox intType (|Seq#Index| |l#5| (U_2_int ($Unbox intType |$l#0#x#0|))))) |l#6|) (U_2_int ($Unbox intType (|Seq#Index| |l#7| (U_2_int ($Unbox intType |$l#0#x#0|)))))))))))
 :qid |DafnyPre.515:12|
 :skolemid |1645|
 :pattern ( (MapType2Select (|lambda#55| |l#0@@77| |l#1@@37| |l#2@@37| |l#3@@34| |l#4| |l#5| |l#6| |l#7|) |$l#0#heap#0@@4| |$l#0#x#0|))
)))
(assert (forall ((arg0@@296 T@U) (arg1@@159 T@U) (arg2@@109 T@U) (arg3@@79 Bool) ) (! (= (type (|lambda#65| arg0@@296 arg1@@159 arg2@@109 arg3@@79)) (MapType6Type refType boolType))
 :qid |funType:lambda#65|
 :pattern ( (|lambda#65| arg0@@296 arg1@@159 arg2@@109 arg3@@79))
)))
(assert (forall (($o@@44 T@U) ($f@@34 T@U) (|l#0@@78| T@U) (|l#1@@38| T@U) (|l#2@@38| T@U) (|l#3@@35| Bool) ) (! (let ((alpha@@41 (FieldTypeInv0 (type $f@@34))))
 (=> (and (and (and (and (= (type $o@@44) refType) (= (type $f@@34) (FieldType alpha@@41))) (= (type |l#0@@78|) refType)) (= (type |l#1@@38|) (MapType0Type refType MapType1Type))) (= (type |l#2@@38|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#65| |l#0@@78| |l#1@@38| |l#2@@38| |l#3@@35|) $o@@44 $f@@34))  (=> (and (not (= $o@@44 |l#0@@78|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@38| $o@@44) |l#2@@38|))) |l#3@@35|))))
 :qid |DLLDafny.238:20|
 :skolemid |1646|
 :pattern ( (MapType6Select (|lambda#65| |l#0@@78| |l#1@@38| |l#2@@38| |l#3@@35|) $o@@44 $f@@34))
)))
(assert (forall ((arg0@@297 T@U) (arg1@@160 T@U) (arg2@@110 T@U) (arg3@@80 Bool) ) (! (= (type (|lambda#66| arg0@@297 arg1@@160 arg2@@110 arg3@@80)) (MapType6Type refType boolType))
 :qid |funType:lambda#66|
 :pattern ( (|lambda#66| arg0@@297 arg1@@160 arg2@@110 arg3@@80))
)))
(assert (forall (($o@@45 T@U) ($f@@35 T@U) (|l#0@@79| T@U) (|l#1@@39| T@U) (|l#2@@39| T@U) (|l#3@@36| Bool) ) (! (let ((alpha@@42 (FieldTypeInv0 (type $f@@35))))
 (=> (and (and (and (and (= (type $o@@45) refType) (= (type $f@@35) (FieldType alpha@@42))) (= (type |l#0@@79|) refType)) (= (type |l#1@@39|) (MapType0Type refType MapType1Type))) (= (type |l#2@@39|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#66| |l#0@@79| |l#1@@39| |l#2@@39| |l#3@@36|) $o@@45 $f@@35))  (=> (and (not (= $o@@45 |l#0@@79|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@39| $o@@45) |l#2@@39|))) |l#3@@36|))))
 :qid |DLLDafny.243:8|
 :skolemid |1647|
 :pattern ( (MapType6Select (|lambda#66| |l#0@@79| |l#1@@39| |l#2@@39| |l#3@@36|) $o@@45 $f@@35))
)))
(assert (forall ((arg0@@298 T@U) (arg1@@161 T@U) (arg2@@111 T@U) (arg3@@81 Bool) ) (! (= (type (|lambda#67| arg0@@298 arg1@@161 arg2@@111 arg3@@81)) (MapType6Type refType boolType))
 :qid |funType:lambda#67|
 :pattern ( (|lambda#67| arg0@@298 arg1@@161 arg2@@111 arg3@@81))
)))
(assert (forall (($o@@46 T@U) ($f@@36 T@U) (|l#0@@80| T@U) (|l#1@@40| T@U) (|l#2@@40| T@U) (|l#3@@37| Bool) ) (! (let ((alpha@@43 (FieldTypeInv0 (type $f@@36))))
 (=> (and (and (and (and (= (type $o@@46) refType) (= (type $f@@36) (FieldType alpha@@43))) (= (type |l#0@@80|) refType)) (= (type |l#1@@40|) (MapType0Type refType MapType1Type))) (= (type |l#2@@40|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#67| |l#0@@80| |l#1@@40| |l#2@@40| |l#3@@37|) $o@@46 $f@@36))  (=> (and (not (= $o@@46 |l#0@@80|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@40| $o@@46) |l#2@@40|))) |l#3@@37|))))
 :qid |DLLDafny.243:8|
 :skolemid |1648|
 :pattern ( (MapType6Select (|lambda#67| |l#0@@80| |l#1@@40| |l#2@@40| |l#3@@37|) $o@@46 $f@@36))
)))
(assert (forall ((arg0@@299 T@U) (arg1@@162 T@U) (arg2@@112 T@U) (arg3@@82 Bool) ) (! (= (type (|lambda#68| arg0@@299 arg1@@162 arg2@@112 arg3@@82)) (MapType6Type refType boolType))
 :qid |funType:lambda#68|
 :pattern ( (|lambda#68| arg0@@299 arg1@@162 arg2@@112 arg3@@82))
)))
(assert (forall (($o@@47 T@U) ($f@@37 T@U) (|l#0@@81| T@U) (|l#1@@41| T@U) (|l#2@@41| T@U) (|l#3@@38| Bool) ) (! (let ((alpha@@44 (FieldTypeInv0 (type $f@@37))))
 (=> (and (and (and (and (= (type $o@@47) refType) (= (type $f@@37) (FieldType alpha@@44))) (= (type |l#0@@81|) refType)) (= (type |l#1@@41|) (MapType0Type refType MapType1Type))) (= (type |l#2@@41|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#68| |l#0@@81| |l#1@@41| |l#2@@41| |l#3@@38|) $o@@47 $f@@37))  (=> (and (not (= $o@@47 |l#0@@81|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@41| $o@@47) |l#2@@41|))) |l#3@@38|))))
 :qid |DLLDafny.269:14|
 :skolemid |1649|
 :pattern ( (MapType6Select (|lambda#68| |l#0@@81| |l#1@@41| |l#2@@41| |l#3@@38|) $o@@47 $f@@37))
)))
(assert (forall ((arg0@@300 T@U) (arg1@@163 T@U) (arg2@@113 T@U) (arg3@@83 Bool) ) (! (= (type (|lambda#69| arg0@@300 arg1@@163 arg2@@113 arg3@@83)) (MapType6Type refType boolType))
 :qid |funType:lambda#69|
 :pattern ( (|lambda#69| arg0@@300 arg1@@163 arg2@@113 arg3@@83))
)))
(assert (forall (($o@@48 T@U) ($f@@38 T@U) (|l#0@@82| T@U) (|l#1@@42| T@U) (|l#2@@42| T@U) (|l#3@@39| Bool) ) (! (let ((alpha@@45 (FieldTypeInv0 (type $f@@38))))
 (=> (and (and (and (and (= (type $o@@48) refType) (= (type $f@@38) (FieldType alpha@@45))) (= (type |l#0@@82|) refType)) (= (type |l#1@@42|) (MapType0Type refType MapType1Type))) (= (type |l#2@@42|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#69| |l#0@@82| |l#1@@42| |l#2@@42| |l#3@@39|) $o@@48 $f@@38))  (=> (and (not (= $o@@48 |l#0@@82|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@42| $o@@48) |l#2@@42|))) |l#3@@39|))))
 :qid |DLLDafny.269:14|
 :skolemid |1650|
 :pattern ( (MapType6Select (|lambda#69| |l#0@@82| |l#1@@42| |l#2@@42| |l#3@@39|) $o@@48 $f@@38))
)))
(assert (forall ((arg0@@301 Int) (arg1@@164 Int) (arg2@@114 T@U) (arg3@@84 Int) (arg4@@31 T@U) (arg5@@20 Int) (arg6@@16 T@U) ) (! (= (type (|lambda#70| arg0@@301 arg1@@164 arg2@@114 arg3@@84 arg4@@31 arg5@@20 arg6@@16)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#70|
 :pattern ( (|lambda#70| arg0@@301 arg1@@164 arg2@@114 arg3@@84 arg4@@31 arg5@@20 arg6@@16))
)))
(assert (forall ((|$l#0#heap#0@@5| T@U) (|$l#0#x#0@@0| T@U) (|l#0@@83| Int) (|l#1@@43| Int) (|l#2@@43| T@U) (|l#3@@40| Int) (|l#4@@0| T@U) (|l#5@@0| Int) (|l#6@@0| T@U) ) (!  (=> (and (and (and (and (= (type |$l#0#heap#0@@5|) (MapType0Type refType MapType1Type)) (= (type |$l#0#x#0@@0|) BoxType)) (= (type |l#2@@43|) (SeqType BoxType))) (= (type |l#4@@0|) (SeqType BoxType))) (= (type |l#6@@0|) (SeqType BoxType))) (= (MapType2Select (|lambda#70| |l#0@@83| |l#1@@43| |l#2@@43| |l#3@@40| |l#4@@0| |l#5@@0| |l#6@@0|) |$l#0#heap#0@@5| |$l#0#x#0@@0|) ($Box (int_2_U (ite (= (U_2_int ($Unbox intType |$l#0#x#0@@0|)) |l#0@@83|) |l#1@@43| (ite (> (U_2_int ($Unbox intType (|Seq#Index| |l#2@@43| (U_2_int ($Unbox intType |$l#0#x#0@@0|))))) |l#3@@40|) (+ (U_2_int ($Unbox intType (|Seq#Index| |l#4@@0| (U_2_int ($Unbox intType |$l#0#x#0@@0|))))) |l#5@@0|) (U_2_int ($Unbox intType (|Seq#Index| |l#6@@0| (U_2_int ($Unbox intType |$l#0#x#0@@0|)))))))))))
 :qid |DafnyPre.515:12|
 :skolemid |1651|
 :pattern ( (MapType2Select (|lambda#70| |l#0@@83| |l#1@@43| |l#2@@43| |l#3@@40| |l#4@@0| |l#5@@0| |l#6@@0|) |$l#0#heap#0@@5| |$l#0#x#0@@0|))
)))
(assert (forall ((arg0@@302 T@U) (arg1@@165 T@U) (arg2@@115 T@U) (arg3@@85 Bool) ) (! (= (type (|lambda#80| arg0@@302 arg1@@165 arg2@@115 arg3@@85)) (MapType6Type refType boolType))
 :qid |funType:lambda#80|
 :pattern ( (|lambda#80| arg0@@302 arg1@@165 arg2@@115 arg3@@85))
)))
(assert (forall (($o@@49 T@U) ($f@@39 T@U) (|l#0@@84| T@U) (|l#1@@44| T@U) (|l#2@@44| T@U) (|l#3@@41| Bool) ) (! (let ((alpha@@46 (FieldTypeInv0 (type $f@@39))))
 (=> (and (and (and (and (= (type $o@@49) refType) (= (type $f@@39) (FieldType alpha@@46))) (= (type |l#0@@84|) refType)) (= (type |l#1@@44|) (MapType0Type refType MapType1Type))) (= (type |l#2@@44|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#80| |l#0@@84| |l#1@@44| |l#2@@44| |l#3@@41|) $o@@49 $f@@39))  (=> (and (not (= $o@@49 |l#0@@84|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@44| $o@@49) |l#2@@44|))) |l#3@@41|))))
 :qid |DLLDafny.276:20|
 :skolemid |1652|
 :pattern ( (MapType6Select (|lambda#80| |l#0@@84| |l#1@@44| |l#2@@44| |l#3@@41|) $o@@49 $f@@39))
)))
(assert (forall ((arg0@@303 T@U) (arg1@@166 T@U) (arg2@@116 T@U) (arg3@@86 Bool) ) (! (= (type (|lambda#81| arg0@@303 arg1@@166 arg2@@116 arg3@@86)) (MapType6Type refType boolType))
 :qid |funType:lambda#81|
 :pattern ( (|lambda#81| arg0@@303 arg1@@166 arg2@@116 arg3@@86))
)))
(assert (forall (($o@@50 T@U) ($f@@40 T@U) (|l#0@@85| T@U) (|l#1@@45| T@U) (|l#2@@45| T@U) (|l#3@@42| Bool) ) (! (let ((alpha@@47 (FieldTypeInv0 (type $f@@40))))
 (=> (and (and (and (and (= (type $o@@50) refType) (= (type $f@@40) (FieldType alpha@@47))) (= (type |l#0@@85|) refType)) (= (type |l#1@@45|) (MapType0Type refType MapType1Type))) (= (type |l#2@@45|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#81| |l#0@@85| |l#1@@45| |l#2@@45| |l#3@@42|) $o@@50 $f@@40))  (=> (and (not (= $o@@50 |l#0@@85|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@45| $o@@50) |l#2@@45|))) |l#3@@42|))))
 :qid |DLLDafny.281:8|
 :skolemid |1653|
 :pattern ( (MapType6Select (|lambda#81| |l#0@@85| |l#1@@45| |l#2@@45| |l#3@@42|) $o@@50 $f@@40))
)))
(assert (forall ((arg0@@304 T@U) (arg1@@167 T@U) (arg2@@117 T@U) (arg3@@87 Bool) ) (! (= (type (|lambda#82| arg0@@304 arg1@@167 arg2@@117 arg3@@87)) (MapType6Type refType boolType))
 :qid |funType:lambda#82|
 :pattern ( (|lambda#82| arg0@@304 arg1@@167 arg2@@117 arg3@@87))
)))
(assert (forall (($o@@51 T@U) ($f@@41 T@U) (|l#0@@86| T@U) (|l#1@@46| T@U) (|l#2@@46| T@U) (|l#3@@43| Bool) ) (! (let ((alpha@@48 (FieldTypeInv0 (type $f@@41))))
 (=> (and (and (and (and (= (type $o@@51) refType) (= (type $f@@41) (FieldType alpha@@48))) (= (type |l#0@@86|) refType)) (= (type |l#1@@46|) (MapType0Type refType MapType1Type))) (= (type |l#2@@46|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#82| |l#0@@86| |l#1@@46| |l#2@@46| |l#3@@43|) $o@@51 $f@@41))  (=> (and (not (= $o@@51 |l#0@@86|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@46| $o@@51) |l#2@@46|))) |l#3@@43|))))
 :qid |DLLDafny.281:8|
 :skolemid |1654|
 :pattern ( (MapType6Select (|lambda#82| |l#0@@86| |l#1@@46| |l#2@@46| |l#3@@43|) $o@@51 $f@@41))
)))
(assert (forall ((arg0@@305 T@U) (arg1@@168 T@U) (arg2@@118 T@U) (arg3@@88 Bool) ) (! (= (type (|lambda#83| arg0@@305 arg1@@168 arg2@@118 arg3@@88)) (MapType6Type refType boolType))
 :qid |funType:lambda#83|
 :pattern ( (|lambda#83| arg0@@305 arg1@@168 arg2@@118 arg3@@88))
)))
(assert (forall (($o@@52 T@U) ($f@@42 T@U) (|l#0@@87| T@U) (|l#1@@47| T@U) (|l#2@@47| T@U) (|l#3@@44| Bool) ) (! (let ((alpha@@49 (FieldTypeInv0 (type $f@@42))))
 (=> (and (and (and (and (= (type $o@@52) refType) (= (type $f@@42) (FieldType alpha@@49))) (= (type |l#0@@87|) refType)) (= (type |l#1@@47|) (MapType0Type refType MapType1Type))) (= (type |l#2@@47|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#83| |l#0@@87| |l#1@@47| |l#2@@47| |l#3@@44|) $o@@52 $f@@42))  (=> (and (not (= $o@@52 |l#0@@87|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@47| $o@@52) |l#2@@47|))) |l#3@@44|))))
 :qid |DLLDafny.315:14|
 :skolemid |1655|
 :pattern ( (MapType6Select (|lambda#83| |l#0@@87| |l#1@@47| |l#2@@47| |l#3@@44|) $o@@52 $f@@42))
)))
(assert (forall ((arg0@@306 T@U) (arg1@@169 T@U) (arg2@@119 T@U) (arg3@@89 Bool) ) (! (= (type (|lambda#84| arg0@@306 arg1@@169 arg2@@119 arg3@@89)) (MapType6Type refType boolType))
 :qid |funType:lambda#84|
 :pattern ( (|lambda#84| arg0@@306 arg1@@169 arg2@@119 arg3@@89))
)))
(assert (forall (($o@@53 T@U) ($f@@43 T@U) (|l#0@@88| T@U) (|l#1@@48| T@U) (|l#2@@48| T@U) (|l#3@@45| Bool) ) (! (let ((alpha@@50 (FieldTypeInv0 (type $f@@43))))
 (=> (and (and (and (and (= (type $o@@53) refType) (= (type $f@@43) (FieldType alpha@@50))) (= (type |l#0@@88|) refType)) (= (type |l#1@@48|) (MapType0Type refType MapType1Type))) (= (type |l#2@@48|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#84| |l#0@@88| |l#1@@48| |l#2@@48| |l#3@@45|) $o@@53 $f@@43))  (=> (and (not (= $o@@53 |l#0@@88|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@48| $o@@53) |l#2@@48|))) |l#3@@45|))))
 :qid |DLLDafny.315:14|
 :skolemid |1656|
 :pattern ( (MapType6Select (|lambda#84| |l#0@@88| |l#1@@48| |l#2@@48| |l#3@@45|) $o@@53 $f@@43))
)))
(assert (forall ((arg0@@307 Int) (arg1@@170 Int) (arg2@@120 T@U) (arg3@@90 Int) (arg4@@32 T@U) (arg5@@21 Int) (arg6@@17 T@U) ) (! (= (type (|lambda#85| arg0@@307 arg1@@170 arg2@@120 arg3@@90 arg4@@32 arg5@@21 arg6@@17)) (MapType2Type (MapType0Type refType MapType1Type) BoxType BoxType))
 :qid |funType:lambda#85|
 :pattern ( (|lambda#85| arg0@@307 arg1@@170 arg2@@120 arg3@@90 arg4@@32 arg5@@21 arg6@@17))
)))
(assert (forall ((|$l#0#heap#0@@6| T@U) (|$l#0#x#0@@1| T@U) (|l#0@@89| Int) (|l#1@@49| Int) (|l#2@@49| T@U) (|l#3@@46| Int) (|l#4@@1| T@U) (|l#5@@1| Int) (|l#6@@1| T@U) ) (!  (=> (and (and (and (and (= (type |$l#0#heap#0@@6|) (MapType0Type refType MapType1Type)) (= (type |$l#0#x#0@@1|) BoxType)) (= (type |l#2@@49|) (SeqType BoxType))) (= (type |l#4@@1|) (SeqType BoxType))) (= (type |l#6@@1|) (SeqType BoxType))) (= (MapType2Select (|lambda#85| |l#0@@89| |l#1@@49| |l#2@@49| |l#3@@46| |l#4@@1| |l#5@@1| |l#6@@1|) |$l#0#heap#0@@6| |$l#0#x#0@@1|) ($Box (int_2_U (ite (= (U_2_int ($Unbox intType |$l#0#x#0@@1|)) |l#0@@89|) |l#1@@49| (ite (>= (U_2_int ($Unbox intType (|Seq#Index| |l#2@@49| (U_2_int ($Unbox intType |$l#0#x#0@@1|))))) |l#3@@46|) (+ (U_2_int ($Unbox intType (|Seq#Index| |l#4@@1| (U_2_int ($Unbox intType |$l#0#x#0@@1|))))) |l#5@@1|) (U_2_int ($Unbox intType (|Seq#Index| |l#6@@1| (U_2_int ($Unbox intType |$l#0#x#0@@1|)))))))))))
 :qid |DafnyPre.515:12|
 :skolemid |1657|
 :pattern ( (MapType2Select (|lambda#85| |l#0@@89| |l#1@@49| |l#2@@49| |l#3@@46| |l#4@@1| |l#5@@1| |l#6@@1|) |$l#0#heap#0@@6| |$l#0#x#0@@1|))
)))
(assert (forall ((arg0@@308 T@U) (arg1@@171 T@U) (arg2@@121 T@U) (arg3@@91 Bool) ) (! (= (type (|lambda#95| arg0@@308 arg1@@171 arg2@@121 arg3@@91)) (MapType6Type refType boolType))
 :qid |funType:lambda#95|
 :pattern ( (|lambda#95| arg0@@308 arg1@@171 arg2@@121 arg3@@91))
)))
(assert (forall (($o@@54 T@U) ($f@@44 T@U) (|l#0@@90| T@U) (|l#1@@50| T@U) (|l#2@@50| T@U) (|l#3@@47| Bool) ) (! (let ((alpha@@51 (FieldTypeInv0 (type $f@@44))))
 (=> (and (and (and (and (= (type $o@@54) refType) (= (type $f@@44) (FieldType alpha@@51))) (= (type |l#0@@90|) refType)) (= (type |l#1@@50|) (MapType0Type refType MapType1Type))) (= (type |l#2@@50|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#95| |l#0@@90| |l#1@@50| |l#2@@50| |l#3@@47|) $o@@54 $f@@44))  (=> (and (not (= $o@@54 |l#0@@90|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@50| $o@@54) |l#2@@50|))) |l#3@@47|))))
 :qid |DLLDafny.322:20|
 :skolemid |1658|
 :pattern ( (MapType6Select (|lambda#95| |l#0@@90| |l#1@@50| |l#2@@50| |l#3@@47|) $o@@54 $f@@44))
)))
(assert (forall ((arg0@@309 T@U) (arg1@@172 T@U) (arg2@@122 T@U) (arg3@@92 Bool) ) (! (= (type (|lambda#96| arg0@@309 arg1@@172 arg2@@122 arg3@@92)) (MapType6Type refType boolType))
 :qid |funType:lambda#96|
 :pattern ( (|lambda#96| arg0@@309 arg1@@172 arg2@@122 arg3@@92))
)))
(assert (forall (($o@@55 T@U) ($f@@45 T@U) (|l#0@@91| T@U) (|l#1@@51| T@U) (|l#2@@51| T@U) (|l#3@@48| Bool) ) (! (let ((alpha@@52 (FieldTypeInv0 (type $f@@45))))
 (=> (and (and (and (and (= (type $o@@55) refType) (= (type $f@@45) (FieldType alpha@@52))) (= (type |l#0@@91|) refType)) (= (type |l#1@@51|) (MapType0Type refType MapType1Type))) (= (type |l#2@@51|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#96| |l#0@@91| |l#1@@51| |l#2@@51| |l#3@@48|) $o@@55 $f@@45))  (=> (and (not (= $o@@55 |l#0@@91|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@51| $o@@55) |l#2@@51|))) |l#3@@48|))))
 :qid |DLLDafny.327:8|
 :skolemid |1659|
 :pattern ( (MapType6Select (|lambda#96| |l#0@@91| |l#1@@51| |l#2@@51| |l#3@@48|) $o@@55 $f@@45))
)))
(assert (forall ((arg0@@310 T@U) (arg1@@173 T@U) (arg2@@123 T@U) (arg3@@93 Bool) ) (! (= (type (|lambda#97| arg0@@310 arg1@@173 arg2@@123 arg3@@93)) (MapType6Type refType boolType))
 :qid |funType:lambda#97|
 :pattern ( (|lambda#97| arg0@@310 arg1@@173 arg2@@123 arg3@@93))
)))
(assert (forall (($o@@56 T@U) ($f@@46 T@U) (|l#0@@92| T@U) (|l#1@@52| T@U) (|l#2@@52| T@U) (|l#3@@49| Bool) ) (! (let ((alpha@@53 (FieldTypeInv0 (type $f@@46))))
 (=> (and (and (and (and (= (type $o@@56) refType) (= (type $f@@46) (FieldType alpha@@53))) (= (type |l#0@@92|) refType)) (= (type |l#1@@52|) (MapType0Type refType MapType1Type))) (= (type |l#2@@52|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#97| |l#0@@92| |l#1@@52| |l#2@@52| |l#3@@49|) $o@@56 $f@@46))  (=> (and (not (= $o@@56 |l#0@@92|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@52| $o@@56) |l#2@@52|))) |l#3@@49|))))
 :qid |DLLDafny.327:8|
 :skolemid |1660|
 :pattern ( (MapType6Select (|lambda#97| |l#0@@92| |l#1@@52| |l#2@@52| |l#3@@49|) $o@@56 $f@@46))
)))
(assert (forall ((arg0@@311 T@U) (arg1@@174 T@U) (arg2@@124 T@U) (arg3@@94 Bool) ) (! (= (type (|lambda#98| arg0@@311 arg1@@174 arg2@@124 arg3@@94)) (MapType6Type refType boolType))
 :qid |funType:lambda#98|
 :pattern ( (|lambda#98| arg0@@311 arg1@@174 arg2@@124 arg3@@94))
)))
(assert (forall (($o@@57 T@U) ($f@@47 T@U) (|l#0@@93| T@U) (|l#1@@53| T@U) (|l#2@@53| T@U) (|l#3@@50| Bool) ) (! (let ((alpha@@54 (FieldTypeInv0 (type $f@@47))))
 (=> (and (and (and (and (= (type $o@@57) refType) (= (type $f@@47) (FieldType alpha@@54))) (= (type |l#0@@93|) refType)) (= (type |l#1@@53|) (MapType0Type refType MapType1Type))) (= (type |l#2@@53|) (FieldType boolType))) (= (U_2_bool (MapType6Select (|lambda#98| |l#0@@93| |l#1@@53| |l#2@@53| |l#3@@50|) $o@@57 $f@@47))  (=> (and (not (= $o@@57 |l#0@@93|)) (U_2_bool (MapType1Select (MapType0Select |l#1@@53| $o@@57) |l#2@@53|))) |l#3@@50|))))
 :qid |DLLDafny.360:8|
 :skolemid |1661|
 :pattern ( (MapType6Select (|lambda#98| |l#0@@93| |l#1@@53| |l#2@@53| |l#3@@50|) $o@@57 $f@@47))
)))
(declare-fun |l#0@@94| () T@U)
(declare-fun _module._default.Index$A@@3 () T@U)
...
(assert  (and (and (and (and (= (type |l#0@@94|) DatatypeTypeType) (= (type _module._default.Index$A@@3) TyType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type $_Frame@0) (MapType6Type refType boolType))) (= (type $_Frame@0@@0) (MapType6Type refType boolType))))
(push 1)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Index)
(assert (not
(let ((GeneratedUnifiedExit_correct  (=> (! (and %lbl%+0 true) :lblpos +0) (and (! (or %lbl%@1  (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (_module.__default.ValidPtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (<= 0 |i#2@@2|))) :lblneg @1) (=> (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (_module.__default.ValidPtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (<= 0 |i#2@@2|)) (and (! (or %lbl%@2  (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (_module.__default.ValidPtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (< |i#2@@2| (|Seq#Length| (_module.__default.Seq _module._default.Index$A@@3 |l#0@@94|))))) :lblneg @2) (=> (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (_module.__default.ValidPtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (< |i#2@@2| (|Seq#Length| (_module.__default.Seq _module._default.Index$A@@3 |l#0@@94|)))) (! (or %lbl%@3  (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (= |p#0@@30| 0)) (= |i#2@@2| (- 0 1)))) :lblneg @3))))))))
(let ((anon26_correct  (=> (! (and %lbl%+4 true) :lblpos +4) (=> (and (and (= |i#3@0| |let#0#0#0|) (= (_module.__default.Index _module._default.Index$A@@3 |l#0@@94| |p#0@@30|) |i#3@0|)) (and ($Is (int_2_U (_module.__default.Index _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) TInt) (= (_module.__default.Index _module._default.Index$A@@3 |l#0@@94| |p#0@@30|) |i#2@@2|))) (and (! (or %lbl%@5 |b$reqreads#0@0|) :lblneg @5) (=> |b$reqreads#0@0| (and (! (or %lbl%@6 |b$reqreads#1@1|) :lblneg @6) (=> |b$reqreads#1@1| GeneratedUnifiedExit_correct))))))))
(let ((anon24_correct  (=> (! (and %lbl%+7 true) :lblpos +7) (=> (=> (<= 0 |p#0@@30|) (_module.DList.DList_q |l#0@@94|)) (=> (and (and (<= 0 |p#0@@30|) (< |p#0@@30| (|Seq#Length| (_module.DList.g |l#0@@94|)))) (_module.DList.DList_q |l#0@@94|)) (and (! (or %lbl%@8  (and (<= 0 |p#0@@30|) (< |p#0@@30| (|Seq#Length| (_module.DList.g |l#0@@94|))))) :lblneg @8) (=> (and (<= 0 |p#0@@30|) (< |p#0@@30| (|Seq#Length| (_module.DList.g |l#0@@94|)))) (=> (= |let#0#0#0| (U_2_int ($Unbox intType (|Seq#Index| (_module.DList.g |l#0@@94|) |p#0@@30|)))) (=> (and (_module.DList.DList_q |l#0@@94|) ($Is (int_2_U |let#0#0#0|) TInt)) anon26_correct)))))))))
(let ((anon37_Else_correct  (=> (! (and %lbl%+9 true) :lblpos +9) (=> (< |p#0@@30| 0) anon24_correct))))
(let ((anon37_Then_correct  (=> (! (and %lbl%+10 true) :lblpos +10) (=> (and (<= 0 |p#0@@30|) (_module.DList.DList_q |l#0@@94|)) anon24_correct))))
(let ((anon22_correct  (=> (! (and %lbl%+11 true) :lblpos +11) (=> (=> (not (= |p#0@@30| 0)) (=> (< 0 |p#0@@30|) (_module.DList.DList_q |l#0@@94|))) (and (! (or %lbl%@12  (or (= |p#0@@30| 0) (and (< 0 |p#0@@30|) (< |p#0@@30| (|Seq#Length| (_module.DList.g |l#0@@94|)))))) :lblneg @12) (=> (or (= |p#0@@30| 0) (and (< 0 |p#0@@30|) (< |p#0@@30| (|Seq#Length| (_module.DList.g |l#0@@94|))))) (and anon37_Then_correct anon37_Else_correct)))))))
(let ((anon36_Else_correct  (=> (! (and %lbl%+13 true) :lblpos +13) (=> (<= |p#0@@30| 0) anon22_correct))))
(let ((anon36_Then_correct  (=> (! (and %lbl%+14 true) :lblpos +14) (=> (and (< 0 |p#0@@30|) (_module.DList.DList_q |l#0@@94|)) anon22_correct))))
(let ((anon35_Then_correct  (=> (! (and %lbl%+15 true) :lblpos +15) (=> (not (= |p#0@@30| 0)) (and anon36_Then_correct anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (! (and %lbl%+16 true) :lblpos +16) (=> (= |p#0@@30| 0) anon22_correct))))
(let ((anon19_correct  (=> (! (and %lbl%+17 true) :lblpos +17) (=> (=> (< 0 |p#0@@30|) (not (= |p#0@@30| 0))) (and anon35_Then_correct anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (! (and %lbl%+18 true) :lblpos +18) (=> (<= |p#0@@30| 0) anon19_correct))))
(let ((anon34_Then_correct  (=> (! (and %lbl%+19 true) :lblpos +19) (=> (< 0 |p#0@@30|) anon19_correct))))
(let ((anon17_correct  (=> (! (and %lbl%+20 true) :lblpos +20) (=> (=> (< 0 |p#0@@30|) (<= 0 |p#0@@30|)) (and anon34_Then_correct anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (! (and %lbl%+21 true) :lblpos +21) (=> (<= |p#0@@30| 0) anon17_correct))))
(let ((anon33_Then_correct  (=> (! (and %lbl%+22 true) :lblpos +22) (=> (< 0 |p#0@@30|) anon17_correct))))
(let ((anon32_Then_correct  (=> (! (and %lbl%+23 true) :lblpos +23) (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (_module.__default.MaybePtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (and anon33_Then_correct anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (! (and %lbl%+24 true) :lblpos +24) (=> (not (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (_module.__default.MaybePtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|))) (=> (and (= |let#0#0#0| 0) ($Is (int_2_U |let#0#0#0|) TInt)) anon26_correct)))))
(let ((anon31_Else_correct  (=> (! (and %lbl%+25 true) :lblpos +25) (=> (not (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|)) (=> (and (=> |b$reqreads#1@1| true) (=> true |b$reqreads#1@1|)) (and anon32_Then_correct anon32_Else_correct))))))
(let ((anon31_Then_correct  (=> (! (and %lbl%+26 true) :lblpos +26) (=> (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (=> (and ($IsAlloc |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3) $Heap) ($IsAlloc (int_2_U |p#0@@30|) TInt $Heap)) (=> (and (and (and (=> |b$reqreads#1@0| (forall (($o@@58 T@U) ($f@@48 T@U) ) (! (let ((alpha@@55 (FieldTypeInv0 (type $f@@48))))
 (=> (and (and (= (type $o@@58) refType) (= (type $f@@48) (FieldType alpha@@55))) false) (U_2_bool (MapType6Select $_Frame@0 $o@@58 $f@@48))))
 :qid |DLLDafny.124:18|
 :skolemid |1160|
 :no-pattern (type $o@@58)
...
))) (=> (forall (($o@@59 T@U) ($f@@49 T@U) ) (! (let ((alpha@@56 (FieldTypeInv0 (type $f@@49))))
 (=> (and (and (= (type $o@@59) refType) (= (type $f@@49) (FieldType alpha@@56))) false) (U_2_bool (MapType6Select $_Frame@0 $o@@59 $f@@49))))
 :qid |DLLDafny.124:18|
 :skolemid |1160|
 :no-pattern (type $o@@59)
 ...
 :no-pattern (U_2_int $o@@59)
 :no-pattern (U_2_bool $o@@59)
 :no-pattern (U_2_int $f@@49)
 :no-pattern (U_2_bool $f@@49)
)) |b$reqreads#1@0|)) (|_module.__default.MaybePtr#canCall| _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (and (=> |b$reqreads#1@1| |b$reqreads#1@0|) (=> |b$reqreads#1@0| |b$reqreads#1@1|))) (and anon32_Then_correct anon32_Else_correct)))))))
(let ((anon27_Else_correct  (=> (! (and %lbl%+27 true) :lblpos +27) (=> (and (= $_Frame@0@@0 (|lambda#17| null $Heap alloc false)) ($IsAlloc |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3) $Heap)) (=> (and (and (=> |b$reqreads#0@0| (forall (($o@@60 T@U) ($f@@50 T@U) ) (! (let ((alpha@@57 (FieldTypeInv0 (type $f@@50))))
 (=> (and (and (= (type $o@@60) refType) (= (type $f@@50) (FieldType alpha@@57))) false) (U_2_bool (MapType6Select $_Frame@0 $o@@60 $f@@50))))
 :qid |DLLDafny.124:8|
 :skolemid |1159|
 :no-pattern (type $o@@60)
 :no-pattern (type $f@@50)
 :no-pattern (U_2_int $o@@60)
 :no-pattern (U_2_bool $o@@60)
 :no-pattern (U_2_int $f@@50)
 :no-pattern (U_2_bool $f@@50)
))) (=> (forall (($o@@61 T@U) ($f@@51 T@U) ) (! (let ((alpha@@58 (FieldTypeInv0 (type $f@@51))))
 (=> (and (and (= (type $o@@61) refType) (= (type $f@@51) (FieldType alpha@@58))) false) (U_2_bool (MapType6Select $_Frame@0 $o@@61 $f@@51))))
 :qid |DLLDafny.124:8|
 :skolemid |1159|
 :no-pattern (type $o@@61)
 :no-pattern (type $f@@51)
 :no-pattern (U_2_int $o@@61)
 :no-pattern (U_2_bool $o@@61)
 :no-pattern (U_2_int $f@@51)
 :no-pattern (U_2_bool $f@@51)
)) |b$reqreads#0@0|)) (|_module.__default.Inv#canCall| _module._default.Index$A@@3 |l#0@@94|)) (and anon31_Then_correct anon31_Else_correct))))))
(let ((anon11_correct  (=> (! (and %lbl%+28 true) :lblpos +28) true)))
(let ((anon30_Else_correct  (=> (! (and %lbl%+29 true) :lblpos +29) (=> (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (= |p#0@@30| 0)) (= |i#2@@2| (- 0 1))) anon11_correct))))
(let ((anon30_Then_correct  (=> (! (and %lbl%+30 true) :lblpos +30) (=> ($IsAlloc |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3) $Heap) (=> (and (and (|_module.__default.Inv#canCall| _module._default.Index$A@@3 |l#0@@94|) (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|)) (and (= |p#0@@30| 0) (= |i#2@@2| (- 0 1)))) anon11_correct)))))
(let ((anon29_Else_correct  (=> (! (and %lbl%+31 true) :lblpos +31) (=> (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (_module.__default.ValidPtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (< |i#2@@2| (|Seq#Length| (_module.__default.Seq _module._default.Index$A@@3 |l#0@@94|)))) (and anon30_Then_correct anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (! (and %lbl%+32 true) :lblpos +32) (=> (and ($IsAlloc |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3) $Heap) (|_module.__default.Inv#canCall| _module._default.Index$A@@3 |l#0@@94|)) (=> (and (and (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) ($IsAlloc |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3) $Heap)) (and ($IsAlloc (int_2_U |p#0@@30|) TInt $Heap) (|_module.__default.ValidPtr#canCall| _module._default.Index$A@@3 |l#0@@94| |p#0@@30|))) (and (and (_module.__default.ValidPtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|) ($IsAlloc |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3) $Heap)) (and (|_module.__default.Seq#canCall| _module._default.Index$A@@3 |l#0@@94|) (< |i#2@@2| (|Seq#Length| (_module.__default.Seq _module._default.Index$A@@3 |l#0@@94|)))))) (and anon30_Then_correct anon30_Else_correct))))))
(let ((anon28_Else_correct  (=> (! (and %lbl%+33 true) :lblpos +33) (=> (=> (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) (_module.__default.ValidPtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (<= 0 |i#2@@2|)) (and anon29_Then_correct anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> (! (and %lbl%+34 true) :lblpos +34) (=> (and (and (and ($IsAlloc |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3) $Heap) (|_module.__default.Inv#canCall| _module._default.Index$A@@3 |l#0@@94|)) (and (_module.__default.Inv _module._default.Index$A@@3 |l#0@@94|) ($IsAlloc |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3) $Heap))) (and (and ($IsAlloc (int_2_U |p#0@@30|) TInt $Heap) (|_module.__default.ValidPtr#canCall| _module._default.Index$A@@3 |l#0@@94| |p#0@@30|)) (and (_module.__default.ValidPtr _module._default.Index$A@@3 |l#0@@94| |p#0@@30|) (<= 0 |i#2@@2|)))) (and anon29_Then_correct anon29_Else_correct)))))
(let ((anon0_correct  (=> (! (and %lbl%+35 true) :lblpos +35) (=> (= $_Frame@0 (|lambda#16| null $Heap alloc false)) (and (and anon27_Else_correct anon28_Then_correct) anon28_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+36 true) :lblpos +36) (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is |l#0@@94| (Tclass._module.DList _module._default.Index$A@@3)) (= 12 $FunctionContextHeight))) anon0_correct))))
