...
// function declaration for _module._default.mySeqIndex
function _module.__default.mySeqIndex(_module._default.mySeqIndex$X: Ty, i#0: int, s#0: Seq Box) : Box;

function _module.__default.mySeqIndex#canCall(_module._default.mySeqIndex$X: Ty, i#0: int, s#0: Seq Box) : bool;

// consequence axiom for _module.__default.mySeqIndex
axiom 0 <= $FunctionContextHeight
   ==> (forall _module._default.mySeqIndex$X: Ty, i#0: int, s#0: Seq Box :: 
    { _module.__default.mySeqIndex(_module._default.mySeqIndex$X, i#0, s#0) } 
    _module.__default.mySeqIndex#canCall(_module._default.mySeqIndex$X, i#0, s#0)
         || (0 != $FunctionContextHeight
           && 
          $Is(s#0, TSeq(_module._default.mySeqIndex$X))
           && 
          LitInt(0) <= i#0
           && i#0 < Seq#Length(s#0))
       ==> Seq#Index(s#0, i#0)
           == _module.__default.mySeqIndex(_module._default.mySeqIndex$X, i#0, s#0)
         && $IsBox(_module.__default.mySeqIndex(_module._default.mySeqIndex$X, i#0, s#0), 
          _module._default.mySeqIndex$X));

function _module.__default.mySeqIndex#requires(Ty, int, Seq Box) : bool;

// #requires axiom for _module.__default.mySeqIndex
axiom (forall _module._default.mySeqIndex$X: Ty, i#0: int, s#0: Seq Box :: 
  { _module.__default.mySeqIndex#requires(_module._default.mySeqIndex$X, i#0, s#0) } 
  $Is(s#0, TSeq(_module._default.mySeqIndex$X))
     ==> _module.__default.mySeqIndex#requires(_module._default.mySeqIndex$X, i#0, s#0)
       == (LitInt(0) <= i#0 && i#0 < Seq#Length(s#0)));

procedure CheckWellformed$$_module.__default.mySeqIndex(_module._default.mySeqIndex$X: Ty, 
    i#0: int, 
    s#0: Seq Box where $Is(s#0, TSeq(_module._default.mySeqIndex$X)))
   returns (v#0: Box where $IsBox(v#0, _module._default.mySeqIndex$X));
...
implementation CheckWellformed$$_module.__default.mySeqIndex(_module._default.mySeqIndex$X: Ty, i#0: int, s#0: Seq Box) returns (v#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;


    // AddWellformednessCheck for function mySeqIndex
    assume {:captureState "test_Dafny.dfy(1,16): initial state"} true;
    ...
    if (*)
    {
        assume $IsBox(_module.__default.mySeqIndex(_module._default.mySeqIndex$X, i#0, s#0), 
          _module._default.mySeqIndex$X);
...
procedure CheckWellformed$$_module.__default.myTest(s1#0: Seq Box where $Is(s1#0, TSeq(TBool)) && $IsAlloc(s1#0, TSeq(TBool), $Heap), 
...
procedure Call$$_module.__default.myTest(s1#0: Seq Box where $Is(s1#0, TSeq(TBool)) && $IsAlloc(s1#0, TSeq(TBool), $Heap), 
    s2#0: Seq Box where $Is(s2#0, TSeq(TInt)) && $IsAlloc(s2#0, TSeq(TInt), $Heap));
  modifies $Heap, $Tick;
...
procedure Impl$$_module.__default.myTest(s1#0: Seq Box where $Is(s1#0, TSeq(TBool)) && $IsAlloc(s1#0, TSeq(TBool), $Heap), 
    s2#0: Seq Box where $Is(s2#0, TSeq(TInt)) && $IsAlloc(s2#0, TSeq(TInt), $Heap))
...
implementation Impl$$_module.__default.myTest(s1#0: Seq Box, s2#0: Seq Box) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#0: int;
  var ##i#0: int;
  ...
  var ##s#6: Seq Box;
    ...
    // AddMethodImpl: myTest, Impl$$_module.__default.myTest
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "test_Dafny.dfy(6,4): initial state"} true;
    $_reverifyPost := false;
    // ----- assume statement ----- test_Dafny.dfy(7,9)
    havoc i#0;
    ...
    if (LitInt(0) <= i#0 && i#0 < Seq#Length(s2#0))
    {
        ##i#0 := i#0;
        ...
        assume _module.__default.mySeqIndex#canCall(TInt, i#0, s2#0);
        if (0 < $Unbox(_module.__default.mySeqIndex(TInt, i#0, s2#0)): int)
        {
            ##i#1 := i#0;
            // assume allocatedness for argument to function
    ...
    assume (forall i#1: int :: 
      { $Unbox(_module.__default.mySeqIndex(TInt, i#1, s2#0)): int } 
      (LitInt(0) <= i#1 && i#1 < Seq#Length(s2#0)
           ==> _module.__default.mySeqIndex#canCall(TInt, i#1, s2#0))
         && (
          (LitInt(0) <= i#1 && i#1 < Seq#Length(s2#0)
           ==> 0 < $Unbox(_module.__default.mySeqIndex(TInt, i#1, s2#0)): int)
           ==> 
          LitInt(0) <= i#1 && i#1 < Seq#Length(s2#0)
           ==> _module.__default.mySeqIndex#canCall(TInt, i#1, s2#0)));
    assume (forall i#1: int :: 
      ...
      true
         ==> (LitInt(0) <= i#1 && i#1 < Seq#Length(s2#0)
             ==> 0 < $Unbox(_module.__default.mySeqIndex(TInt, i#1, s2#0)): int)
           && (LitInt(0) <= i#1 && i#1 < Seq#Length(s2#0)
             ==> $Unbox(_module.__default.mySeqIndex(TInt, i#1, s2#0)): int < Seq#Length(s1#0)));
    // ----- assume statement ----- test_Dafny.dfy(8,9)
    havoc i#2;
    // Begin Comprehension WF check
    if (LitInt(0) <= i#2)
    {
    ...
    if (LitInt(0) <= i#2 && i#2 < Seq#Length(s1#0))
    {
        ##i#2 := i#2;
        // assume allocatedness for argument to function
        ...
        ##s#2 := s1#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##s#2, TSeq(TBool), $Heap);
        assert {:subsumption 0} LitInt(0) <= ##i#2;
        assert {:subsumption 0} ##i#2 < Seq#Length(##s#2);
        assume _module.__default.mySeqIndex#canCall(TBool, i#2, s1#0);
    }

    // End Comprehension WF check
    assume (forall i#3: int :: 
      { $Unbox(_module.__default.mySeqIndex(TBool, i#3, s1#0)): bool } 
      LitInt(0) <= i#3 && i#3 < Seq#Length(s1#0)
         ==> _module.__default.mySeqIndex#canCall(TBool, i#3, s1#0));
    assume (forall i#3: int :: 
      { $Unbox(_module.__default.mySeqIndex(TBool, i#3, s1#0)): bool } 
      true
         ==> 
        LitInt(0) <= i#3 && i#3 < Seq#Length(s1#0)
         ==> $Unbox(_module.__default.mySeqIndex(TBool, i#3, s1#0)): bool);
    // ----- assert statement ----- test_Dafny.dfy(9,9)
    havoc i#4;
    // Begin Comprehension WF check
    if (LitInt(0) <= i#4)
    {
    ...
    if (LitInt(0) <= i#4 && i#4 < Seq#Length(s2#0))
    {
        ##i#3 := i#4;
        // assume allocatedness for argument to function
        ...
        assert {:subsumption 0} ##i#3 < Seq#Length(##s#3);
        assume _module.__default.mySeqIndex#canCall(TInt, i#4, s2#0);
        if (LitInt(0) <= $Unbox(_module.__default.mySeqIndex(TInt, i#4, s2#0)): int)
        {
            ##i#4 := i#4;
            // assume allocatedness for argument to function
            ...
            assert {:subsumption 0} ##i#4 < Seq#Length(##s#4);
            assume _module.__default.mySeqIndex#canCall(TInt, i#4, s2#0);
        }

        if (LitInt(0) <= $Unbox(_module.__default.mySeqIndex(TInt, i#4, s2#0)): int
           && $Unbox(_module.__default.mySeqIndex(TInt, i#4, s2#0)): int < Seq#Length(s1#0))
        {
            ##i#5 := i#4;
            // assume allocatedness for argument to function
            ...
            assert {:subsumption 0} ##i#5 < Seq#Length(##s#5);
            assume _module.__default.mySeqIndex#canCall(TInt, i#4, s2#0);
            ##i#6 := $Unbox(_module.__default.mySeqIndex(TInt, i#4, s2#0)): int;
            // assume allocatedness for argument to function
            assume $IsAlloc(##i#6, TInt, $Heap);
            ##s#6 := s1#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##s#6, TSeq(TBool), $Heap);
            assert {:subsumption 0} LitInt(0) <= ##i#6;
            assert {:subsumption 0} ##i#6 < Seq#Length(##s#6);
            assume _module.__default.mySeqIndex#canCall(TBool, $Unbox(_module.__default.mySeqIndex(TInt, i#4, s2#0)): int, s1#0);
        }
    }

    // End Comprehension WF check
    assume (forall i#5: int :: 
      { $Unbox(_module.__default.mySeqIndex(TInt, i#5, s2#0)): int } 
      LitInt(0) <= i#5 && i#5 < Seq#Length(s2#0)
         ==> _module.__default.mySeqIndex#canCall(TInt, i#5, s2#0)
           && (LitInt(0) <= $Unbox(_module.__default.mySeqIndex(TInt, i#5, s2#0)): int
             ==> _module.__default.mySeqIndex#canCall(TInt, i#5, s2#0))
           && (LitInt(0) <= $Unbox(_module.__default.mySeqIndex(TInt, i#5, s2#0)): int
               && $Unbox(_module.__default.mySeqIndex(TInt, i#5, s2#0)): int < Seq#Length(s1#0)
             ==> _module.__default.mySeqIndex#canCall(TInt, i#5, s2#0)
               && _module.__default.mySeqIndex#canCall(TBool, $Unbox(_module.__default.mySeqIndex(TInt, i#5, s2#0)): int, s1#0)));
    assert (forall i#5: int :: 
      ...
      true
        ...
        LitInt(0) <= $Unbox(_module.__default.mySeqIndex(TInt, i#5, s2#0)): int
           && $Unbox(_module.__default.mySeqIndex(TInt, i#5, s2#0)): int < Seq#Length(s1#0)
         ==> $Unbox(_module.__default.mySeqIndex(TBool, $Unbox(_module.__default.mySeqIndex(TInt, i#5, s2#0)): int, s1#0)): bool);
}



// function declaration for _module._default.myP
function _module.__default.myP(a#0: bool, b#0: bool) : bool;
...
// #requires axiom for _module.__default.myP
axiom (forall a#0: bool, b#0: bool :: 
  { _module.__default.myP#requires(a#0, b#0) } 
...
procedure Call$$_module.__default.myTest2(a#0: bool, b#0: bool);
  modifies $Heap, $Tick;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation Impl$$_module.__default.myTest2(a#0: bool, b#0: bool) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var ##a#0: bool;
  var ##b#0: bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "test_Dafny.dfy(17,4): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- test_Dafny.dfy(17,7)
    ##a#0 := a#0;
    // assume allocatedness for argument to function
    ...
    {
        // ----- assert statement ----- test_Dafny.dfy(17,22)
        if (!a#0)
        {
        }
