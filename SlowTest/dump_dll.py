...
loc_orig_5 = os.path.join('Logs_orig_4.8.5', '*.trace')
loc_orig_9 = os.path.join('Logs_orig_4.8.9', '*.trace')
loc_adt_5 = os.path.join('Logs_adt_4.8.5', '*.trace')
loc_adt_9 = os.path.join('Logs_adt_4.8.9', '*.trace')
...
orig_cp3_mean, orig_cp1_mean, adt_cp3_mean, adt_cp1_mean = (Expand_cp3_5_mean, Expand_cp3_9_mean, Remove_cp3_5_mean, Remove_cp3_9_mean, InsertAfter_cp3_5_mean, InsertAfter_cp3_9_mean, InsertBefore_cp3_5_mean, InsertBefore_cp3_9_mean), (Expand_cp1_5_mean, Expand_cp1_9_mean, Remove_cp1_5_mean, Remove_cp1_9_mean, InsertAfter_cp1_5_mean, InsertAfter_cp1_9_mean, InsertBefore_cp1_5_mean, InsertBefore_cp1_9_mean), (Expand_adt_cp3_5_mean, Expand_adt_cp3_9_mean, Remove_adt_cp3_5_mean, Remove_adt_cp3_9_mean, InsertAfter_adt_cp3_5_mean, InsertAfter_adt_cp3_9_mean, InsertBefore_adt_cp3_5_mean, InsertBefore_adt_cp3_9_mean), (Expand_adt_cp1_5_mean, Expand_adt_cp1_9_mean, Remove_adt_cp1_5_mean, Remove_adt_cp1_9_mean, InsertAfter_adt_cp1_5_mean, InsertAfter_adt_cp1_9_mean, InsertBefore_adt_cp1_5_mean, InsertBefore_adt_cp1_9_mean)

orig_cp3_std, orig_cp1_std, adt_cp3_std, adt_cp1_std = (Expand_cp3_5_std, Expand_cp3_9_std, Remove_cp3_5_std, Remove_cp3_9_std, InsertAfter_cp3_5_std, InsertAfter_cp3_9_std, InsertBefore_cp3_5_std, InsertBefore_cp3_9_std), (Expand_cp1_5_std, Expand_cp1_9_std, Remove_cp1_5_std, Remove_cp1_9_std, InsertAfter_cp1_5_std, InsertAfter_cp1_9_std, InsertBefore_cp1_5_std, InsertBefore_cp1_9_std), (Expand_adt_cp3_5_std, Expand_adt_cp3_9_std, Remove_adt_cp3_5_std, Remove_adt_cp3_9_std, InsertAfter_adt_cp3_5_std, InsertAfter_adt_cp3_9_std, InsertBefore_adt_cp3_5_std, InsertBefore_adt_cp3_9_std), (Expand_adt_cp1_5_std, Expand_adt_cp1_9_std, Remove_adt_cp1_5_std, Remove_adt_cp1_9_std, InsertAfter_adt_cp1_5_std, InsertAfter_adt_cp1_9_std, InsertBefore_adt_cp1_5_std, InsertBefore_adt_cp1_9_std)
...
ax.set_ylabel('Execution time', fontsize=13)
ax.set_xticks(ind)
