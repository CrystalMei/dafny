...
dafny /compile:0 SMN-ADT-module-ContLen-Add.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:smt.CASE_SPLIT=1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.9/bin/z3" > $ADT_9_LOG_DIR/CP1-S0.trace;
echo "4.8.9, CP1, no Seed, done";
for i in $seeds; do
    dafny /compile:0 SMN-ADT-module-ContLen-Add.dfy /restartProver /trace /timeLimit:100 /proverOpt:O:random-seed=${i}00 /proverOpt:O:smt.CASE_SPLIT=1 /z3exe:"/home/jmhu/MSRintern/dafny/Binaries/z3-4.8.9/bin/z3" > $ADT_9_LOG_DIR/CP1-S${i}00.trace;
    echo "4.8.9, CP1, Seed${i}00, done";
done
